namespace Humidifier.ElastiCache
{
    ...
    public class ServerlessCache : Humidifier.Resource, IHaveTags, IHaveDescription
    {
        ...
        /// </summary>
        public CacheUsageLimits CacheUsageLimits { get; set; }
        /// <summary>
        /// SecurityGroupIds
        ...
        /// PrimitiveType: String
        /// </summary>
        public dynamic ServerlessCacheName { get; set; }
        /// <summary>
        /// MajorEngineVersion
    ...
    namespace ServerlessCacheTypes
    {
        public class CacheUsageLimits
        {
            ...
            /// Type: ECPUPerSecond
            /// </summary>
            public ECPUPerSecond ECPUPerSecond { get; set; }
        }
