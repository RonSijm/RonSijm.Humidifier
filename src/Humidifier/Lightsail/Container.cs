namespace Humidifier.Lightsail
{
    ...
    public class Container : Humidifier.Resource
    {
        ...
        /// </summary>
        public List<PublicDomainName> PublicDomainNames { get; set; }
        /// <summary>
        /// ServiceName
        ...
        /// </summary>
        public ContainerServiceDeployment ContainerServiceDeployment { get; set; }
        /// <summary>
        /// IsDisabled
    ...
    namespace ContainerTypes
    {
        ...
        public class ContainerServiceDeployment
        {
            ...
            /// Type: PublicEndpoint
            /// </summary>
            public PublicEndpoint PublicEndpoint { get; set; }
        }

        public class EcrImagePullerRole
        {
            /// <summary>
            /// PrincipalArn
        ...
        public class PrivateRegistryAccess
        {
            ...
            /// </summary>
            public EcrImagePullerRole EcrImagePullerRole { get; set; }
        }
