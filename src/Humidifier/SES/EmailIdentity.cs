namespace Humidifier.SES
{
    ...
    public class EmailIdentity : Humidifier.Resource
    {
        ...
        /// </summary>
        public ConfigurationSetAttributes ConfigurationSetAttributes { get; set; }
        /// <summary>
        /// EmailIdentity
    ...
    {
        public class ConfigurationSetAttributes
        {
            /// <summary>
