namespace Humidifier.StepFunctions
{
    ...
    public class StateMachineAlias : Humidifier.Resource, IHaveDescription
    {
        ...
        /// </summary>
        public List<RoutingConfigurationVersion> RoutingConfiguration { get; set; }
        /// <summary>
    ...
    namespace StateMachineAliasTypes
    {
        ...
        public class RoutingConfigurationVersion
        {
            /// <summary>
            /// StateMachineVersionArn
