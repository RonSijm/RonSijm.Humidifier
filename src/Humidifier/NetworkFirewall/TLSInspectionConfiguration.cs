namespace Humidifier.NetworkFirewall
{
    ...
    public class TLSInspectionConfiguration : Humidifier.Resource, IHaveTags, IHaveDescription
    {
        ...
        /// PrimitiveType: String
        /// </summary>
        public dynamic TLSInspectionConfigurationName { get; set; }
        /// <summary>
        /// Tags
        ...
        /// </summary>
        public TLSInspectionConfiguration TLSInspectionConfiguration_ { get; set; }
    }
    ...
    namespace TLSInspectionConfigurationTypes
    {
        ...
        public class CheckCertificateRevocationStatus
        {
            /// <summary>
            /// UnknownStatusAction
        ...
        public class ServerCertificateConfiguration
        {
            ...
            /// </summary>
            public CheckCertificateRevocationStatus CheckCertificateRevocationStatus { get; set; }
            /// <summary>
            /// Scopes
            ...
            /// </summary>
            public List<ServerCertificateScope> Scopes { get; set; }
            /// <summary>
            /// ServerCertificates
        ...
        public class TLSInspectionConfiguration
        {
            ...
            /// </summary>
            public List<ServerCertificateConfiguration> ServerCertificateConfigurations { get; set; }
        }
    }
}