namespace Humidifier.Bedrock
{
    ...
    public class Prompt : Humidifier.Resource, IHaveDescription
    {
        ...
        /// </summary>
        public List<PromptVariant> Variants { get; set; }
        /// <summary>
        /// Description
    ...
    namespace PromptTypes
    {
        ...
        public class TextPromptTemplateConfiguration
        {
            ...
            /// Type: TextS3Location
            /// </summary>
            public TextS3Location TextS3Location { get; set; }
            /// <summary>
            /// Text
