namespace Humidifier.Bedrock
{
    ...
    public class Agent : Humidifier.Resource, IHaveDescription
    {
        ...
        /// PrimitiveType: String
        /// </summary>
        public dynamic AgentName { get; set; }
        /// <summary>
        /// KnowledgeBases
        ...
        /// </summary>
        public List<AgentActionGroup> ActionGroups { get; set; }
        /// <summary>
        /// AutoPrepare
    ...
    namespace AgentTypes
    {
        ...
        public class PromptOverrideConfiguration
        {
            ...
            /// </summary>
            public List<PromptConfiguration> PromptConfigurations { get; set; }
            /// <summary>
            /// OverrideLambda
