namespace Humidifier.Bedrock
{
    ...
    public class FlowAlias : Humidifier.Resource, IHaveDescription
    {
        ...
        /// </summary>
        public List<FlowAliasRoutingConfigurationListItem> RoutingConfiguration { get; set; }
        /// <summary>
        /// FlowArn
    ...
    {
        public class FlowAliasRoutingConfigurationListItem
        {
            /// <summary>
            /// FlowVersion
