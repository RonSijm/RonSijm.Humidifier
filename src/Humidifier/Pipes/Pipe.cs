namespace Humidifier.Pipes
{
    ...
    namespace PipeTypes
    {
        ...
        public class BatchContainerOverrides
        {
            ...
            /// </summary>
            public List<BatchEnvironmentVariable> Environment { get; set; }
            /// <summary>
            /// InstanceType
            ...
            /// </summary>
            public List<BatchResourceRequirement> ResourceRequirements { get; set; }
        }
        ...
        public class EcsContainerOverride
        {
            ...
            /// </summary>
            public List<EcsEnvironmentVariable> Environment { get; set; }
            /// <summary>
            /// ResourceRequirements
            ...
            /// </summary>
            public List<EcsResourceRequirement> ResourceRequirements { get; set; }
            /// <summary>
            /// EnvironmentFiles
            ...
            /// </summary>
            public List<EcsEnvironmentFile> EnvironmentFiles { get; set; }
            /// <summary>
            /// Name
        ...
        public class EcsTaskOverride
        {
            ...
            /// </summary>
            public List<EcsInferenceAcceleratorOverride> InferenceAcceleratorOverrides { get; set; }
            /// <summary>
            /// EphemeralStorage
            ...
            /// </summary>
            public List<EcsContainerOverride> ContainerOverrides { get; set; }
        }
        ...
        public class MultiMeasureMapping
        {
            /// <summary>
            /// MultiMeasureName
        ...
        public class PipeTargetBatchJobParameters
        {
            ...
            /// </summary>
            public List<BatchJobDependency> DependsOn { get; set; }
            /// <summary>
            /// Parameters
        ...
        public class PipeTargetTimestreamParameters
        {
            /// <summary>
            /// VersionValue
            ...
            /// </summary>
            public List<MultiMeasureMapping> MultiMeasureMappings { get; set; }
            /// <summary>
            /// TimeValue
            ...
            /// </summary>
            public List<SingleMeasureMapping> SingleMeasureMappings { get; set; }
        }
        ...
        public class SingleMeasureMapping
        {
            /// <summary>
            /// MeasureName
