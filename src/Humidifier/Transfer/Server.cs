namespace Humidifier.Transfer
{
    ...
    public class Server : Humidifier.Resource
    {
        ...
        /// </summary>
        public S3StorageOptions S3StorageOptions { get; set; }
        /// <summary>
        /// WorkflowDetails
    ...
    namespace ServerTypes
    {
        ...
        public class ProtocolDetails
        {
            ...
            /// </summary>
            public List<As2Transport> As2Transports { get; set; }
            /// <summary>
            /// PassiveIp
        ...
        public class WorkflowDetails
        {
            ...
            /// </summary>
            public List<WorkflowDetail> OnUpload { get; set; }
            /// <summary>
            /// OnPartialUpload
            ...
            /// ItemType: WorkflowDetail
            /// </summary>
            public List<WorkflowDetail> OnPartialUpload { get; set; }
        }
    }
}