namespace Humidifier.Transfer
{
    ...
    public class Workflow : Humidifier.Resource, IHaveTags, IHaveDescription
    {
        ...
        /// ItemType: WorkflowStep
        /// </summary>
        public List<WorkflowStep> OnExceptionSteps { get; set; }
        /// <summary>
        /// Tags
    ...
    namespace WorkflowTypes
    {
        public class CopyStepDetails
        {
            ...
            /// Type: S3FileLocation
            /// </summary>
            public S3FileLocation DestinationFileLocation { get; set; }
            /// <summary>
            /// SourceFileLocation
        ...
        public class EfsInputFileLocation
        {
            /// <summary>
            /// Path
        ...
        public class InputFileLocation
        {
            ...
            /// </summary>
            public EfsInputFileLocation EfsFileLocation { get; set; }
            /// <summary>
            /// S3FileLocation
        ...
        public class S3FileLocation
        {
            ...
            /// Type: S3InputFileLocation
            /// </summary>
            public S3InputFileLocation S3FileLocation_ { get; set; }
        }
