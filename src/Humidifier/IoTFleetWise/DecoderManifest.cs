namespace Humidifier.IoTFleetWise
{
    ...
    public class DecoderManifest : Humidifier.Resource, IHaveTags, IHaveDescription
    {
        ...
        /// </summary>
        public List<SignalDecodersItems> SignalDecoders { get; set; }
        /// <summary>
        /// Status
        ...
        /// </summary>
        public List<NetworkInterfacesItems> NetworkInterfaces { get; set; }
        /// <summary>
        /// ModelManifestArn
    ...
    namespace DecoderManifestTypes
    {
        ...
        public class NetworkInterfacesItems
        {
            /// <summary>
            /// Type
        ...
        public class SignalDecodersItems
        {
            /// <summary>
            /// Type
