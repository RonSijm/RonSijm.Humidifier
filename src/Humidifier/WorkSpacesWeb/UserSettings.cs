namespace Humidifier.WorkSpacesWeb
{
    ...
    {
        public class CookieSpecification
        {
            /// <summary>
            /// Path
        ...
        public class CookieSynchronizationConfiguration
        {
            /// <summary>
            /// Blocklist
            ...
            /// </summary>
            public List<CookieSpecification> Blocklist { get; set; }
            /// <summary>
            /// Allowlist
            ...
            /// ItemType: CookieSpecification
            /// </summary>
            public List<CookieSpecification> Allowlist { get; set; }
        }
    }
}