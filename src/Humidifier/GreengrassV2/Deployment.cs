namespace Humidifier.GreengrassV2
{
    ...
    public class Deployment : Humidifier.Resource
    {
        ...
        /// </summary>
        public Dictionary<string, ComponentDeploymentSpecification> Components { get; set; }
        /// <summary>
        /// DeploymentName
        ...
        /// </summary>
        public dynamic DeploymentName { get; set; }
        /// <summary>
        /// IotJobConfiguration
    ...
    namespace DeploymentTypes
    {
        ...
        public class IoTJobAbortConfig
        {
            ...
            /// </summary>
            public List<IoTJobAbortCriteria> CriteriaList { get; set; }
        }
