namespace Humidifier.CleanRooms
{
    ...
    public class IdMappingTable : Humidifier.Resource, IHaveTags, IHaveDescription
    {
    ...
    {
        public class IdMappingTableInputReferenceConfig
        {
            /// <summary>
            /// InputReferenceArn
        ...
        public class IdMappingTableInputReferenceProperties
        {
            /// <summary>
            ...
            /// </summary>
            public List<IdMappingTableInputSource> IdMappingTableInputSource { get; set; }
        }

        public class IdMappingTableInputSource
        {
            /// <summary>
            /// Type
