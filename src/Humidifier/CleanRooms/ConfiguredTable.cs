namespace Humidifier.CleanRooms
{
    ...
    public class ConfiguredTable : Humidifier.Resource, IHaveTags, IHaveDescription
    {
        ...
        /// </summary>
        public List<AnalysisRule> AnalysisRules { get; set; }
        /// <summary>
        /// AllowedColumns
    ...
    namespace ConfiguredTableTypes
    {
        ...
        public class AnalysisRuleAggregation
        {
            ...
            /// </summary>
            public List<AggregationConstraint> OutputConstraints { get; set; }
            /// <summary>
            /// DimensionColumns
        ...
        public class AnalysisRuleCustom
        {
            ...
            /// </summary>
            public DifferentialPrivacy DifferentialPrivacy { get; set; }
            /// <summary>
            /// AllowedAnalyses
        ...
        public class DifferentialPrivacy
        {
            ...
            /// </summary>
            public List<DifferentialPrivacyColumn> Columns { get; set; }
        }

        public class DifferentialPrivacyColumn
        {
            /// <summary>
            /// Name
