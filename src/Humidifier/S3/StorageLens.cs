namespace Humidifier.S3
{
    ...
    public class StorageLens : Humidifier.Resource, IHaveTags
    {
    ...
    namespace StorageLensTypes
    {
        public class AccountLevel
        {
            ...
            /// </summary>
            public StorageLensGroupLevel StorageLensGroupLevel { get; set; }
            /// <summary>
            /// ActivityMetrics
        ...
        public class StorageLensGroupLevel
        {
            /// <summary>
            ...
            /// </summary>
            public StorageLensGroupSelectionCriteria StorageLensGroupSelectionCriteria { get; set; }
        }

        public class StorageLensGroupSelectionCriteria
        {
            /// <summary>
            /// Exclude
