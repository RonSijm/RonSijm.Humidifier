namespace Humidifier.Pinpoint
{
    ...
    public class InAppTemplate : Humidifier.Resource
    {
        ...
        /// </summary>
        public List<InAppMessageContent> Content { get; set; }
        /// <summary>
        /// TemplateName
    ...
    namespace InAppTemplateTypes
    {
        ...
        public class InAppMessageContent
        {
            ...
            /// Type: BodyConfig
            /// </summary>
            public BodyConfig BodyConfig { get; set; }
            /// <summary>
            /// SecondaryBtn
            ...
            /// Type: ButtonConfig
            /// </summary>
            public ButtonConfig SecondaryBtn { get; set; }
            /// <summary>
            /// ImageUrl
            ...
            /// Type: ButtonConfig
            /// </summary>
            public ButtonConfig PrimaryBtn { get; set; }
            /// <summary>
            /// HeaderConfig
