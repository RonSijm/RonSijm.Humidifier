namespace Humidifier.MediaConnect
{
    ...
    public class Flow : Humidifier.Resource
    {
        ...
        /// </summary>
        public List<VpcInterface> VpcInterfaces { get; set; }
        /// <summary>
        /// MediaStreams
    ...
    namespace FlowTypes
    {
        ...
        public class MediaStream
        {
            ...
            /// </summary>
            public MediaStreamAttributes Attributes_ { get; set; }
            /// <summary>
            /// ClockRate
        ...
        public class MediaStreamSourceConfiguration
        {
            ...
            /// </summary>
            public List<InputConfiguration> InputConfigurations { get; set; }
            /// <summary>
            /// EncodingName
        ...
        public class Source
        {
            ...
            /// </summary>
            public List<MediaStreamSourceConfiguration> MediaStreamSourceConfigurations { get; set; }
            /// <summary>
            /// IngestPort
