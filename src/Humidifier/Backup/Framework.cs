namespace Humidifier.Backup
{
    ...
    public class Framework : Humidifier.Resource
    {
        ...
        /// </summary>
        public List<FrameworkControl> FrameworkControls { get; set; }
        /// <summary>
        /// FrameworkName
        ...
        /// </summary>
        public dynamic FrameworkName { get; set; }
        /// <summary>
        /// FrameworkTags
    ...
    namespace FrameworkTypes
    {
        ...
        public class FrameworkControl
        {
            ...
            /// </summary>
            public List<ControlInputParameter> ControlInputParameters { get; set; }
            /// <summary>
            /// ControlScope
