namespace Humidifier.Backup
{
    ...
    public class BackupPlan : Humidifier.Resource
    {
        ...
        /// </summary>
        public BackupPlanResourceType BackupPlan_ { get; set; }
        /// <summary>
        /// BackupPlanTags
    ...
    {
        public class AdvancedBackupSettingResourceType
        {
            /// <summary>
            /// BackupOptions
        ...
        public class BackupPlanResourceType
        {
            ...
            /// </summary>
            public List<AdvancedBackupSettingResourceType> AdvancedBackupSettings { get; set; }
            /// <summary>
            /// BackupPlanRule
            ...
            /// </summary>
            public List<BackupRuleResourceType> BackupPlanRule { get; set; }
        }
        ...
        public class BackupRuleResourceType
        {
            ...
            /// </summary>
            public List<CopyActionResourceType> CopyActions { get; set; }
            /// <summary>
            ...
            /// </summary>
            public LifecycleResourceType Lifecycle { get; set; }
            /// <summary>
            /// TargetBackupVault
