namespace Humidifier.Deadline
{
    ...
    public class Queue : Humidifier.Resource, IHaveTags, IHaveDescription
    {
        ...
        /// Type: JobRunAsUser
        /// </summary>
        public JobRunAsUser JobRunAsUser { get; set; }
        /// <summary>
        ...
        /// </summary>
        public JobAttachmentSettings JobAttachmentSettings { get; set; }
        /// <summary>
        /// DefaultBudgetAction
    ...
    {
        public class JobAttachmentSettings
        {
            /// <summary>
            /// RootPrefix
        ...
        public class JobRunAsUser
        {
            ...
            /// Type: PosixUser
            /// </summary>
            public PosixUser Posix { get; set; }
            /// <summary>
            /// Windows
            ...
            /// Type: WindowsUser
            /// </summary>
            public WindowsUser Windows { get; set; }
        }
