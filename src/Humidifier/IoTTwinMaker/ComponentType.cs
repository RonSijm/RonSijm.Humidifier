namespace Humidifier.IoTTwinMaker
{
    ...
    public class ComponentType : Humidifier.Resource, IHaveDescription
    {
        ...
        /// </summary>
        public Dictionary<string, PropertyDefinition> PropertyDefinitions { get; set; }
        /// <summary>
        /// PropertyGroups
        ...
        /// </summary>
        public Dictionary<string, CompositeComponentType> CompositeComponentTypes { get; set; }
        /// <summary>
        /// Tags
    ...
    namespace ComponentTypeTypes
    {
        ...
        public class DataType
        {
            ...
            /// ItemType: DataValue
            /// </summary>
            public List<DataValue> AllowedValues { get; set; }
            /// <summary>
            /// UnitOfMeasure
        ...
        public class DataValue
        {
            ...
            /// ItemType: DataValue
            /// </summary>
            public List<DataValue> ListValue { get; set; }
            /// <summary>
            /// LongValue
            ...
            /// ItemType: DataValue
            /// </summary>
            public Dictionary<string, DataValue> MapValue { get; set; }
            /// <summary>
            /// RelationshipValue
