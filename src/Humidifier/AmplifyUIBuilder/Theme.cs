namespace Humidifier.AmplifyUIBuilder
{
    ...
    public class Theme : Humidifier.Resource
    {
        ...
        /// </summary>
        public List<ThemeValues> Values { get; set; }
        /// <summary>
        /// Overrides
        ...
        /// ItemType: ThemeValues
        /// </summary>
        public List<ThemeValues> Overrides { get; set; }
        /// <summary>
        /// Tags
    ...
    namespace ThemeTypes
    {
        public class ThemeValue
        {
            ...
            /// ItemType: ThemeValues
            /// </summary>
            public List<ThemeValues> Children { get; set; }
        }
