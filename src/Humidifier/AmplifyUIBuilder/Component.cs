namespace Humidifier.AmplifyUIBuilder
{
    ...
    public class Component : Humidifier.Resource
    {
        ...
        /// </summary>
        public Dictionary<string, ComponentBindingPropertiesValue> BindingProperties { get; set; }
        /// <summary>
        /// SourceId
        ...
        /// </summary>
        public Dictionary<string, ComponentDataConfiguration> CollectionProperties { get; set; }
        /// <summary>
        /// Name
        ...
        /// </summary>
        public Dictionary<string, ComponentEvent> Events { get; set; }
        /// <summary>
        /// Overrides
        ...
        /// </summary>
        public List<ComponentChild> Children { get; set; }
        /// <summary>
        /// Tags
    ...
    namespace ComponentTypes
    {
        public class ActionParameters
        {
            ...
            /// ItemType: ComponentProperty
            /// </summary>
            public Dictionary<string, ComponentProperty> Fields { get; set; }
            /// <summary>
            /// State
        ...
        public class ComponentDataConfiguration
        {
            ...
            /// </summary>
            public List<SortProperty> Sort { get; set; }
            /// <summary>
            /// Identifiers
        ...
        public class ComponentProperty
        {
            ...
            /// </summary>
            public Dictionary<string, FormBindingElement> Bindings { get; set; }
            /// <summary>
            /// Configured
            ...
            /// ItemType: ComponentProperty
            /// </summary>
            public List<ComponentProperty> Concat { get; set; }
            /// <summary>
            /// DefaultValue
        ...
        public class Predicate
        {
            ...
            /// ItemType: Predicate
            /// </summary>
            public List<Predicate> Or { get; set; }
            /// <summary>
            /// And
            ...
            /// ItemType: Predicate
            /// </summary>
            public List<Predicate> And { get; set; }
            /// <summary>
            /// Operand
