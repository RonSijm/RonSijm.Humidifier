namespace Humidifier.AmplifyUIBuilder
{
    ...
    public class Form : Humidifier.Resource
    {
        ...
        /// </summary>
        public Dictionary<string, SectionalElement> SectionalElements { get; set; }
        /// <summary>
        /// DataType
    ...
    namespace FormTypes
    {
        public class FieldConfig
        {
            ...
            /// </summary>
            public List<FieldValidationConfiguration> Validations { get; set; }
            /// <summary>
            /// InputType
        ...
        public class FormInputValueProperty
        {
            ...
            /// </summary>
            public List<FormInputValueProperty> Concat { get; set; }
            /// <summary>
            /// BindingProperties
        ...
        public class ValueMappings
        {
            ...
            /// </summary>
            public Dictionary<string, FormInputBindingPropertiesValue> BindingProperties { get; set; }
            /// <summary>
            /// Values
            ...
            /// </summary>
            public List<ValueMapping> Values { get; set; }
        }
    }
}