namespace Humidifier.LookoutEquipment
{
    ...
    public class InferenceScheduler : Humidifier.Resource, IHaveTags
    {
        ...
        /// </summary>
        public dynamic InferenceSchedulerName { get; set; }
        /// <summary>
        /// DataUploadFrequency
        ...
        /// </summary>
        public DataInputConfiguration DataInputConfiguration { get; set; }
        /// <summary>
        ...
        /// </summary>
        public DataOutputConfiguration DataOutputConfiguration { get; set; }
        /// <summary>
        /// ServerSideKmsKeyId
    ...
    namespace InferenceSchedulerTypes
    {
        public class DataInputConfiguration
        {
            ...
            /// </summary>
            public InputNameConfiguration InferenceInputNameConfiguration { get; set; }
            /// <summary>
            ...
            /// </summary>
            public S3InputConfiguration S3InputConfiguration { get; set; }
            /// <summary>
            /// InputTimeZoneOffset
        ...
        public class DataOutputConfiguration
        {
            /// <summary>
            /// KmsKeyId
            ...
            /// </summary>
            public S3OutputConfiguration S3OutputConfiguration { get; set; }
        }
        ...
        public class S3InputConfiguration
        {
            /// <summary>
            /// Bucket
