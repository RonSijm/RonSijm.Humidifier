namespace Humidifier.NimbleStudio
{
    ...
    public class Studio : Humidifier.Base.BaseResource, IHaveImpliedResourceName
    {
        ...
        /// </summary>
        public StudioTypes.StudioEncryptionConfiguration StudioEncryptionConfiguration { get; set; }
        /// <summary>
        /// Tags
    ...
    {
        public class StudioEncryptionConfiguration : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// KeyType
