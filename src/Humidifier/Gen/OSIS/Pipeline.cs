namespace Humidifier.OSIS
{
    ...
    public class Pipeline : Humidifier.Base.BaseResource, IHaveImpliedResourceName, IHaveTags
    {
        ...
        /// </summary>
        public PipelineTypes.LogPublishingOptions LogPublishingOptions { get; set; }
        /// <summary>
        ...
        /// </summary>
        public PipelineTypes.EncryptionAtRestOptions EncryptionAtRestOptions { get; set; }
        /// <summary>
        /// Tags
    ...
    namespace PipelineTypes
    {
        ...
        public class CloudWatchLogDestination : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// LogGroup
        ...
        public class LogPublishingOptions : Humidifier.Base.BaseSubResource
        {
            ...
            /// </summary>
            public PipelineTypes.CloudWatchLogDestination CloudWatchLogDestination { get; set; }
            /// <summary>
            /// IsLoggingEnabled
