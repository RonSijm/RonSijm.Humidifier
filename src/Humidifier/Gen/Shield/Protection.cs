namespace Humidifier.Shield
{
    ...
    public class Protection : Humidifier.Base.BaseResource, IHaveTags, IHaveImpliedResourceName
    {
        ...
        /// </summary>
        public ProtectionTypes.ApplicationLayerAutomaticResponseConfiguration ApplicationLayerAutomaticResponseConfiguration { get; set; }
        /// <summary>
        /// Tags
    ...
    namespace ProtectionTypes
    {
        ...
        public class ApplicationLayerAutomaticResponseConfiguration : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// Status
            ...
            /// Type: Action
            /// </summary>
            public ProtectionTypes.Action Action { get; set; }
        }
    }
}