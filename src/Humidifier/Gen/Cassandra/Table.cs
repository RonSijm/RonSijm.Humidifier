namespace Humidifier.Cassandra
{
    ...
    public class Table : Humidifier.Base.BaseResource, IHaveTags, IHaveImpliedResourceName
    {
        ...
        /// </summary>
        public List<TableTypes.ReplicaSpecification> ReplicaSpecifications { get; set; }
        /// <summary>
        ...
        /// </summary>
        public TableTypes.EncryptionSpecification EncryptionSpecification { get; set; }
        ...
        /// </summary>
        public TableTypes.AutoScalingSpecification AutoScalingSpecifications { get; set; }
        /// <summary>
        ...
        /// Type: BillingMode
        /// </summary>
        public TableTypes.BillingMode BillingMode { get; set; }
        /// <summary>
        /// DefaultTimeToLive
        ...
        /// ItemType: Column
        /// </summary>
        public List<TableTypes.Column> RegularColumns { get; set; }
        /// <summary>
        /// Tags
    ...
    namespace TableTypes
    {
        public class AutoScalingSetting : Humidifier.Base.BaseSubResource
        {
            ...
            /// Type: ScalingPolicy
            /// </summary>
            public TableTypes.ScalingPolicy ScalingPolicy { get; set; }
            /// <summary>
            /// MinimumUnits
        ...
        public class AutoScalingSpecification : Humidifier.Base.BaseSubResource
        {
            ...
            /// </summary>
            public TableTypes.AutoScalingSetting ReadCapacityAutoScaling { get; set; }
            /// <summary>
            ...
            /// Type: AutoScalingSetting
            /// </summary>
            public TableTypes.AutoScalingSetting WriteCapacityAutoScaling { get; set; }
        }

        public class BillingMode : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// Mode
        ...
        public class ClusteringKeyColumn : Humidifier.Base.BaseSubResource
        {
            ...
            /// Type: Column
            /// </summary>
            public TableTypes.Column Column { get; set; }
        }
        ...
        public class EncryptionSpecification : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// EncryptionType
        ...
        public class ScalingPolicy : Humidifier.Base.BaseSubResource
        {
            ...
            /// </summary>
            public TableTypes.TargetTrackingScalingPolicyConfiguration TargetTrackingScalingPolicyConfiguration { get; set; }
        }
