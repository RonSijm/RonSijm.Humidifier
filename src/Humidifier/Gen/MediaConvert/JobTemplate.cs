namespace Humidifier.MediaConvert
{
    ...
    public class JobTemplate : Humidifier.Base.BaseResource, IHaveDescription, IHaveImpliedResourceName
    {
        ...
        /// </summary>
        public JobTemplateTypes.AccelerationSettings AccelerationSettings { get; set; }
        /// <summary>
        /// Priority
        ...
        /// </summary>
        public List<JobTemplateTypes.HopDestination> HopDestinations { get; set; }
        /// <summary>
        /// Tags
    ...
    {
        public class AccelerationSettings : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// Mode
        ...
        public class HopDestination : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// WaitMinutes
