namespace Humidifier.Timestream
{
    ...
    public class Table : Humidifier.Base.BaseResource, IHaveImpliedResourceName, IHaveTags
    {
        ...
        /// </summary>
        public TableTypes.RetentionProperties RetentionProperties { get; set; }
        /// <summary>
        /// Schema
        ...
        /// </summary>
        public TableTypes.MagneticStoreWriteProperties MagneticStoreWriteProperties { get; set; }
    }
    ...
    namespace TableTypes
    {
        public class MagneticStoreRejectedDataLocation : Humidifier.Base.BaseSubResource
        {
            ...
            /// </summary>
            public TableTypes.S3Configuration S3Configuration { get; set; }
        }
        ...
        public class MagneticStoreWriteProperties : Humidifier.Base.BaseSubResource
        {
            ...
            /// </summary>
            public TableTypes.MagneticStoreRejectedDataLocation MagneticStoreRejectedDataLocation { get; set; }
        }

        public class PartitionKey : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// Type
        ...
        public class Schema : Humidifier.Base.BaseSubResource
        {
            ...
            /// </summary>
            public List<TableTypes.PartitionKey> CompositePartitionKey { get; set; }
        }
    }
}