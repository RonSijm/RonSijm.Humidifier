namespace Humidifier.Timestream
{
    ...
    public class ScheduledQuery : Humidifier.Base.BaseResource, IHaveImpliedResourceName, IHaveTags, IHaveKmsKeyId
    {
        ...
        /// </summary>
        public ScheduledQueryTypes.TargetConfiguration TargetConfiguration { get; set; }
        /// <summary>
        /// KmsKeyId
    ...
    namespace ScheduledQueryTypes
    {
        ...
        public class ErrorReportConfiguration : Humidifier.Base.BaseSubResource
        {
            ...
            /// </summary>
            public ScheduledQueryTypes.S3Configuration S3Configuration { get; set; }
        }

        public class MixedMeasureMapping : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// MeasureName
            ...
            /// </summary>
            public List<ScheduledQueryTypes.MultiMeasureAttributeMapping> MultiMeasureAttributeMappings { get; set; }
        }
        ...
        public class NotificationConfiguration : Humidifier.Base.BaseSubResource
        {
            ...
            /// </summary>
            public ScheduledQueryTypes.SnsConfiguration SnsConfiguration { get; set; }
        }
        ...
        public class SnsConfiguration : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// TopicArn
        ...
        public class TargetConfiguration : Humidifier.Base.BaseSubResource
        {
            ...
            /// </summary>
            public ScheduledQueryTypes.TimestreamConfiguration TimestreamConfiguration { get; set; }
        }

        public class TimestreamConfiguration : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// TimeColumn
            ...
            /// </summary>
            public List<ScheduledQueryTypes.DimensionMapping> DimensionMappings { get; set; }
            /// <summary>
            ...
            /// </summary>
            public List<ScheduledQueryTypes.MixedMeasureMapping> MixedMeasureMappings { get; set; }
            /// <summary>
            /// MeasureNameColumn
            ...
            /// </summary>
            public ScheduledQueryTypes.MultiMeasureMappings MultiMeasureMappings { get; set; }
        }
    }
}