namespace Humidifier.Timestream
{
    ...
    public class InfluxDBInstance : Humidifier.Base.BaseResource, IHaveImpliedResourceName, IHaveTags
    {
        ...
        /// </summary>
        public InfluxDBInstanceTypes.LogDeliveryConfiguration LogDeliveryConfiguration { get; set; }
        /// <summary>
        /// Username
    ...
    namespace InfluxDBInstanceTypes
    {
        public class LogDeliveryConfiguration : Humidifier.Base.BaseSubResource
        {
            ...
            /// </summary>
            public InfluxDBInstanceTypes.S3Configuration S3Configuration { get; set; }
        }
