namespace Humidifier.ApiGatewayV2
{
    ...
    public class ApiGatewayManagedOverrides : Humidifier.Base.BaseResource
    {
        ...
        /// </summary>
        public ApiGatewayManagedOverridesTypes.IntegrationOverrides Integration { get; set; }
        /// <summary>
        /// Stage
        ...
        /// Type: RouteOverrides
        /// </summary>
        public ApiGatewayManagedOverridesTypes.RouteOverrides Route { get; set; }
    }

    namespace ApiGatewayManagedOverridesTypes
    {
        public class AccessLogSettings : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// Format
        ...
        public class IntegrationOverrides : Humidifier.Base.BaseSubResource, IHaveDescription
        {
            /// <summary>
            /// Description
        ...
        public class RouteOverrides : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// Target
        ...
        public class RouteSettings : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// LoggingLevel
        ...
        public class StageOverrides : Humidifier.Base.BaseSubResource, IHaveDescription
        {
            ...
            /// </summary>
            public ApiGatewayManagedOverridesTypes.AccessLogSettings AccessLogSettings { get; set; }
            /// <summary>
            /// AutoDeploy
            ...
            /// Type: RouteSettings
            /// </summary>
            public ApiGatewayManagedOverridesTypes.RouteSettings DefaultRouteSettings { get; set; }
        }
    }
}