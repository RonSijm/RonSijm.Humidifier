namespace Humidifier.ApiGatewayV2
{
    ...
    public class RouteResponse : Humidifier.Base.BaseResource
    {
        ...
        /// </summary>
        public Dictionary<string, RouteResponseTypes.ParameterConstraints> ResponseParameters { get; set; }
    ...
    {
        public class ParameterConstraints : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// Required
