namespace Humidifier.ApiGatewayV2
{
    ...
    public class Integration : Humidifier.Base.BaseResource, IHaveDescription
    {
        ...
        /// Type: TlsConfig
        /// </summary>
        public IntegrationTypes.TlsConfig TlsConfig { get; set; }
        /// <summary>
    ...
    {
        public class ResponseParameter : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// Destination
        ...
        public class ResponseParameterList : Humidifier.Base.BaseSubResource
        {
            ...
            /// </summary>
            public List<IntegrationTypes.ResponseParameter> ResponseParameters { get; set; }
        }
