namespace Humidifier.ApiGatewayV2
{
    ...
    public class Api : Humidifier.Base.BaseResource, IHaveImpliedResourceName, IHaveDescription
    {
        ...
        /// Type: BodyS3Location
        /// </summary>
        public ApiTypes.BodyS3Location BodyS3Location { get; set; }
        /// <summary>
        /// Description
        ...
        /// Type: Cors
        /// </summary>
        public ApiTypes.Cors CorsConfiguration { get; set; }
        /// <summary>
        /// Version
    ...
    namespace ApiTypes
    {
        public class BodyS3Location : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// Etag
        ...
        public class Cors : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// AllowOrigins
