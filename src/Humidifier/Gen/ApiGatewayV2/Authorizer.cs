namespace Humidifier.ApiGatewayV2
{
    ...
    public class Authorizer : Humidifier.Base.BaseResource, IHaveImpliedResourceName
    {
        ...
        /// </summary>
        public AuthorizerTypes.JWTConfiguration JwtConfiguration { get; set; }
        /// <summary>
    ...
    {
        public class JWTConfiguration : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// Issuer
