namespace Humidifier.ApiGatewayV2
{
    ...
    public class DomainName : Humidifier.Base.BaseResource
    {
        ...
        /// </summary>
        public List<DomainNameTypes.DomainNameConfiguration> DomainNameConfigurations { get; set; }
        /// <summary>
        /// Tags
    ...
    {
        public class DomainNameConfiguration : Humidifier.Base.BaseSubResource
        {
            /// <summary>
