namespace Humidifier.CloudFormation
{
    ...
    public class StackSet : Humidifier.Base.BaseResource, IHaveTags, IHaveDescription, IHaveImpliedResourceName
    {
        ...
        /// ItemType: Parameter
        /// </summary>
        public List<StackSetTypes.Parameter> Parameters { get; set; }
        /// <summary>
        /// StackInstancesGroup
        ...
        /// </summary>
        public List<StackSetTypes.StackInstances> StackInstancesGroup { get; set; }
        /// <summary>
        /// TemplateBody
        ...
        /// </summary>
        public StackSetTypes.OperationPreferences OperationPreferences { get; set; }
        /// <summary>
        /// TemplateURL
        ...
        /// Type: AutoDeployment
        /// </summary>
        public StackSetTypes.AutoDeployment AutoDeployment { get; set; }
        /// <summary>
        /// Capabilities
        ...
        /// </summary>
        public StackSetTypes.ManagedExecution ManagedExecution { get; set; }
        /// <summary>
        /// Tags
    ...
    {
        public class AutoDeployment : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// Enabled
        ...
        public class DeploymentTargets : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// AccountFilterType
        ...
        public class ManagedExecution : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// Active
        ...
        public class StackInstances : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// ParameterOverrides
            ...
            /// ItemType: Parameter
            /// </summary>
            public List<StackSetTypes.Parameter> ParameterOverrides { get; set; }
            /// <summary>
            /// DeploymentTargets
            ...
            /// </summary>
            public StackSetTypes.DeploymentTargets DeploymentTargets { get; set; }
            /// <summary>
            /// Regions
