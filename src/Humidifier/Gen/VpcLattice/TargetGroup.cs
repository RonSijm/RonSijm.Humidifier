namespace Humidifier.VpcLattice
{
    ...
    public class TargetGroup : Humidifier.Base.BaseResource, IHaveImpliedResourceName, IHaveTags
    {
        ...
        /// </summary>
        public TargetGroupTypes.TargetGroupConfig Config { get; set; }
        /// <summary>
        /// Targets
        ...
        /// ItemType: Target
        /// </summary>
        public List<TargetGroupTypes.Target> Targets { get; set; }
        /// <summary>
        /// Tags
    ...
    namespace TargetGroupTypes
    {
        public class HealthCheckConfig : Humidifier.Base.BaseSubResource
        {
            ...
            /// Type: Matcher
            /// </summary>
            public TargetGroupTypes.Matcher Matcher { get; set; }
            /// <summary>
        ...
        public class TargetGroupConfig : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// IpAddressType
            ...
            /// </summary>
            public TargetGroupTypes.HealthCheckConfig HealthCheck { get; set; }
            /// <summary>
