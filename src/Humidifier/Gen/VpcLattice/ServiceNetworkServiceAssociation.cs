namespace Humidifier.VpcLattice
{
    ...
    public class ServiceNetworkServiceAssociation : Humidifier.Base.BaseResource, IHaveTags
    {
        ...
        /// Type: DnsEntry
        /// </summary>
        public ServiceNetworkServiceAssociationTypes.DnsEntry DnsEntry { get; set; }
        /// <summary>
        /// ServiceIdentifier
    ...
    {
        public class DnsEntry : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// DomainName
