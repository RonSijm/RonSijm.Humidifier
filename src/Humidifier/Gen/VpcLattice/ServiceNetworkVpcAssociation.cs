namespace Humidifier.VpcLattice
{
    ...
    public class ServiceNetworkVpcAssociation : Humidifier.Base.BaseResource, IHaveTags, IHaveSecurityGroupIds, IHaveVpcIdentifier, IHaveServiceNetworkIdentifier
    {
