namespace Humidifier.VpcLattice
{
    ...
    namespace RuleTypes
    {
        public class Action : Humidifier.Base.BaseSubResource
        {
            ...
            /// Type: Forward
            /// </summary>
            public RuleTypes.Forward Forward { get; set; }
            /// <summary>
            /// FixedResponse
            ...
            /// Type: FixedResponse
            /// </summary>
            public RuleTypes.FixedResponse FixedResponse { get; set; }
        }
        ...
        public class Forward : Humidifier.Base.BaseSubResource
        {
            ...
            /// </summary>
            public List<RuleTypes.WeightedTargetGroup> TargetGroups { get; set; }
        }

        public class HeaderMatch : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// CaseSensitive
            ...
            /// </summary>
            public RuleTypes.HeaderMatchType Match { get; set; }
        }

        public class HeaderMatchType : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// Contains
        ...
        public class HttpMatch : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// HeaderMatches
            ...
            /// </summary>
            public List<RuleTypes.HeaderMatch> HeaderMatches { get; set; }
            /// <summary>
            /// PathMatch
            ...
            /// Type: PathMatch
            /// </summary>
            public RuleTypes.PathMatch PathMatch { get; set; }
            /// <summary>
            /// Method
        ...
        public class Match : Humidifier.Base.BaseSubResource
        {
            ...
            /// Type: HttpMatch
            /// </summary>
            public RuleTypes.HttpMatch HttpMatch { get; set; }
        }

        public class PathMatch : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// CaseSensitive
            ...
            /// Type: PathMatchType
            /// </summary>
            public RuleTypes.PathMatchType Match { get; set; }
        }

        public class PathMatchType : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// Exact
