namespace Humidifier.CleanRoomsML
{
    ...
    namespace TrainingDatasetTypes
    {
        ...
        public class DataSource : Humidifier.Base.BaseSubResource
        {
            ...
            /// Type: GlueDataSource
            /// </summary>
            public TrainingDatasetTypes.GlueDataSource GlueDataSource { get; set; }
        }
        ...
        public class Dataset : Humidifier.Base.BaseSubResource
        {
            ...
            /// </summary>
            public TrainingDatasetTypes.DatasetInputConfig InputConfig { get; set; }
        }
        ...
        public class DatasetInputConfig : Humidifier.Base.BaseSubResource
        {
            ...
            /// </summary>
            public List<TrainingDatasetTypes.ColumnSchema> Schema { get; set; }
            /// <summary>
            /// DataSource
            ...
            /// Type: DataSource
            /// </summary>
            public TrainingDatasetTypes.DataSource DataSource { get; set; }
        }

        public class GlueDataSource : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// TableName
