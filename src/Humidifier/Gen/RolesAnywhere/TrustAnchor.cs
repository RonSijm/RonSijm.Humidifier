namespace Humidifier.RolesAnywhere
{
    ...
    public class TrustAnchor : Humidifier.Base.BaseResource, IHaveTags, IHaveImpliedResourceName
    {
        ...
        /// </summary>
        public List<TrustAnchorTypes.NotificationSetting> NotificationSettings { get; set; }
        /// <summary>
        /// Enabled
    ...
    {
        public class NotificationSetting : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// Channel
        ...
        public class Source : Humidifier.Base.BaseSubResource
        {
            ...
            /// Type: SourceData
            /// </summary>
            public TrustAnchorTypes.SourceData SourceData { get; set; }
        }
