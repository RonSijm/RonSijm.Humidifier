namespace Humidifier.MSK
{
    ...
    namespace ReplicatorTypes
    {
        ...
        public class KafkaCluster : Humidifier.Base.BaseSubResource
        {
            ...
            /// </summary>
            public ReplicatorTypes.KafkaClusterClientVpcConfig VpcConfig { get; set; }
            /// <summary>
            /// AmazonMskCluster
        ...
        public class ReplicationInfo : Humidifier.Base.BaseSubResource
        {
            ...
            /// </summary>
            public ReplicatorTypes.TopicReplication TopicReplication { get; set; }
            /// <summary>
            ...
            /// </summary>
            public ReplicatorTypes.ConsumerGroupReplication ConsumerGroupReplication { get; set; }
            /// <summary>
        ...
        public class ReplicationStartingPosition : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// Type
        ...
        public class TopicReplication : Humidifier.Base.BaseSubResource
        {
            ...
            /// </summary>
            public ReplicatorTypes.ReplicationStartingPosition StartingPosition { get; set; }
            /// <summary>
            /// TopicsToReplicate
