namespace Humidifier.MSK
{
    ...
    public class Cluster : Humidifier.Base.BaseResource, IHaveImpliedResourceName
    {
        ...
        /// Type: EncryptionInfo
        /// </summary>
        public ClusterTypes.EncryptionInfo EncryptionInfo { get; set; }
        /// <summary>
        /// OpenMonitoring
        ...
        /// Type: OpenMonitoring
        /// </summary>
        public ClusterTypes.OpenMonitoring OpenMonitoring { get; set; }
        /// <summary>
        /// CurrentVersion
        ...
        /// </summary>
        public ClusterTypes.ClientAuthentication ClientAuthentication { get; set; }
        /// <summary>
        /// LoggingInfo
        ...
        /// Type: LoggingInfo
        /// </summary>
        public ClusterTypes.LoggingInfo LoggingInfo { get; set; }
        /// <summary>
        /// Tags
    ...
    namespace ClusterTypes
    {
        public class BrokerLogs : Humidifier.Base.BaseSubResource
        {
            ...
            /// Type: S3
            /// </summary>
            public ClusterTypes.S3 S3 { get; set; }
            /// <summary>
            /// Firehose
            ...
            /// Type: Firehose
            /// </summary>
            public ClusterTypes.Firehose Firehose { get; set; }
            /// <summary>
            /// CloudWatchLogs
            ...
            /// Type: CloudWatchLogs
            /// </summary>
            public ClusterTypes.CloudWatchLogs CloudWatchLogs { get; set; }
        }

        public class BrokerNodeGroupInfo : Humidifier.Base.BaseSubResource, IHaveSecurityGroups
        {
            /// <summary>
            /// SecurityGroups
            ...
            /// </summary>
            public ClusterTypes.ConnectivityInfo ConnectivityInfo { get; set; }
            /// <summary>
            /// StorageInfo
            ...
            /// Type: StorageInfo
            /// </summary>
            public ClusterTypes.StorageInfo StorageInfo { get; set; }
            /// <summary>
        ...
        public class ClientAuthentication : Humidifier.Base.BaseSubResource
        {
            ...
            /// Type: Sasl
            /// </summary>
            public ClusterTypes.Sasl Sasl { get; set; }
            /// <summary>
            /// Unauthenticated
            ...
            /// </summary>
            public ClusterTypes.Unauthenticated Unauthenticated { get; set; }
            /// <summary>
            /// Tls
            ...
            /// Type: Tls
            /// </summary>
            public ClusterTypes.Tls Tls { get; set; }
        }

        public class CloudWatchLogs : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// LogGroup
        ...
        public class ConfigurationInfo : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// Revision
        ...
        public class ConnectivityInfo : Humidifier.Base.BaseSubResource
        {
            ...
            /// </summary>
            public ClusterTypes.VpcConnectivity VpcConnectivity { get; set; }
            /// <summary>
            /// PublicAccess
            ...
            /// Type: PublicAccess
            /// </summary>
            public ClusterTypes.PublicAccess PublicAccess { get; set; }
        }

        public class EBSStorageInfo : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            ...
            /// </summary>
            public ClusterTypes.ProvisionedThroughput ProvisionedThroughput { get; set; }
            /// <summary>
            /// VolumeSize
        ...
        public class EncryptionInfo : Humidifier.Base.BaseSubResource
        {
            ...
            /// </summary>
            public ClusterTypes.EncryptionAtRest EncryptionAtRest { get; set; }
            /// <summary>
            /// EncryptionInTransit
            ...
            /// </summary>
            public ClusterTypes.EncryptionInTransit EncryptionInTransit { get; set; }
        }

        public class Firehose : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// DeliveryStream
        ...
        public class LoggingInfo : Humidifier.Base.BaseSubResource
        {
            ...
            /// Type: BrokerLogs
            /// </summary>
            public ClusterTypes.BrokerLogs BrokerLogs { get; set; }
        }
        ...
        public class OpenMonitoring : Humidifier.Base.BaseSubResource
        {
            ...
            /// Type: Prometheus
            /// </summary>
            public ClusterTypes.Prometheus Prometheus { get; set; }
        }
        ...
        public class Prometheus : Humidifier.Base.BaseSubResource
        {
            ...
            /// Type: JmxExporter
            /// </summary>
            public ClusterTypes.JmxExporter JmxExporter { get; set; }
            /// <summary>
            /// NodeExporter
            ...
            /// Type: NodeExporter
            /// </summary>
            public ClusterTypes.NodeExporter NodeExporter { get; set; }
        }

        public class ProvisionedThroughput : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// VolumeThroughput
        ...
        public class PublicAccess : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// Type
        ...
        public class Sasl : Humidifier.Base.BaseSubResource
        {
            ...
            /// Type: Iam
            /// </summary>
            public ClusterTypes.Iam Iam { get; set; }
            /// <summary>
            /// Scram
            ...
            /// Type: Scram
            /// </summary>
            public ClusterTypes.Scram Scram { get; set; }
        }

        public class Scram : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// Enabled
        ...
        public class StorageInfo : Humidifier.Base.BaseSubResource
        {
            ...
            /// Type: EBSStorageInfo
            /// </summary>
            public ClusterTypes.EBSStorageInfo EBSStorageInfo { get; set; }
        }

        public class Tls : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// Enabled
        ...
        public class Unauthenticated : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// Enabled
        ...
        public class VpcConnectivity : Humidifier.Base.BaseSubResource
        {
            ...
            /// </summary>
            public ClusterTypes.VpcConnectivityClientAuthentication ClientAuthentication { get; set; }
        }
        ...
        public class VpcConnectivityClientAuthentication : Humidifier.Base.BaseSubResource
        {
            ...
            /// </summary>
            public ClusterTypes.VpcConnectivitySasl Sasl { get; set; }
            /// <summary>
            /// Tls
            ...
            /// </summary>
            public ClusterTypes.VpcConnectivityTls Tls { get; set; }
        }

        public class VpcConnectivityIam : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// Enabled
        ...
        public class VpcConnectivitySasl : Humidifier.Base.BaseSubResource
        {
            ...
            /// </summary>
            public ClusterTypes.VpcConnectivityIam Iam { get; set; }
            /// <summary>
            /// Scram
            ...
            /// </summary>
            public ClusterTypes.VpcConnectivityScram Scram { get; set; }
        }

        public class VpcConnectivityScram : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// Enabled
        ...
        public class VpcConnectivityTls : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// Enabled
