namespace Humidifier.FMS
{
    ...
    public class Policy : Humidifier.Base.BaseResource, IHaveImpliedResourceName
    {
        ...
        /// Type: IEMap
        /// </summary>
        public PolicyTypes.IEMap ExcludeMap { get; set; }
        /// <summary>
        /// IncludeMap
        ...
        /// Type: IEMap
        /// </summary>
        public PolicyTypes.IEMap IncludeMap { get; set; }
        /// <summary>
        /// PolicyDescription
        ...
        /// ItemType: PolicyTag
        /// </summary>
        public List<PolicyTypes.PolicyTag> Tags { get; set; }
    }
    ...
    namespace PolicyTypes
    {
        ...
        public class IcmpTypeCode : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// Type
        ...
        public class NetworkAclCommonPolicy : Humidifier.Base.BaseSubResource
        {
            ...
            /// </summary>
            public PolicyTypes.NetworkAclEntrySet NetworkAclEntrySet { get; set; }
        }

        public class NetworkAclEntry : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// PortRange
            ...
            /// Type: PortRange
            /// </summary>
            public PolicyTypes.PortRange PortRange { get; set; }
            /// <summary>
            /// IcmpTypeCode
            ...
            /// Type: IcmpTypeCode
            /// </summary>
            public PolicyTypes.IcmpTypeCode IcmpTypeCode { get; set; }
            /// <summary>
            /// RuleAction
        ...
        public class NetworkAclEntrySet : Humidifier.Base.BaseSubResource
        {
            ...
            /// </summary>
            public List<PolicyTypes.NetworkAclEntry> LastEntries { get; set; }
            /// <summary>
            ...
            /// ItemType: NetworkAclEntry
            /// </summary>
            public List<PolicyTypes.NetworkAclEntry> FirstEntries { get; set; }
            /// <summary>
        ...
        public class PolicyOption : Humidifier.Base.BaseSubResource
        {
            ...
            /// </summary>
            public PolicyTypes.NetworkFirewallPolicy NetworkFirewallPolicy { get; set; }
            /// <summary>
            ...
            /// </summary>
            public PolicyTypes.NetworkAclCommonPolicy NetworkAclCommonPolicy { get; set; }
            /// <summary>
            ...
            /// </summary>
            public PolicyTypes.ThirdPartyFirewallPolicy ThirdPartyFirewallPolicy { get; set; }
        }

        public class PolicyTag : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// Value
        ...
        public class SecurityServicePolicyData : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// ManagedServiceData
            ...
            /// Type: PolicyOption
            /// </summary>
            public PolicyTypes.PolicyOption PolicyOption { get; set; }
        }
