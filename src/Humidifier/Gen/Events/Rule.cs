namespace Humidifier.Events
{
    ...
    public class Rule : Humidifier.Base.BaseResource, IHaveDescription, IHaveImpliedResourceName
    {
        ...
        /// ItemType: Target
        /// </summary>
        public List<RuleTypes.Target> Targets { get; set; }
        /// <summary>
        /// RoleArn
    ...
    namespace RuleTypes
    {
        ...
        public class BatchParameters : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// ArrayProperties
            ...
            /// </summary>
            public RuleTypes.BatchArrayProperties ArrayProperties { get; set; }
            /// <summary>
            /// JobName
            ...
            /// </summary>
            public RuleTypes.BatchRetryStrategy RetryStrategy { get; set; }
            /// <summary>
            /// JobDefinition
        ...
        public class EcsParameters : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// PlatformVersion
            ...
            /// </summary>
            public List<RuleTypes.PlacementConstraint> PlacementConstraints { get; set; }
            /// <summary>
            /// PropagateTags
            ...
            /// </summary>
            public List<RuleTypes.PlacementStrategy> PlacementStrategies { get; set; }
            /// <summary>
            ...
            /// </summary>
            public List<RuleTypes.CapacityProviderStrategyItem> CapacityProviderStrategy { get; set; }
            /// <summary>
            /// LaunchType
            ...
            /// </summary>
            public RuleTypes.NetworkConfiguration NetworkConfiguration { get; set; }
            /// <summary>
            /// TaskDefinitionArn
        ...
        public class HttpParameters : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// PathParameterValues
        ...
        public class InputTransformer : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// InputPathsMap
        ...
        public class NetworkConfiguration : Humidifier.Base.BaseSubResource
        {
            ...
            /// </summary>
            public RuleTypes.AwsVpcConfiguration AwsVpcConfiguration { get; set; }
        }
        ...
        public class RedshiftDataParameters : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// StatementName
        ...
        public class RetryPolicy : Humidifier.Base.BaseSubResource
        {
            /// <summary>
        ...
        public class RunCommandParameters : Humidifier.Base.BaseSubResource
        {
            ...
            /// </summary>
            public List<RuleTypes.RunCommandTarget> RunCommandTargets { get; set; }
        }

        public class RunCommandTarget : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// Values
        ...
        public class SageMakerPipelineParameters : Humidifier.Base.BaseSubResource
        {
            ...
            /// </summary>
            public List<RuleTypes.SageMakerPipelineParameter> PipelineParameterList { get; set; }
        }

        public class SqsParameters : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// MessageGroupId
        ...
        public class Target : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// InputPath
            ...
            /// Type: HttpParameters
            /// </summary>
            public RuleTypes.HttpParameters HttpParameters { get; set; }
            /// <summary>
            /// DeadLetterConfig
            ...
            /// </summary>
            public RuleTypes.DeadLetterConfig DeadLetterConfig { get; set; }
            /// <summary>
            ...
            /// </summary>
            public RuleTypes.RunCommandParameters RunCommandParameters { get; set; }
            /// <summary>
            /// InputTransformer
            ...
            /// </summary>
            public RuleTypes.InputTransformer InputTransformer { get; set; }
            /// <summary>
            /// KinesisParameters
            ...
            /// </summary>
            public RuleTypes.KinesisParameters KinesisParameters { get; set; }
            /// <summary>
            /// RoleArn
            ...
            /// </summary>
            public RuleTypes.RedshiftDataParameters RedshiftDataParameters { get; set; }
            /// <summary>
            /// AppSyncParameters
            ...
            /// </summary>
            public RuleTypes.AppSyncParameters AppSyncParameters { get; set; }
            /// <summary>
            /// Input
            ...
            /// Type: SqsParameters
            /// </summary>
            public RuleTypes.SqsParameters SqsParameters { get; set; }
            /// <summary>
            /// EcsParameters
            ...
            /// Type: EcsParameters
            /// </summary>
            public RuleTypes.EcsParameters EcsParameters { get; set; }
            /// <summary>
            /// BatchParameters
            ...
            /// </summary>
            public RuleTypes.BatchParameters BatchParameters { get; set; }
            /// <summary>
            /// Id
            ...
            /// </summary>
            public RuleTypes.SageMakerPipelineParameters SageMakerPipelineParameters { get; set; }
            /// <summary>
            /// RetryPolicy
            ...
            /// Type: RetryPolicy
            /// </summary>
            public RuleTypes.RetryPolicy RetryPolicy { get; set; }
        }
    }
}