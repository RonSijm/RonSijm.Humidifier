namespace Humidifier.Events
{
    ...
    public class Connection : Humidifier.Base.BaseResource, IHaveImpliedResourceName, IHaveDescription
    {
        ...
        /// Type: AuthParameters
        /// </summary>
        public ConnectionTypes.AuthParameters AuthParameters { get; set; }
        /// <summary>
        /// Description
    ...
    namespace ConnectionTypes
    {
        ...
        public class AuthParameters : Humidifier.Base.BaseSubResource
        {
            ...
            /// </summary>
            public ConnectionTypes.ConnectionHttpParameters InvocationHttpParameters { get; set; }
            /// <summary>
            /// BasicAuthParameters
            ...
            /// </summary>
            public ConnectionTypes.BasicAuthParameters BasicAuthParameters { get; set; }
            /// <summary>
            ...
            /// </summary>
            public ConnectionTypes.ApiKeyAuthParameters ApiKeyAuthParameters { get; set; }
            /// <summary>
            /// OAuthParameters
            ...
            /// </summary>
            public ConnectionTypes.OAuthParameters OAuthParameters { get; set; }
        }

        public class BasicAuthParameters : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// Username
        ...
        public class ClientParameters : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// ClientSecret
        ...
        public class ConnectionHttpParameters : Humidifier.Base.BaseSubResource
        {
            ...
            /// ItemType: Parameter
            /// </summary>
            public List<ConnectionTypes.Parameter> HeaderParameters { get; set; }
            /// <summary>
            ...
            /// ItemType: Parameter
            /// </summary>
            public List<ConnectionTypes.Parameter> QueryStringParameters { get; set; }
            /// <summary>
            /// BodyParameters
            ...
            /// ItemType: Parameter
            /// </summary>
            public List<ConnectionTypes.Parameter> BodyParameters { get; set; }
        }
        ...
        public class OAuthParameters : Humidifier.Base.BaseSubResource
        {
            ...
            /// </summary>
            public ConnectionTypes.ClientParameters ClientParameters { get; set; }
            /// <summary>
            /// OAuthHttpParameters
            ...
            /// Type: ConnectionHttpParameters
            /// </summary>
            public ConnectionTypes.ConnectionHttpParameters OAuthHttpParameters { get; set; }
            /// <summary>
        ...
        public class Parameter : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// Value
