namespace Humidifier.Events
{
    ...
    public class EventBus : Humidifier.Base.BaseResource, IHaveImpliedResourceName, IHaveTags, IHaveDescription
    {
        ...
        /// </summary>
        public EventBusTypes.DeadLetterConfig DeadLetterConfig { get; set; }
        /// <summary>
        /// Tags
