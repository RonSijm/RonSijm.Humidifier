namespace Humidifier.Events
{
    ...
    {
        public class EndpointEventBus : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// EventBusArn
        ...
        public class FailoverConfig : Humidifier.Base.BaseSubResource
        {
            ...
            /// Type: Secondary
            /// </summary>
            public EndpointTypes.Secondary Secondary { get; set; }
            /// <summary>
            /// Primary
            ...
            /// Type: Primary
            /// </summary>
            public EndpointTypes.Primary Primary { get; set; }
        }
        ...
        public class ReplicationConfig : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// State
        ...
        public class RoutingConfig : Humidifier.Base.BaseSubResource
        {
            ...
            /// Type: FailoverConfig
            /// </summary>
            public EndpointTypes.FailoverConfig FailoverConfig { get; set; }
        }
