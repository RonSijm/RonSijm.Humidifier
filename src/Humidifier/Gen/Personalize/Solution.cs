namespace Humidifier.Personalize
{
    ...
    public class Solution : Humidifier.Base.BaseResource, IHaveImpliedResourceName
    {
        ...
        /// Type: SolutionConfig
        /// </summary>
        public SolutionTypes.SolutionConfig SolutionConfig { get; set; }
        /// <summary>
        /// RecipeArn
    ...
    namespace SolutionTypes
    {
        public class AlgorithmHyperParameterRanges : Humidifier.Base.BaseSubResource
        {
            ...
            /// </summary>
            public List<SolutionTypes.IntegerHyperParameterRange> IntegerHyperParameterRanges { get; set; }
            /// <summary>
            ...
            /// </summary>
            public List<SolutionTypes.CategoricalHyperParameterRange> CategoricalHyperParameterRanges { get; set; }
            /// <summary>
            ...
            /// </summary>
            public List<SolutionTypes.ContinuousHyperParameterRange> ContinuousHyperParameterRanges { get; set; }
        }

        public class AutoMLConfig : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// MetricName
        ...
        public class CategoricalHyperParameterRange : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// Values
        ...
        public class ContinuousHyperParameterRange : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// MinValue
        ...
        public class HpoConfig : Humidifier.Base.BaseSubResource
        {
            ...
            /// </summary>
            public SolutionTypes.HpoResourceConfig HpoResourceConfig { get; set; }
            /// <summary>
            ...
            /// </summary>
            public SolutionTypes.AlgorithmHyperParameterRanges AlgorithmHyperParameterRanges { get; set; }
            /// <summary>
            /// HpoObjective
            ...
            /// Type: HpoObjective
            /// </summary>
            public SolutionTypes.HpoObjective HpoObjective { get; set; }
        }

        public class HpoObjective : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// MetricName
        ...
        public class IntegerHyperParameterRange : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// MinValue
        ...
        public class SolutionConfig : Humidifier.Base.BaseSubResource
        {
            ...
            /// Type: HpoConfig
            /// </summary>
            public SolutionTypes.HpoConfig HpoConfig { get; set; }
            /// <summary>
            ...
            /// Type: AutoMLConfig
            /// </summary>
            public SolutionTypes.AutoMLConfig AutoMLConfig { get; set; }
        }
    }
}