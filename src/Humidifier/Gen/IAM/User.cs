namespace Humidifier.IAM
{
    ...
    public class User : Humidifier.Base.BaseResource, IHaveTags, IHaveImpliedResourceName
    {
        ...
        /// ItemType: Policy
        /// </summary>
        public List<UserTypes.Policy> Policies { get; set; }
        ...
        /// Type: LoginProfile
        /// </summary>
        public UserTypes.LoginProfile LoginProfile { get; set; }
        /// <summary>
        /// Tags
    ...
    namespace UserTypes
    {
        public class LoginProfile : Humidifier.Base.BaseSubResource
        {
            /// <summary>
        ...
        public class Policy : Humidifier.Base.BaseSubResource, IHavePolicyDocument
        {
            /// <summary>
            /// PolicyName
