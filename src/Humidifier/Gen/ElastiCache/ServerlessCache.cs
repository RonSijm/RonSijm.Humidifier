namespace Humidifier.ElastiCache
{
    ...
    public class ServerlessCache : Humidifier.Base.BaseResource, IHaveImpliedResourceName, IHaveTags, IHaveDescription, IHaveSubnetIds, IHaveKmsKeyId
    {
        ...
        /// </summary>
        public ServerlessCacheTypes.CacheUsageLimits CacheUsageLimits { get; set; }
        /// <summary>
        /// SecurityGroupIds
        ...
        /// Type: Endpoint
        /// </summary>
        public ServerlessCacheTypes.Endpoint ReaderEndpoint { get; set; }
        /// <summary>
        ...
        /// Type: Endpoint
        /// </summary>
        public ServerlessCacheTypes.Endpoint Endpoint { get; set; }
    ...
    namespace ServerlessCacheTypes
    {
        public class CacheUsageLimits : Humidifier.Base.BaseSubResource
        {
            ...
            /// Type: DataStorage
            /// </summary>
            public ServerlessCacheTypes.DataStorage DataStorage { get; set; }
            /// <summary>
            /// ECPUPerSecond
            ...
            /// Type: ECPUPerSecond
            /// </summary>
            public ServerlessCacheTypes.ECPUPerSecond ECPUPerSecond { get; set; }
        }

        public class DataStorage : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// Minimum
        ...
        public class ECPUPerSecond : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// Minimum
