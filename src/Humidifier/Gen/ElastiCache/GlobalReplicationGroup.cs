namespace Humidifier.ElastiCache
{
    ...
    public class GlobalReplicationGroup : Humidifier.Base.BaseResource, IHaveDescription
    {
        ...
        /// </summary>
        public List<GlobalReplicationGroupTypes.RegionalConfiguration> RegionalConfigurations { get; set; }
        /// <summary>
    ...
    {
        public class GlobalReplicationGroupMember : Humidifier.Base.BaseSubResource, IHaveRole
        {
            /// <summary>
            /// Role
        ...
        public class RegionalConfiguration : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// ReplicationGroupRegion
            ...
            /// </summary>
            public List<GlobalReplicationGroupTypes.ReshardingConfiguration> ReshardingConfigurations { get; set; }
        }
