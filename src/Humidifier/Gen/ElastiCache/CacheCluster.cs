namespace Humidifier.ElastiCache
{
    ...
    public class CacheCluster : Humidifier.Base.BaseResource, IHaveTags
    {
        ...
        /// </summary>
        public List<CacheClusterTypes.LogDeliveryConfigurationRequest> LogDeliveryConfigurations { get; set; }
        /// <summary>
        /// NetworkType
    ...
    namespace CacheClusterTypes
    {
        ...
        public class DestinationDetails : Humidifier.Base.BaseSubResource
        {
            ...
            /// </summary>
            public CacheClusterTypes.CloudWatchLogsDestinationDetails CloudWatchLogsDetails { get; set; }
            /// <summary>
            ...
            /// </summary>
            public CacheClusterTypes.KinesisFirehoseDestinationDetails KinesisFirehoseDetails { get; set; }
        }
        ...
        public class LogDeliveryConfigurationRequest : Humidifier.Base.BaseSubResource
        {
            ...
            /// </summary>
            public CacheClusterTypes.DestinationDetails DestinationDetails { get; set; }
            /// <summary>
            /// DestinationType
