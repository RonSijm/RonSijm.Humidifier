namespace Humidifier.CodeArtifact
{
    ...
    public class PackageGroup : Humidifier.Base.BaseResource, IHaveTags, IHaveDescription
    {
        ...
        /// </summary>
        public PackageGroupTypes.OriginConfiguration OriginConfiguration { get; set; }
        /// <summary>
        /// ContactInfo
    ...
    namespace PackageGroupTypes
    {
        public class OriginConfiguration : Humidifier.Base.BaseSubResource
        {
            ...
            /// Type: Restrictions
            /// </summary>
            public PackageGroupTypes.Restrictions Restrictions { get; set; }
        }
        ...
        public class Restrictions : Humidifier.Base.BaseSubResource
        {
            ...
            /// </summary>
            public PackageGroupTypes.RestrictionType ExternalUpstream { get; set; }
            /// <summary>
            /// Publish
            ...
            /// Type: RestrictionType
            /// </summary>
            public PackageGroupTypes.RestrictionType Publish { get; set; }
            /// <summary>
            /// InternalUpstream
            ...
            /// Type: RestrictionType
            /// </summary>
            public PackageGroupTypes.RestrictionType InternalUpstream { get; set; }
        }
    }
}