namespace Humidifier.Location
{
    ...
    public class PlaceIndex : Humidifier.Base.BaseResource, IHaveTags, IHaveDescription
    {
        ...
        /// </summary>
        public PlaceIndexTypes.DataSourceConfiguration DataSourceConfiguration { get; set; }
        /// <summary>
        /// Tags
