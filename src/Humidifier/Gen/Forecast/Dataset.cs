namespace Humidifier.Forecast
{
    ...
    public class Dataset : Humidifier.Base.BaseResource, IHaveImpliedResourceName
    {
        ...
        /// </summary>
        public DatasetTypes.EncryptionConfig EncryptionConfig { get; set; }
        /// <summary>
        /// Tags
        ...
        /// ItemType: TagsItems
        /// </summary>
        public List<DatasetTypes.TagsItems> Tags { get; set; }
    }

    namespace DatasetTypes
    {
        public class AttributesItems : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// AttributeType
        ...
        public class Schema : Humidifier.Base.BaseSubResource
        {
            ...
            /// </summary>
            public List<DatasetTypes.AttributesItems> Attributes_ { get; set; }
        }

        public class TagsItems : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// Value
