namespace Humidifier.SSO
{
    ...
    public class PermissionSet : Humidifier.Base.BaseResource, IHaveImpliedResourceName, IHaveTags, IHaveDescription
    {
        ...
        /// </summary>
        public List<PermissionSetTypes.CustomerManagedPolicyReference> CustomerManagedPolicyReferences { get; set; }
        /// <summary>
        /// SessionDuration
        ...
        /// </summary>
        public PermissionSetTypes.PermissionsBoundary PermissionsBoundary { get; set; }
    }

    namespace PermissionSetTypes
    {
        public class CustomerManagedPolicyReference : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// Path
        ...
        public class PermissionsBoundary : Humidifier.Base.BaseSubResource
        {
            ...
            /// </summary>
            public PermissionSetTypes.CustomerManagedPolicyReference CustomerManagedPolicyReference { get; set; }
            /// <summary>
            /// ManagedPolicyArn
