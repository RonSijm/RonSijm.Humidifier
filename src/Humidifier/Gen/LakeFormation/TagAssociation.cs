namespace Humidifier.LakeFormation
{
    ...
    namespace TagAssociationTypes
    {
        ...
        public class LFTagPair : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// TagKey
        ...
        public class Resource : Humidifier.Base.BaseSubResource
        {
            ...
            /// Type: TableResource
            /// </summary>
            public TagAssociationTypes.TableResource Table { get; set; }
            /// <summary>
            /// TableWithColumns
            ...
            /// </summary>
            public TagAssociationTypes.TableWithColumnsResource TableWithColumns { get; set; }
            /// <summary>
            /// Database
            ...
            /// </summary>
            public TagAssociationTypes.DatabaseResource Database { get; set; }
            /// <summary>
            /// Catalog
