namespace Humidifier.SecurityLake
{
    ...
    {
        public class AwsLogSource : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// SourceName
        ...
        public class CustomLogSource : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// SourceName
        ...
        public class Source : Humidifier.Base.BaseSubResource
        {
            ...
            /// Type: AwsLogSource
            /// </summary>
            public SubscriberTypes.AwsLogSource AwsLogSource { get; set; }
            /// <summary>
            /// CustomLogSource
            ...
            /// </summary>
            public SubscriberTypes.CustomLogSource CustomLogSource { get; set; }
        }

        public class SubscriberIdentity : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// ExternalId
