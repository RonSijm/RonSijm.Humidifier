namespace Humidifier.SecurityLake
{
    ...
    {
        public class HttpsNotificationConfiguration : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// Endpoint
        ...
        public class NotificationConfiguration : Humidifier.Base.BaseSubResource
        {
            ...
            /// </summary>
            public SubscriberNotificationTypes.HttpsNotificationConfiguration HttpsNotificationConfiguration { get; set; }
            /// <summary>
