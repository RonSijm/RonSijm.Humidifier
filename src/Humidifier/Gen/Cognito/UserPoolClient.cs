namespace Humidifier.Cognito
{
    ...
    public class UserPoolClient : Humidifier.Base.BaseResource
    {
        ...
        /// </summary>
        public UserPoolClientTypes.AnalyticsConfiguration AnalyticsConfiguration { get; set; }
        /// <summary>
        /// GenerateSecret
        ...
        /// </summary>
        public UserPoolClientTypes.TokenValidityUnits TokenValidityUnits { get; set; }
        /// <summary>
        /// ReadAttributes
    ...
    namespace UserPoolClientTypes
    {
        ...
        public class TokenValidityUnits : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// IdToken
