namespace Humidifier.Cognito
{
    ...
    public class UserPoolRiskConfigurationAttachment : Humidifier.Base.BaseResource
    {
        ...
        /// </summary>
        public UserPoolRiskConfigurationAttachmentTypes.AccountTakeoverRiskConfigurationType AccountTakeoverRiskConfiguration { get; set; }
        /// <summary>
        ...
        /// </summary>
        public UserPoolRiskConfigurationAttachmentTypes.RiskExceptionConfigurationType RiskExceptionConfiguration { get; set; }
    }
    ...
    namespace UserPoolRiskConfigurationAttachmentTypes
    {
        ...
        public class AccountTakeoverActionsType : Humidifier.Base.BaseSubResource
        {
            ...
            /// </summary>
            public UserPoolRiskConfigurationAttachmentTypes.AccountTakeoverActionType HighAction { get; set; }
            /// <summary>
            /// LowAction
            ...
            /// Type: AccountTakeoverActionType
            /// </summary>
            public UserPoolRiskConfigurationAttachmentTypes.AccountTakeoverActionType LowAction { get; set; }
            /// <summary>
            /// MediumAction
            ...
            /// Type: AccountTakeoverActionType
            /// </summary>
            public UserPoolRiskConfigurationAttachmentTypes.AccountTakeoverActionType MediumAction { get; set; }
        }
        ...
        public class AccountTakeoverRiskConfigurationType : Humidifier.Base.BaseSubResource
        {
            ...
            /// </summary>
            public UserPoolRiskConfigurationAttachmentTypes.AccountTakeoverActionsType Actions { get; set; }
            /// <summary>
            /// NotifyConfiguration
            ...
            /// </summary>
            public UserPoolRiskConfigurationAttachmentTypes.NotifyConfigurationType NotifyConfiguration { get; set; }
        }
        ...
        public class CompromisedCredentialsRiskConfigurationType : Humidifier.Base.BaseSubResource
        {
            ...
            /// </summary>
            public UserPoolRiskConfigurationAttachmentTypes.CompromisedCredentialsActionsType Actions { get; set; }
            /// <summary>
            /// EventFilter
        ...
        public class NotifyConfigurationType : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// BlockEmail
            ...
            /// </summary>
            public UserPoolRiskConfigurationAttachmentTypes.NotifyEmailType BlockEmail { get; set; }
            /// <summary>
            /// ReplyTo
            ...
            /// Type: NotifyEmailType
            /// </summary>
            public UserPoolRiskConfigurationAttachmentTypes.NotifyEmailType NoActionEmail { get; set; }
            /// <summary>
            /// From
            ...
            /// Type: NotifyEmailType
            /// </summary>
            public UserPoolRiskConfigurationAttachmentTypes.NotifyEmailType MfaEmail { get; set; }
        }

        public class NotifyEmailType : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// TextBody
