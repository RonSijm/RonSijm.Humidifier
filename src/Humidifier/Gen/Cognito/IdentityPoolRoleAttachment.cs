namespace Humidifier.Cognito
{
    ...
    public class IdentityPoolRoleAttachment : Humidifier.Base.BaseResource
    {
    ...
    namespace IdentityPoolRoleAttachmentTypes
    {
        ...
        public class RoleMapping : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// Type
            ...
            /// </summary>
            public IdentityPoolRoleAttachmentTypes.RulesConfigurationType RulesConfiguration { get; set; }
            /// <summary>
            /// IdentityProvider
        ...
        public class RulesConfigurationType : Humidifier.Base.BaseSubResource
        {
            ...
            /// </summary>
            public List<IdentityPoolRoleAttachmentTypes.MappingRule> Rules { get; set; }
        }
    }
}