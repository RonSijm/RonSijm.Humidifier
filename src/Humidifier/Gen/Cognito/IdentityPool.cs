namespace Humidifier.Cognito
{
    ...
    public class IdentityPool : Humidifier.Base.BaseResource, IHaveImpliedResourceName
    {
        ...
        /// Type: PushSync
        /// </summary>
        public IdentityPoolTypes.PushSync PushSync { get; set; }
        /// <summary>
        ...
        /// </summary>
        public List<IdentityPoolTypes.CognitoIdentityProvider> CognitoIdentityProviders { get; set; }
        /// <summary>
        /// CognitoEvents
        ...
        /// Type: CognitoStreams
        /// </summary>
        public IdentityPoolTypes.CognitoStreams CognitoStreams { get; set; }
    ...
    {
        public class CognitoIdentityProvider : Humidifier.Base.BaseSubResource
        {
            /// <summary>
        ...
        public class CognitoStreams : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// StreamingStatus
        ...
        public class PushSync : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// ApplicationArns
