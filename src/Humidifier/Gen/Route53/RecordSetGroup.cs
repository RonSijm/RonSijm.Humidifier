namespace Humidifier.Route53
{
    ...
    public class RecordSetGroup : Humidifier.Base.BaseResource
    {
        ...
        /// ItemType: RecordSet
        /// </summary>
        public List<RecordSetGroupTypes.RecordSet> RecordSets { get; set; }
    }

    namespace RecordSetGroupTypes
    {
        public class AliasTarget : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// DNSName
        ...
        public class CidrRoutingConfig : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// CollectionId
        ...
        public class GeoLocation : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// ContinentCode
        ...
        public class GeoProximityLocation : Humidifier.Base.BaseSubResource
        {
            ...
            /// Type: Coordinates
            /// </summary>
            public RecordSetGroupTypes.Coordinates Coordinates { get; set; }
            /// <summary>
            /// LocalZoneGroup
        ...
        public class RecordSet : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// AliasTarget
            ...
            /// Type: AliasTarget
            /// </summary>
            public RecordSetGroupTypes.AliasTarget AliasTarget { get; set; }
            /// <summary>
            /// CidrRoutingConfig
            ...
            /// </summary>
            public RecordSetGroupTypes.CidrRoutingConfig CidrRoutingConfig { get; set; }
            /// <summary>
            /// Failover
            ...
            /// Type: GeoLocation
            /// </summary>
            public RecordSetGroupTypes.GeoLocation GeoLocation { get; set; }
            /// <summary>
            ...
            /// </summary>
            public RecordSetGroupTypes.GeoProximityLocation GeoProximityLocation { get; set; }
            /// <summary>
            /// HealthCheckId
