namespace Humidifier.Route53
{
    ...
    public class HostedZone : Humidifier.Base.BaseResource, IHaveImpliedResourceName
    {
        ...
        /// </summary>
        public List<HostedZoneTypes.HostedZoneTag> HostedZoneTags { get; set; }
        /// <summary>
        /// VPCs
        ...
        /// ItemType: VPC
        /// </summary>
        public List<HostedZoneTypes.VPC> VPCs { get; set; }
        /// <summary>
        /// HostedZoneConfig
        ...
        /// </summary>
        public HostedZoneTypes.HostedZoneConfig HostedZoneConfig { get; set; }
        /// <summary>
        /// QueryLoggingConfig
        ...
        /// </summary>
        public HostedZoneTypes.QueryLoggingConfig QueryLoggingConfig { get; set; }
        public dynamic Name { get => GivenName; set => GivenName = value; }
    }

    namespace HostedZoneTypes
    {
        public class HostedZoneConfig : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// Comment
        ...
        public class HostedZoneTag : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// Value
        ...
        public class QueryLoggingConfig : Humidifier.Base.BaseSubResource
        {
            /// <summary>
