namespace Humidifier.Route53
{
    ...
    public class HealthCheck : Humidifier.Base.BaseResource
    {
        ...
        /// </summary>
        public List<HealthCheckTypes.HealthCheckTag> HealthCheckTags { get; set; }
    }

    namespace HealthCheckTypes
    {
        public class AlarmIdentifier : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// Region
        ...
        public class HealthCheckConfig : Humidifier.Base.BaseSubResource
        {
            ...
            /// </summary>
            public HealthCheckTypes.AlarmIdentifier AlarmIdentifier { get; set; }
            /// <summary>
            /// FailureThreshold
        ...
        public class HealthCheckTag : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// Value
