namespace Humidifier.Route53
{
    ...
    public class RecordSet : Humidifier.Base.BaseResource, IHaveImpliedResourceName
    {
        ...
        /// Type: AliasTarget
        /// </summary>
        public RecordSetTypes.AliasTarget AliasTarget { get; set; }
        /// <summary>
        /// CidrRoutingConfig
        ...
        /// </summary>
        public RecordSetTypes.CidrRoutingConfig CidrRoutingConfig { get; set; }
        /// <summary>
        /// Comment
        ...
        /// Type: GeoLocation
        /// </summary>
        public RecordSetTypes.GeoLocation GeoLocation { get; set; }
        /// <summary>
        ...
        /// </summary>
        public RecordSetTypes.GeoProximityLocation GeoProximityLocation { get; set; }
        /// <summary>
        /// HealthCheckId
    ...
    namespace RecordSetTypes
    {
        ...
        public class GeoProximityLocation : Humidifier.Base.BaseSubResource
        {
            ...
            /// Type: Coordinates
            /// </summary>
            public RecordSetTypes.Coordinates Coordinates { get; set; }
            /// <summary>
            /// LocalZoneGroup
