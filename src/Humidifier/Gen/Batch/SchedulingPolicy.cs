namespace Humidifier.Batch
{
    ...
    public class SchedulingPolicy : Humidifier.Base.BaseResource, IHaveImpliedResourceName
    {
        ...
        /// </summary>
        public SchedulingPolicyTypes.FairsharePolicy FairsharePolicy { get; set; }
        /// <summary>
        /// Tags
    ...
    namespace SchedulingPolicyTypes
    {
        public class FairsharePolicy : Humidifier.Base.BaseSubResource
        {
            ...
            /// </summary>
            public List<SchedulingPolicyTypes.ShareAttributes> ShareDistribution { get; set; }
            /// <summary>
            /// ShareDecaySeconds
