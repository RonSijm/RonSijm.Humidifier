namespace Humidifier.Batch
{
    ...
    public class JobQueue : Humidifier.Base.BaseResource, IHaveImpliedResourceName
    {
        ...
        /// </summary>
        public List<JobQueueTypes.JobStateTimeLimitAction> JobStateTimeLimitActions { get; set; }
    ...
    {
        public class ComputeEnvironmentOrder : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// ComputeEnvironment
        ...
        public class JobStateTimeLimitAction : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// Action
