namespace Humidifier.WorkSpacesWeb
{
    ...
    public class UserSettings : Humidifier.Base.BaseResource, IHaveTags
    {
    ...
    {
        public class CookieSpecification : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// Path
        ...
        public class CookieSynchronizationConfiguration : Humidifier.Base.BaseSubResource
        {
            ...
            /// </summary>
            public List<UserSettingsTypes.CookieSpecification> Blocklist { get; set; }
            /// <summary>
            /// Allowlist
            ...
            /// ItemType: CookieSpecification
            /// </summary>
            public List<UserSettingsTypes.CookieSpecification> Allowlist { get; set; }
        }
    }
}