namespace Humidifier.Backup
{
    ...
    {
        public class AdvancedBackupSettingResourceType : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// BackupOptions
        ...
        public class BackupPlanResourceType : Humidifier.Base.BaseSubResource
        {
            ...
            /// </summary>
            public List<BackupPlanTypes.AdvancedBackupSettingResourceType> AdvancedBackupSettings { get; set; }
            /// <summary>
            /// BackupPlanRule
            ...
            /// </summary>
            public List<BackupPlanTypes.BackupRuleResourceType> BackupPlanRule { get; set; }
        }

        public class BackupRuleResourceType : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            ...
            /// </summary>
            public List<BackupPlanTypes.CopyActionResourceType> CopyActions { get; set; }
            /// <summary>
            ...
            /// </summary>
            public BackupPlanTypes.LifecycleResourceType Lifecycle { get; set; }
            /// <summary>
            /// TargetBackupVault
