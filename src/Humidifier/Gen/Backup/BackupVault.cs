namespace Humidifier.Backup
{
    ...
    public class BackupVault : Humidifier.Base.BaseResource, IHaveImpliedResourceName
    {
        ...
        /// </summary>
        public BackupVaultTypes.LockConfigurationType LockConfiguration { get; set; }
        /// <summary>
        /// Notifications
        ...
        /// </summary>
        public BackupVaultTypes.NotificationObjectType Notifications { get; set; }
        /// <summary>
        /// AccessPolicy
