namespace Humidifier.IoTSiteWise
{
    ...
    public class AssetModel : Humidifier.Base.BaseResource, IHaveImpliedResourceName, IHaveTags, IHaveDescription
    {
        ...
        /// </summary>
        public List<AssetModelTypes.AssetModelCompositeModel> AssetModelCompositeModels { get; set; }
        /// <summary>
        /// AssetModelType
        ...
        /// </summary>
        public List<AssetModelTypes.AssetModelHierarchy> AssetModelHierarchies { get; set; }
        /// <summary>
        ...
        /// </summary>
        public List<AssetModelTypes.AssetModelProperty> AssetModelProperties { get; set; }
        /// <summary>
    ...
    {
        public class AssetModelCompositeModel : Humidifier.Base.BaseSubResource, IHaveDescription
        {
            /// <summary>
            /// Path
            ...
            /// ItemType: AssetModelProperty
            /// </summary>
            public List<AssetModelTypes.AssetModelProperty> CompositeModelProperties { get; set; }
            /// <summary>
            /// Id
        ...
        public class AssetModelHierarchy : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// LogicalId
        ...
        public class AssetModelProperty : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// Type
            ...
            /// Type: PropertyType
            /// </summary>
            public AssetModelTypes.PropertyType Type { get; set; }
            /// <summary>
            /// LogicalId
        ...
        public class ExpressionVariable : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// Value
            ...
            /// Type: VariableValue
            /// </summary>
            public AssetModelTypes.VariableValue Value { get; set; }
            /// <summary>
            /// Name
        ...
        public class Metric : Humidifier.Base.BaseSubResource
        {
            ...
            /// </summary>
            public List<AssetModelTypes.ExpressionVariable> Variables { get; set; }
            /// <summary>
            /// Window
            ...
            /// Type: MetricWindow
            /// </summary>
            public AssetModelTypes.MetricWindow Window { get; set; }
            /// <summary>
            /// Expression
        ...
        public class MetricWindow : Humidifier.Base.BaseSubResource
        {
            ...
            /// Type: TumblingWindow
            /// </summary>
            public AssetModelTypes.TumblingWindow Tumbling { get; set; }
        }

        public class PropertyPathDefinition : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// Name
        ...
        public class PropertyType : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// TypeName
            ...
            /// Type: Attribute
            /// </summary>
            public AssetModelTypes.Attribute Attribute { get; set; }
            /// <summary>
            /// Metric
            ...
            /// Type: Metric
            /// </summary>
            public AssetModelTypes.Metric Metric { get; set; }
            /// <summary>
            /// Transform
            ...
            /// Type: Transform
            /// </summary>
            public AssetModelTypes.Transform Transform { get; set; }
        }

        public class Transform : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// Variables
        ...
        public class TumblingWindow : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// Interval
        ...
        public class VariableValue : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// PropertyExternalId
            ...
            /// </summary>
            public List<AssetModelTypes.PropertyPathDefinition> PropertyPath { get; set; }
            /// <summary>
            /// HierarchyExternalId
