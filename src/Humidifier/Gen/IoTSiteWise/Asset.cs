namespace Humidifier.IoTSiteWise
{
    ...
    public class Asset : Humidifier.Base.BaseResource, IHaveTags, IHaveImpliedResourceName
    {
        ...
        /// </summary>
        public List<AssetTypes.AssetProperty> AssetProperties { get; set; }
        /// <summary>
        /// AssetExternalId
        ...
        /// </summary>
        public List<AssetTypes.AssetHierarchy> AssetHierarchies { get; set; }
    }

    namespace AssetTypes
    {
        public class AssetHierarchy : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// LogicalId
        ...
        public class AssetProperty : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// LogicalId
