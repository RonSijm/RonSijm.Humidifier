namespace Humidifier.Lightsail
{
    ...
    public class Database : Humidifier.Base.BaseResource, IHaveTags
    {
        ...
        /// </summary>
        public List<DatabaseTypes.RelationalDatabaseParameter> RelationalDatabaseParameters { get; set; }
        /// <summary>
    ...
    {
        public class RelationalDatabaseParameter : Humidifier.Base.BaseSubResource, IHaveDescription
        {
            /// <summary>
            /// ApplyMethod
