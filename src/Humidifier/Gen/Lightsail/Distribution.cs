namespace Humidifier.Lightsail
{
    ...
    public class Distribution : Humidifier.Base.BaseResource, IHaveImpliedResourceName, IHaveTags
    {
        ...
        /// Type: CacheSettings
        /// </summary>
        public DistributionTypes.CacheSettings CacheBehaviorSettings { get; set; }
        /// <summary>
        /// CertificateName
        ...
        /// </summary>
        public List<DistributionTypes.CacheBehaviorPerPath> CacheBehaviors { get; set; }
    }
    ...
    namespace DistributionTypes
    {
        ...
        public class CacheBehaviorPerPath : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// Path
        ...
        public class CacheSettings : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// ForwardedCookies
            ...
            /// Type: CookieObject
            /// </summary>
            public DistributionTypes.CookieObject ForwardedCookies { get; set; }
            /// <summary>
            /// MinimumTTL
            ...
            /// Type: HeaderObject
            /// </summary>
            public DistributionTypes.HeaderObject ForwardedHeaders { get; set; }
            /// <summary>
            /// DefaultTTL
            ...
            /// </summary>
            public DistributionTypes.QueryStringObject ForwardedQueryStrings { get; set; }
        }

        public class CookieObject : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// CookiesAllowList
        ...
        public class HeaderObject : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// HeadersAllowList
        ...
        public class InputOrigin : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// RegionName
        ...
        public class QueryStringObject : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// Option
