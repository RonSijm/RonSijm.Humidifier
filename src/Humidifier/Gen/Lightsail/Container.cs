namespace Humidifier.Lightsail
{
    ...
    public class Container : Humidifier.Base.BaseResource, IHaveTags
    {
        ...
        /// </summary>
        public ContainerTypes.PrivateRegistryAccess PrivateRegistryAccess { get; set; }
        /// <summary>
        ...
        /// </summary>
        public ContainerTypes.ContainerServiceDeployment ContainerServiceDeployment { get; set; }
        /// <summary>
        /// IsDisabled
    ...
    namespace ContainerTypes
    {
        public class Container : Humidifier.Base.BaseSubResource
        {
            ...
            /// </summary>
            public List<ContainerTypes.EnvironmentVariable> Environment { get; set; }
            /// <summary>
            /// Ports
            ...
            /// ItemType: PortInfo
            /// </summary>
            public List<ContainerTypes.PortInfo> Ports { get; set; }
            /// <summary>
            /// Image
        ...
        public class ContainerServiceDeployment : Humidifier.Base.BaseSubResource
        {
            ...
            /// ItemType: Container
            /// </summary>
            public List<ContainerTypes.Container> Containers { get; set; }
            /// <summary>
            /// PublicEndpoint
            ...
            /// Type: PublicEndpoint
            /// </summary>
            public ContainerTypes.PublicEndpoint PublicEndpoint { get; set; }
        }

        public class EcrImagePullerRole : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// PrincipalArn
        ...
        public class HealthCheckConfig : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// Path
        ...
        public class PortInfo : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// Port
        ...
        public class PrivateRegistryAccess : Humidifier.Base.BaseSubResource
        {
            ...
            /// </summary>
            public ContainerTypes.EcrImagePullerRole EcrImagePullerRole { get; set; }
        }

        public class PublicDomainName : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// CertificateName
        ...
        public class PublicEndpoint : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// ContainerName
            ...
            /// </summary>
            public ContainerTypes.HealthCheckConfig HealthCheckConfig { get; set; }
        }
    }
}