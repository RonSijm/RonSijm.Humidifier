namespace Humidifier.Lightsail
{
    ...
    public class Certificate : Humidifier.Base.BaseResource, IHaveImpliedResourceName, IHaveTags, IHaveDomainName, IHaveCertificateName, IHaveSubjectAlternativeNames
    {
