namespace Humidifier.Lightsail
{
    ...
    public class Disk : Humidifier.Base.BaseResource, IHaveImpliedResourceName, IHaveTags
    {
        ...
        /// ItemType: AddOn
        /// </summary>
        public List<DiskTypes.AddOn> AddOns { get; set; }
        ...
        /// Type: Location
        /// </summary>
        public DiskTypes.Location Location { get; set; }
    }
    ...
    namespace DiskTypes
    {
        public class AddOn : Humidifier.Base.BaseSubResource
        {
            ...
            /// </summary>
            public DiskTypes.AutoSnapshotAddOn AutoSnapshotAddOnRequest { get; set; }
        }
