namespace Humidifier.Lightsail
{
    ...
    public class Instance : Humidifier.Base.BaseResource, IHaveImpliedResourceName, IHaveTags
    {
        ...
        /// Type: Networking
        /// </summary>
        public InstanceTypes.Networking Networking { get; set; }
        /// <summary>
        /// UserData
        ...
        /// Type: State
        /// </summary>
        public InstanceTypes.State State { get; set; }
        /// <summary>
        /// AvailabilityZone
        ...
        /// ItemType: AddOn
        /// </summary>
        public List<InstanceTypes.AddOn> AddOns { get; set; }
        /// <summary>
        /// Hardware
        ...
        /// Type: Hardware
        /// </summary>
        public InstanceTypes.Hardware Hardware { get; set; }
        /// <summary>
        /// Tags
        ...
        /// Type: Location
        /// </summary>
        public InstanceTypes.Location Location { get; set; }
    }

    namespace InstanceTypes
    {
        public class AddOn : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// Status
            ...
            /// </summary>
            public InstanceTypes.AutoSnapshotAddOn AutoSnapshotAddOnRequest { get; set; }
        }
        ...
        public class Disk : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// SizeInGb
        ...
        public class Hardware : Humidifier.Base.BaseSubResource
        {
            ...
            /// ItemType: Disk
            /// </summary>
            public List<InstanceTypes.Disk> Disks { get; set; }
        }
        ...
        public class Networking : Humidifier.Base.BaseSubResource
        {
            ...
            /// ItemType: Port
            /// </summary>
            public List<InstanceTypes.Port> Ports { get; set; }
            /// <summary>
            /// MonthlyTransfer
            ...
            /// </summary>
            public InstanceTypes.MonthlyTransfer MonthlyTransfer { get; set; }
        }

        public class Port : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// FromPort
