namespace Humidifier.OpenSearchServerless
{
    ...
    public class SecurityConfig : Humidifier.Base.BaseResource, IHaveImpliedResourceName, IHaveDescription
    {
        ...
        /// </summary>
        public SecurityConfigTypes.SamlConfigOptions SamlOptions { get; set; }
        public dynamic Name { get => GivenName; set => GivenName = value; }
    }

    namespace SecurityConfigTypes
    {
        public class SamlConfigOptions : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// SessionTimeout
