namespace Humidifier.GuardDuty
{
    ...
    public class Detector : Humidifier.Base.BaseResource
    {
        ...
        /// </summary>
        public List<DetectorTypes.CFNFeatureConfiguration> Features { get; set; }
        /// <summary>
        /// Tags
        ...
        /// ItemType: TagItem
        /// </summary>
        public List<DetectorTypes.TagItem> Tags { get; set; }
    }
    ...
    namespace DetectorTypes
    {
        public class CFNDataSourceConfigurations : Humidifier.Base.BaseSubResource
        {
            ...
            /// </summary>
            public DetectorTypes.CFNMalwareProtectionConfiguration MalwareProtection { get; set; }
            /// <summary>
            /// S3Logs
            ...
            /// </summary>
            public DetectorTypes.CFNS3LogsConfiguration S3Logs { get; set; }
            /// <summary>
            /// Kubernetes
            ...
            /// </summary>
            public DetectorTypes.CFNKubernetesConfiguration Kubernetes { get; set; }
        }

        public class CFNFeatureAdditionalConfiguration : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// Status
        ...
        public class CFNFeatureConfiguration : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// Status
            ...
            /// </summary>
            public List<DetectorTypes.CFNFeatureAdditionalConfiguration> AdditionalConfiguration { get; set; }
            /// <summary>
            /// Name
        ...
        public class CFNKubernetesAuditLogsConfiguration : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// Enable
        ...
        public class CFNKubernetesConfiguration : Humidifier.Base.BaseSubResource
        {
            ...
            /// </summary>
            public DetectorTypes.CFNKubernetesAuditLogsConfiguration AuditLogs { get; set; }
        }
        ...
        public class CFNMalwareProtectionConfiguration : Humidifier.Base.BaseSubResource
        {
            ...
            /// </summary>
            public DetectorTypes.CFNScanEc2InstanceWithFindingsConfiguration ScanEc2InstanceWithFindings { get; set; }
        }

        public class CFNS3LogsConfiguration : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// Enable
