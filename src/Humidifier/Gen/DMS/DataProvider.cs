namespace Humidifier.DMS
{
    ...
    public class DataProvider : Humidifier.Base.BaseResource, IHaveTags, IHaveDescription, IHaveImpliedResourceName
    {
        ...
        /// Type: Settings
        /// </summary>
        public DataProviderTypes.Settings Settings { get; set; }
        /// <summary>
        /// Tags
    ...
    namespace DataProviderTypes
    {
        ...
        public class Settings : Humidifier.Base.BaseSubResource
        {
            ...
            /// Type: OracleSettings
            /// </summary>
            public DataProviderTypes.OracleSettings OracleSettings { get; set; }
            /// <summary>
            ...
            /// </summary>
            public DataProviderTypes.MicrosoftSqlServerSettings MicrosoftSqlServerSettings { get; set; }
            /// <summary>
            /// MySqlSettings
            ...
            /// Type: MySqlSettings
            /// </summary>
            public DataProviderTypes.MySqlSettings MySqlSettings { get; set; }
            /// <summary>
            /// PostgreSqlSettings
            ...
            /// </summary>
            public DataProviderTypes.PostgreSqlSettings PostgreSqlSettings { get; set; }
        }
    }
}