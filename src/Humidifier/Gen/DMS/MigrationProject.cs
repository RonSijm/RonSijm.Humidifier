namespace Humidifier.DMS
{
    ...
    public class MigrationProject : Humidifier.Base.BaseResource, IHaveImpliedResourceName, IHaveTags, IHaveDescription
    {
        ...
        /// </summary>
        public List<MigrationProjectTypes.DataProviderDescriptor> TargetDataProviderDescriptors { get; set; }
        ...
        /// ItemType: DataProviderDescriptor
        /// </summary>
        public List<MigrationProjectTypes.DataProviderDescriptor> SourceDataProviderDescriptors { get; set; }
        /// <summary>
        /// TransformationRules
        ...
        /// </summary>
        public MigrationProjectTypes.SchemaConversionApplicationAttributes SchemaConversionApplicationAttributes { get; set; }
        /// <summary>
        /// InstanceProfileArn
    ...
    {
        public class DataProviderDescriptor : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// DataProviderName
