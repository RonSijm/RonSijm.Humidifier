namespace Humidifier.CloudTrail
{
    ...
    public class Trail : Humidifier.Base.BaseResource, IHaveTags, IHaveImpliedResourceName
    {
        ...
        /// </summary>
        public List<TrailTypes.EventSelector> EventSelectors { get; set; }
        /// <summary>
        /// KMSKeyId
        ...
        /// </summary>
        public List<TrailTypes.AdvancedEventSelector> AdvancedEventSelectors { get; set; }
        ...
        /// </summary>
        public List<TrailTypes.InsightSelector> InsightSelectors { get; set; }
        /// <summary>
    ...
    {
        public class AdvancedEventSelector : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// FieldSelectors
            ...
            /// </summary>
            public List<TrailTypes.AdvancedFieldSelector> FieldSelectors { get; set; }
            /// <summary>
            /// Name
        ...
        public class AdvancedFieldSelector : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// Field
        ...
        public class DataResource : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// Type
        ...
        public class EventSelector : Humidifier.Base.BaseSubResource
        {
            ...
            /// </summary>
            public List<TrailTypes.DataResource> DataResources { get; set; }
        }
