namespace Humidifier.CloudTrail
{
    ...
    public class EventDataStore : Humidifier.Base.BaseResource, IHaveTags, IHaveImpliedResourceName
    {
        ...
        /// </summary>
        public List<EventDataStoreTypes.AdvancedEventSelector> AdvancedEventSelectors { get; set; }
        /// <summary>
        ...
        /// </summary>
        public List<EventDataStoreTypes.InsightSelector> InsightSelectors { get; set; }
        /// <summary>
        /// OrganizationEnabled
    ...
    namespace EventDataStoreTypes
    {
        public class AdvancedEventSelector : Humidifier.Base.BaseSubResource
        {
            ...
            /// </summary>
            public List<EventDataStoreTypes.AdvancedFieldSelector> FieldSelectors { get; set; }
            /// <summary>
            /// Name
