namespace Humidifier.OpsWorks
{
    ...
    public class Layer : Humidifier.Base.BaseResource, IHaveTags, IHaveImpliedResourceName
    {
        ...
        /// Type: Recipes
        /// </summary>
        public LayerTypes.Recipes CustomRecipes { get; set; }
        /// <summary>
        ...
        /// </summary>
        public LayerTypes.LifecycleEventConfiguration LifecycleEventConfiguration { get; set; }
        /// <summary>
        ...
        /// </summary>
        public LayerTypes.LoadBasedAutoScaling LoadBasedAutoScaling { get; set; }
        ...
        /// </summary>
        public List<LayerTypes.VolumeConfiguration> VolumeConfigurations { get; set; }
    }

    namespace LayerTypes
    {
        public class AutoScalingThresholds : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// CpuThreshold
        ...
        public class LifecycleEventConfiguration : Humidifier.Base.BaseSubResource
        {
            ...
            /// </summary>
            public LayerTypes.ShutdownEventConfiguration ShutdownEventConfiguration { get; set; }
        }

        public class LoadBasedAutoScaling : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// DownScaling
            ...
            /// </summary>
            public LayerTypes.AutoScalingThresholds DownScaling { get; set; }
            /// <summary>
            /// Enable
            ...
            /// Type: AutoScalingThresholds
            /// </summary>
            public LayerTypes.AutoScalingThresholds UpScaling { get; set; }
        }
        ...
        public class VolumeConfiguration : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// Encrypted
