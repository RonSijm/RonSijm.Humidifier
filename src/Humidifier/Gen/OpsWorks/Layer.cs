namespace Humidifier.OpsWorks
{
    ...
    public class Layer : Humidifier.Base.BaseResource, IHaveImpliedResourceName, IHaveName, IHaveTags, IHaveType, IHaveStackId
    {
        ...
        /// </summary>
        public dynamic CustomInstanceProfileArn { get; set; }
        /// <summary>
        /// CustomJson
        ...
        /// Type: Recipes
        /// </summary>
        public Humidifier.OpsWorks.LayerTypes.Recipes CustomRecipes { get; set; }
        /// <summary>
        ...
        /// </summary>
        public Humidifier.OpsWorks.LayerTypes.LifecycleEventConfiguration LifecycleEventConfiguration { get; set; }
        /// <summary>
        ...
        /// </summary>
        public Humidifier.OpsWorks.LayerTypes.LoadBasedAutoScaling LoadBasedAutoScaling { get; set; }
        ...
        /// PrimitiveType: Boolean
        /// </summary>
        public dynamic UseEbsOptimizedInstances { get; set; }
        /// <summary>
        ...
        /// </summary>
        public List<Humidifier.OpsWorks.LayerTypes.VolumeConfiguration> VolumeConfigurations { get; set; }
    }

    namespace LayerTypes
    {
        public class AutoScalingThresholds : Humidifier.Base.BaseSubResource, IHaveInstanceCount
        {
            /// <summary>
            /// CpuThreshold
            ...
            /// </summary>
            public dynamic CpuThreshold { get; set; }
            /// <summary>
            /// IgnoreMetricsTime
            ...
            /// </summary>
            public dynamic IgnoreMetricsTime { get; set; }
            /// <summary>
            /// InstanceCount
            ...
            /// PrimitiveType: Double
            /// </summary>
            public dynamic LoadThreshold { get; set; }
            /// <summary>
            /// MemoryThreshold
            ...
            /// PrimitiveType: Double
            /// </summary>
            public dynamic MemoryThreshold { get; set; }
            /// <summary>
            /// ThresholdsWaitTime
            ...
            /// PrimitiveType: Integer
            /// </summary>
            public dynamic ThresholdsWaitTime { get; set; }
        }

        public class LifecycleEventConfiguration : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            ...
            /// </summary>
            public Humidifier.OpsWorks.LayerTypes.ShutdownEventConfiguration ShutdownEventConfiguration { get; set; }
        }

        public class LoadBasedAutoScaling : Humidifier.Base.BaseSubResource, IHaveEnable
        {
            /// <summary>
            /// DownScaling
            ...
            /// </summary>
            public Humidifier.OpsWorks.LayerTypes.AutoScalingThresholds DownScaling { get; set; }
            /// <summary>
            /// Enable
            ...
            /// Type: AutoScalingThresholds
            /// </summary>
            public Humidifier.OpsWorks.LayerTypes.AutoScalingThresholds UpScaling { get; set; }
        }

        public class Recipes : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// Configure
            ...
            /// PrimitiveItemType: String
            /// </summary>
            public dynamic Configure { get; set; }
            /// <summary>
            /// Deploy
            ...
            /// PrimitiveItemType: String
            /// </summary>
            public dynamic Shutdown { get; set; }
            /// <summary>
            /// Undeploy
        ...
        public class ShutdownEventConfiguration : Humidifier.Base.BaseSubResource
        {
            ...
            /// PrimitiveType: Boolean
            /// </summary>
            public dynamic DelayUntilElbConnectionsDrained { get; set; }
            /// <summary>
            /// ExecutionTimeout
        ...
        public class VolumeConfiguration : Humidifier.Base.BaseSubResource, IHaveIops, IHaveSize, IHaveVolumeType, IHaveEncrypted, IHaveMountPoint
        {
            /// <summary>
            /// Encrypted
            ...
            /// PrimitiveType: Integer
            /// </summary>
            public dynamic NumberOfDisks { get; set; }
            /// <summary>
            /// RaidLevel
            ...
            /// PrimitiveType: Integer
            /// </summary>
            public dynamic RaidLevel { get; set; }
            /// <summary>
            /// Size
