namespace Humidifier.OpsWorks
{
    ...
    public class Stack : Humidifier.Base.BaseResource, IHaveTags, IHaveVpcId, IHaveImpliedResourceName
    {
        ...
        /// </summary>
        public StackTypes.ChefConfiguration ChefConfiguration { get; set; }
        /// <summary>
        /// CloneAppIds
        ...
        /// </summary>
        public StackTypes.StackConfigurationManager ConfigurationManager { get; set; }
        /// <summary>
        ...
        /// Type: Source
        /// </summary>
        public StackTypes.Source CustomCookbooksSource { get; set; }
        /// <summary>
        /// CustomJson
        ...
        /// ItemType: ElasticIp
        /// </summary>
        public List<StackTypes.ElasticIp> ElasticIps { get; set; }
        /// <summary>
        /// HostnameTheme
    ...
    namespace StackTypes
    {
        ...
        public class ElasticIp : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// Ip
        ...
        public class RdsDbInstance : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// DbPassword
        ...
        public class StackConfigurationManager : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// Name
