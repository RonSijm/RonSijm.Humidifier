namespace Humidifier.OpsWorks
{
    ...
    public class Stack : Humidifier.Base.BaseResource, IHaveImpliedResourceName, IHaveName, IHaveTags, IHaveVpcId, IHaveServiceRoleArn, IHaveAgentVersion
    {
        ...
        /// </summary>
        public Humidifier.OpsWorks.StackTypes.ChefConfiguration ChefConfiguration { get; set; }
        /// <summary>
        /// CloneAppIds
        ...
        /// </summary>
        public Humidifier.OpsWorks.StackTypes.StackConfigurationManager ConfigurationManager { get; set; }
        /// <summary>
        ...
        /// Type: Source
        /// </summary>
        public Humidifier.OpsWorks.StackTypes.Source CustomCookbooksSource { get; set; }
        /// <summary>
        /// CustomJson
        ...
        /// ItemType: ElasticIp
        /// </summary>
        public List<Humidifier.OpsWorks.StackTypes.ElasticIp> ElasticIps { get; set; }
        /// <summary>
        /// HostnameTheme
        ...
        /// </summary>
        public List<Humidifier.OpsWorks.StackTypes.RdsDbInstance> RdsDbInstances { get; set; }
    ...
    {
        public class ChefConfiguration : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// BerkshelfVersion
        ...
        public class ElasticIp : Humidifier.Base.BaseSubResource, IHaveName, IHaveIp
        {
            /// <summary>
            /// Ip
        ...
        public class RdsDbInstance : Humidifier.Base.BaseSubResource, IHaveDbUser
        {
            /// <summary>
            /// DbPassword
        ...
        public class StackConfigurationManager : Humidifier.Base.BaseSubResource, IHaveName, IHaveVersion
        {
            /// <summary>
            /// Name
