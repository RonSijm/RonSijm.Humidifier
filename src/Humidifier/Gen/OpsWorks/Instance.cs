namespace Humidifier.OpsWorks
{
    ...
    public class Instance : Humidifier.Base.BaseResource, IHaveInstanceType, IHaveAvailabilityZone, IHaveSubnetId, IHaveEbsOptimized, IHaveTenancy, IHaveArchitecture, IHaveHostname, IHaveStackId, IHaveAgentVersion, IHaveAmiId, IHaveInstallUpdatesOnBoot
    {
        ...
        public override string AWSTypeName { get => AWS.OpsWorks.Instance; }
        /// <summary>
        /// AgentVersion
        ...
        /// </summary>
        public List<Humidifier.OpsWorks.InstanceTypes.BlockDeviceMapping> BlockDeviceMappings { get; set; }
        /// <summary>
        /// EbsOptimized
        ...
        /// </summary>
        public Humidifier.OpsWorks.InstanceTypes.TimeBasedAutoScaling TimeBasedAutoScaling { get; set; }
        /// <summary>
        /// VirtualizationType
    ...
    namespace InstanceTypes
    {
        public class BlockDeviceMapping : Humidifier.Base.BaseSubResource, IHaveDeviceName, IHaveNoDevice, IHaveVirtualName
        {
            ...
            /// Type: EbsBlockDevice
            /// </summary>
            public Humidifier.OpsWorks.InstanceTypes.EbsBlockDevice Ebs { get; set; }
            /// <summary>
            /// NoDevice
        ...
        public class EbsBlockDevice : Humidifier.Base.BaseSubResource, IHaveIops, IHaveVolumeType, IHaveDeleteOnTermination, IHaveVolumeSize, IHaveSnapshotId
        {
            /// <summary>
            /// DeleteOnTermination
        ...
        public class TimeBasedAutoScaling : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// Friday
