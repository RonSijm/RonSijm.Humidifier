namespace Humidifier.OpsWorks
{
    ...
    public class App : Humidifier.Base.BaseResource, IHaveImpliedResourceName, IHaveDescription
    {
        ...
        /// Type: Source
        /// </summary>
        public AppTypes.Source AppSource { get; set; }
        /// <summary>
        /// Attributes_
        ...
        /// ItemType: DataSource
        /// </summary>
        public List<AppTypes.DataSource> DataSources { get; set; }
        /// <summary>
        /// Description
        ...
        /// </summary>
        public List<AppTypes.EnvironmentVariable> Environment { get; set; }
    ...
    namespace AppTypes
    {
        ...
        public class SslConfiguration : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// Certificate
