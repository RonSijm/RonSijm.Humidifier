namespace Humidifier.StepFunctions
{
    ...
    public class StateMachineAlias : Humidifier.Base.BaseResource, IHaveDescription, IHaveImpliedResourceName
    {
        ...
        /// </summary>
        public List<StateMachineAliasTypes.RoutingConfigurationVersion> RoutingConfiguration { get; set; }
        /// <summary>
        ...
        /// </summary>
        public StateMachineAliasTypes.DeploymentPreference DeploymentPreference { get; set; }
        public dynamic Name { get => GivenName; set => GivenName = value; }
    }

    namespace StateMachineAliasTypes
    {
        public class DeploymentPreference : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// Type
        ...
        public class RoutingConfigurationVersion : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// StateMachineVersionArn
