namespace Humidifier.StepFunctions
{
    ...
    public class StateMachine : Humidifier.Base.BaseResource, IHaveImpliedResourceName
    {
        ...
        /// </summary>
        public StateMachineTypes.EncryptionConfiguration EncryptionConfiguration { get; set; }
        /// <summary>
        /// DefinitionString
        ...
        /// </summary>
        public StateMachineTypes.LoggingConfiguration LoggingConfiguration { get; set; }
        /// <summary>
        ...
        /// ItemType: TagsEntry
        /// </summary>
        public List<StateMachineTypes.TagsEntry> Tags { get; set; }
        /// <summary>
        /// StateMachineType
        ...
        /// </summary>
        public StateMachineTypes.TracingConfiguration TracingConfiguration { get; set; }
    }

    namespace StateMachineTypes
    {
        public class CloudWatchLogsLogGroup : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// LogGroupArn
        ...
        public class LogDestination : Humidifier.Base.BaseSubResource
        {
            ...
            /// </summary>
            public StateMachineTypes.CloudWatchLogsLogGroup CloudWatchLogsLogGroup { get; set; }
        }
        ...
        public class LoggingConfiguration : Humidifier.Base.BaseSubResource
        {
            ...
            /// </summary>
            public List<StateMachineTypes.LogDestination> Destinations { get; set; }
            /// <summary>
            /// Level
        ...
        public class TracingConfiguration : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// Enabled
