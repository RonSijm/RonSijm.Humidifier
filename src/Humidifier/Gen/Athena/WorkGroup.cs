namespace Humidifier.Athena
{
    ...
    public class WorkGroup : Humidifier.Base.BaseResource, IHaveImpliedResourceName, IHaveTags, IHaveDescription
    {
        ...
        /// </summary>
        public WorkGroupTypes.WorkGroupConfiguration WorkGroupConfiguration { get; set; }
        /// <summary>
        /// Description
    ...
    namespace WorkGroupTypes
    {
        ...
        public class CustomerContentEncryptionConfiguration : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// KmsKey
        ...
        public class ResultConfiguration : Humidifier.Base.BaseSubResource
        {
            ...
            /// </summary>
            public WorkGroupTypes.EncryptionConfiguration EncryptionConfiguration { get; set; }
            /// <summary>
            /// OutputLocation
            ...
            /// </summary>
            public WorkGroupTypes.AclConfiguration AclConfiguration { get; set; }
            /// <summary>
            /// ExpectedBucketOwner
        ...
        public class WorkGroupConfiguration : Humidifier.Base.BaseSubResource, IHaveExecutionRole
        {
            ...
            /// Type: EngineVersion
            /// </summary>
            public WorkGroupTypes.EngineVersion EngineVersion { get; set; }
            /// <summary>
            ...
            /// </summary>
            public WorkGroupTypes.ResultConfiguration ResultConfiguration { get; set; }
            /// <summary>
            ...
            /// </summary>
            public WorkGroupTypes.CustomerContentEncryptionConfiguration CustomerContentEncryptionConfiguration { get; set; }
            /// <summary>
