namespace Humidifier.Athena
{
    ...
    public class CapacityReservation : Humidifier.Base.BaseResource, IHaveImpliedResourceName, IHaveTags
    {
        ...
        /// </summary>
        public CapacityReservationTypes.CapacityAssignmentConfiguration CapacityAssignmentConfiguration { get; set; }
        /// <summary>
        /// Tags
    ...
    namespace CapacityReservationTypes
    {
        ...
        public class CapacityAssignmentConfiguration : Humidifier.Base.BaseSubResource
        {
            ...
            /// </summary>
            public List<CapacityReservationTypes.CapacityAssignment> CapacityAssignments { get; set; }
        }
    }
}