namespace Humidifier.SecurityHub
{
    ...
    {
        public class ParameterConfiguration : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// ValueType
            ...
            /// Type: ParameterValue
            /// </summary>
            public ConfigurationPolicyTypes.ParameterValue Value { get; set; }
        }
        ...
        public class Policy : Humidifier.Base.BaseSubResource
        {
            ...
            /// </summary>
            public ConfigurationPolicyTypes.SecurityHubPolicy SecurityHub { get; set; }
        }
        ...
        public class SecurityControlCustomParameter : Humidifier.Base.BaseSubResource
        {
            ...
            /// </summary>
            public Dictionary<string, ConfigurationPolicyTypes.ParameterConfiguration> Parameters { get; set; }
        }
        ...
        public class SecurityControlsConfiguration : Humidifier.Base.BaseSubResource
        {
            ...
            /// </summary>
            public List<ConfigurationPolicyTypes.SecurityControlCustomParameter> SecurityControlCustomParameters { get; set; }
        }
        ...
        public class SecurityHubPolicy : Humidifier.Base.BaseSubResource
        {
            ...
            /// </summary>
            public ConfigurationPolicyTypes.SecurityControlsConfiguration SecurityControlsConfiguration { get; set; }
        }
    }
}