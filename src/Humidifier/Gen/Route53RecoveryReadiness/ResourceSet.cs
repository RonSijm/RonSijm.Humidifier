namespace Humidifier.Route53RecoveryReadiness
{
    ...
    {
        public class DNSTargetResource : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// TargetResource
            ...
            /// Type: TargetResource
            /// </summary>
            public ResourceSetTypes.TargetResource TargetResource { get; set; }
            /// <summary>
            /// RecordType
        ...
        public class NLBResource : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// Arn
        ...
        public class R53ResourceRecord : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// DomainName
        ...
        public class Resource : Humidifier.Base.BaseSubResource
        {
            ...
            /// </summary>
            public ResourceSetTypes.DNSTargetResource DnsTargetResource { get; set; }
            /// <summary>
            /// ReadinessScopes
        ...
        public class TargetResource : Humidifier.Base.BaseSubResource
        {
            ...
            /// </summary>
            public ResourceSetTypes.R53ResourceRecord R53Resource { get; set; }
            /// <summary>
            /// NLBResource
            ...
            /// Type: NLBResource
            /// </summary>
            public ResourceSetTypes.NLBResource NLBResource { get; set; }
        }
    }
}