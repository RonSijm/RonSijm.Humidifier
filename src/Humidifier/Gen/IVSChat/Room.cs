namespace Humidifier.IVSChat
{
    ...
    public class Room : Humidifier.Base.BaseResource, IHaveTags, IHaveImpliedResourceName
    {
        ...
        /// </summary>
        public RoomTypes.MessageReviewHandler MessageReviewHandler { get; set; }
        /// <summary>
    ...
    namespace RoomTypes
    {
        public class MessageReviewHandler : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// FallbackResult
