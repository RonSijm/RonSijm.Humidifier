namespace Humidifier.Elasticsearch
{
    ...
    public class Domain : Humidifier.Base.BaseResource, IHaveTags, IHaveImpliedResourceName
    {
        ...
        /// </summary>
        public DomainTypes.ElasticsearchClusterConfig ElasticsearchClusterConfig { get; set; }
        /// <summary>
    ...
    namespace DomainTypes
    {
        ...
        public class ElasticsearchClusterConfig : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// ColdStorageOptions
