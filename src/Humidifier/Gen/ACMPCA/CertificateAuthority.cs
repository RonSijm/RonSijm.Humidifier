namespace Humidifier.ACMPCA
{
    ...
    public class CertificateAuthority : Humidifier.Base.BaseResource, IHaveTags
    {
        ...
        /// </summary>
        public CertificateAuthorityTypes.RevocationConfiguration RevocationConfiguration { get; set; }
        /// <summary>
        /// UsageMode
    ...
    namespace CertificateAuthorityTypes
    {
        public class AccessDescription : Humidifier.Base.BaseSubResource
        {
            ...
            /// Type: AccessMethod
            /// </summary>
            public CertificateAuthorityTypes.AccessMethod AccessMethod { get; set; }
            /// <summary>
            /// AccessLocation
            ...
            /// Type: GeneralName
            /// </summary>
            public CertificateAuthorityTypes.GeneralName AccessLocation { get; set; }
        }
        ...
        public class CrlConfiguration : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            ...
            /// </summary>
            public CertificateAuthorityTypes.CrlDistributionPointExtensionConfiguration CrlDistributionPointExtensionConfiguration { get; set; }
            /// <summary>
            /// CustomCname
        ...
        public class CsrExtensions : Humidifier.Base.BaseSubResource
        {
            ...
            /// Type: KeyUsage
            /// </summary>
            public CertificateAuthorityTypes.KeyUsage KeyUsage { get; set; }
            /// <summary>
            ...
            /// </summary>
            public List<CertificateAuthorityTypes.AccessDescription> SubjectInformationAccess { get; set; }
        }

        public class CustomAttribute : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// Value
        ...
        public class GeneralName : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            ...
            /// Type: EdiPartyName
            /// </summary>
            public CertificateAuthorityTypes.EdiPartyName EdiPartyName { get; set; }
            /// <summary>
            /// RegisteredId
            ...
            /// Type: OtherName
            /// </summary>
            public CertificateAuthorityTypes.OtherName OtherName { get; set; }
            /// <summary>
            /// IpAddress
            ...
            /// Type: Subject
            /// </summary>
            public CertificateAuthorityTypes.Subject DirectoryName { get; set; }
        }
        ...
        public class OcspConfiguration : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// OcspCustomCname
        ...
        public class OtherName : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// TypeId
        ...
        public class RevocationConfiguration : Humidifier.Base.BaseSubResource
        {
            ...
            /// </summary>
            public CertificateAuthorityTypes.OcspConfiguration OcspConfiguration { get; set; }
            /// <summary>
            /// CrlConfiguration
            ...
            /// </summary>
            public CertificateAuthorityTypes.CrlConfiguration CrlConfiguration { get; set; }
        }

        public class Subject : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// Organization
            ...
            /// </summary>
            public List<CertificateAuthorityTypes.CustomAttribute> CustomAttributes { get; set; }
            /// <summary>
            /// SerialNumber
