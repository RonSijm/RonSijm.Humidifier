namespace Humidifier.ACMPCA
{
    ...
    public class Certificate : Humidifier.Base.BaseResource
    {
        ...
        /// Type: ApiPassthrough
        /// </summary>
        public CertificateTypes.ApiPassthrough ApiPassthrough { get; set; }
        /// <summary>
        /// ValidityNotBefore
        ...
        /// Type: Validity
        /// </summary>
        public CertificateTypes.Validity ValidityNotBefore { get; set; }
    }
    ...
    namespace CertificateTypes
    {
        public class ApiPassthrough : Humidifier.Base.BaseSubResource
        {
            ...
            /// Type: Extensions
            /// </summary>
            public CertificateTypes.Extensions Extensions { get; set; }
            /// <summary>
            /// Subject
            ...
            /// Type: Subject
            /// </summary>
            public CertificateTypes.Subject Subject { get; set; }
        }
        ...
        public class CustomExtension : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// Value
        ...
        public class Extensions : Humidifier.Base.BaseSubResource
        {
            ...
            /// </summary>
            public List<CertificateTypes.CustomExtension> CustomExtensions { get; set; }
            /// <summary>
            /// CertificatePolicies
            ...
            /// </summary>
            public List<CertificateTypes.PolicyInformation> CertificatePolicies { get; set; }
            /// <summary>
            /// KeyUsage
            ...
            /// Type: KeyUsage
            /// </summary>
            public CertificateTypes.KeyUsage KeyUsage { get; set; }
            /// <summary>
            ...
            /// </summary>
            public List<CertificateTypes.GeneralName> SubjectAlternativeNames { get; set; }
            /// <summary>
            /// ExtendedKeyUsage
            ...
            /// </summary>
            public List<CertificateTypes.ExtendedKeyUsage> ExtendedKeyUsage { get; set; }
        }
        ...
        public class GeneralName : Humidifier.Base.BaseSubResource
        {
            ...
            /// Type: EdiPartyName
            /// </summary>
            public CertificateTypes.EdiPartyName EdiPartyName { get; set; }
            /// <summary>
            /// RegisteredId
            ...
            /// Type: OtherName
            /// </summary>
            public CertificateTypes.OtherName OtherName { get; set; }
            /// <summary>
            /// IpAddress
            ...
            /// Type: Subject
            /// </summary>
            public CertificateTypes.Subject DirectoryName { get; set; }
        }
        ...
        public class PolicyInformation : Humidifier.Base.BaseSubResource
        {
            ...
            /// </summary>
            public List<CertificateTypes.PolicyQualifierInfo> PolicyQualifiers { get; set; }
        }
        ...
        public class PolicyQualifierInfo : Humidifier.Base.BaseSubResource
        {
            ...
            /// Type: Qualifier
            /// </summary>
            public CertificateTypes.Qualifier Qualifier { get; set; }
            /// <summary>
            /// PolicyQualifierId
        ...
        public class Subject : Humidifier.Base.BaseSubResource
        {
            ...
            /// </summary>
            public List<CertificateTypes.CustomAttribute> CustomAttributes { get; set; }
            /// <summary>
            /// SerialNumber
        ...
        public class Validity : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// Type
