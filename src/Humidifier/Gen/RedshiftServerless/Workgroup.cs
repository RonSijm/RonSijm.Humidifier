namespace Humidifier.RedshiftServerless
{
    ...
    public class Workgroup : Humidifier.Base.BaseResource, IHaveImpliedResourceName, IHaveTags, IHaveSubnetIds
    {
        ...
        /// </summary>
        public List<WorkgroupTypes.ConfigParameter> ConfigParameters { get; set; }
        /// <summary>
        /// Port
    ...
    {
        public class ConfigParameter : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// ParameterValue
        ...
        public class Endpoint : Humidifier.Base.BaseSubResource
        {
            ...
            /// </summary>
            public List<WorkgroupTypes.VpcEndpoint> VpcEndpoints { get; set; }
            /// <summary>
            /// Port
        ...
        public class NetworkInterface : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// PrivateIpAddress
        ...
        public class VpcEndpoint : Humidifier.Base.BaseSubResource, IHaveVpcId
        {
            /// <summary>
            /// VpcId
            ...
            /// </summary>
            public List<WorkgroupTypes.NetworkInterface> NetworkInterfaces { get; set; }
            /// <summary>
            /// VpcEndpointId
        ...
        public class Workgroup : Humidifier.Base.BaseSubResource, IHaveSubnetIds
        {
            ...
            /// Type: Endpoint
            /// </summary>
            public WorkgroupTypes.Endpoint Endpoint { get; set; }
            /// <summary>
            /// ConfigParameters
