namespace Humidifier.CodeCommit
{
    ...
    public class Repository : Humidifier.Base.BaseResource, IHaveImpliedResourceName, IHaveTags, IHaveKmsKeyId, IHaveDescription
    {
        ...
        /// </summary>
        public List<RepositoryTypes.RepositoryTrigger> Triggers { get; set; }
        /// <summary>
        /// Code
        ...
        /// Type: Code
        /// </summary>
        public RepositoryTypes.Code Code { get; set; }
        /// <summary>
    ...
    namespace RepositoryTypes
    {
        public class Code : Humidifier.Base.BaseSubResource
        {
            ...
            /// Type: S3
            /// </summary>
            public RepositoryTypes.S3 S3 { get; set; }
            /// <summary>
            /// BranchName
        ...
        public class RepositoryTrigger : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// Events
