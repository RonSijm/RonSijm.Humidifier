namespace Humidifier.FSx
{
    ...
    public class DataRepositoryAssociation : Humidifier.Base.BaseResource, IHaveTags
    {
    ...
    {
        public class AutoExportPolicy : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// Events
        ...
        public class AutoImportPolicy : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// Events
        ...
        public class S3 : Humidifier.Base.BaseSubResource
        {
            ...
            /// </summary>
            public DataRepositoryAssociationTypes.AutoImportPolicy AutoImportPolicy { get; set; }
            /// <summary>
            /// AutoExportPolicy
            ...
            /// </summary>
            public DataRepositoryAssociationTypes.AutoExportPolicy AutoExportPolicy { get; set; }
        }
    }
}