namespace Humidifier.FSx
{
    ...
    public class Volume : Humidifier.Base.BaseResource, IHaveImpliedResourceName, IHaveTags
    {
        ...
        /// </summary>
        public VolumeTypes.OpenZFSConfiguration OpenZFSConfiguration { get; set; }
        /// <summary>
        /// VolumeType
        ...
        /// </summary>
        public VolumeTypes.OntapConfiguration OntapConfiguration { get; set; }
        /// <summary>
        /// Tags
    ...
    namespace VolumeTypes
    {
        ...
        public class AutocommitPeriod : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// Type
        ...
        public class NfsExports : Humidifier.Base.BaseSubResource
        {
            ...
            /// </summary>
            public List<VolumeTypes.ClientConfigurations> ClientConfigurations { get; set; }
        }
        ...
        public class OntapConfiguration : Humidifier.Base.BaseSubResource
        {
            ...
            /// Type: TieringPolicy
            /// </summary>
            public VolumeTypes.TieringPolicy TieringPolicy { get; set; }
            /// <summary>
            /// SizeInMegabytes
            ...
            /// </summary>
            public VolumeTypes.SnaplockConfiguration SnaplockConfiguration { get; set; }
            /// <summary>
            ...
            /// </summary>
            public VolumeTypes.AggregateConfiguration AggregateConfiguration { get; set; }
            /// <summary>
            /// SnapshotPolicy
        ...
        public class OpenZFSConfiguration : Humidifier.Base.BaseSubResource
        {
            ...
            /// ItemType: NfsExports
            /// </summary>
            public List<VolumeTypes.NfsExports> NfsExports { get; set; }
            /// <summary>
            ...
            /// Type: OriginSnapshot
            /// </summary>
            public VolumeTypes.OriginSnapshot OriginSnapshot { get; set; }
            /// <summary>
            /// UserAndGroupQuotas
            ...
            /// </summary>
            public List<VolumeTypes.UserAndGroupQuotas> UserAndGroupQuotas { get; set; }
        }
        ...
        public class SnaplockConfiguration : Humidifier.Base.BaseSubResource
        {
            ...
            /// </summary>
            public VolumeTypes.AutocommitPeriod AutocommitPeriod { get; set; }
            /// <summary>
            /// RetentionPeriod
            ...
            /// </summary>
            public VolumeTypes.SnaplockRetentionPeriod RetentionPeriod { get; set; }
            /// <summary>
            /// PrivilegedDelete
        ...
        public class SnaplockRetentionPeriod : Humidifier.Base.BaseSubResource
        {
            ...
            /// </summary>
            public VolumeTypes.RetentionPeriod DefaultRetention { get; set; }
            /// <summary>
            /// MaximumRetention
            ...
            /// Type: RetentionPeriod
            /// </summary>
            public VolumeTypes.RetentionPeriod MaximumRetention { get; set; }
            /// <summary>
            /// MinimumRetention
            ...
            /// Type: RetentionPeriod
            /// </summary>
            public VolumeTypes.RetentionPeriod MinimumRetention { get; set; }
        }

        public class TieringPolicy : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// CoolingPeriod
