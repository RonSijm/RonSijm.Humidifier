namespace Humidifier.FSx
{
    ...
    public class StorageVirtualMachine : Humidifier.Base.BaseResource, IHaveImpliedResourceName, IHaveTags
    {
        ...
        /// </summary>
        public StorageVirtualMachineTypes.ActiveDirectoryConfiguration ActiveDirectoryConfiguration { get; set; }
        /// <summary>
    ...
    namespace StorageVirtualMachineTypes
    {
        public class ActiveDirectoryConfiguration : Humidifier.Base.BaseSubResource
        {
            ...
            /// </summary>
            public StorageVirtualMachineTypes.SelfManagedActiveDirectoryConfiguration SelfManagedActiveDirectoryConfiguration { get; set; }
            /// <summary>
            /// NetBiosName
