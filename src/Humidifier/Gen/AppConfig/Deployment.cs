namespace Humidifier.AppConfig
{
    ...
    public class Deployment : Humidifier.Base.BaseResource, IHaveDescription
    {
        ...
        /// </summary>
        public List<DeploymentTypes.DynamicExtensionParameters> DynamicExtensionParameters { get; set; }
        /// <summary>
        /// Tags
    ...
    {
        public class DynamicExtensionParameters : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// ParameterValue
