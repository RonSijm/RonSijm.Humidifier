namespace Humidifier.AppConfig
{
    ...
    public class ConfigurationProfile : Humidifier.Base.BaseResource, IHaveImpliedResourceName, IHaveDescription
    {
        ...
        /// ItemType: Validators
        /// </summary>
        public List<ConfigurationProfileTypes.Validators> Validators { get; set; }
        /// <summary>
        /// RetrievalRoleArn
        ...
        /// ItemType: Tags
        /// </summary>
        public List<ConfigurationProfileTypes.Tags> Tags { get; set; }
    ...
    namespace ConfigurationProfileTypes
    {
        ...
        public class Validators : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// Type
