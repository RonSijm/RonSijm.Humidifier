namespace Humidifier.Synthetics
{
    ...
    public class Canary : Humidifier.Base.BaseResource, IHaveImpliedResourceName, IHaveTags
    {
        ...
        /// </summary>
        public CanaryTypes.VisualReference VisualReference { get; set; }
        /// <summary>
        /// ArtifactConfig
        ...
        /// Type: ArtifactConfig
        /// </summary>
        public CanaryTypes.ArtifactConfig ArtifactConfig { get; set; }
        /// <summary>
        ...
        /// Type: VPCConfig
        /// </summary>
        public CanaryTypes.VPCConfig VPCConfig { get; set; }
        /// <summary>
        /// RunConfig
        ...
        /// Type: RunConfig
        /// </summary>
        public CanaryTypes.RunConfig RunConfig { get; set; }
        /// <summary>
    ...
    namespace CanaryTypes
    {
        public class ArtifactConfig : Humidifier.Base.BaseSubResource
        {
            ...
            /// Type: S3Encryption
            /// </summary>
            public CanaryTypes.S3Encryption S3Encryption { get; set; }
        }
        ...
        public class RunConfig : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// TimeoutInSeconds
        ...
        public class S3Encryption : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// KmsKeyArn
        ...
        public class VisualReference : Humidifier.Base.BaseSubResource
        {
            ...
            /// </summary>
            public List<CanaryTypes.BaseScreenshot> BaseScreenshots { get; set; }
            /// <summary>
            /// BaseCanaryRunId
