namespace Humidifier.AccessAnalyzer
{
    ...
    public class Analyzer : Humidifier.Base.BaseResource, IHaveImpliedResourceName, IHaveTags
    {
        ...
        /// </summary>
        public List<AnalyzerTypes.ArchiveRule> ArchiveRules { get; set; }
        ...
        /// </summary>
        public AnalyzerTypes.AnalyzerConfiguration AnalyzerConfiguration { get; set; }
    }
    ...
    namespace AnalyzerTypes
    {
        public class AnalyzerConfiguration : Humidifier.Base.BaseSubResource
        {
            ...
            /// </summary>
            public AnalyzerTypes.UnusedAccessConfiguration UnusedAccessConfiguration { get; set; }
        }
        ...
        public class ArchiveRule : Humidifier.Base.BaseSubResource
        {
            ...
            /// ItemType: Filter
            /// </summary>
            public List<AnalyzerTypes.Filter> Filter { get; set; }
            /// <summary>
            /// RuleName
