namespace Humidifier.MediaStore
{
    ...
    public class Container : Humidifier.Base.BaseResource, IHaveImpliedResourceName, IHaveTags
    {
        ...
        /// Type: MetricPolicy
        /// </summary>
        public ContainerTypes.MetricPolicy MetricPolicy { get; set; }
        ...
        /// ItemType: CorsRule
        /// </summary>
        public List<ContainerTypes.CorsRule> CorsPolicy { get; set; }
        /// <summary>
        /// LifecyclePolicy
    ...
    namespace ContainerTypes
    {
        ...
        public class MetricPolicy : Humidifier.Base.BaseSubResource
        {
            ...
            /// </summary>
            public List<ContainerTypes.MetricPolicyRule> MetricPolicyRules { get; set; }
        }
