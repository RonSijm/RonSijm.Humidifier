namespace Humidifier.MWAA
{
    ...
    public class Environment : Humidifier.Base.BaseResource, IHaveImpliedResourceName
    {
        ...
        /// </summary>
        public EnvironmentTypes.LoggingConfiguration LoggingConfiguration { get; set; }
        /// <summary>
        /// WebserverAccessMode
        ...
        /// </summary>
        public EnvironmentTypes.NetworkConfiguration NetworkConfiguration { get; set; }
        /// <summary>
        /// KmsKey
    ...
    namespace EnvironmentTypes
    {
        public class LoggingConfiguration : Humidifier.Base.BaseSubResource
        {
            ...
            /// </summary>
            public EnvironmentTypes.ModuleLoggingConfiguration SchedulerLogs { get; set; }
            /// <summary>
            /// TaskLogs
            ...
            /// Type: ModuleLoggingConfiguration
            /// </summary>
            public EnvironmentTypes.ModuleLoggingConfiguration TaskLogs { get; set; }
            /// <summary>
            /// DagProcessingLogs
            ...
            /// Type: ModuleLoggingConfiguration
            /// </summary>
            public EnvironmentTypes.ModuleLoggingConfiguration DagProcessingLogs { get; set; }
            /// <summary>
            /// WebserverLogs
            ...
            /// Type: ModuleLoggingConfiguration
            /// </summary>
            public EnvironmentTypes.ModuleLoggingConfiguration WebserverLogs { get; set; }
            /// <summary>
            /// WorkerLogs
            ...
            /// Type: ModuleLoggingConfiguration
            /// </summary>
            public EnvironmentTypes.ModuleLoggingConfiguration WorkerLogs { get; set; }
        }

        public class ModuleLoggingConfiguration : Humidifier.Base.BaseSubResource
        {
            /// <summary>
