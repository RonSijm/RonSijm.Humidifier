namespace Humidifier.Grafana
{
    ...
    public class Workspace : Humidifier.Base.BaseResource, IHaveDescription, IHaveImpliedResourceName
    {
        ...
        /// </summary>
        public WorkspaceTypes.SamlConfiguration SamlConfiguration { get; set; }
        /// <summary>
        /// OrganizationalUnits
        ...
        /// </summary>
        public WorkspaceTypes.VpcConfiguration VpcConfiguration { get; set; }
        /// <summary>
        ...
        /// </summary>
        public WorkspaceTypes.NetworkAccessControl NetworkAccessControl { get; set; }
        /// <summary>
        /// ClientToken
    ...
    {
        public class AssertionAttributes : Humidifier.Base.BaseSubResource, IHaveRole
        {
            /// <summary>
            /// Role
        ...
        public class IdpMetadata : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// Xml
        ...
        public class SamlConfiguration : Humidifier.Base.BaseSubResource
        {
            ...
            /// Type: RoleValues
            /// </summary>
            public WorkspaceTypes.RoleValues RoleValues { get; set; }
            /// <summary>
            /// IdpMetadata
            ...
            /// Type: IdpMetadata
            /// </summary>
            public WorkspaceTypes.IdpMetadata IdpMetadata { get; set; }
            /// <summary>
            /// AssertionAttributes
            ...
            /// </summary>
            public WorkspaceTypes.AssertionAttributes AssertionAttributes { get; set; }
            /// <summary>
