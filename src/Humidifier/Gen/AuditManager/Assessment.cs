namespace Humidifier.AuditManager
{
    ...
    public class Assessment : Humidifier.Base.BaseResource, IHaveTags, IHaveDescription, IHaveImpliedResourceName
    {
        ...
        /// </summary>
        public AssessmentTypes.AssessmentReportsDestination AssessmentReportsDestination { get; set; }
        /// <summary>
        /// Delegations
        ...
        /// ItemType: Delegation
        /// </summary>
        public List<AssessmentTypes.Delegation> Delegations { get; set; }
        /// <summary>
        /// Description
        ...
        /// Type: Scope
        /// </summary>
        public AssessmentTypes.Scope Scope { get; set; }
        /// <summary>
        /// AwsAccount
        ...
        /// Type: AWSAccount
        /// </summary>
        public AssessmentTypes.AWSAccount AwsAccount { get; set; }
        /// <summary>
        /// Roles
        ...
        /// ItemType: Role
        /// </summary>
        public List<AssessmentTypes.Role> Roles { get; set; }
        /// <summary>
        /// FrameworkId
    ...
    {
        public class AWSAccount : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// Id
        ...
        public class AWSService : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// ServiceName
        ...
        public class AssessmentReportsDestination : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// Destination
        ...
        public class Delegation : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// Status
        ...
        public class Role : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// RoleType
        ...
        public class Scope : Humidifier.Base.BaseSubResource
        {
            ...
            /// ItemType: AWSAccount
            /// </summary>
            public List<AssessmentTypes.AWSAccount> AwsAccounts { get; set; }
            /// <summary>
            /// AwsServices
            ...
            /// ItemType: AWSService
            /// </summary>
            public List<AssessmentTypes.AWSService> AwsServices { get; set; }
        }
    }
}