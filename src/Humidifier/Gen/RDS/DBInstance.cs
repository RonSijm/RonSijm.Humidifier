namespace Humidifier.RDS
{
    ...
    public class DBInstance : Humidifier.Base.BaseResource, IHaveTags, IHaveKmsKeyId
    {
        ...
        /// </summary>
        public DBInstanceTypes.CertificateDetails CertificateDetails { get; set; }
        /// <summary>
        /// Port
        ...
        /// Type: Endpoint
        /// </summary>
        public DBInstanceTypes.Endpoint Endpoint { get; set; }
        /// <summary>
        ...
        /// </summary>
        public DBInstanceTypes.MasterUserSecret MasterUserSecret { get; set; }
        /// <summary>
        ...
        /// </summary>
        public List<DBInstanceTypes.DBInstanceRole> AssociatedRoles { get; set; }
        /// <summary>
        /// DomainOu
        ...
        /// </summary>
        public List<DBInstanceTypes.ProcessorFeature> ProcessorFeatures { get; set; }
        /// <summary>
    ...
    namespace DBInstanceTypes
    {
        ...
        public class DBInstanceRole : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// RoleArn
        ...
        public class ProcessorFeature : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// Value
