namespace Humidifier.RDS
{
    ...
    public class DBCluster : Humidifier.Base.BaseResource, IHaveTags
    {
        ...
        /// </summary>
        public DBClusterTypes.ServerlessV2ScalingConfiguration ServerlessV2ScalingConfiguration { get; set; }
        /// <summary>
        ...
        /// </summary>
        public DBClusterTypes.MasterUserSecret MasterUserSecret { get; set; }
        /// <summary>
        ...
        /// </summary>
        public DBClusterTypes.ScalingConfiguration ScalingConfiguration { get; set; }
        /// <summary>
        ...
        /// </summary>
        public List<DBClusterTypes.DBClusterRole> AssociatedRoles { get; set; }
        /// <summary>
        /// EnableHttpEndpoint
    ...
    {
        public class DBClusterRole : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// RoleArn
        ...
        public class ReadEndpoint : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// Address
        ...
        public class ServerlessV2ScalingConfiguration : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// MinCapacity
