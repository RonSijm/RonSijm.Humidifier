namespace Humidifier.RDS
{
    ...
    public class DBProxy : Humidifier.Base.BaseResource, IHaveImpliedResourceName
    {
        ...
        /// ItemType: TagFormat
        /// </summary>
        public List<DBProxyTypes.TagFormat> Tags { get; set; }
    }

    namespace DBProxyTypes
    {
        public class AuthFormat : Humidifier.Base.BaseSubResource, IHaveDescription
        {
            /// <summary>
            /// SecretArn
        ...
        public class TagFormat : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// Value
