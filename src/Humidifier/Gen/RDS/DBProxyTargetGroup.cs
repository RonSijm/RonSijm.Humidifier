namespace Humidifier.RDS
{
    ...
    public class DBProxyTargetGroup : Humidifier.Base.BaseResource
    {
        ...
        /// </summary>
        public DBProxyTargetGroupTypes.ConnectionPoolConfigurationInfoFormat ConnectionPoolConfigurationInfo { get; set; }
        /// <summary>
