namespace Humidifier.ResourceExplorer2
{
    ...
    public class View : Humidifier.Base.BaseResource, IHaveImpliedResourceName
    {
        ...
        /// Type: SearchFilter
        /// </summary>
        public ViewTypes.SearchFilter Filters { get; set; }
        /// <summary>
        /// Scope
        ...
        /// </summary>
        public List<ViewTypes.IncludedProperty> IncludedProperties { get; set; }
        /// <summary>
        /// Tags
    ...
    namespace ViewTypes
    {
        public class IncludedProperty : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// Name
