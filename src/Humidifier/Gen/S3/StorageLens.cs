namespace Humidifier.S3
{
    ...
    namespace StorageLensTypes
    {
        public class AccountLevel : Humidifier.Base.BaseSubResource
        {
            ...
            /// </summary>
            public StorageLensTypes.AdvancedDataProtectionMetrics AdvancedDataProtectionMetrics { get; set; }
            /// <summary>
            ...
            /// </summary>
            public StorageLensTypes.StorageLensGroupLevel StorageLensGroupLevel { get; set; }
            /// <summary>
            /// ActivityMetrics
            ...
            /// </summary>
            public StorageLensTypes.ActivityMetrics ActivityMetrics { get; set; }
            /// <summary>
            /// BucketLevel
            ...
            /// Type: BucketLevel
            /// </summary>
            public StorageLensTypes.BucketLevel BucketLevel { get; set; }
            /// <summary>
            ...
            /// </summary>
            public StorageLensTypes.AdvancedCostOptimizationMetrics AdvancedCostOptimizationMetrics { get; set; }
            /// <summary>
            ...
            /// </summary>
            public StorageLensTypes.DetailedStatusCodesMetrics DetailedStatusCodesMetrics { get; set; }
        }

        public class ActivityMetrics : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// IsEnabled
        ...
        public class AdvancedCostOptimizationMetrics : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// IsEnabled
        ...
        public class AdvancedDataProtectionMetrics : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// IsEnabled
        ...
        public class AwsOrg : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// Arn
        ...
        public class BucketLevel : Humidifier.Base.BaseSubResource
        {
            ...
            /// Type: PrefixLevel
            /// </summary>
            public StorageLensTypes.PrefixLevel PrefixLevel { get; set; }
            /// <summary>
            /// ActivityMetrics
        ...
        public class BucketsAndRegions : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// Regions
        ...
        public class CloudWatchMetrics : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// IsEnabled
        ...
        public class DataExport : Humidifier.Base.BaseSubResource
        {
            ...
            /// </summary>
            public StorageLensTypes.S3BucketDestination S3BucketDestination { get; set; }
            /// <summary>
            /// CloudWatchMetrics
            ...
            /// </summary>
            public StorageLensTypes.CloudWatchMetrics CloudWatchMetrics { get; set; }
        }

        public class DetailedStatusCodesMetrics : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// IsEnabled
        ...
        public class Encryption : Humidifier.Base.BaseSubResource
        {
            ...
            /// Type: SSEKMS
            /// </summary>
            public StorageLensTypes.SSEKMS SSEKMS { get; set; }
            /// <summary>
            /// SSES3
        ...
        public class PrefixLevel : Humidifier.Base.BaseSubResource
        {
            ...
            /// </summary>
            public StorageLensTypes.PrefixLevelStorageMetrics StorageMetrics { get; set; }
        }

        public class PrefixLevelStorageMetrics : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// IsEnabled
            ...
            /// </summary>
            public StorageLensTypes.SelectionCriteria SelectionCriteria { get; set; }
        }

        public class S3BucketDestination : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// OutputSchemaVersion
            ...
            /// Type: Encryption
            /// </summary>
            public StorageLensTypes.Encryption Encryption { get; set; }
            /// <summary>
            /// Arn
        ...
        public class SSEKMS : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// KeyId
        ...
        public class SelectionCriteria : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// Delimiter
        ...
        public class StorageLensConfiguration : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// AccountLevel
            ...
            /// Type: AccountLevel
            /// </summary>
            public StorageLensTypes.AccountLevel AccountLevel { get; set; }
            /// <summary>
            /// Exclude
            ...
            /// </summary>
            public StorageLensTypes.BucketsAndRegions Exclude { get; set; }
            /// <summary>
            /// IsEnabled
            ...
            /// Type: BucketsAndRegions
            /// </summary>
            public StorageLensTypes.BucketsAndRegions Include { get; set; }
            /// <summary>
            /// AwsOrg
            ...
            /// Type: AwsOrg
            /// </summary>
            public StorageLensTypes.AwsOrg AwsOrg { get; set; }
            /// <summary>
            /// Id
            ...
            /// Type: DataExport
            /// </summary>
            public StorageLensTypes.DataExport DataExport { get; set; }
        }
        ...
        public class StorageLensGroupLevel : Humidifier.Base.BaseSubResource
        {
            ...
            /// </summary>
            public StorageLensTypes.StorageLensGroupSelectionCriteria StorageLensGroupSelectionCriteria { get; set; }
        }
