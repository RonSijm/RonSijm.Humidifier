namespace Humidifier.S3
{
    ...
    {
        public class And : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// MatchObjectAge
            ...
            /// Type: MatchObjectAge
            /// </summary>
            public StorageLensGroupTypes.MatchObjectAge MatchObjectAge { get; set; }
            /// <summary>
            /// MatchAnyPrefix
            ...
            /// </summary>
            public StorageLensGroupTypes.MatchObjectSize MatchObjectSize { get; set; }
        }
        ...
        public class Filter : Humidifier.Base.BaseSubResource
        {
            ...
            /// Type: Or
            /// </summary>
            public StorageLensGroupTypes.Or Or { get; set; }
            /// <summary>
            /// And
            ...
            /// Type: And
            /// </summary>
            public StorageLensGroupTypes.And And { get; set; }
            /// <summary>
            /// MatchAnyPrefix
        ...
        public class Or : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// MatchObjectAge
