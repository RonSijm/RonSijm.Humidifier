namespace Humidifier.S3
{
    ...
    public class AccessGrant : Humidifier.Base.BaseResource, IHaveTags
    {
        ...
        /// </summary>
        public AccessGrantTypes.AccessGrantsLocationConfiguration AccessGrantsLocationConfiguration { get; set; }
        /// <summary>
        /// ApplicationArn
