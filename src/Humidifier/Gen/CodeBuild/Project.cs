namespace Humidifier.CodeBuild
{
    ...
    public class Project : Humidifier.Base.BaseResource, IHaveImpliedResourceName, IHaveTags, IHaveDescription
    {
        ...
        /// Type: VpcConfig
        /// </summary>
        public ProjectTypes.VpcConfig VpcConfig { get; set; }
        /// <summary>
        /// SecondarySources
        ...
        /// ItemType: Source
        /// </summary>
        public List<ProjectTypes.Source> SecondarySources { get; set; }
        /// <summary>
        /// EncryptionKey
        ...
        /// </summary>
        public ProjectTypes.ProjectTriggers Triggers { get; set; }
        /// <summary>
        /// SecondaryArtifacts
        ...
        /// </summary>
        public List<ProjectTypes.ProjectSourceVersion> SecondarySourceVersions { get; set; }
        /// <summary>
        ...
        /// </summary>
        public ProjectTypes.ProjectBuildBatchConfig BuildBatchConfig { get; set; }
        /// <summary>
        /// Tags
        ...
        /// Type: ProjectCache
        /// </summary>
        public ProjectTypes.ProjectCache Cache { get; set; }
    }

    namespace ProjectTypes
    {
        public class Artifacts : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// Path
        ...
        public class BuildStatusConfig : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// Context
        ...
        public class CloudWatchLogsConfig : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// Status
        ...
        public class Environment : Humidifier.Base.BaseSubResource
        {
            ...
            /// </summary>
            public List<ProjectTypes.EnvironmentVariable> EnvironmentVariables { get; set; }
            /// <summary>
            /// Fleet
            ...
            /// Type: ProjectFleet
            /// </summary>
            public ProjectTypes.ProjectFleet Fleet { get; set; }
            /// <summary>
            /// PrivilegedMode
            ...
            /// </summary>
            public ProjectTypes.RegistryCredential RegistryCredential { get; set; }
            /// <summary>
            /// ComputeType
        ...
        public class EnvironmentVariable : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// Type
        ...
        public class LogsConfig : Humidifier.Base.BaseSubResource
        {
            ...
            /// </summary>
            public ProjectTypes.CloudWatchLogsConfig CloudWatchLogs { get; set; }
            /// <summary>
            /// S3Logs
            ...
            /// Type: S3LogsConfig
            /// </summary>
            public ProjectTypes.S3LogsConfig S3Logs { get; set; }
        }

        public class ProjectBuildBatchConfig : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// CombineArtifacts
            ...
            /// </summary>
            public ProjectTypes.BatchRestrictions Restrictions { get; set; }
        }

        public class ProjectCache : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// Modes
        ...
        public class ProjectFileSystemLocation : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// MountPoint
        ...
        public class ProjectSourceVersion : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// SourceIdentifier
        ...
        public class ProjectTriggers : Humidifier.Base.BaseSubResource
        {
            ...
            /// </summary>
            public List<ProjectTypes.FilterGroup> FilterGroups { get; set; }
            /// <summary>
            /// BuildType
            ...
            /// </summary>
            public ProjectTypes.ScopeConfiguration ScopeConfiguration { get; set; }
        }
        ...
        public class S3LogsConfig : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// Status
        ...
        public class ScopeConfiguration : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// Name
        ...
        public class Source : Humidifier.Base.BaseSubResource
        {
            ...
            /// Type: SourceAuth
            /// </summary>
            public ProjectTypes.SourceAuth Auth { get; set; }
            /// <summary>
            /// SourceIdentifier
            ...
            /// </summary>
            public ProjectTypes.BuildStatusConfig BuildStatusConfig { get; set; }
            /// <summary>
            /// GitSubmodulesConfig
            ...
            /// </summary>
            public ProjectTypes.GitSubmodulesConfig GitSubmodulesConfig { get; set; }
            /// <summary>
            /// InsecureSsl
        ...
        public class SourceAuth : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// Type
        ...
        public class VpcConfig : Humidifier.Base.BaseSubResource, IHaveSubnets, IHaveVpcId
        {
            /// <summary>
            /// Subnets
        ...
        public class WebhookFilter : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// Pattern
