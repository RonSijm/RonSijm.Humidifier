namespace Humidifier.KendraRanking
{
    ...
    public class ExecutionPlan : Humidifier.Base.BaseResource, IHaveTags, IHaveDescription, IHaveImpliedResourceName
    {
        ...
        /// </summary>
        public ExecutionPlanTypes.CapacityUnitsConfiguration CapacityUnits { get; set; }
        /// <summary>
        /// Tags
