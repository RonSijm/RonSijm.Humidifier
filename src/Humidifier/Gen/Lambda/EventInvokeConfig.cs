namespace Humidifier.Lambda
{
    ...
    namespace EventInvokeConfigTypes
    {
        public class DestinationConfig : Humidifier.Base.BaseSubResource
        {
            ...
            /// Type: OnSuccess
            /// </summary>
            public EventInvokeConfigTypes.OnSuccess OnSuccess { get; set; }
            /// <summary>
            /// OnFailure
            ...
            /// Type: OnFailure
            /// </summary>
            public EventInvokeConfigTypes.OnFailure OnFailure { get; set; }
        }
        ...
        public class OnSuccess : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// Destination
