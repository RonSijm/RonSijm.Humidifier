namespace Humidifier.Lambda
{
    ...
    public class Version : Humidifier.Base.BaseResource, IHaveDescription
    {
        ...
        /// </summary>
        public VersionTypes.ProvisionedConcurrencyConfiguration ProvisionedConcurrencyConfig { get; set; }
        /// <summary>
        /// Description
        ...
        /// Type: RuntimePolicy
        /// </summary>
        public VersionTypes.RuntimePolicy RuntimePolicy { get; set; }
        /// <summary>
        /// CodeSha256
