namespace Humidifier.Lambda
{
    ...
    public class Alias : Humidifier.Base.BaseResource, IHaveImpliedResourceName, IHaveDescription
    {
        ...
        /// </summary>
        public AliasTypes.ProvisionedConcurrencyConfiguration ProvisionedConcurrencyConfig { get; set; }
        /// <summary>
        /// Description
        ...
        /// </summary>
        public AliasTypes.AliasRoutingConfiguration RoutingConfig { get; set; }
    ...
    namespace AliasTypes
    {
        public class AliasRoutingConfiguration : Humidifier.Base.BaseSubResource
        {
            ...
            /// </summary>
            public List<AliasTypes.VersionWeight> AdditionalVersionWeights { get; set; }
        }
        ...
        public class VersionWeight : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// FunctionVersion
