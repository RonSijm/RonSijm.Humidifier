namespace Humidifier.SSM
{
    ...
    public class Association : Humidifier.Base.BaseResource, IHaveImpliedResourceName
    {
        ...
        /// ItemType: Target
        /// </summary>
        public List<AssociationTypes.Target> Targets { get; set; }
        /// <summary>
        /// SyncCompliance
        ...
        /// </summary>
        public AssociationTypes.InstanceAssociationOutputLocation OutputLocation { get; set; }
        /// <summary>
        /// ScheduleOffset
    ...
    namespace AssociationTypes
    {
        public class InstanceAssociationOutputLocation : Humidifier.Base.BaseSubResource
        {
            ...
            /// </summary>
            public AssociationTypes.S3OutputLocation S3Location { get; set; }
        }
