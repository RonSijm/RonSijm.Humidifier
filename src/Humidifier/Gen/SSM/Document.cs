namespace Humidifier.SSM
{
    ...
    public class Document : Humidifier.Base.BaseResource, IHaveImpliedResourceName, IHaveTags
    {
        ...
        /// </summary>
        public List<DocumentTypes.AttachmentsSource> Attachments { get; set; }
        /// <summary>
        /// Tags
    ...
    {
        public class AttachmentsSource : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// Values
        ...
        public class DocumentRequires : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// Version
