namespace Humidifier.SSM
{
    ...
    public class ResourceDataSync : Humidifier.Base.BaseResource, IHaveBucketName, IHaveBucketPrefix, IHaveSyncType, IHaveKMSKeyArn, IHaveBucketRegion, IHaveSyncFormat
    {
        ...
        /// Type: S3Destination
        /// </summary>
        public Humidifier.SSM.ResourceDataSyncTypes.S3Destination S3Destination { get; set; }
        /// <summary>
        /// KMSKeyArn
        ...
        /// Type: SyncSource
        /// </summary>
        public Humidifier.SSM.ResourceDataSyncTypes.SyncSource SyncSource { get; set; }
        /// <summary>
        /// BucketName
    ...
    namespace ResourceDataSyncTypes
    {
        ...
        public class SyncSource : Humidifier.Base.BaseSubResource, IHaveSourceType
        {
            /// <summary>
            /// SourceType
            ...
            /// </summary>
            public Humidifier.SSM.ResourceDataSyncTypes.AwsOrganizationsSource AwsOrganizationsSource { get; set; }
            /// <summary>
