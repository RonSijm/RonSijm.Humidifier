namespace Humidifier.SSM
{
    ...
    public class ResourceDataSync : Humidifier.Base.BaseResource
    {
        ...
        /// Type: S3Destination
        /// </summary>
        public ResourceDataSyncTypes.S3Destination S3Destination { get; set; }
        /// <summary>
        /// KMSKeyArn
        ...
        /// Type: SyncSource
        /// </summary>
        public ResourceDataSyncTypes.SyncSource SyncSource { get; set; }
        /// <summary>
        /// BucketName
        ...
        /// PrimitiveType: String
        /// </summary>
        public dynamic BucketRegion { get; set; }
        /// <summary>
        /// SyncFormat
    ...
    namespace ResourceDataSyncTypes
    {
        public class AwsOrganizationsSource : Humidifier.Base.BaseSubResource
        {
            ...
            /// PrimitiveType: String
            /// </summary>
            public dynamic OrganizationSourceType { get; set; }
            /// <summary>
            /// OrganizationalUnits
        ...
        public class SyncSource : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// SourceType
            ...
            /// </summary>
            public ResourceDataSyncTypes.AwsOrganizationsSource AwsOrganizationsSource { get; set; }
            /// <summary>
            ...
            /// </summary>
            public dynamic IncludeFutureRegions { get; set; }
            /// <summary>
            /// SourceRegions
            ...
            /// PrimitiveItemType: String
            /// </summary>
            public dynamic SourceRegions { get; set; }
        }
    }
}