namespace Humidifier.SSM
{
    ...
    public class PatchBaseline : Humidifier.Base.BaseResource, IHaveTags, IHaveDescription, IHaveImpliedResourceName
    {
        ...
        /// Type: RuleGroup
        /// </summary>
        public PatchBaselineTypes.RuleGroup ApprovalRules { get; set; }
        /// <summary>
        /// Sources
        ...
        /// </summary>
        public List<PatchBaselineTypes.PatchSource> Sources { get; set; }
        ...
        /// </summary>
        public PatchBaselineTypes.PatchFilterGroup GlobalFilters { get; set; }
        /// <summary>
        /// Tags
    ...
    {
        public class PatchFilter : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// Values
        ...
        public class PatchFilterGroup : Humidifier.Base.BaseSubResource
        {
            ...
            /// </summary>
            public List<PatchBaselineTypes.PatchFilter> PatchFilters { get; set; }
        }

        public class PatchSource : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// Products
        ...
        public class Rule : Humidifier.Base.BaseSubResource
        {
            ...
            /// Type: PatchFilterGroup
            /// </summary>
            public PatchBaselineTypes.PatchFilterGroup PatchFilterGroup { get; set; }
            /// <summary>
            /// ApproveAfterDays
        ...
        public class RuleGroup : Humidifier.Base.BaseSubResource
        {
            ...
            /// ItemType: Rule
            /// </summary>
            public List<PatchBaselineTypes.Rule> PatchRules { get; set; }
        }
    }
}