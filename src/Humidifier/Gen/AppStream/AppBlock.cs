namespace Humidifier.AppStream
{
    ...
    public class AppBlock : Humidifier.Base.BaseResource, IHaveTags, IHaveDescription, IHaveImpliedResourceName
    {
        ...
        /// Type: ScriptDetails
        /// </summary>
        public AppBlockTypes.ScriptDetails SetupScriptDetails { get; set; }
        /// <summary>
        /// Description
        ...
        /// Type: ScriptDetails
        /// </summary>
        public AppBlockTypes.ScriptDetails PostSetupScriptDetails { get; set; }
        /// <summary>
        /// DisplayName
    ...
    namespace AppBlockTypes
    {
        ...
        public class ScriptDetails : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// TimeoutInSeconds
            ...
            /// Type: S3Location
            /// </summary>
            public AppBlockTypes.S3Location ScriptS3Location { get; set; }
            /// <summary>
            /// ExecutablePath
