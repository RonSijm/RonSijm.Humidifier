namespace Humidifier.AppStream
{
    ...
    public class ImageBuilder : Humidifier.Base.BaseResource, IHaveImpliedResourceName, IHaveTags, IHaveDescription
    {
        ...
        /// Type: VpcConfig
        /// </summary>
        public ImageBuilderTypes.VpcConfig VpcConfig { get; set; }
        /// <summary>
        ...
        /// Type: DomainJoinInfo
        /// </summary>
        public ImageBuilderTypes.DomainJoinInfo DomainJoinInfo { get; set; }
        /// <summary>
        ...
        /// </summary>
        public List<ImageBuilderTypes.AccessEndpoint> AccessEndpoints { get; set; }
    }
    ...
    namespace ImageBuilderTypes
    {
        ...
        public class DomainJoinInfo : Humidifier.Base.BaseSubResource
        {
            /// <summary>
