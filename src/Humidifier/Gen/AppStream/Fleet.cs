namespace Humidifier.AppStream
{
    ...
    public class Fleet : Humidifier.Base.BaseResource, IHaveTags, IHaveDescription, IHaveImpliedResourceName
    {
        ...
        /// </summary>
        public FleetTypes.ComputeCapacity ComputeCapacity { get; set; }
        /// <summary>
        /// Platform
        ...
        /// Type: VpcConfig
        /// </summary>
        public FleetTypes.VpcConfig VpcConfig { get; set; }
        /// <summary>
        /// FleetType
        ...
        /// Type: DomainJoinInfo
        /// </summary>
        public FleetTypes.DomainJoinInfo DomainJoinInfo { get; set; }
        /// <summary>
        ...
        /// Type: S3Location
        /// </summary>
        public FleetTypes.S3Location SessionScriptS3Location { get; set; }
