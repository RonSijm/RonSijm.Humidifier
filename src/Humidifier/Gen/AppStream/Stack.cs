namespace Humidifier.AppStream
{
    ...
    public class Stack : Humidifier.Base.BaseResource, IHaveTags, IHaveDescription, IHaveImpliedResourceName
    {
        ...
        /// </summary>
        public List<StackTypes.StorageConnector> StorageConnectors { get; set; }
        /// <summary>
        ...
        /// </summary>
        public List<StackTypes.UserSetting> UserSettings { get; set; }
        /// <summary>
        /// AttributesToDelete
        ...
        /// </summary>
        public StackTypes.StreamingExperienceSettings StreamingExperienceSettings { get; set; }
        ...
        /// </summary>
        public StackTypes.ApplicationSettings ApplicationSettings { get; set; }
        /// <summary>
        /// DisplayName
        ...
        /// </summary>
        public List<StackTypes.AccessEndpoint> AccessEndpoints { get; set; }
    }

    namespace StackTypes
    {
        public class AccessEndpoint : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// EndpointType
        ...
        public class ApplicationSettings : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// SettingsGroup
        ...
        public class StorageConnector : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// Domains
        ...
        public class UserSetting : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// Action
