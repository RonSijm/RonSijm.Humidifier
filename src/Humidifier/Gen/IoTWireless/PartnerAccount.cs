namespace Humidifier.IoTWireless
{
    ...
    public class PartnerAccount : Humidifier.Base.BaseResource, IHaveTags
    {
        ...
        /// </summary>
        public PartnerAccountTypes.SidewalkAccountInfoWithFingerprint SidewalkResponse { get; set; }
        /// <summary>
        /// AccountLinked
        ...
        /// </summary>
        public PartnerAccountTypes.SidewalkAccountInfo Sidewalk { get; set; }
        /// <summary>
        /// PartnerAccountId
        ...
        /// </summary>
        public PartnerAccountTypes.SidewalkUpdateAccount SidewalkUpdate { get; set; }
        /// <summary>
        /// Tags
    ...
    namespace PartnerAccountTypes
    {
        ...
        public class SidewalkAccountInfoWithFingerprint : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// Fingerprint
