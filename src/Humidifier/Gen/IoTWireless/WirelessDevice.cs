namespace Humidifier.IoTWireless
{
    ...
    namespace WirelessDeviceTypes
    {
        public class AbpV10x : Humidifier.Base.BaseSubResource
        {
            ...
            /// </summary>
            public WirelessDeviceTypes.SessionKeysAbpV10x SessionKeys { get; set; }
            /// <summary>
            /// DevAddr
        ...
        public class AbpV11 : Humidifier.Base.BaseSubResource
        {
            ...
            /// </summary>
            public WirelessDeviceTypes.SessionKeysAbpV11 SessionKeys { get; set; }
            /// <summary>
            /// DevAddr
        ...
        public class FPorts : Humidifier.Base.BaseSubResource
        {
            ...
            /// </summary>
            public List<WirelessDeviceTypes.Application> Applications { get; set; }
        }
        ...
        public class LoRaWANDevice : Humidifier.Base.BaseSubResource
        {
            ...
            /// Type: AbpV10x
            /// </summary>
            public WirelessDeviceTypes.AbpV10x AbpV10x { get; set; }
            /// <summary>
            /// FPorts
            ...
            /// Type: FPorts
            /// </summary>
            public WirelessDeviceTypes.FPorts FPorts { get; set; }
            /// <summary>
            /// OtaaV11
            ...
            /// Type: OtaaV11
            /// </summary>
            public WirelessDeviceTypes.OtaaV11 OtaaV11 { get; set; }
            /// <summary>
            /// AbpV11
            ...
            /// Type: AbpV11
            /// </summary>
            public WirelessDeviceTypes.AbpV11 AbpV11 { get; set; }
            /// <summary>
            /// DeviceProfileId
            ...
            /// Type: OtaaV10x
            /// </summary>
            public WirelessDeviceTypes.OtaaV10x OtaaV10x { get; set; }
            /// <summary>
            /// ServiceProfileId
