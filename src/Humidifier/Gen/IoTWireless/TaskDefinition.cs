namespace Humidifier.IoTWireless
{
    ...
    public class TaskDefinition : Humidifier.Base.BaseResource, IHaveTags, IHaveImpliedResourceName
    {
        ...
        /// </summary>
        public TaskDefinitionTypes.LoRaWANUpdateGatewayTaskEntry LoRaWANUpdateGatewayTaskEntry { get; set; }
        /// <summary>
        /// Update
        ...
        /// </summary>
        public TaskDefinitionTypes.UpdateWirelessGatewayTaskCreate Update { get; set; }
        /// <summary>
        /// TaskDefinitionType
    ...
    {
        public class LoRaWANGatewayVersion : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// Station
        ...
        public class LoRaWANUpdateGatewayTaskCreate : Humidifier.Base.BaseSubResource
        {
            ...
            /// </summary>
            public TaskDefinitionTypes.LoRaWANGatewayVersion UpdateVersion { get; set; }
            /// <summary>
            /// CurrentVersion
            ...
            /// Type: LoRaWANGatewayVersion
            /// </summary>
            public TaskDefinitionTypes.LoRaWANGatewayVersion CurrentVersion { get; set; }
        }
        ...
        public class UpdateWirelessGatewayTaskCreate : Humidifier.Base.BaseSubResource
        {
            ...
            /// </summary>
            public TaskDefinitionTypes.LoRaWANUpdateGatewayTaskCreate LoRaWAN { get; set; }
            /// <summary>
            /// UpdateDataSource
