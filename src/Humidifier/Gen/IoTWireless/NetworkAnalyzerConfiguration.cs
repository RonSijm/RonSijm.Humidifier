namespace Humidifier.IoTWireless
{
    ...
    public class NetworkAnalyzerConfiguration : Humidifier.Base.BaseResource, IHaveImpliedResourceName, IHaveTags, IHaveDescription
    {
        ...
        /// Type: TraceContent
        /// </summary>
        public NetworkAnalyzerConfigurationTypes.TraceContent TraceContent { get; set; }
        /// <summary>
        /// WirelessGateways
    ...
    {
        public class TraceContent : Humidifier.Base.BaseSubResource
        {
            /// <summary>
