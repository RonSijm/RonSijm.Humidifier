namespace Humidifier.MediaPackageV2
{
    ...
    public class OriginEndpoint : Humidifier.Base.BaseResource, IHaveImpliedResourceName, IHaveTags, IHaveDescription
    {
        ...
        /// </summary>
        public List<OriginEndpointTypes.LowLatencyHlsManifestConfiguration> LowLatencyHlsManifests { get; set; }
        /// <summary>
        /// ContainerType
        ...
        /// </summary>
        public OriginEndpointTypes.ForceEndpointErrorConfiguration ForceEndpointErrorConfiguration { get; set; }
        ...
        /// </summary>
        public List<OriginEndpointTypes.DashManifestConfiguration> DashManifests { get; set; }
        /// <summary>
        /// Segment
        ...
        /// Type: Segment
        /// </summary>
        public OriginEndpointTypes.Segment Segment { get; set; }
        /// <summary>
        /// Tags
    ...
    namespace OriginEndpointTypes
    {
        public class DashManifestConfiguration : Humidifier.Base.BaseSubResource
        {
            ...
            /// Type: DashUtcTiming
            /// </summary>
            public OriginEndpointTypes.DashUtcTiming UtcTiming { get; set; }
            /// <summary>
            ...
            /// </summary>
            public OriginEndpointTypes.FilterConfiguration FilterConfiguration { get; set; }
            /// <summary>
            ...
            /// Type: ScteDash
            /// </summary>
            public OriginEndpointTypes.ScteDash ScteDash { get; set; }
        }
        ...
        public class Encryption : Humidifier.Base.BaseSubResource
        {
            ...
            /// </summary>
            public OriginEndpointTypes.EncryptionMethod EncryptionMethod { get; set; }
        }
        ...
        public class HlsManifestConfiguration : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// ManifestWindowSeconds
            ...
            /// Type: ScteHls
            /// </summary>
            public OriginEndpointTypes.ScteHls ScteHls { get; set; }
            /// <summary>
            /// FilterConfiguration
        ...
        public class Segment : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// SegmentName
            ...
            /// Type: Scte
            /// </summary>
            public OriginEndpointTypes.Scte Scte { get; set; }
            /// <summary>
            ...
            /// Type: Encryption
            /// </summary>
            public OriginEndpointTypes.Encryption Encryption { get; set; }
        }
