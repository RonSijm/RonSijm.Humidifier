namespace Humidifier.MediaConnect
{
    ...
    public class Bridge : Humidifier.Base.BaseResource, IHaveImpliedResourceName
    {
        ...
        /// Type: FailoverConfig
        /// </summary>
        public BridgeTypes.FailoverConfig SourceFailoverConfig { get; set; }
        /// <summary>
        ...
        /// </summary>
        public BridgeTypes.IngressGatewayBridge IngressGatewayBridge { get; set; }
        /// <summary>
        /// EgressGatewayBridge
        ...
        /// </summary>
        public BridgeTypes.EgressGatewayBridge EgressGatewayBridge { get; set; }
        /// <summary>
        /// Outputs
    ...
    {
        public class BridgeFlowSource : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            ...
            /// </summary>
            public BridgeTypes.VpcInterfaceAttachment FlowVpcInterfaceAttachment { get; set; }
            /// <summary>
            /// FlowArn
        ...
        public class BridgeNetworkOutput : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// NetworkName
        ...
        public class BridgeNetworkSource : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// NetworkName
        ...
        public class BridgeOutput : Humidifier.Base.BaseSubResource
        {
            ...
            /// </summary>
            public BridgeTypes.BridgeNetworkOutput NetworkOutput { get; set; }
        }
        ...
        public class BridgeSource : Humidifier.Base.BaseSubResource
        {
            ...
            /// </summary>
            public BridgeTypes.BridgeNetworkSource NetworkSource { get; set; }
            /// <summary>
            /// FlowSource
            ...
            /// </summary>
            public BridgeTypes.BridgeFlowSource FlowSource { get; set; }
        }

        public class EgressGatewayBridge : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// MaxBitrate
        ...
        public class FailoverConfig : Humidifier.Base.BaseSubResource
        {
            ...
            /// Type: SourcePriority
            /// </summary>
            public BridgeTypes.SourcePriority SourcePriority { get; set; }
            /// <summary>
            /// FailoverMode
        ...
        public class IngressGatewayBridge : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// MaxOutputs
