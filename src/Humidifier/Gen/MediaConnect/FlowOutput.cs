namespace Humidifier.MediaConnect
{
    ...
    public class FlowOutput : Humidifier.Base.BaseResource, IHaveImpliedResourceName, IHaveDescription
    {
        ...
        /// </summary>
        public List<FlowOutputTypes.MediaStreamOutputConfiguration> MediaStreamOutputConfigurations { get; set; }
        /// <summary>
        /// Encryption
        ...
        /// Type: Encryption
        /// </summary>
        public FlowOutputTypes.Encryption Encryption { get; set; }
        /// <summary>
        /// OutputStatus
        ...
        /// </summary>
        public FlowOutputTypes.VpcInterfaceAttachment VpcInterfaceAttachment { get; set; }
        /// <summary>
        /// MinLatency
    ...
    namespace FlowOutputTypes
    {
        public class DestinationConfiguration : Humidifier.Base.BaseSubResource
        {
            ...
            /// Type: Interface
            /// </summary>
            public FlowOutputTypes.Interface Interface { get; set; }
        }
        ...
        public class MediaStreamOutputConfiguration : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// EncodingParameters
            ...
            /// </summary>
            public FlowOutputTypes.EncodingParameters EncodingParameters { get; set; }
            /// <summary>
            /// MediaStreamName
            ...
            /// </summary>
            public List<FlowOutputTypes.DestinationConfiguration> DestinationConfigurations { get; set; }
        }
