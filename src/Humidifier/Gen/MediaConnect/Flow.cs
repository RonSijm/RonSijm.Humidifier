namespace Humidifier.MediaConnect
{
    ...
    public class Flow : Humidifier.Base.BaseResource, IHaveImpliedResourceName
    {
        ...
        /// Type: FailoverConfig
        /// </summary>
        public FlowTypes.FailoverConfig SourceFailoverConfig { get; set; }
        /// <summary>
        /// VpcInterfaces
        ...
        /// </summary>
        public List<FlowTypes.VpcInterface> VpcInterfaces { get; set; }
        /// <summary>
        /// MediaStreams
        ...
        /// </summary>
        public List<FlowTypes.MediaStream> MediaStreams { get; set; }
        /// <summary>
        /// AvailabilityZone
    ...
    namespace FlowTypes
    {
        ...
        public class FailoverConfig : Humidifier.Base.BaseSubResource
        {
            ...
            /// Type: SourcePriority
            /// </summary>
            public FlowTypes.SourcePriority SourcePriority { get; set; }
            /// <summary>
            /// FailoverMode
        ...
        public class GatewayBridgeSource : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// BridgeArn
            ...
            /// </summary>
            public FlowTypes.VpcInterfaceAttachment VpcInterfaceAttachment { get; set; }
        }
        ...
        public class InputConfiguration : Humidifier.Base.BaseSubResource
        {
            ...
            /// Type: Interface
            /// </summary>
            public FlowTypes.Interface Interface { get; set; }
        }

        public class Interface : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// Name
        ...
        public class Maintenance : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// MaintenanceDay
        ...
        public class MediaStream : Humidifier.Base.BaseSubResource, IHaveDescription
        {
            /// <summary>
            /// MediaStreamType
            ...
            /// </summary>
            public FlowTypes.MediaStreamAttributes Attributes_ { get; set; }
            /// <summary>
            /// ClockRate
        ...
        public class MediaStreamAttributes : Humidifier.Base.BaseSubResource
        {
            ...
            /// Type: Fmtp
            /// </summary>
            public FlowTypes.Fmtp Fmtp { get; set; }
            /// <summary>
            /// Lang
        ...
        public class MediaStreamSourceConfiguration : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// MediaStreamName
            ...
            /// </summary>
            public List<FlowTypes.InputConfiguration> InputConfigurations { get; set; }
            /// <summary>
            /// EncodingName
        ...
        public class Source : Humidifier.Base.BaseSubResource, IHaveDescription
        {
            /// <summary>
            /// IngestIp
            ...
            /// </summary>
            public List<FlowTypes.MediaStreamSourceConfiguration> MediaStreamSourceConfigurations { get; set; }
            /// <summary>
            /// IngestPort
            ...
            /// Type: Encryption
            /// </summary>
            public FlowTypes.Encryption Decryption { get; set; }
            /// <summary>
            /// GatewayBridgeSource
            ...
            /// </summary>
            public FlowTypes.GatewayBridgeSource GatewayBridgeSource { get; set; }
            /// <summary>
        ...
        public class VpcInterface : Humidifier.Base.BaseSubResource
        {
            /// <summary>
        ...
        public class VpcInterfaceAttachment : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// VpcInterfaceName
