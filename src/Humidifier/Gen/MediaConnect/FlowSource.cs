namespace Humidifier.MediaConnect
{
    ...
    public class FlowSource : Humidifier.Base.BaseResource, IHaveImpliedResourceName, IHaveDescription
    {
        ...
        /// Type: Encryption
        /// </summary>
        public FlowSourceTypes.Encryption Decryption { get; set; }
        /// <summary>
        /// GatewayBridgeSource
        ...
        /// </summary>
        public FlowSourceTypes.GatewayBridgeSource GatewayBridgeSource { get; set; }
        /// <summary>
    ...
    namespace FlowSourceTypes
    {
        ...
        public class GatewayBridgeSource : Humidifier.Base.BaseSubResource
        {
            ...
            /// </summary>
            public FlowSourceTypes.VpcInterfaceAttachment VpcInterfaceAttachment { get; set; }
        }
