namespace Humidifier.CodeGuruProfiler
{
    ...
    public class ProfilingGroup : Humidifier.Base.BaseResource, IHaveImpliedResourceName, IHaveTags
    {
        ...
        /// ItemType: Channel
        /// </summary>
        public List<ProfilingGroupTypes.Channel> AnomalyDetectionNotificationConfiguration { get; set; }
        /// <summary>
        /// AgentPermissions
        ...
        /// </summary>
        public ProfilingGroupTypes.AgentPermissions AgentPermissions { get; set; }
        /// <summary>
        /// ComputePlatform
    ...
    {
        public class AgentPermissions : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// Principals
