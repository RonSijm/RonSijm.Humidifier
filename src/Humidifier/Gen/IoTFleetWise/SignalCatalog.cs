namespace Humidifier.IoTFleetWise
{
    ...
    public class SignalCatalog : Humidifier.Base.BaseResource, IHaveImpliedResourceName, IHaveTags, IHaveDescription
    {
        ...
        /// Type: NodeCounts
        /// </summary>
        public SignalCatalogTypes.NodeCounts NodeCounts { get; set; }
        /// <summary>
        /// Nodes
        ...
        /// ItemType: Node
        /// </summary>
        public List<SignalCatalogTypes.Node> Nodes { get; set; }
        /// <summary>
        /// Tags
    ...
    {
        public class Actuator : Humidifier.Base.BaseSubResource, IHaveDescription
        {
            /// <summary>
            /// Description
        ...
        public class Attribute : Humidifier.Base.BaseSubResource, IHaveDescription
        {
            /// <summary>
            /// DefaultValue
        ...
        public class Branch : Humidifier.Base.BaseSubResource, IHaveDescription
        {
            /// <summary>
            /// Description
        ...
        public class Node : Humidifier.Base.BaseSubResource
        {
            ...
            /// Type: Attribute
            /// </summary>
            public SignalCatalogTypes.Attribute Attribute { get; set; }
            /// <summary>
            /// Branch
            ...
            /// Type: Branch
            /// </summary>
            public SignalCatalogTypes.Branch Branch { get; set; }
            /// <summary>
            /// Sensor
            ...
            /// Type: Sensor
            /// </summary>
            public SignalCatalogTypes.Sensor Sensor { get; set; }
            /// <summary>
            /// Actuator
            ...
            /// Type: Actuator
            /// </summary>
            public SignalCatalogTypes.Actuator Actuator { get; set; }
        }
        ...
        public class Sensor : Humidifier.Base.BaseSubResource, IHaveDescription
        {
            /// <summary>
            /// Description
