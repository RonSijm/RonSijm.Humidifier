namespace Humidifier.IoTFleetWise
{
    ...
    public class Campaign : Humidifier.Base.BaseResource, IHaveImpliedResourceName, IHaveTags, IHaveDescription
    {
        ...
        /// </summary>
        public List<CampaignTypes.SignalInformation> SignalsToCollect { get; set; }
        /// <summary>
        /// StartTime
    ...
    namespace CampaignTypes
    {
        public class CollectionScheme : Humidifier.Base.BaseSubResource
        {
            ...
            /// </summary>
            public CampaignTypes.TimeBasedCollectionScheme TimeBasedCollectionScheme { get; set; }
            /// <summary>
            ...
            /// </summary>
            public CampaignTypes.ConditionBasedCollectionScheme ConditionBasedCollectionScheme { get; set; }
        }

        public class ConditionBasedCollectionScheme : Humidifier.Base.BaseSubResource
        {
            /// <summary>
        ...
        public class DataDestinationConfig : Humidifier.Base.BaseSubResource
        {
            ...
            /// Type: S3Config
            /// </summary>
            public CampaignTypes.S3Config S3Config { get; set; }
            /// <summary>
            /// TimestreamConfig
            ...
            /// </summary>
            public CampaignTypes.TimestreamConfig TimestreamConfig { get; set; }
        }
        ...
        public class SignalInformation : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// MaxSampleCount
        ...
        public class TimestreamConfig : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// ExecutionRoleArn
