namespace Humidifier.IoTFleetWise
{
    ...
    public class DecoderManifest : Humidifier.Base.BaseResource, IHaveImpliedResourceName, IHaveTags, IHaveDescription
    {
        ...
        /// </summary>
        public List<DecoderManifestTypes.SignalDecodersItems> SignalDecoders { get; set; }
        /// <summary>
        /// Status
    ...
    {
        public class CanInterface : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// ProtocolName
        ...
        public class CanSignal : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// IsBigEndian
        ...
        public class NetworkInterfacesItems : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// Type
            ...
            /// Type: CanInterface
            /// </summary>
            public DecoderManifestTypes.CanInterface CanInterface { get; set; }
            /// <summary>
            /// InterfaceId
            ...
            /// Type: ObdInterface
            /// </summary>
            public DecoderManifestTypes.ObdInterface ObdInterface { get; set; }
        }

        public class ObdInterface : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// HasTransmissionEcu
        ...
        public class ObdSignal : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// BitRightShift
        ...
        public class SignalDecodersItems : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// Type
            ...
            /// Type: ObdSignal
            /// </summary>
            public DecoderManifestTypes.ObdSignal ObdSignal { get; set; }
            /// <summary>
            /// FullyQualifiedName
            ...
            /// Type: CanSignal
            /// </summary>
            public DecoderManifestTypes.CanSignal CanSignal { get; set; }
            /// <summary>
            /// InterfaceId
