namespace Humidifier.DynamoDB
{
    ...
    public class Table : Humidifier.Base.BaseResource, IHaveImpliedResourceName, IHaveTags
    {
        ...
        /// </summary>
        public TableTypes.OnDemandThroughput OnDemandThroughput { get; set; }
        /// <summary>
        /// SSESpecification
        ...
        /// </summary>
        public TableTypes.SSESpecification SSESpecification { get; set; }
        /// <summary>
        ...
        /// </summary>
        public TableTypes.KinesisStreamSpecification KinesisStreamSpecification { get; set; }
        /// <summary>
        /// StreamSpecification
        ...
        /// </summary>
        public TableTypes.StreamSpecification StreamSpecification { get; set; }
        /// <summary>
        ...
        /// </summary>
        public TableTypes.ContributorInsightsSpecification ContributorInsightsSpecification { get; set; }
        /// <summary>
        ...
        /// </summary>
        public TableTypes.ImportSourceSpecification ImportSourceSpecification { get; set; }
        /// <summary>
        ...
        /// </summary>
        public TableTypes.PointInTimeRecoverySpecification PointInTimeRecoverySpecification { get; set; }
        /// <summary>
        ...
        /// </summary>
        public TableTypes.ProvisionedThroughput ProvisionedThroughput { get; set; }
        ...
        /// </summary>
        public List<TableTypes.AttributeDefinition> AttributeDefinitions { get; set; }
        /// <summary>
        /// BillingMode
        ...
        /// </summary>
        public List<TableTypes.GlobalSecondaryIndex> GlobalSecondaryIndexes { get; set; }
        /// <summary>
        /// ResourcePolicy
        ...
        /// </summary>
        public List<TableTypes.LocalSecondaryIndex> LocalSecondaryIndexes { get; set; }
        /// <summary>
        ...
        /// </summary>
        public TableTypes.TimeToLiveSpecification TimeToLiveSpecification { get; set; }
    }
    ...
    namespace TableTypes
    {
        ...
        public class GlobalSecondaryIndex : Humidifier.Base.BaseSubResource
        {
            ...
            /// Type: Projection
            /// </summary>
            public TableTypes.Projection Projection { get; set; }
            /// <summary>
            /// ProvisionedThroughput
        ...
        public class ImportSourceSpecification : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// S3BucketSource
            ...
            /// Type: S3BucketSource
            /// </summary>
            public TableTypes.S3BucketSource S3BucketSource { get; set; }
            /// <summary>
            /// InputFormat
            ...
            /// </summary>
            public TableTypes.InputFormatOptions InputFormatOptions { get; set; }
            /// <summary>
        ...
        public class InputFormatOptions : Humidifier.Base.BaseSubResource
        {
            ...
            /// Type: Csv
            /// </summary>
            public TableTypes.Csv Csv { get; set; }
        }
        ...
        public class S3BucketSource : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// S3Bucket
