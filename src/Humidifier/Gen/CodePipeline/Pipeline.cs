namespace Humidifier.CodePipeline
{
    ...
    public class Pipeline : Humidifier.Base.BaseResource, IHaveImpliedResourceName, IHaveTags
    {
        ...
        /// </summary>
        public List<PipelineTypes.VariableDeclaration> Variables { get; set; }
        /// <summary>
        /// ArtifactStores
        ...
        /// </summary>
        public List<PipelineTypes.ArtifactStoreMap> ArtifactStores { get; set; }
        /// <summary>
        /// ArtifactStore
        ...
        /// Type: ArtifactStore
        /// </summary>
        public PipelineTypes.ArtifactStore ArtifactStore { get; set; }
        /// <summary>
    ...
    {
        public class ActionDeclaration : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// ActionTypeId
            ...
            /// Type: ActionTypeId
            /// </summary>
            public PipelineTypes.ActionTypeId ActionTypeId { get; set; }
            /// <summary>
            /// Configuration
            ...
            /// </summary>
            public List<PipelineTypes.InputArtifact> InputArtifacts { get; set; }
            /// <summary>
            /// OutputArtifacts
            ...
            /// </summary>
            public List<PipelineTypes.OutputArtifact> OutputArtifacts { get; set; }
            /// <summary>
            /// Region
        ...
        public class ActionTypeId : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// Owner
        ...
        public class ArtifactStore : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// Type
            ...
            /// Type: EncryptionKey
            /// </summary>
            public PipelineTypes.EncryptionKey EncryptionKey { get; set; }
            /// <summary>
            /// Location
        ...
        public class ArtifactStoreMap : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// ArtifactStore
        ...
        public class BlockerDeclaration : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// Type
        ...
        public class EncryptionKey : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// Type
        ...
        public class GitBranchFilterCriteria : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// Includes
        ...
        public class GitConfiguration : Humidifier.Base.BaseSubResource
        {
            ...
            /// </summary>
            public List<PipelineTypes.GitPullRequestFilter> PullRequest { get; set; }
            /// <summary>
            /// Push
            ...
            /// </summary>
            public List<PipelineTypes.GitPushFilter> Push { get; set; }
            /// <summary>
            /// SourceActionName
        ...
        public class GitFilePathFilterCriteria : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// Includes
        ...
        public class GitPullRequestFilter : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// FilePaths
            ...
            /// </summary>
            public PipelineTypes.GitFilePathFilterCriteria FilePaths { get; set; }
            /// <summary>
            /// Events
            ...
            /// </summary>
            public PipelineTypes.GitBranchFilterCriteria Branches { get; set; }
        }
        ...
        public class GitPushFilter : Humidifier.Base.BaseSubResource
        {
            ...
            /// </summary>
            public PipelineTypes.GitTagFilterCriteria Tags { get; set; }
        }

        public class GitTagFilterCriteria : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// Includes
        ...
        public class InputArtifact : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// Name
        ...
        public class OutputArtifact : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// Name
        ...
        public class PipelineTriggerDeclaration : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// GitConfiguration
            ...
            /// </summary>
            public PipelineTypes.GitConfiguration GitConfiguration { get; set; }
            /// <summary>
            /// ProviderType
        ...
        public class StageDeclaration : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// Blockers
            ...
            /// </summary>
            public List<PipelineTypes.BlockerDeclaration> Blockers { get; set; }
            /// <summary>
            /// Actions
            ...
            /// </summary>
            public List<PipelineTypes.ActionDeclaration> Actions { get; set; }
            /// <summary>
            /// Name
            ...
            /// </summary>
            public PipelineTypes.FailureConditions OnFailure { get; set; }
        }

        public class StageTransition : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// StageName
        ...
        public class VariableDeclaration : Humidifier.Base.BaseSubResource, IHaveDescription
        {
            /// <summary>
            /// DefaultValue
