namespace Humidifier.CodePipeline
{
    ...
    public class CustomActionType : Humidifier.Base.BaseResource, IHaveTags
    {
        ...
        /// </summary>
        public List<CustomActionTypeTypes.ConfigurationProperties> ConfigurationProperties { get; set; }
        /// <summary>
        /// Settings
        ...
        /// Type: Settings
        /// </summary>
        public CustomActionTypeTypes.Settings Settings { get; set; }
        /// <summary>
        /// Tags
    ...
    namespace CustomActionTypeTypes
    {
        ...
        public class ConfigurationProperties : Humidifier.Base.BaseSubResource, IHaveDescription
        {
            /// <summary>
            /// Secret
