namespace Humidifier.AmazonMQ
{
    ...
    public class Broker : Humidifier.Base.BaseResource, IHaveSecurityGroups, IHaveImpliedResourceName
    {
        ...
        /// </summary>
        public BrokerTypes.ConfigurationId Configuration { get; set; }
        /// <summary>
        ...
        /// Type: LogList
        /// </summary>
        public BrokerTypes.LogList Logs { get; set; }
        /// <summary>
        /// SubnetIds
        ...
        /// </summary>
        public BrokerTypes.EncryptionOptions EncryptionOptions { get; set; }
        /// <summary>
        /// Tags
        ...
        /// ItemType: TagsEntry
        /// </summary>
        public List<BrokerTypes.TagsEntry> Tags { get; set; }
    }

    namespace BrokerTypes
    {
        public class ConfigurationId : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// Revision
        ...
        public class LdapServerMetadata : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// Hosts
