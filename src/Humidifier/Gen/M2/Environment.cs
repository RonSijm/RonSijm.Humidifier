namespace Humidifier.M2
{
    ...
    public class Environment : Humidifier.Base.BaseResource, IHaveImpliedResourceName, IHaveDescription, IHaveSubnetIds, IHaveKmsKeyId
    {
        ...
        /// </summary>
        public EnvironmentTypes.HighAvailabilityConfig HighAvailabilityConfig { get; set; }
        /// <summary>
        ...
        /// </summary>
        public List<EnvironmentTypes.StorageConfiguration> StorageConfigurations { get; set; }
        /// <summary>
        /// Tags
    ...
    {
        public class EfsStorageConfiguration : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// MountPoint
        ...
        public class FsxStorageConfiguration : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// MountPoint
        ...
        public class HighAvailabilityConfig : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// DesiredCapacity
        ...
        public class StorageConfiguration : Humidifier.Base.BaseSubResource
        {
            ...
            /// </summary>
            public EnvironmentTypes.EfsStorageConfiguration Efs { get; set; }
            /// <summary>
            /// Fsx
            ...
            /// </summary>
            public EnvironmentTypes.FsxStorageConfiguration Fsx { get; set; }
        }
    }
}