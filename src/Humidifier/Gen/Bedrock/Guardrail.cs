namespace Humidifier.Bedrock
{
    ...
    public class Guardrail : Humidifier.Base.BaseResource, IHaveImpliedResourceName, IHaveTags, IHaveDescription
    {
        ...
        /// </summary>
        public GuardrailTypes.TopicPolicyConfig TopicPolicyConfig { get; set; }
        /// <summary>
        /// Description
        ...
        /// </summary>
        public GuardrailTypes.WordPolicyConfig WordPolicyConfig { get; set; }
        /// <summary>
        ...
        /// </summary>
        public GuardrailTypes.ContextualGroundingPolicyConfig ContextualGroundingPolicyConfig { get; set; }
        /// <summary>
        /// KmsKeyArn
        ...
        /// </summary>
        public GuardrailTypes.SensitiveInformationPolicyConfig SensitiveInformationPolicyConfig { get; set; }
        /// <summary>
        /// ContentPolicyConfig
        ...
        /// </summary>
        public GuardrailTypes.ContentPolicyConfig ContentPolicyConfig { get; set; }
        /// <summary>
        /// Tags
    ...
    {
        public class ContentFilterConfig : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// OutputStrength
        ...
        public class ContentPolicyConfig : Humidifier.Base.BaseSubResource
        {
            ...
            /// </summary>
            public List<GuardrailTypes.ContentFilterConfig> FiltersConfig { get; set; }
        }

        public class ContextualGroundingFilterConfig : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// Type
        ...
        public class ContextualGroundingPolicyConfig : Humidifier.Base.BaseSubResource
        {
            ...
            /// </summary>
            public List<GuardrailTypes.ContextualGroundingFilterConfig> FiltersConfig { get; set; }
        }

        public class ManagedWordsConfig : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// Type
        ...
        public class PiiEntityConfig : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// Type
        ...
        public class RegexConfig : Humidifier.Base.BaseSubResource, IHaveDescription
        {
            /// <summary>
            /// Pattern
        ...
        public class SensitiveInformationPolicyConfig : Humidifier.Base.BaseSubResource
        {
            ...
            /// </summary>
            public List<GuardrailTypes.RegexConfig> RegexesConfig { get; set; }
            /// <summary>
            /// PiiEntitiesConfig
            ...
            /// </summary>
            public List<GuardrailTypes.PiiEntityConfig> PiiEntitiesConfig { get; set; }
        }

        public class TopicConfig : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// Type
        ...
        public class TopicPolicyConfig : Humidifier.Base.BaseSubResource
        {
            ...
            /// </summary>
            public List<GuardrailTypes.TopicConfig> TopicsConfig { get; set; }
        }

        public class WordConfig : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// Text
        ...
        public class WordPolicyConfig : Humidifier.Base.BaseSubResource
        {
            ...
            /// </summary>
            public List<GuardrailTypes.ManagedWordsConfig> ManagedWordListsConfig { get; set; }
            /// <summary>
            /// WordsConfig
            ...
            /// ItemType: WordConfig
            /// </summary>
            public List<GuardrailTypes.WordConfig> WordsConfig { get; set; }
        }
    }
}