namespace Humidifier.Bedrock
{
    ...
    public class Agent : Humidifier.Base.BaseResource, IHaveImpliedResourceName, IHaveDescription
    {
        ...
        /// </summary>
        public AgentTypes.GuardrailConfiguration GuardrailConfiguration { get; set; }
        /// <summary>
        ...
        /// </summary>
        public AgentTypes.PromptOverrideConfiguration PromptOverrideConfiguration { get; set; }
        /// <summary>
        /// Instruction
        ...
        /// </summary>
        public List<AgentTypes.AgentKnowledgeBase> KnowledgeBases { get; set; }
        /// <summary>
        /// ActionGroups
        ...
        /// </summary>
        public List<AgentTypes.AgentActionGroup> ActionGroups { get; set; }
        /// <summary>
        /// AutoPrepare
    ...
    {
        public class APISchema : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// S3
            ...
            /// Type: S3Identifier
            /// </summary>
            public AgentTypes.S3Identifier S3 { get; set; }
            /// <summary>
            /// Payload
        ...
        public class AgentActionGroup : Humidifier.Base.BaseSubResource, IHaveDescription
        {
            ...
            /// Type: APISchema
            /// </summary>
            public AgentTypes.APISchema ApiSchema { get; set; }
            /// <summary>
            /// FunctionSchema
            ...
            /// Type: FunctionSchema
            /// </summary>
            public AgentTypes.FunctionSchema FunctionSchema { get; set; }
            /// <summary>
            /// SkipResourceInUseCheckOnDelete
            ...
            /// </summary>
            public AgentTypes.ActionGroupExecutor ActionGroupExecutor { get; set; }
            /// <summary>
            /// ActionGroupName
        ...
        public class AgentKnowledgeBase : Humidifier.Base.BaseSubResource, IHaveDescription
        {
            /// <summary>
            /// Description
        ...
        public class Function : Humidifier.Base.BaseSubResource, IHaveDescription
        {
            /// <summary>
            /// Description
            ...
            /// </summary>
            public Dictionary<string, AgentTypes.ParameterDetail> Parameters { get; set; }
            /// <summary>
            /// Name
        ...
        public class FunctionSchema : Humidifier.Base.BaseSubResource
        {
            ...
            /// ItemType: Function
            /// </summary>
            public List<AgentTypes.Function> Functions { get; set; }
        }
        ...
        public class InferenceConfiguration : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// TopK
        ...
        public class ParameterDetail : Humidifier.Base.BaseSubResource, IHaveDescription
        {
            /// <summary>
            /// Type
        ...
        public class PromptConfiguration : Humidifier.Base.BaseSubResource
        {
            ...
            /// </summary>
            public AgentTypes.InferenceConfiguration InferenceConfiguration { get; set; }
            /// <summary>
            /// PromptCreationMode
        ...
        public class PromptOverrideConfiguration : Humidifier.Base.BaseSubResource
        {
            ...
            /// </summary>
            public List<AgentTypes.PromptConfiguration> PromptConfigurations { get; set; }
            /// <summary>
            /// OverrideLambda
        ...
        public class S3Identifier : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// S3BucketName
