namespace Humidifier.BillingConductor
{
    ...
    public class CustomLineItem : Humidifier.Base.BaseResource, IHaveImpliedResourceName, IHaveTags, IHaveDescription
    {
        ...
        /// </summary>
        public CustomLineItemTypes.BillingPeriodRange BillingPeriodRange { get; set; }
        /// <summary>
        /// Description
        ...
        /// </summary>
        public CustomLineItemTypes.CustomLineItemChargeDetails CustomLineItemChargeDetails { get; set; }
        /// <summary>
        /// Tags
    ...
    namespace CustomLineItemTypes
    {
        ...
        public class CustomLineItemChargeDetails : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// LineItemFilters
            ...
            /// </summary>
            public List<CustomLineItemTypes.LineItemFilter> LineItemFilters { get; set; }
            /// <summary>
            /// Type
            ...
            /// </summary>
            public CustomLineItemTypes.CustomLineItemPercentageChargeDetails Percentage { get; set; }
            /// <summary>
            /// Flat
            ...
            /// </summary>
            public CustomLineItemTypes.CustomLineItemFlatChargeDetails Flat { get; set; }
        }
        ...
        public class LineItemFilter : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// MatchOption
