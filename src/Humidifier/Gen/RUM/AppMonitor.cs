namespace Humidifier.RUM
{
    ...
    public class AppMonitor : Humidifier.Base.BaseResource, IHaveImpliedResourceName, IHaveTags
    {
        ...
        /// Type: CustomEvents
        /// </summary>
        public AppMonitorTypes.CustomEvents CustomEvents { get; set; }
        /// <summary>
        /// CwLogEnabled
        ...
        /// </summary>
        public AppMonitorTypes.AppMonitorConfiguration AppMonitorConfiguration { get; set; }
        /// <summary>
        /// Tags
    ...
    {
        public class AppMonitorConfiguration : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// MetricDestinations
            ...
            /// </summary>
            public List<AppMonitorTypes.MetricDestination> MetricDestinations { get; set; }
            /// <summary>
            /// IncludedPages
        ...
        public class CustomEvents : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// Status
        ...
        public class MetricDefinition : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// EventPattern
        ...
        public class MetricDestination : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// Destination
            ...
            /// </summary>
            public List<AppMonitorTypes.MetricDefinition> MetricDefinitions { get; set; }
            /// <summary>
            /// DestinationArn
