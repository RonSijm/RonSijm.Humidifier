namespace Humidifier.DevOpsGuru
{
    ...
    namespace ResourceCollectionTypes
    {
        ...
        public class ResourceCollectionFilter : Humidifier.Base.BaseSubResource
        {
            ...
            /// </summary>
            public ResourceCollectionTypes.CloudFormationCollectionFilter CloudFormation { get; set; }
            /// <summary>
            /// Tags
            ...
            /// </summary>
            public List<ResourceCollectionTypes.TagCollection> Tags { get; set; }
        }

        public class TagCollection : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// AppBoundaryKey
