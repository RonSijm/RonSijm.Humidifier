namespace Humidifier.DevOpsGuru
{
    ...
    namespace NotificationChannelTypes
    {
        public class NotificationChannelConfig : Humidifier.Base.BaseSubResource
        {
            ...
            /// </summary>
            public NotificationChannelTypes.NotificationFilterConfig Filters { get; set; }
            /// <summary>
            /// Sns
            ...
            /// </summary>
            public NotificationChannelTypes.SnsChannelConfig Sns { get; set; }
        }
        ...
        public class SnsChannelConfig : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// TopicArn
