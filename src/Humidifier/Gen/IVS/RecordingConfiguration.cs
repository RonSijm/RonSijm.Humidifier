namespace Humidifier.IVS
{
    ...
    public class RecordingConfiguration : Humidifier.Base.BaseResource, IHaveImpliedResourceName, IHaveTags
    {
        ...
        /// </summary>
        public RecordingConfigurationTypes.RenditionConfiguration RenditionConfiguration { get; set; }
        /// <summary>
        ...
        /// </summary>
        public RecordingConfigurationTypes.ThumbnailConfiguration ThumbnailConfiguration { get; set; }
    ...
    namespace RecordingConfigurationTypes
    {
        public class DestinationConfiguration : Humidifier.Base.BaseSubResource
        {
            ...
            /// </summary>
            public RecordingConfigurationTypes.S3DestinationConfiguration S3 { get; set; }
        }
