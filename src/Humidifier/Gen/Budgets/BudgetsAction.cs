namespace Humidifier.Budgets
{
    ...
    public class BudgetsAction : Humidifier.Base.BaseResource
    {
    ...
    {
        public class ActionThreshold : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// Type
        ...
        public class Definition : Humidifier.Base.BaseSubResource
        {
            ...
            /// </summary>
            public BudgetsActionTypes.SsmActionDefinition SsmActionDefinition { get; set; }
            /// <summary>
            /// IamActionDefinition
            ...
            /// </summary>
            public BudgetsActionTypes.IamActionDefinition IamActionDefinition { get; set; }
            /// <summary>
            /// ScpActionDefinition
            ...
            /// </summary>
            public BudgetsActionTypes.ScpActionDefinition ScpActionDefinition { get; set; }
        }

        public class IamActionDefinition : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// PolicyArn
        ...
        public class SsmActionDefinition : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// Region
