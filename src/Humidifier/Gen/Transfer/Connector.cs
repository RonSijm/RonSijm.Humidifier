namespace Humidifier.Transfer
{
    ...
    public class Connector : Humidifier.Base.BaseResource, IHaveTags
    {
        ...
        /// Type: As2Config
        /// </summary>
        public ConnectorTypes.As2Config As2Config { get; set; }
        /// <summary>
        /// LoggingRole
        ...
        /// Type: SftpConfig
        /// </summary>
        public ConnectorTypes.SftpConfig SftpConfig { get; set; }
        /// <summary>
        /// Tags
    ...
    {
        public class As2Config : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// Compression
