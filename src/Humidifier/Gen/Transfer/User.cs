namespace Humidifier.Transfer
{
    ...
    public class User : Humidifier.Base.BaseResource, IHaveImpliedResourceName, IHaveTags, IHaveRole
    {
        ...
        /// </summary>
        public List<UserTypes.HomeDirectoryMapEntry> HomeDirectoryMappings { get; set; }
        /// <summary>
        /// PosixProfile
        ...
        /// Type: PosixProfile
        /// </summary>
        public UserTypes.PosixProfile PosixProfile { get; set; }
        /// <summary>
        /// SshPublicKeys
    ...
    namespace UserTypes
    {
        public class HomeDirectoryMapEntry : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// Entry
        ...
        public class PosixProfile : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// Uid
