namespace Humidifier.Transfer
{
    ...
    public class Server : Humidifier.Base.BaseResource, IHaveTags
    {
        ...
        /// </summary>
        public ServerTypes.IdentityProviderDetails IdentityProviderDetails { get; set; }
        /// <summary>
        /// EndpointDetails
        ...
        /// </summary>
        public ServerTypes.EndpointDetails EndpointDetails { get; set; }
        /// <summary>
        ...
        /// </summary>
        public ServerTypes.ProtocolDetails ProtocolDetails { get; set; }
        /// <summary>
        /// S3StorageOptions
        ...
        /// </summary>
        public ServerTypes.S3StorageOptions S3StorageOptions { get; set; }
        /// <summary>
        /// WorkflowDetails
        ...
        /// </summary>
        public ServerTypes.WorkflowDetails WorkflowDetails { get; set; }
        /// <summary>
        /// Domain
    ...
    namespace ServerTypes
    {
        ...
        public class IdentityProviderDetails : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// Function
        ...
        public class ProtocolDetails : Humidifier.Base.BaseSubResource
        {
            ...
            /// </summary>
            public List<ServerTypes.As2Transport> As2Transports { get; set; }
            /// <summary>
            /// PassiveIp
        ...
        public class WorkflowDetails : Humidifier.Base.BaseSubResource
        {
            ...
            /// </summary>
            public List<ServerTypes.WorkflowDetail> OnUpload { get; set; }
            /// <summary>
            /// OnPartialUpload
            ...
            /// ItemType: WorkflowDetail
            /// </summary>
            public List<ServerTypes.WorkflowDetail> OnPartialUpload { get; set; }
        }
    }
}