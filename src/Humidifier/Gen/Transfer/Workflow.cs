namespace Humidifier.Transfer
{
    ...
    public class Workflow : Humidifier.Base.BaseResource, IHaveTags, IHaveDescription
    {
        ...
        /// ItemType: WorkflowStep
        /// </summary>
        public List<WorkflowTypes.WorkflowStep> OnExceptionSteps { get; set; }
        /// <summary>
        /// Tags
    ...
    {
        public class CopyStepDetails : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            ...
            /// Type: S3FileLocation
            /// </summary>
            public WorkflowTypes.S3FileLocation DestinationFileLocation { get; set; }
            /// <summary>
            /// SourceFileLocation
        ...
        public class CustomStepDetails : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// TimeoutSeconds
        ...
        public class DecryptStepDetails : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// DestinationFileLocation
            ...
            /// </summary>
            public WorkflowTypes.InputFileLocation DestinationFileLocation { get; set; }
            /// <summary>
            /// Type
        ...
        public class DeleteStepDetails : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// SourceFileLocation
        ...
        public class EfsInputFileLocation : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// Path
        ...
        public class InputFileLocation : Humidifier.Base.BaseSubResource
        {
            ...
            /// </summary>
            public WorkflowTypes.EfsInputFileLocation EfsFileLocation { get; set; }
            /// <summary>
            /// S3FileLocation
            ...
            /// </summary>
            public WorkflowTypes.S3InputFileLocation S3FileLocation { get; set; }
        }
        ...
        public class S3FileLocation : Humidifier.Base.BaseSubResource
        {
            ...
            /// Type: S3InputFileLocation
            /// </summary>
            public WorkflowTypes.S3InputFileLocation S3FileLocation_ { get; set; }
        }

        public class S3InputFileLocation : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// Bucket
        ...
        public class S3Tag : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// Value
        ...
        public class TagStepDetails : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// SourceFileLocation
            ...
            /// ItemType: S3Tag
            /// </summary>
            public List<WorkflowTypes.S3Tag> Tags { get; set; }
            /// <summary>
            /// Name
        ...
        public class WorkflowStep : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// CustomStepDetails
            ...
            /// </summary>
            public WorkflowTypes.CustomStepDetails CustomStepDetails { get; set; }
            /// <summary>
            /// CopyStepDetails
            ...
            /// </summary>
            public WorkflowTypes.CopyStepDetails CopyStepDetails { get; set; }
            /// <summary>
            /// DecryptStepDetails
            ...
            /// </summary>
            public WorkflowTypes.DecryptStepDetails DecryptStepDetails { get; set; }
            /// <summary>
            /// Type
            ...
            /// Type: TagStepDetails
            /// </summary>
            public WorkflowTypes.TagStepDetails TagStepDetails { get; set; }
            /// <summary>
            /// DeleteStepDetails
            ...
            /// </summary>
            public WorkflowTypes.DeleteStepDetails DeleteStepDetails { get; set; }
        }
    }
}