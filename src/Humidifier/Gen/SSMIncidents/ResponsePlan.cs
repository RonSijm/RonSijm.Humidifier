namespace Humidifier.SSMIncidents
{
    ...
    public class ResponsePlan : Humidifier.Base.BaseResource, IHaveTags, IHaveImpliedResourceName
    {
        ...
        /// Type: ChatChannel
        /// </summary>
        public ResponsePlanTypes.ChatChannel ChatChannel { get; set; }
        /// <summary>
        /// Integrations
        ...
        /// </summary>
        public List<ResponsePlanTypes.Integration> Integrations { get; set; }
        /// <summary>
        /// Actions
        ...
        /// ItemType: Action
        /// </summary>
        public List<ResponsePlanTypes.Action> Actions { get; set; }
        /// <summary>
        /// DisplayName
    ...
    namespace ResponsePlanTypes
    {
        public class Action : Humidifier.Base.BaseSubResource
        {
            ...
            /// Type: SsmAutomation
            /// </summary>
            public ResponsePlanTypes.SsmAutomation SsmAutomation { get; set; }
        }
        ...
        public class DynamicSsmParameter : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// Value
            ...
            /// </summary>
            public ResponsePlanTypes.DynamicSsmParameterValue Value { get; set; }
            /// <summary>
            /// Key
        ...
        public class IncidentTemplate : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// Impact
            ...
            /// </summary>
            public List<ResponsePlanTypes.NotificationTargetItem> NotificationTargets { get; set; }
            /// <summary>
            /// DedupeString
        ...
        public class Integration : Humidifier.Base.BaseSubResource
        {
            ...
            /// </summary>
            public ResponsePlanTypes.PagerDutyConfiguration PagerDutyConfiguration { get; set; }
        }

        public class NotificationTargetItem : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// SnsTopicArn
        ...
        public class PagerDutyConfiguration : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// SecretId
            ...
            /// </summary>
            public ResponsePlanTypes.PagerDutyIncidentConfiguration PagerDutyIncidentConfiguration { get; set; }
            /// <summary>
            /// Name
        ...
        public class PagerDutyIncidentConfiguration : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// ServiceId
        ...
        public class SsmAutomation : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// Parameters
            ...
            /// </summary>
            public List<ResponsePlanTypes.SsmParameter> Parameters { get; set; }
            /// <summary>
            /// TargetAccount
            ...
            /// </summary>
            public List<ResponsePlanTypes.DynamicSsmParameter> DynamicParameters { get; set; }
            /// <summary>
            /// DocumentVersion
        ...
        public class SsmParameter : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// Values
