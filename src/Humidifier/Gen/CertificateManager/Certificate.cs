namespace Humidifier.CertificateManager
{
    ...
    public class Certificate : Humidifier.Base.BaseResource, IHaveTags
    {
        ...
        /// </summary>
        public List<CertificateTypes.DomainValidationOption> DomainValidationOptions { get; set; }
        /// <summary>
        /// KeyAlgorithm
    ...
    {
        public class DomainValidationOption : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// DomainName
