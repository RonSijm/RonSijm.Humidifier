namespace Humidifier.DataBrew
{
    ...
    public class Job : Humidifier.Base.BaseResource, IHaveTags, IHaveImpliedResourceName
    {
        ...
        /// Type: Recipe
        /// </summary>
        public JobTypes.Recipe Recipe { get; set; }
        /// <summary>
        /// EncryptionKeyArn
        ...
        /// </summary>
        public List<JobTypes.DatabaseOutput> DatabaseOutputs { get; set; }
        /// <summary>
        /// OutputLocation
        ...
        /// </summary>
        public JobTypes.ProfileConfiguration ProfileConfiguration { get; set; }
        /// <summary>
        /// Outputs
        ...
        /// ItemType: Output
        /// </summary>
        public List<JobTypes.Output> Outputs { get; set; }
        /// <summary>
        ...
        /// </summary>
        public List<JobTypes.ValidationConfiguration> ValidationConfigurations { get; set; }
        /// <summary>
        /// Tags
        ...
        /// Type: JobSample
        /// </summary>
        public JobTypes.JobSample JobSample { get; set; }
        /// <summary>
        /// EncryptionMode
        ...
        /// </summary>
        public List<JobTypes.DataCatalogOutput> DataCatalogOutputs { get; set; }
    }
    ...
    namespace JobTypes
    {
        ...
        public class ColumnStatisticsConfiguration : Humidifier.Base.BaseSubResource
        {
            ...
            /// </summary>
            public JobTypes.StatisticsConfiguration Statistics { get; set; }
            /// <summary>
            /// Selectors
            ...
            /// </summary>
            public List<JobTypes.ColumnSelector> Selectors { get; set; }
        }

        public class CsvOutputOptions : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// Delimiter
        ...
        public class DataCatalogOutput : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// TableName
            ...
            /// </summary>
            public JobTypes.S3TableOutputOptions S3Options { get; set; }
            /// <summary>
            /// DatabaseOptions
            ...
            /// </summary>
            public JobTypes.DatabaseTableOutputOptions DatabaseOptions { get; set; }
            /// <summary>
            /// DatabaseName
        ...
        public class DatabaseTableOutputOptions : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// TempDirectory
            ...
            /// Type: S3Location
            /// </summary>
            public JobTypes.S3Location TempDirectory { get; set; }
            /// <summary>
            /// TableName
        ...
        public class EntityDetectorConfiguration : Humidifier.Base.BaseSubResource
        {
            ...
            /// </summary>
            public JobTypes.AllowedStatistics AllowedStatistics { get; set; }
        }

        public class JobSample : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// Size
        ...
        public class Output : Humidifier.Base.BaseSubResource
        {
            ...
            /// </summary>
            public JobTypes.OutputFormatOptions FormatOptions { get; set; }
            /// <summary>
            /// Location
            ...
            /// Type: S3Location
            /// </summary>
            public JobTypes.S3Location Location { get; set; }
        }
        ...
        public class OutputFormatOptions : Humidifier.Base.BaseSubResource
        {
            ...
            /// </summary>
            public JobTypes.CsvOutputOptions Csv { get; set; }
        }

        public class OutputLocation : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// Bucket
        ...
        public class ProfileConfiguration : Humidifier.Base.BaseSubResource
        {
            ...
            /// ItemType: ColumnSelector
            /// </summary>
            public List<JobTypes.ColumnSelector> ProfileColumns { get; set; }
            /// <summary>
            ...
            /// Type: StatisticsConfiguration
            /// </summary>
            public JobTypes.StatisticsConfiguration DatasetStatisticsConfiguration { get; set; }
            /// <summary>
            ...
            /// </summary>
            public List<JobTypes.ColumnStatisticsConfiguration> ColumnStatisticsConfigurations { get; set; }
            /// <summary>
            ...
            /// </summary>
            public JobTypes.EntityDetectorConfiguration EntityDetectorConfiguration { get; set; }
        }

        public class Recipe : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// Version
        ...
        public class StatisticOverride : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// Parameters
        ...
        public class StatisticsConfiguration : Humidifier.Base.BaseSubResource
        {
            ...
            /// </summary>
            public List<JobTypes.StatisticOverride> Overrides { get; set; }
        }
