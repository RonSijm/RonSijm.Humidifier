namespace Humidifier.DataBrew
{
    ...
    public class Recipe : Humidifier.Base.BaseResource, IHaveTags, IHaveDescription, IHaveImpliedResourceName
    {
        ...
        /// ItemType: RecipeStep
        /// </summary>
        public List<RecipeTypes.RecipeStep> Steps { get; set; }
        /// <summary>
        /// Description
    ...
    namespace RecipeTypes
    {
        public class Action : Humidifier.Base.BaseSubResource
        {
            ...
            /// </summary>
            public RecipeTypes.RecipeParameters Parameters { get; set; }
            /// <summary>
            /// Operation
        ...
        public class ConditionExpression : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// Condition
        ...
        public class DataCatalogInputDefinition : Humidifier.Base.BaseSubResource
        {
            ...
            /// Type: S3Location
            /// </summary>
            public RecipeTypes.S3Location TempDirectory { get; set; }
            /// <summary>
            /// DatabaseName
        ...
        public class Input : Humidifier.Base.BaseSubResource
        {
            ...
            /// Type: S3Location
            /// </summary>
            public RecipeTypes.S3Location S3InputDefinition { get; set; }
            /// <summary>
            ...
            /// </summary>
            public RecipeTypes.DataCatalogInputDefinition DataCatalogInputDefinition { get; set; }
        }

        public class RecipeParameters : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// IgnoreCase
            ...
            /// </summary>
            public List<RecipeTypes.SecondaryInput> SecondaryInputs { get; set; }
            /// <summary>
            /// SampleType
            ...
            /// Type: Input
            /// </summary>
            public RecipeTypes.Input Input { get; set; }
            /// <summary>
            /// StepCount
        ...
        public class RecipeStep : Humidifier.Base.BaseSubResource
        {
            ...
            /// Type: Action
            /// </summary>
            public RecipeTypes.Action Action { get; set; }
            /// <summary>
            ...
            /// </summary>
            public List<RecipeTypes.ConditionExpression> ConditionExpressions { get; set; }
        }
