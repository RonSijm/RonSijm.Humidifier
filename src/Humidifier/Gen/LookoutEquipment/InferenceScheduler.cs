namespace Humidifier.LookoutEquipment
{
    ...
    namespace InferenceSchedulerTypes
    {
        public class DataInputConfiguration : Humidifier.Base.BaseSubResource
        {
            ...
            /// </summary>
            public InferenceSchedulerTypes.InputNameConfiguration InferenceInputNameConfiguration { get; set; }
            /// <summary>
            ...
            /// </summary>
            public InferenceSchedulerTypes.S3InputConfiguration S3InputConfiguration { get; set; }
            /// <summary>
            /// InputTimeZoneOffset
        ...
        public class DataOutputConfiguration : Humidifier.Base.BaseSubResource, IHaveKmsKeyId
        {
            ...
            /// </summary>
            public InferenceSchedulerTypes.S3OutputConfiguration S3OutputConfiguration { get; set; }
        }

        public class InputNameConfiguration : Humidifier.Base.BaseSubResource
        {
            /// <summary>
        ...
        public class S3InputConfiguration : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// Bucket
        ...
        public class S3OutputConfiguration : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// Bucket
