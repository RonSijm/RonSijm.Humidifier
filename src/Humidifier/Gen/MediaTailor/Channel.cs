namespace Humidifier.MediaTailor
{
    ...
    public class Channel : Humidifier.Base.BaseResource, IHaveImpliedResourceName, IHaveTags
    {
        ...
        /// Type: SlateSource
        /// </summary>
        public ChannelTypes.SlateSource FillerSlate { get; set; }
        ...
        /// </summary>
        public ChannelTypes.TimeShiftConfiguration TimeShiftConfiguration { get; set; }
    }

    namespace ChannelTypes
    {
        public class DashPlaylistSettings : Humidifier.Base.BaseSubResource
        {
            /// <summary>
        ...
        public class HlsPlaylistSettings : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// ManifestWindowSeconds
        ...
        public class RequestOutputItem : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// ManifestName
            ...
            /// </summary>
            public ChannelTypes.DashPlaylistSettings DashPlaylistSettings { get; set; }
            /// <summary>
            /// HlsPlaylistSettings
            ...
            /// </summary>
            public ChannelTypes.HlsPlaylistSettings HlsPlaylistSettings { get; set; }
            /// <summary>
            /// SourceGroup
        ...
        public class SlateSource : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// VodSourceName
