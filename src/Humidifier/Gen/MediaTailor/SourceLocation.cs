namespace Humidifier.MediaTailor
{
    ...
    public class SourceLocation : Humidifier.Base.BaseResource, IHaveImpliedResourceName, IHaveTags
    {
        ...
        /// </summary>
        public SourceLocationTypes.DefaultSegmentDeliveryConfiguration DefaultSegmentDeliveryConfiguration { get; set; }
        /// <summary>
        ...
        /// </summary>
        public SourceLocationTypes.AccessConfiguration AccessConfiguration { get; set; }
        /// <summary>
        /// Tags
    ...
    {
        public class AccessConfiguration : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            ...
            /// </summary>
            public SourceLocationTypes.SecretsManagerAccessTokenConfiguration SecretsManagerAccessTokenConfiguration { get; set; }
            /// <summary>
            /// AccessType
        ...
        public class DefaultSegmentDeliveryConfiguration : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// BaseUrl
        ...
        public class HttpConfiguration : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// BaseUrl
        ...
        public class SecretsManagerAccessTokenConfiguration : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// SecretArn
        ...
        public class SegmentDeliveryConfiguration : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// BaseUrl
