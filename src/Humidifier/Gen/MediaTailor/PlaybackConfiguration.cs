namespace Humidifier.MediaTailor
{
    ...
    public class PlaybackConfiguration : Humidifier.Base.BaseResource, IHaveImpliedResourceName, IHaveTags
    {
        ...
        /// Type: Bumper
        /// </summary>
        public PlaybackConfigurationTypes.Bumper Bumper { get; set; }
        /// <summary>
        /// DashConfiguration
        ...
        /// </summary>
        public PlaybackConfigurationTypes.DashConfiguration DashConfiguration { get; set; }
        /// <summary>
        /// CdnConfiguration
        ...
        /// </summary>
        public PlaybackConfigurationTypes.CdnConfiguration CdnConfiguration { get; set; }
        /// <summary>
        ...
        /// </summary>
        public PlaybackConfigurationTypes.ManifestProcessingRules ManifestProcessingRules { get; set; }
        /// <summary>
        ...
        /// </summary>
        public PlaybackConfigurationTypes.LivePreRollConfiguration LivePreRollConfiguration { get; set; }
        /// <summary>
        /// HlsConfiguration
        ...
        /// </summary>
        public PlaybackConfigurationTypes.AvailSuppression AvailSuppression { get; set; }
        /// <summary>
        /// Tags
    ...
    {
        public class AdMarkerPassthrough : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// Enabled
        ...
        public class AvailSuppression : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// Mode
        ...
        public class ManifestProcessingRules : Humidifier.Base.BaseSubResource
        {
            ...
            /// </summary>
            public PlaybackConfigurationTypes.AdMarkerPassthrough AdMarkerPassthrough { get; set; }
        }
    }
}