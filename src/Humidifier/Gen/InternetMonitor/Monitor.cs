namespace Humidifier.InternetMonitor
{
    ...
    public class Monitor : Humidifier.Base.BaseResource, IHaveImpliedResourceName, IHaveTags
    {
        ...
        /// </summary>
        public MonitorTypes.HealthEventsConfig HealthEventsConfig { get; set; }
        /// <summary>
        /// ResourcesToAdd
        ...
        /// </summary>
        public MonitorTypes.InternetMeasurementsLogDelivery InternetMeasurementsLogDelivery { get; set; }
    ...
    namespace MonitorTypes
    {
        public class HealthEventsConfig : Humidifier.Base.BaseSubResource
        {
            ...
            /// </summary>
            public MonitorTypes.LocalHealthEventsConfig AvailabilityLocalHealthEventsConfig { get; set; }
            /// <summary>
            ...
            /// Type: LocalHealthEventsConfig
            /// </summary>
            public MonitorTypes.LocalHealthEventsConfig PerformanceLocalHealthEventsConfig { get; set; }
            /// <summary>
        ...
        public class InternetMeasurementsLogDelivery : Humidifier.Base.BaseSubResource
        {
            ...
            /// Type: S3Config
            /// </summary>
            public MonitorTypes.S3Config S3Config { get; set; }
        }

        public class LocalHealthEventsConfig : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// Status
