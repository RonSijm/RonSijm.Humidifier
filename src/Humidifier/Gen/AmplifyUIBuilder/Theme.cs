namespace Humidifier.AmplifyUIBuilder
{
    ...
    public class Theme : Humidifier.Base.BaseResource, IHaveImpliedResourceName
    {
        ...
        /// </summary>
        public List<ThemeTypes.ThemeValues> Values { get; set; }
        /// <summary>
        /// Overrides
        ...
        /// ItemType: ThemeValues
        /// </summary>
        public List<ThemeTypes.ThemeValues> Overrides { get; set; }
        /// <summary>
        /// Tags
    ...
    {
        public class ThemeValue : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// Value
            ...
            /// ItemType: ThemeValues
            /// </summary>
            public List<ThemeTypes.ThemeValues> Children { get; set; }
        }

        public class ThemeValues : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// Value
            ...
            /// Type: ThemeValue
            /// </summary>
            public ThemeTypes.ThemeValue Value { get; set; }
            /// <summary>
            /// Key
