namespace Humidifier.ElasticLoadBalancingV2
{
    ...
    public class Listener : Humidifier.Base.BaseResource
    {
        ...
        /// </summary>
        public ListenerTypes.MutualAuthentication MutualAuthentication { get; set; }
        /// <summary>
        /// AlpnPolicy
        ...
        /// </summary>
        public List<ListenerTypes.Certificate> Certificates { get; set; }
        /// <summary>
        /// Protocol
    ...
    namespace ListenerTypes
    {
        public class Action : Humidifier.Base.BaseSubResource
        {
            ...
            /// </summary>
            public ListenerTypes.FixedResponseConfig FixedResponseConfig { get; set; }
            /// <summary>
            ...
            /// </summary>
            public ListenerTypes.AuthenticateCognitoConfig AuthenticateCognitoConfig { get; set; }
            /// <summary>
            /// Type
            ...
            /// Type: RedirectConfig
            /// </summary>
            public ListenerTypes.RedirectConfig RedirectConfig { get; set; }
            /// <summary>
            /// ForwardConfig
            ...
            /// Type: ForwardConfig
            /// </summary>
            public ListenerTypes.ForwardConfig ForwardConfig { get; set; }
            /// <summary>
            ...
            /// </summary>
            public ListenerTypes.AuthenticateOidcConfig AuthenticateOidcConfig { get; set; }
        }
        ...
        public class Certificate : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// CertificateArn
        ...
        public class ForwardConfig : Humidifier.Base.BaseSubResource
        {
            ...
            /// </summary>
            public ListenerTypes.TargetGroupStickinessConfig TargetGroupStickinessConfig { get; set; }
            /// <summary>
            /// TargetGroups
            ...
            /// </summary>
            public List<ListenerTypes.TargetGroupTuple> TargetGroups { get; set; }
        }

        public class MutualAuthentication : Humidifier.Base.BaseSubResource
        {
            /// <summary>
