namespace Humidifier.ElasticLoadBalancingV2
{
    ...
    public class TargetGroup : Humidifier.Base.BaseResource, IHaveTags, IHaveVpcId, IHaveImpliedResourceName
    {
        ...
        /// </summary>
        public List<TargetGroupTypes.TargetDescription> Targets { get; set; }
        /// <summary>
        /// HealthCheckEnabled
        ...
        /// </summary>
        public List<TargetGroupTypes.TargetGroupAttribute> TargetGroupAttributes { get; set; }
        /// <summary>
        /// TargetType
    ...
    namespace TargetGroupTypes
    {
        ...
        public class TargetDescription : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// Port
        ...
        public class TargetGroupAttribute : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// Value
