namespace Humidifier.ElasticLoadBalancingV2
{
    ...
    public class TrustStoreRevocation : Humidifier.Base.BaseResource
    {
        ...
        /// </summary>
        public List<TrustStoreRevocationTypes.RevocationContent> RevocationContents { get; set; }
        /// <summary>
        /// TrustStoreArn
    ...
    {
        public class RevocationContent : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// S3ObjectVersion
        ...
        public class TrustStoreRevocation : Humidifier.Base.BaseSubResource
        {
            /// <summary>
