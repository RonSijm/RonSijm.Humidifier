namespace Humidifier.ElasticLoadBalancingV2
{
    ...
    public class LoadBalancer : Humidifier.Base.BaseResource, IHaveImpliedResourceName, IHaveTags, IHaveSecurityGroups, IHaveSubnets
    {
        ...
        /// </summary>
        public List<LoadBalancerTypes.LoadBalancerAttribute> LoadBalancerAttributes { get; set; }
        /// <summary>
        /// Subnets
        ...
        /// </summary>
        public List<LoadBalancerTypes.SubnetMapping> SubnetMappings { get; set; }
    }

    namespace LoadBalancerTypes
    {
        public class LoadBalancerAttribute : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// Value
        ...
        public class SubnetMapping : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// AllocationId
