namespace Humidifier.Panorama
{
    ...
    public class Package : Humidifier.Base.BaseResource, IHaveImpliedResourceName, IHaveTags
    {
        ...
        /// </summary>
        public PackageTypes.StorageLocation StorageLocation { get; set; }
        /// <summary>
        /// Tags
    ...
    {
        public class StorageLocation : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// RepoPrefixLocation
