namespace Humidifier.Kinesis
{
    ...
    public class Stream : Humidifier.Base.BaseResource, IHaveImpliedResourceName, IHaveTags
    {
        ...
        /// </summary>
        public StreamTypes.StreamModeDetails StreamModeDetails { get; set; }
        /// <summary>
        /// StreamEncryption
        ...
        /// </summary>
        public StreamTypes.StreamEncryption StreamEncryption { get; set; }
        /// <summary>
    ...
    {
        public class StreamEncryption : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// EncryptionType
