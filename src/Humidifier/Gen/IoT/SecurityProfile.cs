namespace Humidifier.IoT
{
    ...
    public class SecurityProfile : Humidifier.Base.BaseResource, IHaveImpliedResourceName, IHaveTags, IHaveDescription
    {
        ...
        /// </summary>
        public List<SecurityProfileTypes.MetricToRetain> AdditionalMetricsToRetainV2 { get; set; }
        /// <summary>
        /// MetricsExportConfig
        ...
        /// </summary>
        public SecurityProfileTypes.MetricsExportConfig MetricsExportConfig { get; set; }
        /// <summary>
        ...
        /// ItemType: Behavior
        /// </summary>
        public List<SecurityProfileTypes.Behavior> Behaviors { get; set; }
        ...
        /// </summary>
        public Dictionary<string, SecurityProfileTypes.AlertTarget> AlertTargets { get; set; }
        /// <summary>
        /// TargetArns
    ...
    {
        public class AlertTarget : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// AlertTargetArn
        ...
        public class Behavior : Humidifier.Base.BaseSubResource
        {
            ...
            /// </summary>
            public SecurityProfileTypes.BehaviorCriteria Criteria { get; set; }
            /// <summary>
            /// MetricDimension
            ...
            /// </summary>
            public SecurityProfileTypes.MetricDimension MetricDimension { get; set; }
            /// <summary>
            /// Name
        ...
        public class BehaviorCriteria : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// ComparisonOperator
            ...
            /// </summary>
            public SecurityProfileTypes.MachineLearningDetectionConfig MlDetectionConfig { get; set; }
            /// <summary>
            /// Value
            ...
            /// Type: MetricValue
            /// </summary>
            public SecurityProfileTypes.MetricValue Value { get; set; }
            /// <summary>
            ...
            /// </summary>
            public SecurityProfileTypes.StatisticalThreshold StatisticalThreshold { get; set; }
            /// <summary>
            /// DurationSeconds
        ...
        public class MetricToRetain : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// ExportMetric
        ...
        public class MetricValue : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// Numbers
        ...
        public class MetricsExportConfig : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// MqttTopic
        ...
        public class StatisticalThreshold : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// Statistic
