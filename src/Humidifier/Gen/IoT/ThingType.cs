namespace Humidifier.IoT
{
    ...
    public class ThingType : Humidifier.Base.BaseResource, IHaveTags, IHaveImpliedResourceName
    {
        ...
        /// </summary>
        public ThingTypeTypes.ThingTypeProperties ThingTypeProperties { get; set; }
        /// <summary>
        /// Tags
