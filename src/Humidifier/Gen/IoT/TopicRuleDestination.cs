namespace Humidifier.IoT
{
    ...
    public class TopicRuleDestination : Humidifier.Base.BaseResource
    {
        ...
        /// </summary>
        public TopicRuleDestinationTypes.HttpUrlDestinationSummary HttpUrlProperties { get; set; }
        /// <summary>
        /// VpcProperties
        ...
        /// </summary>
        public TopicRuleDestinationTypes.VpcDestinationProperties VpcProperties { get; set; }
    }
