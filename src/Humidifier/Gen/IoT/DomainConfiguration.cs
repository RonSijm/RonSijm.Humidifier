namespace Humidifier.IoT
{
    ...
    public class DomainConfiguration : Humidifier.Base.BaseResource, IHaveImpliedResourceName, IHaveTags
    {
        ...
        /// Type: TlsConfig
        /// </summary>
        public DomainConfigurationTypes.TlsConfig TlsConfig { get; set; }
        /// <summary>
        ...
        /// </summary>
        public DomainConfigurationTypes.ServerCertificateConfig ServerCertificateConfig { get; set; }
        /// <summary>
        /// AuthorizerConfig
        ...
        /// </summary>
        public DomainConfigurationTypes.AuthorizerConfig AuthorizerConfig { get; set; }
        /// <summary>
        /// Tags
