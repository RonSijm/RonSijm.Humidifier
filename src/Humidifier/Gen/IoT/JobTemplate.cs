namespace Humidifier.IoT
{
    ...
    public class JobTemplate : Humidifier.Base.BaseResource, IHaveTags, IHaveDescription
    {
        ...
        /// </summary>
        public JobTemplateTypes.JobExecutionsRetryConfig JobExecutionsRetryConfig { get; set; }
        /// <summary>
        /// AbortConfig
        ...
        /// </summary>
        public JobTemplateTypes.JobExecutionsRolloutConfig JobExecutionsRolloutConfig { get; set; }
        /// <summary>
        /// DocumentSource
        ...
        /// </summary>
        public List<JobTemplateTypes.MaintenanceWindow> MaintenanceWindows { get; set; }
        /// <summary>
        /// PresignedUrlConfig
        ...
        /// </summary>
        public JobTemplateTypes.PresignedUrlConfig PresignedUrlConfig { get; set; }
        /// <summary>
        /// Tags
    ...
    namespace JobTemplateTypes
    {
        public class AbortConfig : Humidifier.Base.BaseSubResource
        {
            ...
            /// </summary>
            public List<JobTemplateTypes.AbortCriteria> CriteriaList { get; set; }
        }

        public class AbortCriteria : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// Action
        ...
        public class ExponentialRolloutRate : Humidifier.Base.BaseSubResource
        {
            ...
            /// </summary>
            public JobTemplateTypes.RateIncreaseCriteria RateIncreaseCriteria { get; set; }
            /// <summary>
            /// BaseRatePerMinute
        ...
        public class JobExecutionsRetryConfig : Humidifier.Base.BaseSubResource
        {
            ...
            /// </summary>
            public List<JobTemplateTypes.RetryCriteria> RetryCriteriaList { get; set; }
        }
        ...
        public class JobExecutionsRolloutConfig : Humidifier.Base.BaseSubResource
        {
            ...
            /// </summary>
            public JobTemplateTypes.ExponentialRolloutRate ExponentialRolloutRate { get; set; }
        }

        public class MaintenanceWindow : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// DurationInMinutes
        ...
        public class PresignedUrlConfig : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// ExpiresInSec
        ...
        public class RetryCriteria : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// FailureType
