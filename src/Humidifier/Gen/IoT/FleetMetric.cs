namespace Humidifier.IoT
{
    ...
    public class FleetMetric : Humidifier.Base.BaseResource, IHaveTags, IHaveDescription
    {
        ...
        /// </summary>
        public FleetMetricTypes.AggregationType AggregationType { get; set; }
        /// <summary>
        /// AggregationField
    ...
    {
        public class AggregationType : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// Values
