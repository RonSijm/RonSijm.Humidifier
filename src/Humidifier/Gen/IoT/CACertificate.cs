namespace Humidifier.IoT
{
    ...
    public class CACertificate : Humidifier.Base.BaseResource, IHaveTags
    {
        ...
        /// </summary>
        public CACertificateTypes.RegistrationConfig RegistrationConfig { get; set; }
        /// <summary>
    ...
    {
        public class RegistrationConfig : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// TemplateName
