namespace Humidifier.IoT
{
    ...
    public class ProvisioningTemplate : Humidifier.Base.BaseResource, IHaveTags, IHaveDescription
    {
        ...
        /// </summary>
        public ProvisioningTemplateTypes.ProvisioningHook PreProvisioningHook { get; set; }
        /// <summary>
        /// TemplateName
    ...
    {
        public class ProvisioningHook : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// TargetArn
