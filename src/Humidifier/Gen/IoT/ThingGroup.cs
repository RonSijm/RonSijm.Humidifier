namespace Humidifier.IoT
{
    ...
    public class ThingGroup : Humidifier.Base.BaseResource, IHaveImpliedResourceName, IHaveTags
    {
        ...
        /// </summary>
        public ThingGroupTypes.ThingGroupProperties ThingGroupProperties { get; set; }
        /// <summary>
        /// QueryString
    ...
    namespace ThingGroupTypes
    {
        ...
        public class ThingGroupProperties : Humidifier.Base.BaseSubResource
        {
            ...
            /// </summary>
            public ThingGroupTypes.AttributePayload AttributePayload { get; set; }
            /// <summary>
