namespace Humidifier.IoT
{
    ...
    public class BillingGroup : Humidifier.Base.BaseResource, IHaveTags, IHaveImpliedResourceName
    {
        ...
        /// </summary>
        public BillingGroupTypes.BillingGroupProperties BillingGroupProperties { get; set; }
        /// <summary>
        /// Tags
