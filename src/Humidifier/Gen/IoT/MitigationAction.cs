namespace Humidifier.IoT
{
    ...
    public class MitigationAction : Humidifier.Base.BaseResource, IHaveTags
    {
    ...
    namespace MitigationActionTypes
    {
        public class ActionParams : Humidifier.Base.BaseSubResource
        {
            ...
            /// </summary>
            public MitigationActionTypes.UpdateDeviceCertificateParams UpdateDeviceCertificateParams { get; set; }
            /// <summary>
            ...
            /// </summary>
            public MitigationActionTypes.AddThingsToThingGroupParams AddThingsToThingGroupParams { get; set; }
            /// <summary>
            ...
            /// </summary>
            public MitigationActionTypes.PublishFindingToSnsParams PublishFindingToSnsParams { get; set; }
            /// <summary>
            ...
            /// </summary>
            public MitigationActionTypes.EnableIoTLoggingParams EnableIoTLoggingParams { get; set; }
            /// <summary>
            ...
            /// </summary>
            public MitigationActionTypes.ReplaceDefaultPolicyVersionParams ReplaceDefaultPolicyVersionParams { get; set; }
            /// <summary>
            ...
            /// </summary>
            public MitigationActionTypes.UpdateCACertificateParams UpdateCACertificateParams { get; set; }
        }
        ...
        public class EnableIoTLoggingParams : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// RoleArnForLogging
        ...
        public class PublishFindingToSnsParams : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// TopicArn
        ...
        public class ReplaceDefaultPolicyVersionParams : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// TemplateName
        ...
        public class UpdateCACertificateParams : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// Action
        ...
        public class UpdateDeviceCertificateParams : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// Action
