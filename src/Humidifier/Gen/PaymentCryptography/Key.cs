namespace Humidifier.PaymentCryptography
{
    ...
    public class Key : Humidifier.Base.BaseResource, IHaveTags
    {
    ...
    namespace KeyTypes
    {
        public class KeyAttributes : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// KeyClass
            ...
            /// Type: KeyModesOfUse
            /// </summary>
            public KeyTypes.KeyModesOfUse KeyModesOfUse { get; set; }
            /// <summary>
            /// KeyAlgorithm
