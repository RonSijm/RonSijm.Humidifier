namespace Humidifier.ECS
{
    ...
    public class Cluster : Humidifier.Base.BaseResource, IHaveImpliedResourceName, IHaveTags
    {
        ...
        /// </summary>
        public List<ClusterTypes.ClusterSettings> ClusterSettings { get; set; }
        /// <summary>
        ...
        /// </summary>
        public List<ClusterTypes.CapacityProviderStrategyItem> DefaultCapacityProviderStrategy { get; set; }
        /// <summary>
        /// Configuration
        ...
        /// </summary>
        public ClusterTypes.ClusterConfiguration Configuration { get; set; }
        /// <summary>
        ...
        /// </summary>
        public ClusterTypes.ServiceConnectDefaults ServiceConnectDefaults { get; set; }
        /// <summary>
        /// CapacityProviders
    ...
    namespace ClusterTypes
    {
        ...
        public class ClusterConfiguration : Humidifier.Base.BaseSubResource
        {
            ...
            /// </summary>
            public ClusterTypes.ManagedStorageConfiguration ManagedStorageConfiguration { get; set; }
            /// <summary>
            ...
            /// </summary>
            public ClusterTypes.ExecuteCommandConfiguration ExecuteCommandConfiguration { get; set; }
        }

        public class ClusterSettings : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// Value
        ...
        public class ExecuteCommandConfiguration : Humidifier.Base.BaseSubResource
        {
            ...
            /// </summary>
            public ClusterTypes.ExecuteCommandLogConfiguration LogConfiguration { get; set; }
        }

        public class ExecuteCommandLogConfiguration : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// S3EncryptionEnabled
