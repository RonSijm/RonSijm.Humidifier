namespace Humidifier.ECS
{
    ...
    public class TaskSet : Humidifier.Base.BaseResource, IHaveTags
    {
        ...
        /// </summary>
        public TaskSetTypes.NetworkConfiguration NetworkConfiguration { get; set; }
        /// <summary>
        /// Scale
        ...
        /// Type: Scale
        /// </summary>
        public TaskSetTypes.Scale Scale { get; set; }
        /// <summary>
        /// ServiceRegistries
        ...
        /// </summary>
        public List<TaskSetTypes.ServiceRegistry> ServiceRegistries { get; set; }
        /// <summary>
        /// LaunchType
    ...
    namespace TaskSetTypes
    {
        ...
        public class NetworkConfiguration : Humidifier.Base.BaseSubResource
        {
            ...
            /// </summary>
            public TaskSetTypes.AwsVpcConfiguration AwsVpcConfiguration { get; set; }
        }

        public class Scale : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// Value
