namespace Humidifier.SageMaker
{
    ...
    namespace ProjectTypes
    {
        ...
        public class ServiceCatalogProvisioningDetails : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// PathId
            ...
            /// </summary>
            public List<ProjectTypes.ProvisioningParameter> ProvisioningParameters { get; set; }
            /// <summary>
            /// ProductId
