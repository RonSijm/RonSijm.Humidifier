namespace Humidifier.SageMaker
{
    ...
    public class Endpoint : Humidifier.Base.BaseResource, IHaveImpliedResourceName, IHaveTags
    {
        ...
        /// </summary>
        public EndpointTypes.DeploymentConfig DeploymentConfig { get; set; }
        /// <summary>
    ...
    namespace EndpointTypes
    {
        ...
        public class AutoRollbackConfig : Humidifier.Base.BaseSubResource
        {
            ...
            /// ItemType: Alarm
            /// </summary>
            public List<EndpointTypes.Alarm> Alarms { get; set; }
        }
        ...
        public class BlueGreenUpdatePolicy : Humidifier.Base.BaseSubResource
        {
            ...
            /// </summary>
            public EndpointTypes.TrafficRoutingConfig TrafficRoutingConfiguration { get; set; }
        }

        public class CapacitySize : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// Type
        ...
        public class DeploymentConfig : Humidifier.Base.BaseSubResource
        {
            ...
            /// </summary>
            public EndpointTypes.AutoRollbackConfig AutoRollbackConfiguration { get; set; }
            /// <summary>
            /// RollingUpdatePolicy
            ...
            /// </summary>
            public EndpointTypes.RollingUpdatePolicy RollingUpdatePolicy { get; set; }
            /// <summary>
            ...
            /// </summary>
            public EndpointTypes.BlueGreenUpdatePolicy BlueGreenUpdatePolicy { get; set; }
        }
        ...
        public class RollingUpdatePolicy : Humidifier.Base.BaseSubResource
        {
            ...
            /// Type: CapacitySize
            /// </summary>
            public EndpointTypes.CapacitySize MaximumBatchSize { get; set; }
            /// <summary>
            ...
            /// Type: CapacitySize
            /// </summary>
            public EndpointTypes.CapacitySize RollbackMaximumBatchSize { get; set; }
        }

        public class TrafficRoutingConfig : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// Type
            ...
            /// Type: CapacitySize
            /// </summary>
            public EndpointTypes.CapacitySize LinearStepSize { get; set; }
            /// <summary>
            /// CanarySize
            ...
            /// Type: CapacitySize
            /// </summary>
            public EndpointTypes.CapacitySize CanarySize { get; set; }
            /// <summary>
            /// WaitIntervalInSeconds
