namespace Humidifier.SageMaker
{
    ...
    public class ModelBiasJobDefinition : Humidifier.Base.BaseResource, IHaveTags
    {
        ...
        /// </summary>
        public ModelBiasJobDefinitionTypes.StoppingCondition StoppingCondition { get; set; }
        /// <summary>
        /// JobDefinitionName
        ...
        /// Type: NetworkConfig
        /// </summary>
        public ModelBiasJobDefinitionTypes.NetworkConfig NetworkConfig { get; set; }
        /// <summary>
    ...
    namespace ModelBiasJobDefinitionTypes
    {
        public class BatchTransformInput : Humidifier.Base.BaseSubResource
        {
            ...
            /// Type: DatasetFormat
            /// </summary>
            public ModelBiasJobDefinitionTypes.DatasetFormat DatasetFormat { get; set; }
            /// <summary>
        ...
        public class DatasetFormat : Humidifier.Base.BaseSubResource
        {
            ...
            /// Type: Csv
            /// </summary>
            public ModelBiasJobDefinitionTypes.Csv Csv { get; set; }
            /// <summary>
            /// Json
            ...
            /// Type: Json
            /// </summary>
            public ModelBiasJobDefinitionTypes.Json Json { get; set; }
        }
        ...
        public class ModelBiasAppSpecification : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// ConfigUri
        ...
        public class ModelBiasBaselineConfig : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// ConstraintsResource
            ...
            /// </summary>
            public ModelBiasJobDefinitionTypes.ConstraintsResource ConstraintsResource { get; set; }
            /// <summary>
            /// BaseliningJobName
        ...
        public class ModelBiasJobInput : Humidifier.Base.BaseSubResource
        {
            ...
            /// </summary>
            public ModelBiasJobDefinitionTypes.MonitoringGroundTruthS3Input GroundTruthS3Input { get; set; }
            /// <summary>
            /// BatchTransformInput
            ...
            /// </summary>
            public ModelBiasJobDefinitionTypes.BatchTransformInput BatchTransformInput { get; set; }
            /// <summary>
            /// EndpointInput
            ...
            /// Type: EndpointInput
            /// </summary>
            public ModelBiasJobDefinitionTypes.EndpointInput EndpointInput { get; set; }
        }
        ...
        public class MonitoringOutput : Humidifier.Base.BaseSubResource
        {
            ...
            /// Type: S3Output
            /// </summary>
            public ModelBiasJobDefinitionTypes.S3Output S3Output { get; set; }
        }
        ...
        public class MonitoringOutputConfig : Humidifier.Base.BaseSubResource
        {
            ...
            /// </summary>
            public List<ModelBiasJobDefinitionTypes.MonitoringOutput> MonitoringOutputs { get; set; }
        }
        ...
        public class MonitoringResources : Humidifier.Base.BaseSubResource
        {
            ...
            /// Type: ClusterConfig
            /// </summary>
            public ModelBiasJobDefinitionTypes.ClusterConfig ClusterConfig { get; set; }
        }
        ...
        public class NetworkConfig : Humidifier.Base.BaseSubResource
        {
            ...
            /// Type: VpcConfig
            /// </summary>
            public ModelBiasJobDefinitionTypes.VpcConfig VpcConfig { get; set; }
        }
