namespace Humidifier.SageMaker
{
    ...
    public class AppImageConfig : Humidifier.Base.BaseResource, IHaveTags, IHaveImpliedResourceName
    {
        ...
        /// </summary>
        public AppImageConfigTypes.KernelGatewayImageConfig KernelGatewayImageConfig { get; set; }
        /// <summary>
        ...
        /// </summary>
        public AppImageConfigTypes.CodeEditorAppImageConfig CodeEditorAppImageConfig { get; set; }
        ...
        /// </summary>
        public AppImageConfigTypes.JupyterLabAppImageConfig JupyterLabAppImageConfig { get; set; }
        /// <summary>
        /// Tags
    ...
    namespace AppImageConfigTypes
    {
        public class CodeEditorAppImageConfig : Humidifier.Base.BaseSubResource
        {
            ...
            /// </summary>
            public AppImageConfigTypes.ContainerConfig ContainerConfig { get; set; }
        }

        public class ContainerConfig : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// ContainerEntrypoint
            ...
            /// </summary>
            public List<AppImageConfigTypes.CustomImageContainerEnvironmentVariable> ContainerEnvironmentVariables { get; set; }
            /// <summary>
            /// ContainerArguments
        ...
        public class CustomImageContainerEnvironmentVariable : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// Value
        ...
        public class KernelGatewayImageConfig : Humidifier.Base.BaseSubResource
        {
            ...
            /// ItemType: KernelSpec
            /// </summary>
            public List<AppImageConfigTypes.KernelSpec> KernelSpecs { get; set; }
            /// <summary>
            /// FileSystemConfig
            ...
            /// </summary>
            public AppImageConfigTypes.FileSystemConfig FileSystemConfig { get; set; }
        }

        public class KernelSpec : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// DisplayName
