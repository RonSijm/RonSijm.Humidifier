namespace Humidifier.SageMaker
{
    ...
    public class ModelExplainabilityJobDefinition : Humidifier.Base.BaseResource, IHaveTags
    {
        ...
        /// </summary>
        public ModelExplainabilityJobDefinitionTypes.StoppingCondition StoppingCondition { get; set; }
        /// <summary>
        ...
        /// </summary>
        public ModelExplainabilityJobDefinitionTypes.ModelExplainabilityBaselineConfig ModelExplainabilityBaselineConfig { get; set; }
        /// <summary>
        /// JobDefinitionName
    ...
    namespace ModelExplainabilityJobDefinitionTypes
    {
        public class BatchTransformInput : Humidifier.Base.BaseSubResource
        {
            ...
            /// Type: DatasetFormat
            /// </summary>
            public ModelExplainabilityJobDefinitionTypes.DatasetFormat DatasetFormat { get; set; }
            /// <summary>
        ...
        public class DatasetFormat : Humidifier.Base.BaseSubResource
        {
            ...
            /// Type: Csv
            /// </summary>
            public ModelExplainabilityJobDefinitionTypes.Csv Csv { get; set; }
            /// <summary>
            /// Json
            ...
            /// Type: Json
            /// </summary>
            public ModelExplainabilityJobDefinitionTypes.Json Json { get; set; }
        }
        ...
        public class ModelExplainabilityAppSpecification : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// ConfigUri
        ...
        public class ModelExplainabilityBaselineConfig : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// ConstraintsResource
            ...
            /// </summary>
            public ModelExplainabilityJobDefinitionTypes.ConstraintsResource ConstraintsResource { get; set; }
            /// <summary>
            /// BaseliningJobName
        ...
        public class ModelExplainabilityJobInput : Humidifier.Base.BaseSubResource
        {
            ...
            /// </summary>
            public ModelExplainabilityJobDefinitionTypes.BatchTransformInput BatchTransformInput { get; set; }
            /// <summary>
            /// EndpointInput
            ...
            /// Type: EndpointInput
            /// </summary>
            public ModelExplainabilityJobDefinitionTypes.EndpointInput EndpointInput { get; set; }
        }
        ...
        public class MonitoringOutputConfig : Humidifier.Base.BaseSubResource, IHaveKmsKeyId
        {
            ...
            /// </summary>
            public List<ModelExplainabilityJobDefinitionTypes.MonitoringOutput> MonitoringOutputs { get; set; }
        }
        ...
        public class MonitoringResources : Humidifier.Base.BaseSubResource
        {
            ...
            /// Type: ClusterConfig
            /// </summary>
            public ModelExplainabilityJobDefinitionTypes.ClusterConfig ClusterConfig { get; set; }
        }
        ...
        public class NetworkConfig : Humidifier.Base.BaseSubResource
        {
            ...
            /// Type: VpcConfig
            /// </summary>
            public ModelExplainabilityJobDefinitionTypes.VpcConfig VpcConfig { get; set; }
        }
