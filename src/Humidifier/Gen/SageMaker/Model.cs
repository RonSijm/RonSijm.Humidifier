namespace Humidifier.SageMaker
{
    ...
    public class Model : Humidifier.Base.BaseResource, IHaveTags, IHaveImpliedResourceName
    {
        ...
        /// </summary>
        public ModelTypes.ContainerDefinition PrimaryContainer { get; set; }
        ...
        /// Type: VpcConfig
        /// </summary>
        public ModelTypes.VpcConfig VpcConfig { get; set; }
        /// <summary>
        /// Containers
        ...
        /// </summary>
        public List<ModelTypes.ContainerDefinition> Containers { get; set; }
        /// <summary>
        ...
        /// </summary>
        public ModelTypes.InferenceExecutionConfig InferenceExecutionConfig { get; set; }
        /// <summary>
        /// Tags
    ...
    namespace ModelTypes
    {
        public class ContainerDefinition : Humidifier.Base.BaseSubResource
        {
            ...
            /// Type: ImageConfig
            /// </summary>
            public ModelTypes.ImageConfig ImageConfig { get; set; }
            /// <summary>
            ...
            /// </summary>
            public ModelTypes.ModelDataSource ModelDataSource { get; set; }
            /// <summary>
            /// MultiModelConfig
            ...
            /// </summary>
            public ModelTypes.MultiModelConfig MultiModelConfig { get; set; }
        }
        ...
        public class ImageConfig : Humidifier.Base.BaseSubResource
        {
            ...
            /// </summary>
            public ModelTypes.RepositoryAuthConfig RepositoryAuthConfig { get; set; }
            /// <summary>
        ...
        public class InferenceExecutionConfig : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// Mode
        ...
        public class ModelDataSource : Humidifier.Base.BaseSubResource
        {
            ...
            /// Type: S3DataSource
            /// </summary>
            public ModelTypes.S3DataSource S3DataSource { get; set; }
        }
        ...
        public class S3DataSource : Humidifier.Base.BaseSubResource
        {
            ...
            /// </summary>
            public ModelTypes.ModelAccessConfig ModelAccessConfig { get; set; }
            /// <summary>
            /// S3Uri
            ...
            /// </summary>
            public ModelTypes.HubAccessConfig HubAccessConfig { get; set; }
        }
