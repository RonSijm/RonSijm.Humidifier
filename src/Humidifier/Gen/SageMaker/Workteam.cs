namespace Humidifier.SageMaker
{
    ...
    public class Workteam : Humidifier.Base.BaseResource, IHaveTags, IHaveDescription, IHaveImpliedResourceName
    {
        ...
        /// </summary>
        public WorkteamTypes.NotificationConfiguration NotificationConfiguration { get; set; }
        ...
        /// </summary>
        public List<WorkteamTypes.MemberDefinition> MemberDefinitions { get; set; }
        /// <summary>
        /// WorkforceName
    ...
    namespace WorkteamTypes
    {
        ...
        public class MemberDefinition : Humidifier.Base.BaseSubResource
        {
            ...
            /// </summary>
            public WorkteamTypes.OidcMemberDefinition OidcMemberDefinition { get; set; }
            /// <summary>
            ...
            /// </summary>
            public WorkteamTypes.CognitoMemberDefinition CognitoMemberDefinition { get; set; }
        }
