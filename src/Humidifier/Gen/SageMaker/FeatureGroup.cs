namespace Humidifier.SageMaker
{
    ...
    public class FeatureGroup : Humidifier.Base.BaseResource, IHaveImpliedResourceName, IHaveTags, IHaveDescription
    {
        ...
        /// </summary>
        public FeatureGroupTypes.ThroughputConfig ThroughputConfig { get; set; }
        /// <summary>
        /// Description
        ...
        /// </summary>
        public FeatureGroupTypes.OnlineStoreConfig OnlineStoreConfig { get; set; }
        /// <summary>
        /// RoleArn
    ...
    {
        public class DataCatalogConfig : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// TableName
        ...
        public class FeatureDefinition : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// FeatureType
        ...
        public class OfflineStoreConfig : Humidifier.Base.BaseSubResource
        {
            ...
            /// </summary>
            public FeatureGroupTypes.DataCatalogConfig DataCatalogConfig { get; set; }
            /// <summary>
            /// S3StorageConfig
            ...
            /// </summary>
            public FeatureGroupTypes.S3StorageConfig S3StorageConfig { get; set; }
            /// <summary>
        ...
        public class OnlineStoreConfig : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// EnableOnlineStore
            ...
            /// </summary>
            public FeatureGroupTypes.OnlineStoreSecurityConfig SecurityConfig { get; set; }
            /// <summary>
            /// TtlDuration
        ...
        public class TtlDuration : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// Value
