namespace Humidifier.SageMaker
{
    ...
    public class InferenceExperiment : Humidifier.Base.BaseResource, IHaveTags, IHaveDescription, IHaveImpliedResourceName
    {
        ...
        /// </summary>
        public InferenceExperimentTypes.DataStorageConfig DataStorageConfig { get; set; }
        /// <summary>
        /// Description
        ...
        /// </summary>
        public InferenceExperimentTypes.InferenceExperimentSchedule Schedule { get; set; }
        /// <summary>
        /// KmsKey
    ...
    namespace InferenceExperimentTypes
    {
        ...
        public class DataStorageConfig : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// Destination
            ...
            /// </summary>
            public InferenceExperimentTypes.CaptureContentTypeHeader ContentType { get; set; }
            /// <summary>
            /// KmsKey
        ...
        public class EndpointMetadata : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// EndpointStatus
        ...
        public class InferenceExperimentSchedule : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// EndTime
        ...
        public class ModelInfrastructureConfig : Humidifier.Base.BaseSubResource
        {
            ...
            /// </summary>
            public InferenceExperimentTypes.RealTimeInferenceConfig RealTimeInferenceConfig { get; set; }
        }

        public class ModelVariantConfig : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// ModelName
            ...
            /// </summary>
            public InferenceExperimentTypes.ModelInfrastructureConfig InfrastructureConfig { get; set; }
        }

        public class RealTimeInferenceConfig : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// InstanceCount
        ...
        public class ShadowModeConfig : Humidifier.Base.BaseSubResource
        {
            ...
            /// </summary>
            public List<InferenceExperimentTypes.ShadowModelVariantConfig> ShadowModelVariants { get; set; }
        }
