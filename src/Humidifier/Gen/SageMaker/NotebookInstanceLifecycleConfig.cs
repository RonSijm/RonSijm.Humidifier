namespace Humidifier.SageMaker
{
    ...
    public class NotebookInstanceLifecycleConfig : Humidifier.Base.BaseResource, IHaveImpliedResourceName
    {
        ...
        /// </summary>
        public List<NotebookInstanceLifecycleConfigTypes.NotebookInstanceLifecycleHook> OnStart { get; set; }
        ...
        /// ItemType: NotebookInstanceLifecycleHook
        /// </summary>
        public List<NotebookInstanceLifecycleConfigTypes.NotebookInstanceLifecycleHook> OnCreate { get; set; }
    }

    namespace NotebookInstanceLifecycleConfigTypes
    {
        public class NotebookInstanceLifecycleHook : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// Content
