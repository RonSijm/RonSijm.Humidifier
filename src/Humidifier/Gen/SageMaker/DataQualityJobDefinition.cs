namespace Humidifier.SageMaker
{
    ...
    public class DataQualityJobDefinition : Humidifier.Base.BaseResource, IHaveTags
    {
        ...
        /// </summary>
        public DataQualityJobDefinitionTypes.StoppingCondition StoppingCondition { get; set; }
        /// <summary>
        /// JobDefinitionName
    ...
    namespace DataQualityJobDefinitionTypes
    {
        public class BatchTransformInput : Humidifier.Base.BaseSubResource
        {
            ...
            /// Type: DatasetFormat
            /// </summary>
            public DataQualityJobDefinitionTypes.DatasetFormat DatasetFormat { get; set; }
            /// <summary>
        ...
        public class DataQualityAppSpecification : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// ContainerEntrypoint
        ...
        public class DataQualityBaselineConfig : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// StatisticsResource
            ...
            /// </summary>
            public DataQualityJobDefinitionTypes.StatisticsResource StatisticsResource { get; set; }
            /// <summary>
            /// ConstraintsResource
            ...
            /// </summary>
            public DataQualityJobDefinitionTypes.ConstraintsResource ConstraintsResource { get; set; }
            /// <summary>
            /// BaseliningJobName
        ...
        public class DataQualityJobInput : Humidifier.Base.BaseSubResource
        {
            ...
            /// </summary>
            public DataQualityJobDefinitionTypes.BatchTransformInput BatchTransformInput { get; set; }
            /// <summary>
            /// EndpointInput
            ...
            /// Type: EndpointInput
            /// </summary>
            public DataQualityJobDefinitionTypes.EndpointInput EndpointInput { get; set; }
        }
        ...
        public class DatasetFormat : Humidifier.Base.BaseSubResource
        {
            ...
            /// Type: Csv
            /// </summary>
            public DataQualityJobDefinitionTypes.Csv Csv { get; set; }
            /// <summary>
            /// Json
            ...
            /// Type: Json
            /// </summary>
            public DataQualityJobDefinitionTypes.Json Json { get; set; }
        }
        ...
        public class MonitoringOutput : Humidifier.Base.BaseSubResource
        {
            ...
            /// Type: S3Output
            /// </summary>
            public DataQualityJobDefinitionTypes.S3Output S3Output { get; set; }
        }
        ...
        public class MonitoringOutputConfig : Humidifier.Base.BaseSubResource
        {
            ...
            /// </summary>
            public List<DataQualityJobDefinitionTypes.MonitoringOutput> MonitoringOutputs { get; set; }
        }
        ...
        public class MonitoringResources : Humidifier.Base.BaseSubResource
        {
            ...
            /// Type: ClusterConfig
            /// </summary>
            public DataQualityJobDefinitionTypes.ClusterConfig ClusterConfig { get; set; }
        }
        ...
        public class NetworkConfig : Humidifier.Base.BaseSubResource
        {
            ...
            /// Type: VpcConfig
            /// </summary>
            public DataQualityJobDefinitionTypes.VpcConfig VpcConfig { get; set; }
        }
