namespace Humidifier.Omics
{
    ...
    public class SequenceStore : Humidifier.Base.BaseResource, IHaveImpliedResourceName, IHaveDescription
    {
        ...
        /// Type: SseConfig
        /// </summary>
        public SequenceStoreTypes.SseConfig SseConfig { get; set; }
        /// <summary>
        /// Tags
