namespace Humidifier.Omics
{
    ...
    public class AnnotationStore : Humidifier.Base.BaseResource, IHaveImpliedResourceName, IHaveDescription
    {
        ...
        /// Type: ReferenceItem
        /// </summary>
        public AnnotationStoreTypes.ReferenceItem Reference { get; set; }
        /// <summary>
        /// SseConfig
        ...
        /// Type: SseConfig
        /// </summary>
        public AnnotationStoreTypes.SseConfig SseConfig { get; set; }
        /// <summary>
        /// StoreOptions
        ...
        /// Type: StoreOptions
        /// </summary>
        public AnnotationStoreTypes.StoreOptions StoreOptions { get; set; }
        /// <summary>
        /// Tags
    ...
    {
        public class ReferenceItem : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// ReferenceArn
        ...
        public class SseConfig : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// Type
        ...
        public class StoreOptions : Humidifier.Base.BaseSubResource
        {
            ...
            /// </summary>
            public AnnotationStoreTypes.TsvStoreOptions TsvStoreOptions { get; set; }
        }

        public class TsvStoreOptions : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// Schema
