namespace Humidifier.Route53Resolver
{
    ...
    public class FirewallRuleGroup : Humidifier.Base.BaseResource, IHaveTags, IHaveImpliedResourceName
    {
        ...
        /// </summary>
        public List<FirewallRuleGroupTypes.FirewallRule> FirewallRules { get; set; }
        /// <summary>
        /// Tags
    ...
    {
        public class FirewallRule : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// Qtype
