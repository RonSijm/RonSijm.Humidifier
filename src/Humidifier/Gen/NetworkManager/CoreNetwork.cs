namespace Humidifier.NetworkManager
{
    ...
    public class CoreNetwork : Humidifier.Base.BaseResource, IHaveTags, IHaveDescription, IHavePolicyDocument
    {
    ...
    {
        public class CoreNetworkEdge : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// InsideCidrBlocks
        ...
        public class CoreNetworkSegment : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// EdgeLocations
