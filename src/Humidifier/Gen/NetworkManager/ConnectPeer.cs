namespace Humidifier.NetworkManager
{
    ...
    public class ConnectPeer : Humidifier.Base.BaseResource, IHaveTags
    {
        ...
        /// Type: BgpOptions
        /// </summary>
        public ConnectPeerTypes.BgpOptions BgpOptions { get; set; }
        /// <summary>
        /// InsideCidrBlocks
    ...
    namespace ConnectPeerTypes
    {
        ...
        public class ConnectPeerBgpConfiguration : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// PeerAddress
        ...
        public class ConnectPeerConfiguration : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// BgpConfigurations
            ...
            /// </summary>
            public List<ConnectPeerTypes.ConnectPeerBgpConfiguration> BgpConfigurations { get; set; }
            /// <summary>
            /// PeerAddress
