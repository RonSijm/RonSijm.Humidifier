namespace Humidifier.NetworkManager
{
    ...
    public class Device : Humidifier.Base.BaseResource, IHaveTags, IHaveDescription
    {
        ...
        /// Type: AWSLocation
        /// </summary>
        public DeviceTypes.AWSLocation AWSLocation { get; set; }
        /// <summary>
        /// Type
        ...
        /// Type: Location
        /// </summary>
        public DeviceTypes.Location Location { get; set; }
    }

    namespace DeviceTypes
    {
        public class AWSLocation : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// Zone
