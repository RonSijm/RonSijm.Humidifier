namespace Humidifier.Config
{
    ...
    public class ConformancePack : Humidifier.Base.BaseResource, IHaveImpliedResourceName
    {
        ...
        /// </summary>
        public List<ConformancePackTypes.ConformancePackInputParameter> ConformancePackInputParameters { get; set; }
        /// <summary>
        ...
        /// </summary>
        public ConformancePackTypes.TemplateSSMDocumentDetails TemplateSSMDocumentDetails { get; set; }
        /// <summary>
        /// DeliveryS3Bucket
    ...
    {
        public class ConformancePackInputParameter : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// ParameterValue
        ...
        public class TemplateSSMDocumentDetails : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// DocumentVersion
