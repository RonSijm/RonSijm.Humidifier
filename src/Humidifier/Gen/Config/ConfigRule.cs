namespace Humidifier.Config
{
    ...
    public class ConfigRule : Humidifier.Base.BaseResource, IHaveDescription, IHaveImpliedResourceName
    {
        ...
        /// </summary>
        public List<ConfigRuleTypes.EvaluationModeConfiguration> EvaluationModes { get; set; }
        /// <summary>
        /// Description
        ...
        /// Type: Scope
        /// </summary>
        public ConfigRuleTypes.Scope Scope { get; set; }
        /// <summary>
        /// Compliance
        ...
        /// Type: Compliance
        /// </summary>
        public ConfigRuleTypes.Compliance Compliance { get; set; }
    ...
    {
        public class Compliance : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// Type
        ...
        public class EvaluationModeConfiguration : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// Mode
        ...
        public class Source : Humidifier.Base.BaseSubResource
        {
            ...
            /// </summary>
            public ConfigRuleTypes.CustomPolicyDetails CustomPolicyDetails { get; set; }
            /// <summary>
            /// SourceIdentifier
            ...
            /// </summary>
            public List<ConfigRuleTypes.SourceDetail> SourceDetails { get; set; }
        }

        public class SourceDetail : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// EventSource
