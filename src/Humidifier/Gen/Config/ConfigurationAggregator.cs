namespace Humidifier.Config
{
    ...
    public class ConfigurationAggregator : Humidifier.Base.BaseResource, IHaveTags, IHaveImpliedResourceName
    {
        ...
        /// </summary>
        public List<ConfigurationAggregatorTypes.AccountAggregationSource> AccountAggregationSources { get; set; }
        ...
        /// </summary>
        public ConfigurationAggregatorTypes.OrganizationAggregationSource OrganizationAggregationSource { get; set; }
        /// <summary>
        /// Tags
    ...
    namespace ConfigurationAggregatorTypes
    {
        ...
        public class OrganizationAggregationSource : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// AllAwsRegions
