namespace Humidifier.Config
{
    ...
    public class OrganizationConformancePack : Humidifier.Base.BaseResource, IHaveImpliedResourceName
    {
        ...
        /// </summary>
        public List<OrganizationConformancePackTypes.ConformancePackInputParameter> ConformancePackInputParameters { get; set; }
        /// <summary>
        /// DeliveryS3Bucket
