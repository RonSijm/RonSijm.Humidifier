namespace Humidifier.Config
{
    ...
    public class ConfigurationRecorder : Humidifier.Base.BaseResource, IHaveImpliedResourceName
    {
        ...
        /// Type: RecordingGroup
        /// </summary>
        public ConfigurationRecorderTypes.RecordingGroup RecordingGroup { get; set; }
        /// <summary>
        /// RecordingMode
    ...
    {
        public class ExclusionByResourceTypes : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// ResourceTypes
        ...
        public class RecordingGroup : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// AllSupported
            ...
            /// </summary>
            public ConfigurationRecorderTypes.ExclusionByResourceTypes ExclusionByResourceTypes { get; set; }
            /// <summary>
            ...
            /// </summary>
            public ConfigurationRecorderTypes.RecordingStrategy RecordingStrategy { get; set; }
            /// <summary>
            /// ResourceTypes
        ...
        public class RecordingMode : Humidifier.Base.BaseSubResource
        {
            ...
            /// </summary>
            public List<ConfigurationRecorderTypes.RecordingModeOverride> RecordingModeOverrides { get; set; }
        }

        public class RecordingModeOverride : Humidifier.Base.BaseSubResource, IHaveDescription
        {
            /// <summary>
            /// Description
