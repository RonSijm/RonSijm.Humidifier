namespace Humidifier.Config
{
    ...
    public class RemediationConfiguration : Humidifier.Base.BaseResource
    {
        ...
        /// </summary>
        public RemediationConfigurationTypes.ExecutionControls ExecutionControls { get; set; }
        /// <summary>
        /// Parameters
    ...
    namespace RemediationConfigurationTypes
    {
        public class ExecutionControls : Humidifier.Base.BaseSubResource
        {
            ...
            /// Type: SsmControls
            /// </summary>
            public RemediationConfigurationTypes.SsmControls SsmControls { get; set; }
        }
        ...
        public class RemediationParameterValue : Humidifier.Base.BaseSubResource
        {
            ...
            /// Type: ResourceValue
            /// </summary>
            public RemediationConfigurationTypes.ResourceValue ResourceValue { get; set; }
            /// <summary>
            /// StaticValue
            ...
            /// Type: StaticValue
            /// </summary>
            public RemediationConfigurationTypes.StaticValue StaticValue { get; set; }
        }

        public class ResourceValue : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// Value
        ...
        public class StaticValue : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// Values
