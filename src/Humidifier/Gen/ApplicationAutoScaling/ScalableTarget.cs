namespace Humidifier.ApplicationAutoScaling
{
    ...
    public class ScalableTarget : Humidifier.Base.BaseResource
    {
    ...
    {
        public class ScalableTargetAction : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// MinCapacity
        ...
        public class ScheduledAction : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// Timezone
            ...
            /// </summary>
            public ScalableTargetTypes.ScalableTargetAction ScalableTargetAction { get; set; }
        }
