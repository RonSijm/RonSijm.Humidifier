namespace Humidifier.ApiGateway
{
    ...
    public class Method : Humidifier.Base.BaseResource
    {
        ...
        /// Type: Integration
        /// </summary>
        public MethodTypes.Integration Integration { get; set; }
        /// <summary>
        /// OperationName
        ...
        /// </summary>
        public List<MethodTypes.MethodResponse> MethodResponses { get; set; }
        /// <summary>
        /// AuthorizerId
    ...
    namespace MethodTypes
    {
        public class Integration : Humidifier.Base.BaseSubResource
        {
            ...
            /// </summary>
            public List<MethodTypes.IntegrationResponse> IntegrationResponses { get; set; }
            /// <summary>
        ...
        public class IntegrationResponse : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// ResponseTemplates
        ...
        public class MethodResponse : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// ResponseParameters
