namespace Humidifier.ApiGateway
{
    ...
    public class RestApi : Humidifier.Base.BaseResource, IHaveTags, IHaveDescription, IHaveImpliedResourceName
    {
        ...
        /// Type: S3Location
        /// </summary>
        public RestApiTypes.S3Location BodyS3Location { get; set; }
        /// <summary>
        /// Description
        ...
        /// </summary>
        public RestApiTypes.EndpointConfiguration EndpointConfiguration { get; set; }
        /// <summary>
        /// Body
    ...
    {
        public class EndpointConfiguration : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// Types
