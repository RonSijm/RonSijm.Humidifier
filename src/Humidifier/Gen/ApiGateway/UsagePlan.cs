namespace Humidifier.ApiGateway
{
    ...
    public class UsagePlan : Humidifier.Base.BaseResource, IHaveTags, IHaveDescription, IHaveImpliedResourceName
    {
        ...
        /// Type: QuotaSettings
        /// </summary>
        public UsagePlanTypes.QuotaSettings Quota { get; set; }
        /// <summary>
        /// ApiStages
        ...
        /// ItemType: ApiStage
        /// </summary>
        public List<UsagePlanTypes.ApiStage> ApiStages { get; set; }
        /// <summary>
        /// Tags
        ...
        /// </summary>
        public UsagePlanTypes.ThrottleSettings Throttle { get; set; }
        public dynamic UsagePlanName { get => GivenName; set => GivenName = value; }
    }

    namespace UsagePlanTypes
    {
        public class ApiStage : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// Stage
            ...
            /// </summary>
            public Dictionary<string, UsagePlanTypes.ThrottleSettings> Throttle { get; set; }
        }

        public class QuotaSettings : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// Period
