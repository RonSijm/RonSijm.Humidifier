namespace Humidifier.Greengrass
{
    ...
    public class ConnectorDefinition : Humidifier.Base.BaseResource, IHaveImpliedResourceName
    {
        ...
        /// </summary>
        public ConnectorDefinitionTypes.ConnectorDefinitionVersion InitialVersion { get; set; }
        /// <summary>
        /// Tags
    ...
    {
        public class Connector : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// ConnectorArn
        ...
        public class ConnectorDefinitionVersion : Humidifier.Base.BaseSubResource
        {
            ...
            /// ItemType: Connector
            /// </summary>
            public List<ConnectorDefinitionTypes.Connector> Connectors { get; set; }
        }
    }
}