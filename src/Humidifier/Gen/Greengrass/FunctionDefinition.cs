namespace Humidifier.Greengrass
{
    ...
    public class FunctionDefinition : Humidifier.Base.BaseResource, IHaveImpliedResourceName
    {
        ...
        /// </summary>
        public FunctionDefinitionTypes.FunctionDefinitionVersion InitialVersion { get; set; }
        /// <summary>
        /// Tags
    ...
    namespace FunctionDefinitionTypes
    {
        public class DefaultConfig : Humidifier.Base.BaseSubResource
        {
            ...
            /// Type: Execution
            /// </summary>
            public FunctionDefinitionTypes.Execution Execution { get; set; }
        }
        ...
        public class Environment : Humidifier.Base.BaseSubResource
        {
            ...
            /// </summary>
            public List<FunctionDefinitionTypes.ResourceAccessPolicy> ResourceAccessPolicies { get; set; }
            /// <summary>
            /// AccessSysfs
        ...
        public class Execution : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// IsolationMode
            ...
            /// Type: RunAs
            /// </summary>
            public FunctionDefinitionTypes.RunAs RunAs { get; set; }
        }
        ...
        public class Function : Humidifier.Base.BaseSubResource
        {
            ...
            /// </summary>
            public FunctionDefinitionTypes.FunctionConfiguration FunctionConfiguration { get; set; }
            /// <summary>
            /// Id
        ...
        public class FunctionConfiguration : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// MemorySize
            ...
            /// Type: Environment
            /// </summary>
            public FunctionDefinitionTypes.Environment Environment { get; set; }
            /// <summary>
            /// Executable
        ...
        public class FunctionDefinitionVersion : Humidifier.Base.BaseSubResource
        {
            ...
            /// Type: DefaultConfig
            /// </summary>
            public FunctionDefinitionTypes.DefaultConfig DefaultConfig { get; set; }
            /// <summary>
            /// Functions
            ...
            /// ItemType: Function
            /// </summary>
            public List<FunctionDefinitionTypes.Function> Functions { get; set; }
        }

        public class ResourceAccessPolicy : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// ResourceId
        ...
        public class RunAs : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// Uid
