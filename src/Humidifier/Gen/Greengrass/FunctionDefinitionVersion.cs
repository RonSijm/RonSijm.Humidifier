namespace Humidifier.Greengrass
{
    ...
    namespace FunctionDefinitionVersionTypes
    {
        public class DefaultConfig : Humidifier.Base.BaseSubResource
        {
            ...
            /// Type: Execution
            /// </summary>
            public FunctionDefinitionVersionTypes.Execution Execution { get; set; }
        }
        ...
        public class Environment : Humidifier.Base.BaseSubResource
        {
            ...
            /// </summary>
            public List<FunctionDefinitionVersionTypes.ResourceAccessPolicy> ResourceAccessPolicies { get; set; }
            /// <summary>
            /// AccessSysfs
        ...
        public class Execution : Humidifier.Base.BaseSubResource
        {
            ...
            /// Type: RunAs
            /// </summary>
            public FunctionDefinitionVersionTypes.RunAs RunAs { get; set; }
        }
        ...
        public class Function : Humidifier.Base.BaseSubResource
        {
            ...
            /// </summary>
            public FunctionDefinitionVersionTypes.FunctionConfiguration FunctionConfiguration { get; set; }
            /// <summary>
            /// Id
        ...
        public class FunctionConfiguration : Humidifier.Base.BaseSubResource
        {
            ...
            /// Type: Environment
            /// </summary>
            public FunctionDefinitionVersionTypes.Environment Environment { get; set; }
            /// <summary>
            /// Executable
