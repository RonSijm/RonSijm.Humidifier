namespace Humidifier.Greengrass
{
    ...
    public class LoggerDefinition : Humidifier.Base.BaseResource, IHaveImpliedResourceName
    {
        ...
        /// </summary>
        public LoggerDefinitionTypes.LoggerDefinitionVersion InitialVersion { get; set; }
        /// <summary>
        /// Tags
    ...
    {
        public class Logger : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// Space
        ...
        public class LoggerDefinitionVersion : Humidifier.Base.BaseSubResource
        {
            ...
            /// ItemType: Logger
            /// </summary>
            public List<LoggerDefinitionTypes.Logger> Loggers { get; set; }
        }
    }
}