namespace Humidifier.Greengrass
{
    ...
    public class SubscriptionDefinition : Humidifier.Base.BaseResource, IHaveImpliedResourceName
    {
        ...
        /// </summary>
        public SubscriptionDefinitionTypes.SubscriptionDefinitionVersion InitialVersion { get; set; }
        /// <summary>
        /// Tags
    ...
    namespace SubscriptionDefinitionTypes
    {
        ...
        public class SubscriptionDefinitionVersion : Humidifier.Base.BaseSubResource
        {
            ...
            /// </summary>
            public List<SubscriptionDefinitionTypes.Subscription> Subscriptions { get; set; }
        }
    }
}