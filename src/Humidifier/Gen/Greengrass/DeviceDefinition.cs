namespace Humidifier.Greengrass
{
    ...
    public class DeviceDefinition : Humidifier.Base.BaseResource, IHaveImpliedResourceName
    {
        ...
        /// </summary>
        public DeviceDefinitionTypes.DeviceDefinitionVersion InitialVersion { get; set; }
        /// <summary>
        /// Tags
    ...
    namespace DeviceDefinitionTypes
    {
        ...
        public class DeviceDefinitionVersion : Humidifier.Base.BaseSubResource
        {
            ...
            /// ItemType: Device
            /// </summary>
            public List<DeviceDefinitionTypes.Device> Devices { get; set; }
        }
    }
}