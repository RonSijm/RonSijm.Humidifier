namespace Humidifier.Greengrass
{
    ...
    public class ResourceDefinition : Humidifier.Base.BaseResource, IHaveImpliedResourceName
    {
        ...
        /// </summary>
        public ResourceDefinitionTypes.ResourceDefinitionVersion InitialVersion { get; set; }
        /// <summary>
        /// Tags
    ...
    {
        public class GroupOwnerSetting : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// AutoAddGroupOwner
        ...
        public class LocalDeviceResourceData : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// SourcePath
            ...
            /// </summary>
            public ResourceDefinitionTypes.GroupOwnerSetting GroupOwnerSetting { get; set; }
        }

        public class LocalVolumeResourceData : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// SourcePath
        ...
        public class ResourceDataContainer : Humidifier.Base.BaseSubResource
        {
            ...
            /// </summary>
            public ResourceDefinitionTypes.SecretsManagerSecretResourceData SecretsManagerSecretResourceData { get; set; }
            /// <summary>
            ...
            /// </summary>
            public ResourceDefinitionTypes.SageMakerMachineLearningModelResourceData SageMakerMachineLearningModelResourceData { get; set; }
            /// <summary>
            ...
            /// </summary>
            public ResourceDefinitionTypes.LocalVolumeResourceData LocalVolumeResourceData { get; set; }
            /// <summary>
            ...
            /// </summary>
            public ResourceDefinitionTypes.LocalDeviceResourceData LocalDeviceResourceData { get; set; }
            /// <summary>
            ...
            /// </summary>
            public ResourceDefinitionTypes.S3MachineLearningModelResourceData S3MachineLearningModelResourceData { get; set; }
        }
        ...
        public class ResourceDefinitionVersion : Humidifier.Base.BaseSubResource
        {
            ...
            /// </summary>
            public List<ResourceDefinitionTypes.ResourceInstance> Resources { get; set; }
        }

        public class ResourceDownloadOwnerSetting : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// GroupOwner
        ...
        public class ResourceInstance : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            ...
            /// </summary>
            public ResourceDefinitionTypes.ResourceDataContainer ResourceDataContainer { get; set; }
            /// <summary>
            /// Id
        ...
        public class S3MachineLearningModelResourceData : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// OwnerSetting
            ...
            /// </summary>
            public ResourceDefinitionTypes.ResourceDownloadOwnerSetting OwnerSetting { get; set; }
            /// <summary>
            /// DestinationPath
        ...
        public class SageMakerMachineLearningModelResourceData : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// OwnerSetting
