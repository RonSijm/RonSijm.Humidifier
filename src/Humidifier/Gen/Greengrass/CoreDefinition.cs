namespace Humidifier.Greengrass
{
    ...
    public class CoreDefinition : Humidifier.Base.BaseResource, IHaveImpliedResourceName
    {
        ...
        /// </summary>
        public CoreDefinitionTypes.CoreDefinitionVersion InitialVersion { get; set; }
        /// <summary>
        /// Tags
    ...
    {
        public class Core : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// SyncShadow
        ...
        public class CoreDefinitionVersion : Humidifier.Base.BaseSubResource
        {
            ...
            /// ItemType: Core
            /// </summary>
            public List<CoreDefinitionTypes.Core> Cores { get; set; }
        }
    }
}