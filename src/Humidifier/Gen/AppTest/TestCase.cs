namespace Humidifier.AppTest
{
    ...
    public class TestCase : Humidifier.Base.BaseResource, IHaveImpliedResourceName, IHaveDescription
    {
        ...
        /// </summary>
        [Required]
        public List<TestCaseTypes.Step> Steps { get; set; }
        /// <summary>
        /// Description
    ...
    namespace TestCaseTypes
    {
        ...
        public class CloudFormationAction : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// ActionType
        ...
        public class CompareAction : Humidifier.Base.BaseSubResource
        {
            ...
            /// Type: Input
            /// </summary>
            public TestCaseTypes.Input Input { get; set; }
            /// <summary>
            /// Output
            ...
            /// Type: Output
            /// </summary>
            public TestCaseTypes.Output Output { get; set; }
        }

        public class DataSet : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// Ccsid
        ...
        public class DatabaseCDC : Humidifier.Base.BaseSubResource
        {
            ...
            /// </summary>
            public TestCaseTypes.SourceDatabaseMetadata SourceMetadata { get; set; }
            /// <summary>
            /// TargetMetadata
            ...
            /// </summary>
            public TestCaseTypes.TargetDatabaseMetadata TargetMetadata { get; set; }
        }
        ...
        public class FileMetadata : Humidifier.Base.BaseSubResource
        {
            ...
            /// Type: DatabaseCDC
            /// </summary>
            public TestCaseTypes.DatabaseCDC DatabaseCDC { get; set; }
            /// <summary>
            /// DataSets
            ...
            /// ItemType: DataSet
            /// </summary>
            public List<TestCaseTypes.DataSet> DataSets { get; set; }
        }
        ...
        public class Input : Humidifier.Base.BaseSubResource
        {
            ...
            /// Type: InputFile
            /// </summary>
            public TestCaseTypes.InputFile File { get; set; }
        }
        ...
        public class InputFile : Humidifier.Base.BaseSubResource
        {
            ...
            /// Type: FileMetadata
            /// </summary>
            public TestCaseTypes.FileMetadata FileMetadata { get; set; }
        }
        ...
        public class M2ManagedApplicationAction : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// ActionType
            ...
            /// </summary>
            public TestCaseTypes.M2ManagedActionProperties Properties { get; set; }
        }

        public class M2NonManagedApplicationAction : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// ActionType
        ...
        public class MainframeAction : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// ActionType
            ...
            /// </summary>
            public TestCaseTypes.MainframeActionType ActionType { get; set; }
            /// <summary>
            /// Resource
            ...
            /// </summary>
            public TestCaseTypes.MainframeActionProperties Properties { get; set; }
        }
        ...
        public class MainframeActionType : Humidifier.Base.BaseSubResource
        {
            ...
            /// Type: Batch
            /// </summary>
            public TestCaseTypes.Batch Batch { get; set; }
            /// <summary>
            /// Tn3270
            ...
            /// Type: TN3270
            /// </summary>
            public TestCaseTypes.TN3270 Tn3270 { get; set; }
        }
        ...
        public class Output : Humidifier.Base.BaseSubResource
        {
            ...
            /// Type: OutputFile
            /// </summary>
            public TestCaseTypes.OutputFile File { get; set; }
        }
        ...
        public class ResourceAction : Humidifier.Base.BaseSubResource
        {
            ...
            /// </summary>
            public TestCaseTypes.CloudFormationAction CloudFormationAction { get; set; }
            /// <summary>
            ...
            /// </summary>
            public TestCaseTypes.M2ManagedApplicationAction M2ManagedApplicationAction { get; set; }
            /// <summary>
            ...
            /// </summary>
            public TestCaseTypes.M2NonManagedApplicationAction M2NonManagedApplicationAction { get; set; }
        }
        ...
        public class SourceDatabaseMetadata : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// Type
        ...
        public class Step : Humidifier.Base.BaseSubResource, IHaveDescription
        {
            /// <summary>
            /// Action
            ...
            /// Type: StepAction
            /// </summary>
            public TestCaseTypes.StepAction Action { get; set; }
            /// <summary>
            /// Description
        ...
        public class StepAction : Humidifier.Base.BaseSubResource
        {
            ...
            /// Type: CompareAction
            /// </summary>
            public TestCaseTypes.CompareAction CompareAction { get; set; }
            /// <summary>
            /// MainframeAction
            ...
            /// </summary>
            public TestCaseTypes.MainframeAction MainframeAction { get; set; }
            /// <summary>
            /// ResourceAction
            ...
            /// Type: ResourceAction
            /// </summary>
            public TestCaseTypes.ResourceAction ResourceAction { get; set; }
        }
        ...
        public class TN3270 : Humidifier.Base.BaseSubResource
        {
            ...
            /// Type: Script
            /// </summary>
            public TestCaseTypes.Script Script { get; set; }
            /// <summary>
            /// ExportDataSetNames
        ...
        public class TargetDatabaseMetadata : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// Type
        ...
        public class TestCaseLatestVersion : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// Status
