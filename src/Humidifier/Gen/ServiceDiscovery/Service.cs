namespace Humidifier.ServiceDiscovery
{
    ...
    public class Service : Humidifier.Base.BaseResource, IHaveImpliedResourceName, IHaveTags, IHaveDescription
    {
        ...
        /// </summary>
        public ServiceTypes.HealthCheckCustomConfig HealthCheckCustomConfig { get; set; }
        /// <summary>
        /// DnsConfig
        ...
        /// Type: DnsConfig
        /// </summary>
        public ServiceTypes.DnsConfig DnsConfig { get; set; }
        /// <summary>
        /// NamespaceId
        ...
        /// </summary>
        public ServiceTypes.HealthCheckConfig HealthCheckConfig { get; set; }
        /// <summary>
        /// Tags
    ...
    {
        public class DnsConfig : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// DnsRecords
            ...
            /// ItemType: DnsRecord
            /// </summary>
            public List<ServiceTypes.DnsRecord> DnsRecords { get; set; }
            /// <summary>
            /// RoutingPolicy
        ...
        public class DnsRecord : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// Type
        ...
        public class HealthCheckCustomConfig : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// FailureThreshold
