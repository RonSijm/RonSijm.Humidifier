namespace Humidifier.ServiceDiscovery
{
    ...
    public class PublicDnsNamespace : Humidifier.Base.BaseResource, IHaveTags, IHaveDescription, IHaveImpliedResourceName
    {
        ...
        /// Type: Properties
        /// </summary>
        public PublicDnsNamespaceTypes.Properties Properties { get; set; }
        /// <summary>
        /// Tags
    ...
    namespace PublicDnsNamespaceTypes
    {
        public class Properties : Humidifier.Base.BaseSubResource
        {
            ...
            /// </summary>
            public PublicDnsNamespaceTypes.PublicDnsPropertiesMutable DnsProperties { get; set; }
        }
        ...
        public class PublicDnsPropertiesMutable : Humidifier.Base.BaseSubResource
        {
            ...
            /// Type: SOA
            /// </summary>
            public PublicDnsNamespaceTypes.SOA SOA { get; set; }
        }
