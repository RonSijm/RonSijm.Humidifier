namespace Humidifier.EMRContainers
{
    ...
    namespace VirtualClusterTypes
    {
        public class ContainerInfo : Humidifier.Base.BaseSubResource
        {
            ...
            /// Type: EksInfo
            /// </summary>
            public VirtualClusterTypes.EksInfo EksInfo { get; set; }
        }

        public class ContainerProvider : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// Type
            ...
            /// Type: ContainerInfo
            /// </summary>
            public VirtualClusterTypes.ContainerInfo Info { get; set; }
        }
