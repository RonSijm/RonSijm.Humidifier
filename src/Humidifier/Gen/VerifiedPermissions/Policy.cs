namespace Humidifier.VerifiedPermissions
{
    ...
    public class Policy : Humidifier.Base.BaseResource
    {
    ...
    {
        public class EntityIdentifier : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// EntityType
        ...
        public class PolicyDefinition : Humidifier.Base.BaseSubResource
        {
            ...
            /// </summary>
            public PolicyTypes.StaticPolicyDefinition Static { get; set; }
            /// <summary>
            /// TemplateLinked
            ...
            /// </summary>
            public PolicyTypes.TemplateLinkedPolicyDefinition TemplateLinked { get; set; }
        }

        public class StaticPolicyDefinition : Humidifier.Base.BaseSubResource, IHaveDescription
        {
            /// <summary>
            /// Description
        ...
        public class TemplateLinkedPolicyDefinition : Humidifier.Base.BaseSubResource
        {
            ...
            /// </summary>
            public PolicyTypes.EntityIdentifier Resource { get; set; }
            /// <summary>
            /// PolicyTemplateId
            ...
            /// Type: EntityIdentifier
            /// </summary>
            public PolicyTypes.EntityIdentifier Principal { get; set; }
        }
    }
}