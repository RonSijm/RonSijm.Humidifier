namespace Humidifier.S3ObjectLambda
{
    ...
    public class AccessPoint : Humidifier.Base.BaseResource, IHaveImpliedResourceName
    {
    ...
    {
        public class Alias : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// Status
        ...
        public class AwsLambda : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// FunctionArn
        ...
        public class ContentTransformation : Humidifier.Base.BaseSubResource
        {
            ...
            /// Type: AwsLambda
            /// </summary>
            public AccessPointTypes.AwsLambda AwsLambda { get; set; }
        }

        public class ObjectLambdaConfiguration : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            ...
            /// </summary>
            public List<AccessPointTypes.TransformationConfiguration> TransformationConfigurations { get; set; }
            /// <summary>
            /// AllowedFeatures
        ...
        public class TransformationConfiguration : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// Actions
            ...
            /// </summary>
            public AccessPointTypes.ContentTransformation ContentTransformation { get; set; }
        }
    }
}