namespace Humidifier.IoTEvents
{
    ...
    public class AlarmModel : Humidifier.Base.BaseResource, IHaveTags, IHaveImpliedResourceName
    {
        ...
        /// </summary>
        public AlarmModelTypes.AlarmEventActions AlarmEventActions { get; set; }
        /// <summary>
        /// Tags
    ...
    {
        public class AcknowledgeFlow : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// Enabled
        ...
        public class AlarmAction : Humidifier.Base.BaseSubResource
        {
            ...
            /// Type: DynamoDBv2
            /// </summary>
            public AlarmModelTypes.DynamoDBv2 DynamoDBv2 { get; set; }
            /// <summary>
            /// IotEvents
            ...
            /// Type: IotEvents
            /// </summary>
            public AlarmModelTypes.IotEvents IotEvents { get; set; }
            /// <summary>
            /// IotSiteWise
            ...
            /// Type: IotSiteWise
            /// </summary>
            public AlarmModelTypes.IotSiteWise IotSiteWise { get; set; }
            /// <summary>
            /// Sqs
            ...
            /// Type: Sqs
            /// </summary>
            public AlarmModelTypes.Sqs Sqs { get; set; }
            /// <summary>
            /// Firehose
            ...
            /// Type: Firehose
            /// </summary>
            public AlarmModelTypes.Firehose Firehose { get; set; }
            /// <summary>
            /// DynamoDB
            ...
            /// Type: DynamoDB
            /// </summary>
            public AlarmModelTypes.DynamoDB DynamoDB { get; set; }
            /// <summary>
            /// IotTopicPublish
            ...
            /// </summary>
            public AlarmModelTypes.IotTopicPublish IotTopicPublish { get; set; }
            /// <summary>
            /// Sns
            ...
            /// Type: Sns
            /// </summary>
            public AlarmModelTypes.Sns Sns { get; set; }
            /// <summary>
            /// Lambda
            ...
            /// Type: Lambda
            /// </summary>
            public AlarmModelTypes.Lambda Lambda { get; set; }
        }
        ...
        public class AlarmCapabilities : Humidifier.Base.BaseSubResource
        {
            ...
            /// </summary>
            public AlarmModelTypes.AcknowledgeFlow AcknowledgeFlow { get; set; }
            /// <summary>
            ...
            /// </summary>
            public AlarmModelTypes.InitializationConfiguration InitializationConfiguration { get; set; }
        }
        ...
        public class AlarmEventActions : Humidifier.Base.BaseSubResource
        {
            ...
            /// </summary>
            public List<AlarmModelTypes.AlarmAction> AlarmActions { get; set; }
        }
        ...
        public class AlarmRule : Humidifier.Base.BaseSubResource
        {
            ...
            /// Type: SimpleRule
            /// </summary>
            public AlarmModelTypes.SimpleRule SimpleRule { get; set; }
        }
        ...
        public class AssetPropertyValue : Humidifier.Base.BaseSubResource
        {
            ...
            /// </summary>
            public AlarmModelTypes.AssetPropertyVariant Value { get; set; }
            /// <summary>
            /// Timestamp
            ...
            /// </summary>
            public AlarmModelTypes.AssetPropertyTimestamp Timestamp { get; set; }
        }
        ...
        public class DynamoDB : Humidifier.Base.BaseSubResource
        {
            ...
            /// Type: Payload
            /// </summary>
            public AlarmModelTypes.Payload Payload { get; set; }
            /// <summary>
            /// Operation
        ...
        public class IotSiteWise : Humidifier.Base.BaseSubResource
        {
            ...
            /// </summary>
            public AlarmModelTypes.AssetPropertyValue PropertyValue { get; set; }
            /// <summary>
            /// AssetId
        ...
        public class SimpleRule : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// ComparisonOperator
