namespace Humidifier.AppMesh
{
    ...
    public class VirtualNode : Humidifier.Base.BaseResource, IHaveImpliedResourceName, IHaveTags
    {
        ...
        /// </summary>
        [Required]
        public VirtualNodeTypes.VirtualNodeSpec Spec { get; set; }
    ...
    namespace VirtualNodeTypes
    {
        public class AccessLog : Humidifier.Base.BaseSubResource
        {
            ...
            /// Type: FileAccessLog
            /// </summary>
            public VirtualNodeTypes.FileAccessLog File { get; set; }
        }

        public class AwsCloudMapInstanceAttribute : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// Value
        ...
        public class AwsCloudMapServiceDiscovery : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// NamespaceName
            ...
            /// </summary>
            public List<VirtualNodeTypes.AwsCloudMapInstanceAttribute> Attributes_ { get; set; }
        }
        ...
        public class Backend : Humidifier.Base.BaseSubResource
        {
            ...
            /// </summary>
            public VirtualNodeTypes.VirtualServiceBackend VirtualService { get; set; }
        }
        ...
        public class BackendDefaults : Humidifier.Base.BaseSubResource
        {
            ...
            /// Type: ClientPolicy
            /// </summary>
            public VirtualNodeTypes.ClientPolicy ClientPolicy { get; set; }
        }
        ...
        public class ClientPolicy : Humidifier.Base.BaseSubResource
        {
            ...
            /// </summary>
            public VirtualNodeTypes.ClientPolicyTls TLS { get; set; }
        }
        ...
        public class ClientPolicyTls : Humidifier.Base.BaseSubResource
        {
            ...
            /// </summary>
            public VirtualNodeTypes.TlsValidationContext Validation { get; set; }
            /// <summary>
            /// Enforce
            ...
            /// </summary>
            public VirtualNodeTypes.ClientTlsCertificate Certificate { get; set; }
        }
        ...
        public class ClientTlsCertificate : Humidifier.Base.BaseSubResource
        {
            ...
            /// </summary>
            public VirtualNodeTypes.ListenerTlsSdsCertificate SDS { get; set; }
            /// <summary>
            /// File
            ...
            /// </summary>
            public VirtualNodeTypes.ListenerTlsFileCertificate File { get; set; }
        }

        public class DnsServiceDiscovery : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// IpPreference
        ...
        public class FileAccessLog : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// Path
            ...
            /// Type: LoggingFormat
            /// </summary>
            public VirtualNodeTypes.LoggingFormat Format { get; set; }
        }
        ...
        public class GrpcTimeout : Humidifier.Base.BaseSubResource
        {
            ...
            /// Type: Duration
            /// </summary>
            public VirtualNodeTypes.Duration PerRequest { get; set; }
            /// <summary>
            /// Idle
            ...
            /// Type: Duration
            /// </summary>
            public VirtualNodeTypes.Duration Idle { get; set; }
        }

        public class HealthCheck : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// Path
        ...
        public class Listener : Humidifier.Base.BaseSubResource
        {
            ...
            /// </summary>
            public VirtualNodeTypes.VirtualNodeConnectionPool ConnectionPool { get; set; }
            /// <summary>
            /// Timeout
            ...
            /// </summary>
            public VirtualNodeTypes.ListenerTimeout Timeout { get; set; }
            /// <summary>
            /// HealthCheck
            ...
            /// Type: HealthCheck
            /// </summary>
            public VirtualNodeTypes.HealthCheck HealthCheck { get; set; }
            /// <summary>
            /// TLS
            ...
            /// Type: ListenerTls
            /// </summary>
            public VirtualNodeTypes.ListenerTls TLS { get; set; }
            /// <summary>
            /// PortMapping
            ...
            /// Type: PortMapping
            /// </summary>
            public VirtualNodeTypes.PortMapping PortMapping { get; set; }
            /// <summary>
            /// OutlierDetection
            ...
            /// </summary>
            public VirtualNodeTypes.OutlierDetection OutlierDetection { get; set; }
        }
        ...
        public class ListenerTimeout : Humidifier.Base.BaseSubResource
        {
            ...
            /// Type: TcpTimeout
            /// </summary>
            public VirtualNodeTypes.TcpTimeout TCP { get; set; }
            /// <summary>
            /// HTTP2
            ...
            /// Type: HttpTimeout
            /// </summary>
            public VirtualNodeTypes.HttpTimeout HTTP2 { get; set; }
            /// <summary>
            /// HTTP
            ...
            /// Type: HttpTimeout
            /// </summary>
            public VirtualNodeTypes.HttpTimeout HTTP { get; set; }
            /// <summary>
            /// GRPC
            ...
            /// Type: GrpcTimeout
            /// </summary>
            public VirtualNodeTypes.GrpcTimeout GRPC { get; set; }
        }

        public class ListenerTls : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// Validation
            ...
            /// </summary>
            public VirtualNodeTypes.ListenerTlsValidationContext Validation { get; set; }
            /// <summary>
            /// Mode
            ...
            /// </summary>
            public VirtualNodeTypes.ListenerTlsCertificate Certificate { get; set; }
        }

        public class ListenerTlsAcmCertificate : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// CertificateArn
        ...
        public class ListenerTlsCertificate : Humidifier.Base.BaseSubResource
        {
            ...
            /// </summary>
            public VirtualNodeTypes.ListenerTlsAcmCertificate ACM { get; set; }
            /// <summary>
            /// File
        ...
        public class ListenerTlsFileCertificate : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// PrivateKey
        ...
        public class ListenerTlsSdsCertificate : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// SecretName
        ...
        public class ListenerTlsValidationContext : Humidifier.Base.BaseSubResource
        {
            ...
            /// </summary>
            public VirtualNodeTypes.SubjectAlternativeNames SubjectAlternativeNames { get; set; }
            /// <summary>
            /// Trust
            ...
            /// </summary>
            public VirtualNodeTypes.ListenerTlsValidationContextTrust Trust { get; set; }
        }
        ...
        public class ListenerTlsValidationContextTrust : Humidifier.Base.BaseSubResource
        {
            ...
            /// </summary>
            public VirtualNodeTypes.TlsValidationContextSdsTrust SDS { get; set; }
            /// <summary>
            /// File
            ...
            /// </summary>
            public VirtualNodeTypes.TlsValidationContextFileTrust File { get; set; }
        }
        ...
        public class Logging : Humidifier.Base.BaseSubResource
        {
            ...
            /// Type: AccessLog
            /// </summary>
            public VirtualNodeTypes.AccessLog AccessLog { get; set; }
        }
        ...
        public class LoggingFormat : Humidifier.Base.BaseSubResource
        {
            ...
            /// </summary>
            public List<VirtualNodeTypes.JsonFormatRef> Json { get; set; }
        }
        ...
        public class OutlierDetection : Humidifier.Base.BaseSubResource
        {
            ...
            /// Type: Duration
            /// </summary>
            public VirtualNodeTypes.Duration BaseEjectionDuration { get; set; }
            /// <summary>
            /// MaxServerErrors
            ...
            /// Type: Duration
            /// </summary>
            public VirtualNodeTypes.Duration Interval { get; set; }
        }

        public class PortMapping : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// Port
        ...
        public class ServiceDiscovery : Humidifier.Base.BaseSubResource
        {
            ...
            /// </summary>
            public VirtualNodeTypes.DnsServiceDiscovery DNS { get; set; }
            /// <summary>
            /// AWSCloudMap
            ...
            /// </summary>
            public VirtualNodeTypes.AwsCloudMapServiceDiscovery AWSCloudMap { get; set; }
        }
        ...
        public class SubjectAlternativeNames : Humidifier.Base.BaseSubResource
        {
            ...
            /// </summary>
            public VirtualNodeTypes.SubjectAlternativeNameMatchers Match { get; set; }
        }
        ...
        public class TlsValidationContext : Humidifier.Base.BaseSubResource
        {
            ...
            /// </summary>
            public VirtualNodeTypes.TlsValidationContextTrust Trust { get; set; }
        }
        ...
        public class TlsValidationContextFileTrust : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// CertificateChain
        ...
        public class TlsValidationContextSdsTrust : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// SecretName
        ...
        public class TlsValidationContextTrust : Humidifier.Base.BaseSubResource
        {
            ...
            /// </summary>
            public VirtualNodeTypes.TlsValidationContextAcmTrust ACM { get; set; }
            /// <summary>
            /// File
        ...
        public class VirtualNodeConnectionPool : Humidifier.Base.BaseSubResource
        {
            ...
            /// </summary>
            public VirtualNodeTypes.VirtualNodeTcpConnectionPool TCP { get; set; }
            /// <summary>
            /// HTTP2
            ...
            /// </summary>
            public VirtualNodeTypes.VirtualNodeHttp2ConnectionPool HTTP2 { get; set; }
            /// <summary>
            /// HTTP
            ...
            /// </summary>
            public VirtualNodeTypes.VirtualNodeHttpConnectionPool HTTP { get; set; }
            /// <summary>
            /// GRPC
            ...
            /// </summary>
            public VirtualNodeTypes.VirtualNodeGrpcConnectionPool GRPC { get; set; }
        }

        public class VirtualNodeGrpcConnectionPool : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// MaxRequests
        ...
        public class VirtualNodeHttp2ConnectionPool : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// MaxRequests
        ...
        public class VirtualNodeHttpConnectionPool : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// MaxConnections
        ...
        public class VirtualNodeSpec : Humidifier.Base.BaseSubResource
        {
            ...
            /// Type: Logging
            /// </summary>
            public VirtualNodeTypes.Logging Logging { get; set; }
            /// <summary>
            /// Backends
            ...
            /// ItemType: Backend
            /// </summary>
            public List<VirtualNodeTypes.Backend> Backends { get; set; }
            /// <summary>
            /// Listeners
            ...
            /// ItemType: Listener
            /// </summary>
            public List<VirtualNodeTypes.Listener> Listeners { get; set; }
            /// <summary>
            /// BackendDefaults
            ...
            /// </summary>
            public VirtualNodeTypes.BackendDefaults BackendDefaults { get; set; }
            /// <summary>
            /// ServiceDiscovery
            ...
            /// </summary>
            public VirtualNodeTypes.ServiceDiscovery ServiceDiscovery { get; set; }
        }

        public class VirtualNodeTcpConnectionPool : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// MaxConnections
        ...
        public class VirtualServiceBackend : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// ClientPolicy
