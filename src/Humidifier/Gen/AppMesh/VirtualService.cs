namespace Humidifier.AppMesh
{
    ...
    namespace VirtualServiceTypes
    {
        ...
        public class VirtualRouterServiceProvider : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// VirtualRouterName
        ...
        public class VirtualServiceProvider : Humidifier.Base.BaseSubResource
        {
            ...
            /// </summary>
            public VirtualServiceTypes.VirtualNodeServiceProvider VirtualNode { get; set; }
            /// <summary>
            /// VirtualRouter
            ...
            /// </summary>
            public VirtualServiceTypes.VirtualRouterServiceProvider VirtualRouter { get; set; }
        }
        ...
        public class VirtualServiceSpec : Humidifier.Base.BaseSubResource
        {
            ...
            /// </summary>
            public VirtualServiceTypes.VirtualServiceProvider Provider { get; set; }
        }
    }
}