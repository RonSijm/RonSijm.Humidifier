namespace Humidifier.AppMesh
{
    ...
    public class Mesh : Humidifier.Base.BaseResource, IHaveImpliedResourceName, IHaveTags
    {
        ...
        /// Type: MeshSpec
        /// </summary>
        public MeshTypes.MeshSpec Spec { get; set; }
        /// <summary>
        /// Tags
    ...
    namespace MeshTypes
    {
        public class EgressFilter : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// Type
        ...
        public class MeshServiceDiscovery : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// IpPreference
        ...
        public class MeshSpec : Humidifier.Base.BaseSubResource
        {
            ...
            /// Type: EgressFilter
            /// </summary>
            public MeshTypes.EgressFilter EgressFilter { get; set; }
            /// <summary>
            /// ServiceDiscovery
            ...
            /// </summary>
            public MeshTypes.MeshServiceDiscovery ServiceDiscovery { get; set; }
        }
    }
}