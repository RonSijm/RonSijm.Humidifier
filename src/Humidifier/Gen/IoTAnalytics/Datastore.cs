namespace Humidifier.IoTAnalytics
{
    ...
    public class Datastore : Humidifier.Base.BaseResource, IHaveImpliedResourceName, IHaveTags
    {
        ...
        /// </summary>
        public DatastoreTypes.DatastoreStorage DatastoreStorage { get; set; }
        /// <summary>
        ...
        /// </summary>
        public DatastoreTypes.FileFormatConfiguration FileFormatConfiguration { get; set; }
        /// <summary>
        /// DatastorePartitions
        ...
        /// </summary>
        public DatastoreTypes.DatastorePartitions DatastorePartitions { get; set; }
        ...
        /// </summary>
        public DatastoreTypes.RetentionPeriod RetentionPeriod { get; set; }
        /// <summary>
        /// Tags
    ...
    {
        public class Column : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// Type
        ...
        public class CustomerManagedS3 : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// Bucket
        ...
        public class CustomerManagedS3Storage : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// Bucket
        ...
        public class DatastorePartition : Humidifier.Base.BaseSubResource
        {
            ...
            /// Type: Partition
            /// </summary>
            public DatastoreTypes.Partition Partition { get; set; }
            /// <summary>
            /// TimestampPartition
            ...
            /// </summary>
            public DatastoreTypes.TimestampPartition TimestampPartition { get; set; }
        }
        ...
        public class DatastorePartitions : Humidifier.Base.BaseSubResource
        {
            ...
            /// </summary>
            public List<DatastoreTypes.DatastorePartition> Partitions { get; set; }
        }
        ...
        public class DatastoreStorage : Humidifier.Base.BaseSubResource
        {
            ...
            /// </summary>
            public DatastoreTypes.CustomerManagedS3 CustomerManagedS3 { get; set; }
            /// <summary>
            /// ServiceManagedS3
            ...
            /// </summary>
            public DatastoreTypes.IotSiteWiseMultiLayerStorage IotSiteWiseMultiLayerStorage { get; set; }
        }
        ...
        public class FileFormatConfiguration : Humidifier.Base.BaseSubResource
        {
            ...
            /// </summary>
            public DatastoreTypes.ParquetConfiguration ParquetConfiguration { get; set; }
            /// <summary>
            /// JsonConfiguration
        ...
        public class IotSiteWiseMultiLayerStorage : Humidifier.Base.BaseSubResource
        {
            ...
            /// </summary>
            public DatastoreTypes.CustomerManagedS3Storage CustomerManagedS3Storage { get; set; }
        }
        ...
        public class ParquetConfiguration : Humidifier.Base.BaseSubResource
        {
            ...
            /// </summary>
            public DatastoreTypes.SchemaDefinition SchemaDefinition { get; set; }
        }

        public class Partition : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// AttributeName
        ...
        public class SchemaDefinition : Humidifier.Base.BaseSubResource
        {
            ...
            /// ItemType: Column
            /// </summary>
            public List<DatastoreTypes.Column> Columns { get; set; }
        }

        public class TimestampPartition : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// AttributeName
