namespace Humidifier.IoTAnalytics
{
    ...
    public class Channel : Humidifier.Base.BaseResource, IHaveImpliedResourceName, IHaveTags
    {
        ...
        /// Type: ChannelStorage
        /// </summary>
        public ChannelTypes.ChannelStorage ChannelStorage { get; set; }
        /// <summary>
        /// RetentionPeriod
        ...
        /// </summary>
        public ChannelTypes.RetentionPeriod RetentionPeriod { get; set; }
        /// <summary>
        /// Tags
    ...
    namespace ChannelTypes
    {
        public class ChannelStorage : Humidifier.Base.BaseSubResource
        {
            ...
            /// </summary>
            public ChannelTypes.CustomerManagedS3 CustomerManagedS3 { get; set; }
            /// <summary>
            /// ServiceManagedS3
