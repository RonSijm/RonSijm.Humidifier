namespace Humidifier.ResourceGroups
{
    ...
    public class Group : Humidifier.Base.BaseResource, IHaveTags, IHaveDescription, IHaveImpliedResourceName
    {
        ...
        /// </summary>
        public List<GroupTypes.ConfigurationItem> Configuration { get; set; }
        /// <summary>
        /// ResourceQuery
        ...
        /// Type: ResourceQuery
        /// </summary>
        public GroupTypes.ResourceQuery ResourceQuery { get; set; }
        /// <summary>
        /// Resources
    ...
    {
        public class ConfigurationItem : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// Type
            ...
            /// </summary>
            public List<GroupTypes.ConfigurationParameter> Parameters { get; set; }
        }

        public class ConfigurationParameter : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// Values
        ...
        public class Query : Humidifier.Base.BaseSubResource
        {
            ...
            /// ItemType: TagFilter
            /// </summary>
            public List<GroupTypes.TagFilter> TagFilters { get; set; }
            /// <summary>
            /// ResourceTypeFilters
        ...
        public class ResourceQuery : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// Type
            ...
            /// Type: Query
            /// </summary>
            public GroupTypes.Query Query { get; set; }
        }
