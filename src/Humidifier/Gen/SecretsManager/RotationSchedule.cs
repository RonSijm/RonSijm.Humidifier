namespace Humidifier.SecretsManager
{
    ...
    public class RotationSchedule : Humidifier.Base.BaseResource
    {
        ...
        /// </summary>
        public RotationScheduleTypes.HostedRotationLambda HostedRotationLambda { get; set; }
        /// <summary>
        /// RotationLambdaARN
        ...
        /// Type: RotationRules
        /// </summary>
        public RotationScheduleTypes.RotationRules RotationRules { get; set; }
        /// <summary>
    ...
    {
        public class HostedRotationLambda : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// Runtime
        ...
        public class RotationRules : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// ScheduleExpression
