namespace Humidifier.KafkaConnect
{
    ...
    public class Connector : Humidifier.Base.BaseResource, IHaveTags, IHaveImpliedResourceName
    {
        ...
        /// Type: LogDelivery
        /// </summary>
        public ConnectorTypes.LogDelivery LogDelivery { get; set; }
        /// <summary>
        /// WorkerConfiguration
    ...
    namespace ConnectorTypes
    {
        public class ApacheKafkaCluster : Humidifier.Base.BaseSubResource
        {
            ...
            /// Type: Vpc
            /// </summary>
            public ConnectorTypes.Vpc Vpc { get; set; }
            /// <summary>
            /// BootstrapServers
        ...
        public class AutoScaling : Humidifier.Base.BaseSubResource
        {
            ...
            /// Type: ScaleOutPolicy
            /// </summary>
            public ConnectorTypes.ScaleOutPolicy ScaleOutPolicy { get; set; }
            /// <summary>
            /// ScaleInPolicy
            ...
            /// Type: ScaleInPolicy
            /// </summary>
            public ConnectorTypes.ScaleInPolicy ScaleInPolicy { get; set; }
            /// <summary>
            /// MaxWorkerCount
        ...
        public class Capacity : Humidifier.Base.BaseSubResource
        {
            ...
            /// </summary>
            public ConnectorTypes.ProvisionedCapacity ProvisionedCapacity { get; set; }
            /// <summary>
            /// AutoScaling
            ...
            /// Type: AutoScaling
            /// </summary>
            public ConnectorTypes.AutoScaling AutoScaling { get; set; }
        }

        public class CloudWatchLogsLogDelivery : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// LogGroup
        ...
        public class CustomPlugin : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// CustomPluginArn
        ...
        public class FirehoseLogDelivery : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// DeliveryStream
        ...
        public class KafkaCluster : Humidifier.Base.BaseSubResource
        {
            ...
            /// </summary>
            public ConnectorTypes.ApacheKafkaCluster ApacheKafkaCluster { get; set; }
        }

        public class KafkaClusterClientAuthentication : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// AuthenticationType
        ...
        public class KafkaClusterEncryptionInTransit : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// EncryptionType
        ...
        public class LogDelivery : Humidifier.Base.BaseSubResource
        {
            ...
            /// </summary>
            public ConnectorTypes.WorkerLogDelivery WorkerLogDelivery { get; set; }
        }
        ...
        public class Plugin : Humidifier.Base.BaseSubResource
        {
            ...
            /// Type: CustomPlugin
            /// </summary>
            public ConnectorTypes.CustomPlugin CustomPlugin { get; set; }
        }
        ...
        public class S3LogDelivery : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// Bucket
        ...
        public class Vpc : Humidifier.Base.BaseSubResource, IHaveSecurityGroups, IHaveSubnets
        {
            /// <summary>
            /// SecurityGroups
        ...
        public class WorkerLogDelivery : Humidifier.Base.BaseSubResource
        {
            ...
            /// Type: S3LogDelivery
            /// </summary>
            public ConnectorTypes.S3LogDelivery S3 { get; set; }
            /// <summary>
            /// Firehose
            ...
            /// </summary>
            public ConnectorTypes.FirehoseLogDelivery Firehose { get; set; }
            /// <summary>
            /// CloudWatchLogs
            ...
            /// </summary>
            public ConnectorTypes.CloudWatchLogsLogDelivery CloudWatchLogs { get; set; }
        }
    }
}