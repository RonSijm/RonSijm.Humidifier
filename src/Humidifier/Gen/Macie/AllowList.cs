namespace Humidifier.Macie
{
    ...
    {
        public class Criteria : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// Regex
            ...
            /// Type: S3WordsList
            /// </summary>
            public AllowListTypes.S3WordsList S3WordsList { get; set; }
        }

        public class S3WordsList : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// BucketName
