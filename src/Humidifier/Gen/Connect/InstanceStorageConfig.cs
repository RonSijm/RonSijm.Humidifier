namespace Humidifier.Connect
{
    ...
    public class InstanceStorageConfig : Humidifier.Base.BaseResource
    {
        ...
        /// </summary>
        public InstanceStorageConfigTypes.KinesisStreamConfig KinesisStreamConfig { get; set; }
        /// <summary>
        /// S3Config
        ...
        /// </summary>
        public InstanceStorageConfigTypes.KinesisVideoStreamConfig KinesisVideoStreamConfig { get; set; }
        /// <summary>
        ...
        /// </summary>
        public InstanceStorageConfigTypes.KinesisFirehoseConfig KinesisFirehoseConfig { get; set; }
    }
    ...
    namespace InstanceStorageConfigTypes
    {
        ...
        public class KinesisStreamConfig : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// StreamArn
        ...
        public class KinesisVideoStreamConfig : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// Prefix
            ...
            /// </summary>
            public InstanceStorageConfigTypes.EncryptionConfig EncryptionConfig { get; set; }
        }

        public class S3Config : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// BucketName
