namespace Humidifier.Connect
{
    ...
    namespace RoutingProfileTypes
    {
        ...
        public class MediaConcurrency : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// Concurrency
            ...
            /// </summary>
            public RoutingProfileTypes.CrossChannelBehavior CrossChannelBehavior { get; set; }
        }

        public class RoutingProfileQueueConfig : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// Priority
            ...
            /// </summary>
            public RoutingProfileTypes.RoutingProfileQueueReference QueueReference { get; set; }
            /// <summary>
            /// Delay
        ...
        public class RoutingProfileQueueReference : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// Channel
