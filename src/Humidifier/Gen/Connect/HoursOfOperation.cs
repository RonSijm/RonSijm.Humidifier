namespace Humidifier.Connect
{
    ...
    public class HoursOfOperation : Humidifier.Base.BaseResource, IHaveTags, IHaveDescription, IHaveImpliedResourceName
    {
        ...
        /// </summary>
        public List<HoursOfOperationTypes.HoursOfOperationConfig> Config { get; set; }
        /// <summary>
        /// InstanceArn
    ...
    namespace HoursOfOperationTypes
    {
        public class HoursOfOperationConfig : Humidifier.Base.BaseSubResource
        {
            ...
            /// </summary>
            public HoursOfOperationTypes.HoursOfOperationTimeSlice EndTime { get; set; }
            /// <summary>
            /// StartTime
            ...
            /// Type: HoursOfOperationTimeSlice
            /// </summary>
            public HoursOfOperationTypes.HoursOfOperationTimeSlice StartTime { get; set; }
            /// <summary>
            /// Day
        ...
        public class HoursOfOperationTimeSlice : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// Hours
