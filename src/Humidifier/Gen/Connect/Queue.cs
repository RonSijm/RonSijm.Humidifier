namespace Humidifier.Connect
{
    ...
    public class Queue : Humidifier.Base.BaseResource, IHaveImpliedResourceName, IHaveTags, IHaveDescription
    {
        ...
        /// </summary>
        public QueueTypes.OutboundCallerConfig OutboundCallerConfig { get; set; }
        /// <summary>
        /// MaxContacts
