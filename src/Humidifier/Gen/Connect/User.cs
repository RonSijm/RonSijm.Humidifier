namespace Humidifier.Connect
{
    ...
    public class User : Humidifier.Base.BaseResource, IHaveTags
    {
        ...
        /// </summary>
        public UserTypes.UserIdentityInfo IdentityInfo { get; set; }
        /// <summary>
        /// HierarchyGroupArn
        ...
        /// </summary>
        public List<UserTypes.UserProficiency> UserProficiencies { get; set; }
        /// <summary>
        /// Password
    ...
    namespace UserTypes
    {
        public class UserIdentityInfo : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// Email
        ...
        public class UserProficiency : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// AttributeValue
