namespace Humidifier.Connect
{
    ...
    namespace RuleTypes
    {
        public class Actions : Humidifier.Base.BaseSubResource
        {
            ...
            /// </summary>
            public List<RuleTypes.EventBridgeAction> EventBridgeActions { get; set; }
            /// <summary>
            /// UpdateCaseActions
            ...
            /// </summary>
            public List<RuleTypes.UpdateCaseAction> UpdateCaseActions { get; set; }
            /// <summary>
            /// CreateCaseActions
            ...
            /// </summary>
            public List<RuleTypes.CreateCaseAction> CreateCaseActions { get; set; }
            /// <summary>
            ...
            /// ItemType: TaskAction
            /// </summary>
            public List<RuleTypes.TaskAction> TaskActions { get; set; }
            /// <summary>
            ...
            /// </summary>
            public List<RuleTypes.SubmitAutoEvaluationAction> SubmitAutoEvaluationActions { get; set; }
            /// <summary>
            ...
            /// </summary>
            public List<RuleTypes.SendNotificationAction> SendNotificationActions { get; set; }
            /// <summary>
        ...
        public class CreateCaseAction : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// Fields
            ...
            /// ItemType: Field
            /// </summary>
            public List<RuleTypes.Field> Fields { get; set; }
            /// <summary>
            /// TemplateId
        ...
        public class EventBridgeAction : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// Name
        ...
        public class Field : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// Value
            ...
            /// Type: FieldValue
            /// </summary>
            public RuleTypes.FieldValue Value { get; set; }
            /// <summary>
            /// Id
        ...
        public class FieldValue : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// DoubleValue
        ...
        public class SendNotificationAction : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// DeliveryMethod
            ...
            /// </summary>
            public RuleTypes.NotificationRecipientType Recipient { get; set; }
            /// <summary>
            /// Subject
        ...
        public class TaskAction : Humidifier.Base.BaseSubResource, IHaveDescription
        {
            /// <summary>
            /// Description
            ...
            /// ItemType: Reference
            /// </summary>
            public Dictionary<string, RuleTypes.Reference> References { get; set; }
            /// <summary>
            /// ContactFlowArn
