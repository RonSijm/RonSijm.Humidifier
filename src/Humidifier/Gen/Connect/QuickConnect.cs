namespace Humidifier.Connect
{
    ...
    public class QuickConnect : Humidifier.Base.BaseResource, IHaveImpliedResourceName, IHaveTags, IHaveDescription
    {
        ...
        /// </summary>
        [Required]
        public QuickConnectTypes.QuickConnectConfig QuickConnectConfig { get; set; }
    ...
    {
        public class PhoneNumberQuickConnectConfig : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// PhoneNumber
        ...
        public class QueueQuickConnectConfig : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// ContactFlowArn
        ...
        public class QuickConnectConfig : Humidifier.Base.BaseSubResource
        {
            ...
            /// </summary>
            public QuickConnectTypes.QueueQuickConnectConfig QueueConfig { get; set; }
            /// <summary>
            /// PhoneConfig
            ...
            /// </summary>
            public QuickConnectTypes.PhoneNumberQuickConnectConfig PhoneConfig { get; set; }
            /// <summary>
            /// QuickConnectType
            ...
            /// </summary>
            public QuickConnectTypes.UserQuickConnectConfig UserConfig { get; set; }
        }

        public class UserQuickConnectConfig : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// UserArn
