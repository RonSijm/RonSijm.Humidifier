namespace Humidifier.Connect
{
    ...
    public class TaskTemplate : Humidifier.Base.BaseResource, IHaveImpliedResourceName, IHaveTags, IHaveDescription
    {
        ...
        /// Type: Constraints
        /// </summary>
        public TaskTemplateTypes.Constraints Constraints { get; set; }
        /// <summary>
        /// Defaults
        ...
        /// </summary>
        public List<TaskTemplateTypes.DefaultFieldValue> Defaults { get; set; }
        /// <summary>
        /// Fields
    ...
    namespace TaskTemplateTypes
    {
        public class Constraints : Humidifier.Base.BaseSubResource
        {
            ...
            /// </summary>
            public List<TaskTemplateTypes.ReadOnlyFieldInfo> ReadOnlyFields { get; set; }
            /// <summary>
            /// InvisibleFields
            ...
            /// </summary>
            public List<TaskTemplateTypes.InvisibleFieldInfo> InvisibleFields { get; set; }
            /// <summary>
            /// RequiredFields
            ...
            /// </summary>
            public List<TaskTemplateTypes.RequiredFieldInfo> RequiredFields { get; set; }
        }

        public class DefaultFieldValue : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// DefaultValue
            ...
            /// </summary>
            public TaskTemplateTypes.FieldIdentifier Id { get; set; }
        }

        public class Field : Humidifier.Base.BaseSubResource, IHaveDescription
        {
            /// <summary>
            /// Type
        ...
        public class InvisibleFieldInfo : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// Id
        ...
        public class ReadOnlyFieldInfo : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// Id
        ...
        public class RequiredFieldInfo : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// Id
