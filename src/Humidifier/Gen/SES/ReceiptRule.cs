namespace Humidifier.SES
{
    ...
    namespace ReceiptRuleTypes
    {
        public class Action : Humidifier.Base.BaseSubResource
        {
            ...
            /// Type: BounceAction
            /// </summary>
            public ReceiptRuleTypes.BounceAction BounceAction { get; set; }
            /// <summary>
            /// S3Action
            ...
            /// Type: S3Action
            /// </summary>
            public ReceiptRuleTypes.S3Action S3Action { get; set; }
            /// <summary>
            /// StopAction
            ...
            /// Type: StopAction
            /// </summary>
            public ReceiptRuleTypes.StopAction StopAction { get; set; }
            /// <summary>
            /// SNSAction
            ...
            /// Type: SNSAction
            /// </summary>
            public ReceiptRuleTypes.SNSAction SNSAction { get; set; }
            /// <summary>
            /// WorkmailAction
            ...
            /// Type: WorkmailAction
            /// </summary>
            public ReceiptRuleTypes.WorkmailAction WorkmailAction { get; set; }
            /// <summary>
            /// AddHeaderAction
            ...
            /// </summary>
            public ReceiptRuleTypes.AddHeaderAction AddHeaderAction { get; set; }
            /// <summary>
            /// LambdaAction
            ...
            /// Type: LambdaAction
            /// </summary>
            public ReceiptRuleTypes.LambdaAction LambdaAction { get; set; }
        }
        ...
        public class BounceAction : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// Sender
        ...
        public class Rule : Humidifier.Base.BaseSubResource
        {
            ...
            /// ItemType: Action
            /// </summary>
            public List<ReceiptRuleTypes.Action> Actions { get; set; }
            /// <summary>
            /// Enabled
        ...
        public class StopAction : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// Scope
        ...
        public class WorkmailAction : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// TopicArn
