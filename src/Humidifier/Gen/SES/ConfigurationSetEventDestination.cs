namespace Humidifier.SES
{
    ...
    namespace ConfigurationSetEventDestinationTypes
    {
        public class CloudWatchDestination : Humidifier.Base.BaseSubResource
        {
            ...
            /// </summary>
            public List<ConfigurationSetEventDestinationTypes.DimensionConfiguration> DimensionConfigurations { get; set; }
        }

        public class DimensionConfiguration : Humidifier.Base.BaseSubResource
        {
            /// <summary>
        ...
        public class EventBridgeDestination : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// EventBusArn
        ...
        public class EventDestination : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// SnsDestination
            ...
            /// Type: SnsDestination
            /// </summary>
            public ConfigurationSetEventDestinationTypes.SnsDestination SnsDestination { get; set; }
            /// <summary>
            ...
            /// </summary>
            public ConfigurationSetEventDestinationTypes.CloudWatchDestination CloudWatchDestination { get; set; }
            /// <summary>
            /// Enabled
            ...
            /// </summary>
            public ConfigurationSetEventDestinationTypes.EventBridgeDestination EventBridgeDestination { get; set; }
            /// <summary>
            /// Name
            ...
            /// </summary>
            public ConfigurationSetEventDestinationTypes.KinesisFirehoseDestination KinesisFirehoseDestination { get; set; }
        }
