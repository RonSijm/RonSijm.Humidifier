namespace Humidifier.SES
{
    ...
    public class ContactList : Humidifier.Base.BaseResource, IHaveTags, IHaveDescription, IHaveImpliedResourceName
    {
        ...
        /// ItemType: Topic
        /// </summary>
        public List<ContactListTypes.Topic> Topics { get; set; }
    ...
    {
        public class Topic : Humidifier.Base.BaseSubResource, IHaveDescription
        {
            /// <summary>
            /// Description
