namespace Humidifier.SES
{
    ...
    public class MailManagerIngressPoint : Humidifier.Base.BaseResource, IHaveTags
    {
        ...
        /// </summary>
        public MailManagerIngressPointTypes.IngressPointConfiguration IngressPointConfiguration { get; set; }
    }

    namespace MailManagerIngressPointTypes
    {
        public class IngressPointConfiguration : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// SecretArn
