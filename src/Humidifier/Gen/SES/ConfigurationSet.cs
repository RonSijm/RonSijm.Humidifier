namespace Humidifier.SES
{
    ...
    public class ConfigurationSet : Humidifier.Base.BaseResource, IHaveImpliedResourceName
    {
        ...
        /// Type: SendingOptions
        /// </summary>
        public ConfigurationSetTypes.SendingOptions SendingOptions { get; set; }
        /// <summary>
        /// SuppressionOptions
        ...
        /// </summary>
        public ConfigurationSetTypes.SuppressionOptions SuppressionOptions { get; set; }
        /// <summary>
        /// TrackingOptions
        ...
        /// </summary>
        public ConfigurationSetTypes.TrackingOptions TrackingOptions { get; set; }
        /// <summary>
        /// ReputationOptions
        ...
        /// </summary>
        public ConfigurationSetTypes.ReputationOptions ReputationOptions { get; set; }
        /// <summary>
        /// VdmOptions
        ...
        /// Type: VdmOptions
        /// </summary>
        public ConfigurationSetTypes.VdmOptions VdmOptions { get; set; }
        /// <summary>
        /// DeliveryOptions
        ...
        /// </summary>
        public ConfigurationSetTypes.DeliveryOptions DeliveryOptions { get; set; }
    ...
    namespace ConfigurationSetTypes
    {
        ...
        public class VdmOptions : Humidifier.Base.BaseSubResource
        {
            ...
            /// </summary>
            public ConfigurationSetTypes.DashboardOptions DashboardOptions { get; set; }
            /// <summary>
            /// GuardianOptions
            ...
            /// </summary>
            public ConfigurationSetTypes.GuardianOptions GuardianOptions { get; set; }
        }
    }
}