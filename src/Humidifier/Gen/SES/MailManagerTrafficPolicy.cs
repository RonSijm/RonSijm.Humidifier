namespace Humidifier.SES
{
    ...
    namespace MailManagerTrafficPolicyTypes
    {
        ...
        public class IngressBooleanExpression : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// Operator
            ...
            /// </summary>
            public MailManagerTrafficPolicyTypes.IngressBooleanToEvaluate Evaluate { get; set; }
        }
        ...
        public class IngressBooleanToEvaluate : Humidifier.Base.BaseSubResource
        {
            ...
            /// </summary>
            public MailManagerTrafficPolicyTypes.IngressAnalysis Analysis { get; set; }
        }

        public class IngressIpToEvaluate : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// Attribute
        ...
        public class IngressIpv4Expression : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// Operator
            ...
            /// </summary>
            public MailManagerTrafficPolicyTypes.IngressIpToEvaluate Evaluate { get; set; }
            /// <summary>
            /// Values
        ...
        public class IngressStringExpression : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// Operator
            ...
            /// </summary>
            public MailManagerTrafficPolicyTypes.IngressStringToEvaluate Evaluate { get; set; }
            /// <summary>
            /// Values
        ...
        public class IngressStringToEvaluate : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// Attribute
        ...
        public class IngressTlsProtocolExpression : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// Operator
            ...
            /// </summary>
            public MailManagerTrafficPolicyTypes.IngressTlsProtocolToEvaluate Evaluate { get; set; }
            /// <summary>
            /// Value
        ...
        public class IngressTlsProtocolToEvaluate : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// Attribute
        ...
        public class PolicyCondition : Humidifier.Base.BaseSubResource
        {
            ...
            /// </summary>
            public MailManagerTrafficPolicyTypes.IngressBooleanExpression BooleanExpression { get; set; }
            /// <summary>
            /// StringExpression
            ...
            /// </summary>
            public MailManagerTrafficPolicyTypes.IngressStringExpression StringExpression { get; set; }
            /// <summary>
            /// TlsExpression
            ...
            /// </summary>
            public MailManagerTrafficPolicyTypes.IngressTlsProtocolExpression TlsExpression { get; set; }
            /// <summary>
            /// IpExpression
            ...
            /// </summary>
            public MailManagerTrafficPolicyTypes.IngressIpv4Expression IpExpression { get; set; }
        }

        public class PolicyStatement : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// Action
            ...
            /// </summary>
            public List<MailManagerTrafficPolicyTypes.PolicyCondition> Conditions { get; set; }
        }
    }
}