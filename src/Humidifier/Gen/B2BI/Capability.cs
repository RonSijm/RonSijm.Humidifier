namespace Humidifier.B2BI
{
    ...
    public class Capability : Humidifier.Base.BaseResource, IHaveImpliedResourceName, IHaveTags
    {
        ...
        /// ItemType: S3Location
        /// </summary>
        public List<CapabilityTypes.S3Location> InstructionsDocuments { get; set; }
        /// <summary>
        /// Tags
    ...
    namespace CapabilityTypes
    {
        public class CapabilityConfiguration : Humidifier.Base.BaseSubResource
        {
            ...
            /// </summary>
            public CapabilityTypes.EdiConfiguration Edi { get; set; }
        }
        ...
        public class EdiConfiguration : Humidifier.Base.BaseSubResource
        {
            ...
            /// Type: EdiType
            /// </summary>
            public CapabilityTypes.EdiType Type { get; set; }
            /// <summary>
            /// InputLocation
            ...
            /// Type: S3Location
            /// </summary>
            public CapabilityTypes.S3Location InputLocation { get; set; }
            /// <summary>
            /// TransformerId
            ...
            /// Type: S3Location
            /// </summary>
            public CapabilityTypes.S3Location OutputLocation { get; set; }
        }
        ...
        public class EdiType : Humidifier.Base.BaseSubResource
        {
            ...
            /// Type: X12Details
            /// </summary>
            public CapabilityTypes.X12Details X12Details { get; set; }
        }
        ...
        public class X12Details : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// Version
