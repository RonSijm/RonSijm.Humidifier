namespace Humidifier.ResilienceHub
{
    ...
    public class App : Humidifier.Base.BaseResource, IHaveImpliedResourceName, IHaveDescription
    {
        ...
        /// </summary>
        public List<AppTypes.EventSubscription> EventSubscriptions { get; set; }
        /// <summary>
        /// Tags
    ...
    namespace AppTypes
    {
        public class EventSubscription : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// EventType
        ...
        public class PermissionModel : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// Type
        ...
        public class PhysicalResourceId : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// Type
        ...
        public class ResourceMapping : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// MappingType
            ...
            /// </summary>
            public AppTypes.PhysicalResourceId PhysicalResourceId { get; set; }
            /// <summary>
            /// EksSourceName
