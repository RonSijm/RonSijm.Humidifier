namespace Humidifier.ResilienceHub
{
    ...
    public class ResiliencyPolicy : Humidifier.Base.BaseResource
    {
    ...
    namespace ResiliencyPolicyTypes
    {
        ...
        public class PolicyMap : Humidifier.Base.BaseSubResource
        {
            ...
            /// Type: FailurePolicy
            /// </summary>
            public ResiliencyPolicyTypes.FailurePolicy AZ { get; set; }
            /// <summary>
            /// Region
            ...
            /// Type: FailurePolicy
            /// </summary>
            public ResiliencyPolicyTypes.FailurePolicy Region { get; set; }
            /// <summary>
            /// Hardware
            ...
            /// Type: FailurePolicy
            /// </summary>
            public ResiliencyPolicyTypes.FailurePolicy Hardware { get; set; }
            /// <summary>
            /// Software
            ...
            /// Type: FailurePolicy
            /// </summary>
            public ResiliencyPolicyTypes.FailurePolicy Software { get; set; }
        }
    }
}