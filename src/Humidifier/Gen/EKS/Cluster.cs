namespace Humidifier.EKS
{
    ...
    public class Cluster : Humidifier.Base.BaseResource, IHaveImpliedResourceName, IHaveTags
    {
        ...
        /// Type: Logging
        /// </summary>
        public ClusterTypes.Logging Logging { get; set; }
        /// <summary>
        /// UpgradePolicy
        ...
        /// Type: UpgradePolicy
        /// </summary>
        public ClusterTypes.UpgradePolicy UpgradePolicy { get; set; }
        /// <summary>
        /// Version
        ...
        /// Type: AccessConfig
        /// </summary>
        public ClusterTypes.AccessConfig AccessConfig { get; set; }
        /// <summary>
        /// OutpostConfig
        ...
        /// Type: OutpostConfig
        /// </summary>
        public ClusterTypes.OutpostConfig OutpostConfig { get; set; }
        /// <summary>
        /// EncryptionConfig
        ...
        /// </summary>
        public List<ClusterTypes.EncryptionConfig> EncryptionConfig { get; set; }
        /// <summary>
    ...
    namespace ClusterTypes
    {
        ...
        public class ClusterLogging : Humidifier.Base.BaseSubResource
        {
            ...
            /// </summary>
            public List<ClusterTypes.LoggingTypeConfig> EnabledTypes { get; set; }
        }

        public class ControlPlanePlacement : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// GroupName
        ...
        public class EncryptionConfig : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// Resources
            ...
            /// Type: Provider
            /// </summary>
            public ClusterTypes.Provider Provider { get; set; }
        }
        ...
        public class Logging : Humidifier.Base.BaseSubResource
        {
            ...
            /// Type: ClusterLogging
            /// </summary>
            public ClusterTypes.ClusterLogging ClusterLogging { get; set; }
        }

        public class LoggingTypeConfig : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// Type
        ...
        public class OutpostConfig : Humidifier.Base.BaseSubResource
        {
            ...
            /// </summary>
            public ClusterTypes.ControlPlanePlacement ControlPlanePlacement { get; set; }
            /// <summary>
        ...
        public class Provider : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// KeyArn
