namespace Humidifier.EKS
{
    ...
    public class IdentityProviderConfig : Humidifier.Base.BaseResource, IHaveTags, IHaveImpliedResourceName
    {
        ...
        /// </summary>
        public IdentityProviderConfigTypes.OidcIdentityProviderConfig Oidc { get; set; }
        /// <summary>
        /// Tags
    ...
    {
        public class OidcIdentityProviderConfig : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// UsernamePrefix
            ...
            /// </summary>
            public List<IdentityProviderConfigTypes.RequiredClaim> RequiredClaims { get; set; }
            /// <summary>
            /// ClientId
        ...
        public class RequiredClaim : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// Value
