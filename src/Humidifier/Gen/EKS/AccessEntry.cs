namespace Humidifier.EKS
{
    ...
    public class AccessEntry : Humidifier.Base.BaseResource, IHaveTags
    {
        ...
        /// </summary>
        public List<AccessEntryTypes.AccessPolicy> AccessPolicies { get; set; }
        /// <summary>
        /// Tags
    ...
    namespace AccessEntryTypes
    {
        public class AccessPolicy : Humidifier.Base.BaseSubResource
        {
            ...
            /// Type: AccessScope
            /// </summary>
            public AccessEntryTypes.AccessScope AccessScope { get; set; }
        }

        public class AccessScope : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// Namespaces
