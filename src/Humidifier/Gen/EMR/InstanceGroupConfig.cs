namespace Humidifier.EMR
{
    ...
    public class InstanceGroupConfig : Humidifier.Base.BaseResource, IHaveImpliedResourceName
    {
        ...
        /// </summary>
        public InstanceGroupConfigTypes.AutoScalingPolicy AutoScalingPolicy { get; set; }
        /// <summary>
        /// BidPrice
        ...
        /// </summary>
        public List<InstanceGroupConfigTypes.Configuration> Configurations { get; set; }
        /// <summary>
        /// CustomAmiId
    ...
    namespace InstanceGroupConfigTypes
    {
        public class AutoScalingPolicy : Humidifier.Base.BaseSubResource
        {
            ...
            /// </summary>
            public InstanceGroupConfigTypes.ScalingConstraints Constraints { get; set; }
            /// <summary>
            /// Rules
            ...
            /// </summary>
            public List<InstanceGroupConfigTypes.ScalingRule> Rules { get; set; }
        }
        ...
        public class CloudWatchAlarmDefinition : Humidifier.Base.BaseSubResource
        {
            ...
            /// </summary>
            public List<InstanceGroupConfigTypes.MetricDimension> Dimensions { get; set; }
            /// <summary>
            /// EvaluationPeriods
        ...
        public class EbsBlockDeviceConfig : Humidifier.Base.BaseSubResource
        {
            ...
            /// </summary>
            public InstanceGroupConfigTypes.VolumeSpecification VolumeSpecification { get; set; }
            /// <summary>
            /// VolumesPerInstance
        ...
        public class EbsConfiguration : Humidifier.Base.BaseSubResource
        {
            ...
            /// </summary>
            public List<InstanceGroupConfigTypes.EbsBlockDeviceConfig> EbsBlockDeviceConfigs { get; set; }
            /// <summary>
            /// EbsOptimized
        ...
        public class ScalingAction : Humidifier.Base.BaseSubResource
        {
            ...
            /// </summary>
            public InstanceGroupConfigTypes.SimpleScalingPolicyConfiguration SimpleScalingPolicyConfiguration { get; set; }
        }
        ...
        public class ScalingRule : Humidifier.Base.BaseSubResource, IHaveDescription
        {
            ...
            /// Type: ScalingAction
            /// </summary>
            public InstanceGroupConfigTypes.ScalingAction Action { get; set; }
            /// <summary>
            /// Description
            ...
            /// Type: ScalingTrigger
            /// </summary>
            public InstanceGroupConfigTypes.ScalingTrigger Trigger { get; set; }
        }
        ...
        public class ScalingTrigger : Humidifier.Base.BaseSubResource
        {
            ...
            /// </summary>
            public InstanceGroupConfigTypes.CloudWatchAlarmDefinition CloudWatchAlarmDefinition { get; set; }
        }
