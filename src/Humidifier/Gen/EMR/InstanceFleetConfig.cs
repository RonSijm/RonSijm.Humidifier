namespace Humidifier.EMR
{
    ...
    public class InstanceFleetConfig : Humidifier.Base.BaseResource, IHaveImpliedResourceName
    {
        ...
        /// </summary>
        public List<InstanceFleetConfigTypes.InstanceTypeConfig> InstanceTypeConfigs { get; set; }
        /// <summary>
        ...
        /// </summary>
        public InstanceFleetConfigTypes.InstanceFleetProvisioningSpecifications LaunchSpecifications { get; set; }
    ...
    namespace InstanceFleetConfigTypes
    {
        public class Configuration : Humidifier.Base.BaseSubResource
        {
            ...
            /// </summary>
            public List<InstanceFleetConfigTypes.Configuration> Configurations { get; set; }
        }
        ...
        public class EbsBlockDeviceConfig : Humidifier.Base.BaseSubResource
        {
            ...
            /// </summary>
            public InstanceFleetConfigTypes.VolumeSpecification VolumeSpecification { get; set; }
            /// <summary>
            /// VolumesPerInstance
        ...
        public class EbsConfiguration : Humidifier.Base.BaseSubResource
        {
            ...
            /// </summary>
            public List<InstanceFleetConfigTypes.EbsBlockDeviceConfig> EbsBlockDeviceConfigs { get; set; }
            /// <summary>
            /// EbsOptimized
        ...
        public class InstanceFleetProvisioningSpecifications : Humidifier.Base.BaseSubResource
        {
            ...
            /// </summary>
            public InstanceFleetConfigTypes.OnDemandProvisioningSpecification OnDemandSpecification { get; set; }
            /// <summary>
            /// SpotSpecification
            ...
            /// </summary>
            public InstanceFleetConfigTypes.SpotProvisioningSpecification SpotSpecification { get; set; }
        }
        ...
        public class InstanceTypeConfig : Humidifier.Base.BaseSubResource
        {
            ...
            /// </summary>
            public InstanceFleetConfigTypes.EbsConfiguration EbsConfiguration { get; set; }
            /// <summary>
            /// InstanceType
