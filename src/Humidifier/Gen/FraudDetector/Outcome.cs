namespace Humidifier.FraudDetector
{
    ...
    public class Outcome : Humidifier.Base.BaseResource, IHaveImpliedResourceName, IHaveName, IHaveTags, IHaveDescription
    {
        ...
        public override string AWSTypeName { get => AWS.FraudDetector.Outcome; }
        /// <summary>
        /// Description
