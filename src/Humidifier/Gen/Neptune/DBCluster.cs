namespace Humidifier.Neptune
{
    ...
    public class DBCluster : Humidifier.Base.BaseResource, IHaveTags, IHaveKmsKeyId
    {
        ...
        /// </summary>
        public DBClusterTypes.ServerlessScalingConfiguration ServerlessScalingConfiguration { get; set; }
        /// <summary>
    ...
    namespace DBClusterTypes
    {
        ...
        public class ServerlessScalingConfiguration : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// MinCapacity
