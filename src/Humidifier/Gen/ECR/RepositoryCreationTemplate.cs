namespace Humidifier.ECR
{
    ...
    public class RepositoryCreationTemplate : Humidifier.Base.BaseResource, IHaveDescription
    {
        ...
        /// </summary>
        public RepositoryCreationTemplateTypes.EncryptionConfiguration EncryptionConfiguration { get; set; }
        /// <summary>
        /// ResourceTags
