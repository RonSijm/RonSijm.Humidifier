namespace Humidifier.ECR
{
    ...
    public class PublicRepository : Humidifier.Base.BaseResource, IHaveTags
    {
        ...
        /// </summary>
        public PublicRepositoryTypes.RepositoryCatalogData RepositoryCatalogData { get; set; }
        /// <summary>
        /// Tags
    ...
    {
        public class RepositoryCatalogData : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// AboutText
