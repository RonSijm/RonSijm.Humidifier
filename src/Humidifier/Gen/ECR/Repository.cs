namespace Humidifier.ECR
{
    ...
    public class Repository : Humidifier.Base.BaseResource, IHaveTags, IHaveImpliedResourceName
    {
        ...
        /// </summary>
        public RepositoryTypes.ImageScanningConfiguration ImageScanningConfiguration { get; set; }
        /// <summary>
        ...
        /// </summary>
        public RepositoryTypes.EncryptionConfiguration EncryptionConfiguration { get; set; }
        /// <summary>
        ...
        /// </summary>
        public RepositoryTypes.LifecyclePolicy LifecyclePolicy { get; set; }
