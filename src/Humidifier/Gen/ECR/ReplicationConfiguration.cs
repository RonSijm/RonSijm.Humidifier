namespace Humidifier.ECR
{
    ...
    namespace ReplicationConfigurationTypes
    {
        public class ReplicationConfiguration : Humidifier.Base.BaseSubResource
        {
            ...
            /// </summary>
            public List<ReplicationConfigurationTypes.ReplicationRule> Rules { get; set; }
        }
        ...
        public class ReplicationRule : Humidifier.Base.BaseSubResource
        {
            ...
            /// </summary>
            public List<ReplicationConfigurationTypes.RepositoryFilter> RepositoryFilters { get; set; }
            /// <summary>
            /// Destinations
            ...
            /// </summary>
            public List<ReplicationConfigurationTypes.ReplicationDestination> Destinations { get; set; }
        }

        public class RepositoryFilter : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// FilterType
