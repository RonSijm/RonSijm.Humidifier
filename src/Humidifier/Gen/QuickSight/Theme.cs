namespace Humidifier.QuickSight
{
    ...
    public class Theme : Humidifier.Base.BaseResource, IHaveImpliedResourceName, IHaveTags
    {
        ...
        /// </summary>
        public List<ThemeTypes.ResourcePermission> Permissions { get; set; }
        /// <summary>
        /// Tags
    ...
    {
        public class BorderStyle : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// Show
        ...
        public class GutterStyle : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// Show
        ...
        public class MarginStyle : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// Show
        ...
        public class SheetStyle : Humidifier.Base.BaseSubResource
        {
            ...
            /// </summary>
            public ThemeTypes.TileLayoutStyle TileLayout { get; set; }
            /// <summary>
            /// Tile
            ...
            /// Type: TileStyle
            /// </summary>
            public ThemeTypes.TileStyle Tile { get; set; }
        }
        ...
        public class ThemeConfiguration : Humidifier.Base.BaseSubResource
        {
            ...
            /// </summary>
            public ThemeTypes.DataColorPalette DataColorPalette { get; set; }
            /// <summary>
            /// UIColorPalette
            ...
            /// Type: UIColorPalette
            /// </summary>
            public ThemeTypes.UIColorPalette UIColorPalette { get; set; }
            /// <summary>
            /// Sheet
            ...
            /// Type: SheetStyle
            /// </summary>
            public ThemeTypes.SheetStyle Sheet { get; set; }
            /// <summary>
            /// Typography
            ...
            /// Type: Typography
            /// </summary>
            public ThemeTypes.Typography Typography { get; set; }
        }

        public class ThemeError : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// Type
        ...
        public class ThemeVersion : Humidifier.Base.BaseSubResource, IHaveDescription
        {
            /// <summary>
            /// Status
            ...
            /// ItemType: ThemeError
            /// </summary>
            public List<ThemeTypes.ThemeError> Errors { get; set; }
            /// <summary>
            /// Description
        ...
        public class TileLayoutStyle : Humidifier.Base.BaseSubResource
        {
            ...
            /// Type: GutterStyle
            /// </summary>
            public ThemeTypes.GutterStyle Gutter { get; set; }
            /// <summary>
            /// Margin
            ...
            /// Type: MarginStyle
            /// </summary>
            public ThemeTypes.MarginStyle Margin { get; set; }
        }
        ...
        public class TileStyle : Humidifier.Base.BaseSubResource
        {
            ...
            /// Type: BorderStyle
            /// </summary>
            public ThemeTypes.BorderStyle Border { get; set; }
        }
        ...
        public class Typography : Humidifier.Base.BaseSubResource
        {
            ...
            /// ItemType: Font
            /// </summary>
            public List<ThemeTypes.Font> FontFamilies { get; set; }
        }
