namespace Humidifier.QuickSight
{
    ...
    public class RefreshSchedule : Humidifier.Base.BaseResource
    {
        ...
        /// </summary>
        public RefreshScheduleTypes.RefreshScheduleMap Schedule { get; set; }
        /// <summary>
        /// AwsAccountId
    ...
    {
        public class RefreshOnDay : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// DayOfWeek
        ...
        public class RefreshScheduleMap : Humidifier.Base.BaseSubResource
        {
            ...
            /// </summary>
            public RefreshScheduleTypes.ScheduleFrequency ScheduleFrequency { get; set; }
            /// <summary>
            /// RefreshType
        ...
        public class ScheduleFrequency : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// TimeZone
            ...
            /// Type: RefreshOnDay
            /// </summary>
            public RefreshScheduleTypes.RefreshOnDay RefreshOnDay { get; set; }
            /// <summary>
            /// TimeOfTheDay
