namespace Humidifier.GroundStation
{
    ...
    public class MissionProfile : Humidifier.Base.BaseResource, IHaveImpliedResourceName, IHaveTags
    {
        ...
        /// Type: StreamsKmsKey
        /// </summary>
        public MissionProfileTypes.StreamsKmsKey StreamsKmsKey { get; set; }
        /// <summary>
    ...
    {
        public class DataflowEdge : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// Destination
        ...
        public class StreamsKmsKey : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// KmsKeyArn
