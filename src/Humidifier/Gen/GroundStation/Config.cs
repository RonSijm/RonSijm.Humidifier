namespace Humidifier.GroundStation
{
    ...
    namespace ConfigTypes
    {
        public class AntennaDownlinkConfig : Humidifier.Base.BaseSubResource
        {
            ...
            /// Type: SpectrumConfig
            /// </summary>
            public ConfigTypes.SpectrumConfig SpectrumConfig { get; set; }
        }
        ...
        public class AntennaDownlinkDemodDecodeConfig : Humidifier.Base.BaseSubResource
        {
            ...
            /// </summary>
            public ConfigTypes.DemodulationConfig DemodulationConfig { get; set; }
            /// <summary>
            /// SpectrumConfig
            ...
            /// Type: DecodeConfig
            /// </summary>
            public ConfigTypes.DecodeConfig DecodeConfig { get; set; }
        }
        ...
        public class AntennaUplinkConfig : Humidifier.Base.BaseSubResource
        {
            ...
            /// </summary>
            public ConfigTypes.UplinkSpectrumConfig SpectrumConfig { get; set; }
            /// <summary>
            /// TargetEirp
            ...
            /// Type: Eirp
            /// </summary>
            public ConfigTypes.Eirp TargetEirp { get; set; }
        }
        ...
        public class ConfigData : Humidifier.Base.BaseSubResource
        {
            ...
            /// </summary>
            public ConfigTypes.DataflowEndpointConfig DataflowEndpointConfig { get; set; }
            /// <summary>
            /// UplinkEchoConfig
            ...
            /// </summary>
            public ConfigTypes.UplinkEchoConfig UplinkEchoConfig { get; set; }
            /// <summary>
            ...
            /// </summary>
            public ConfigTypes.AntennaDownlinkConfig AntennaDownlinkConfig { get; set; }
            /// <summary>
            ...
            /// </summary>
            public ConfigTypes.AntennaDownlinkDemodDecodeConfig AntennaDownlinkDemodDecodeConfig { get; set; }
            /// <summary>
            /// TrackingConfig
            ...
            /// Type: TrackingConfig
            /// </summary>
            public ConfigTypes.TrackingConfig TrackingConfig { get; set; }
            /// <summary>
            /// AntennaUplinkConfig
            ...
            /// </summary>
            public ConfigTypes.AntennaUplinkConfig AntennaUplinkConfig { get; set; }
            /// <summary>
            /// S3RecordingConfig
            ...
            /// </summary>
            public ConfigTypes.S3RecordingConfig S3RecordingConfig { get; set; }
        }
        ...
        public class Eirp : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// Value
        ...
        public class Frequency : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// Value
        ...
        public class FrequencyBandwidth : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// Value
        ...
        public class S3RecordingConfig : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// BucketArn
        ...
        public class SpectrumConfig : Humidifier.Base.BaseSubResource
        {
            ...
            /// </summary>
            public ConfigTypes.FrequencyBandwidth Bandwidth { get; set; }
            /// <summary>
            /// CenterFrequency
            ...
            /// Type: Frequency
            /// </summary>
            public ConfigTypes.Frequency CenterFrequency { get; set; }
        }
        ...
        public class UplinkEchoConfig : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// Enabled
