namespace Humidifier.RefactorSpaces
{
    ...
    public class Service : Humidifier.Base.BaseResource, IHaveImpliedResourceName, IHaveTags, IHaveDescription, IHaveVpcId
    {
        ...
        /// </summary>
        public ServiceTypes.LambdaEndpointInput LambdaEndpoint { get; set; }
        /// <summary>
        /// UrlEndpoint
        ...
        /// </summary>
        public ServiceTypes.UrlEndpointInput UrlEndpoint { get; set; }
        /// <summary>
        /// Description
    ...
    {
        public class LambdaEndpointInput : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// Arn
        ...
        public class UrlEndpointInput : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// HealthUrl
