namespace Humidifier.Rekognition
{
    ...
    public class StreamProcessor : Humidifier.Base.BaseResource, IHaveImpliedResourceName, IHaveTags, IHaveKmsKeyId
    {
        ...
        /// Type: S3Destination
        /// </summary>
        public StreamProcessorTypes.S3Destination S3Destination { get; set; }
        /// <summary>
        ...
        /// </summary>
        public StreamProcessorTypes.DataSharingPreference DataSharingPreference { get; set; }
        /// <summary>
        /// KmsKeyId
        ...
        /// </summary>
        public StreamProcessorTypes.FaceSearchSettings FaceSearchSettings { get; set; }
        /// <summary>
        ...
        /// </summary>
        public StreamProcessorTypes.ConnectedHomeSettings ConnectedHomeSettings { get; set; }
        /// <summary>
        /// NotificationChannel
        ...
        /// </summary>
        public List<StreamProcessorTypes.BoundingBox> BoundingBoxRegionsOfInterest { get; set; }
        /// <summary>
        /// KinesisDataStream
        ...
        /// </summary>
        public StreamProcessorTypes.KinesisDataStream KinesisDataStream { get; set; }
        /// <summary>
        /// Tags
    ...
    {
        public class BoundingBox : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// Left
        ...
        public class ConnectedHomeSettings : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// MinConfidence
        ...
        public class FaceSearchSettings : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// CollectionId
        ...
        public class KinesisDataStream : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// Arn
        ...
        public class KinesisVideoStream : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// Arn
        ...
        public class NotificationChannel : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// Arn
        ...
        public class S3Destination : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// BucketName
