namespace Humidifier.CloudFront
{
    ...
    namespace StreamingDistributionTypes
    {
        ...
        public class S3Origin : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// DomainName
        ...
        public class StreamingDistributionConfig : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// Logging
            ...
            /// Type: Logging
            /// </summary>
            public StreamingDistributionTypes.Logging Logging { get; set; }
            /// <summary>
            /// Comment
            ...
            /// Type: S3Origin
            /// </summary>
            public StreamingDistributionTypes.S3Origin S3Origin { get; set; }
            /// <summary>
            /// Enabled
            ...
            /// Type: TrustedSigners
            /// </summary>
            public StreamingDistributionTypes.TrustedSigners TrustedSigners { get; set; }
        }

        public class TrustedSigners : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// Enabled
