namespace Humidifier.CloudFront
{
    ...
    public class RealtimeLogConfig : Humidifier.Base.BaseResource, IHaveImpliedResourceName
    {
    ...
    namespace RealtimeLogConfigTypes
    {
        public class EndPoint : Humidifier.Base.BaseSubResource
        {
            ...
            /// </summary>
            public RealtimeLogConfigTypes.KinesisStreamConfig KinesisStreamConfig { get; set; }
            /// <summary>
            /// StreamType
