namespace Humidifier.CloudFront
{
    ...
    public class Function : Humidifier.Base.BaseResource, IHaveImpliedResourceName
    {
        ...
        /// </summary>
        public FunctionTypes.FunctionMetadata FunctionMetadata { get; set; }
        /// <summary>
        /// AutoPublish
    ...
    {
        public class FunctionConfig : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// Comment
            ...
            /// </summary>
            public List<FunctionTypes.KeyValueStoreAssociation> KeyValueStoreAssociations { get; set; }
        }
