namespace Humidifier.CloudFront
{
    ...
    public class KeyValueStore : Humidifier.Base.BaseResource, IHaveImpliedResourceName
    {
        ...
        /// Type: ImportSource
        /// </summary>
        public KeyValueStoreTypes.ImportSource ImportSource { get; set; }
        public dynamic Name { get => GivenName; set => GivenName = value; }
    }

    namespace KeyValueStoreTypes
    {
        public class ImportSource : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// SourceArn
