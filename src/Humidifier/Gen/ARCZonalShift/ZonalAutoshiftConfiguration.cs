namespace Humidifier.ARCZonalShift
{
    ...
    public class ZonalAutoshiftConfiguration : Humidifier.Base.BaseResource
    {
        ...
        /// </summary>
        public ZonalAutoshiftConfigurationTypes.PracticeRunConfiguration PracticeRunConfiguration { get; set; }
    }

    namespace ZonalAutoshiftConfigurationTypes
    {
        public class ControlCondition : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// Type
        ...
        public class PracticeRunConfiguration : Humidifier.Base.BaseSubResource
        {
            ...
            /// </summary>
            public List<ZonalAutoshiftConfigurationTypes.ControlCondition> OutcomeAlarms { get; set; }
            /// <summary>
            /// BlockingAlarms
            ...
            /// ItemType: ControlCondition
            /// </summary>
            public List<ZonalAutoshiftConfigurationTypes.ControlCondition> BlockingAlarms { get; set; }
            /// <summary>
            /// BlockedWindows
