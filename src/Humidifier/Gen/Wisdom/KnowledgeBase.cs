namespace Humidifier.Wisdom
{
    ...
    public class KnowledgeBase : Humidifier.Base.BaseResource, IHaveImpliedResourceName, IHaveTags, IHaveDescription
    {
        ...
        /// </summary>
        public KnowledgeBaseTypes.SourceConfiguration SourceConfiguration { get; set; }
        /// <summary>
        ...
        /// </summary>
        public KnowledgeBaseTypes.ServerSideEncryptionConfiguration ServerSideEncryptionConfiguration { get; set; }
        /// <summary>
        ...
        /// </summary>
        public KnowledgeBaseTypes.RenderingConfiguration RenderingConfiguration { get; set; }
        /// <summary>
        /// Tags
    ...
    namespace KnowledgeBaseTypes
    {
        ...
        public class SourceConfiguration : Humidifier.Base.BaseSubResource
        {
            ...
            /// </summary>
            public KnowledgeBaseTypes.AppIntegrationsConfiguration AppIntegrations { get; set; }
        }
    }
}