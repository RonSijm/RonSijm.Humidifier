namespace Humidifier.EntityResolution
{
    ...
    public class IdNamespace : Humidifier.Base.BaseResource, IHaveImpliedResourceName, IHaveTags, IHaveDescription
    {
        ...
        /// </summary>
        public List<IdNamespaceTypes.IdNamespaceInputSource> InputSourceConfig { get; set; }
        /// <summary>
        ...
        /// </summary>
        public List<IdNamespaceTypes.IdNamespaceIdMappingWorkflowProperties> IdMappingWorkflowProperties { get; set; }
        /// <summary>
        /// RoleArn
    ...
    namespace IdNamespaceTypes
    {
        public class IdNamespaceIdMappingWorkflowProperties : Humidifier.Base.BaseSubResource
        {
            ...
            /// </summary>
            public IdNamespaceTypes.NamespaceRuleBasedProperties RuleBasedProperties { get; set; }
            /// <summary>
            /// ProviderProperties
            ...
            /// </summary>
            public IdNamespaceTypes.NamespaceProviderProperties ProviderProperties { get; set; }
            /// <summary>
            /// IdMappingType
        ...
        public class IdNamespaceInputSource : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// InputSourceARN
        ...
        public class NamespaceProviderProperties : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// ProviderServiceArn
        ...
        public class NamespaceRuleBasedProperties : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            ...
            /// ItemType: Rule
            /// </summary>
            public List<IdNamespaceTypes.Rule> Rules { get; set; }
        }
