namespace Humidifier.EntityResolution
{
    ...
    public class MatchingWorkflow : Humidifier.Base.BaseResource, IHaveTags, IHaveDescription
    {
    ...
    {
        public class InputSource : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// ApplyNormalization
        ...
        public class OutputAttribute : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// Hashed
        ...
        public class OutputSource : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// KMSArn
            ...
            /// </summary>
            public List<MatchingWorkflowTypes.OutputAttribute> Output { get; set; }
            /// <summary>
            /// ApplyNormalization
        ...
        public class ProviderProperties : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            ...
            /// </summary>
            public MatchingWorkflowTypes.IntermediateSourceConfiguration IntermediateSourceConfiguration { get; set; }
            /// <summary>
            /// ProviderServiceArn
        ...
        public class ResolutionTechniques : Humidifier.Base.BaseSubResource
        {
            ...
            /// </summary>
            public MatchingWorkflowTypes.RuleBasedProperties RuleBasedProperties { get; set; }
            /// <summary>
            /// ProviderProperties
            ...
            /// </summary>
            public MatchingWorkflowTypes.ProviderProperties ProviderProperties { get; set; }
            /// <summary>
            /// ResolutionType
        ...
        public class RuleBasedProperties : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            ...
            /// ItemType: Rule
            /// </summary>
            public List<MatchingWorkflowTypes.Rule> Rules { get; set; }
        }
    }
}