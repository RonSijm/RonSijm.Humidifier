namespace Humidifier.WAF
{
    ...
    public class SqlInjectionMatchSet : Humidifier.Base.BaseResource, IHaveImpliedResourceName
    {
        ...
        /// </summary>
        public List<SqlInjectionMatchSetTypes.SqlInjectionMatchTuple> SqlInjectionMatchTuples { get; set; }
    }
    ...
    namespace SqlInjectionMatchSetTypes
    {
        ...
        public class SqlInjectionMatchTuple : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// FieldToMatch
            ...
            /// Type: FieldToMatch
            /// </summary>
            public SqlInjectionMatchSetTypes.FieldToMatch FieldToMatch { get; set; }
            /// <summary>
            /// TextTransformation
