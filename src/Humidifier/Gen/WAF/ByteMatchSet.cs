namespace Humidifier.WAF
{
    ...
    public class ByteMatchSet : Humidifier.Base.BaseResource, IHaveImpliedResourceName
    {
        ...
        /// </summary>
        public List<ByteMatchSetTypes.ByteMatchTuple> ByteMatchTuples { get; set; }
        public dynamic Name { get => GivenName; set => GivenName = value; }
    }

    namespace ByteMatchSetTypes
    {
        public class ByteMatchTuple : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// FieldToMatch
            ...
            /// Type: FieldToMatch
            /// </summary>
            public ByteMatchSetTypes.FieldToMatch FieldToMatch { get; set; }
            /// <summary>
