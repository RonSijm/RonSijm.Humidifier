namespace Humidifier.EMRServerless
{
    ...
    public class Application : Humidifier.Base.BaseResource, IHaveImpliedResourceName, IHaveTags
    {
        ...
        /// </summary>
        public ApplicationTypes.AutoStartConfiguration AutoStartConfiguration { get; set; }
        /// <summary>
        /// Architecture
        ...
        /// </summary>
        public Dictionary<string, ApplicationTypes.WorkerTypeSpecificationInput> WorkerTypeSpecifications { get; set; }
        /// <summary>
        ...
        /// </summary>
        public ApplicationTypes.MaximumAllowedResources MaximumCapacity { get; set; }
        /// <summary>
        ...
        /// </summary>
        public ApplicationTypes.AutoStopConfiguration AutoStopConfiguration { get; set; }
        /// <summary>
        ...
        /// </summary>
        public ApplicationTypes.ImageConfigurationInput ImageConfiguration { get; set; }
        /// <summary>
    ...
    {
        public class AutoStartConfiguration : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// Enabled
        ...
        public class AutoStopConfiguration : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// Enabled
        ...
        public class CloudWatchLoggingConfiguration : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// EncryptionKeyArn
            ...
            /// </summary>
            public List<ApplicationTypes.LogTypeMapKeyValuePair> LogTypeMap { get; set; }
        }

        public class ConfigurationObject : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// Classification
            ...
            /// ItemType: ConfigurationObject
            /// </summary>
            public List<ApplicationTypes.ConfigurationObject> Configurations { get; set; }
        }

        public class ImageConfigurationInput : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// ImageUri
        ...
        public class InitialCapacityConfig : Humidifier.Base.BaseSubResource
        {
            ...
            /// </summary>
            public ApplicationTypes.WorkerConfiguration WorkerConfiguration { get; set; }
            /// <summary>
            /// WorkerCount
        ...
        public class InitialCapacityConfigKeyValuePair : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// Value
            ...
            /// </summary>
            public ApplicationTypes.InitialCapacityConfig Value { get; set; }
            /// <summary>
            /// Key
        ...
        public class ManagedPersistenceMonitoringConfiguration : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// EncryptionKeyArn
        ...
        public class MaximumAllowedResources : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// Memory
        ...
        public class MonitoringConfiguration : Humidifier.Base.BaseSubResource
        {
            ...
            /// </summary>
            public ApplicationTypes.S3MonitoringConfiguration S3MonitoringConfiguration { get; set; }
            /// <summary>
            ...
            /// </summary>
            public ApplicationTypes.ManagedPersistenceMonitoringConfiguration ManagedPersistenceMonitoringConfiguration { get; set; }
            /// <summary>
        ...
        public class S3MonitoringConfiguration : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// LogUri
        ...
        public class WorkerConfiguration : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// DiskType
