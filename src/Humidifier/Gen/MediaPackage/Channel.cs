namespace Humidifier.MediaPackage
{
    ...
    public class Channel : Humidifier.Base.BaseResource, IHaveTags, IHaveDescription
    {
        ...
        /// </summary>
        public ChannelTypes.LogConfiguration IngressAccessLogs { get; set; }
        /// <summary>
        /// HlsIngest
        ...
        /// Type: LogConfiguration
        /// </summary>
        public ChannelTypes.LogConfiguration EgressAccessLogs { get; set; }
        /// <summary>
        /// Tags
    ...
    namespace ChannelTypes
    {
        public class HlsIngest : Humidifier.Base.BaseSubResource
        {
            ...
            /// </summary>
            public List<ChannelTypes.IngestEndpoint> ingestEndpoints { get; set; }
        }

        public class IngestEndpoint : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// Username
