namespace Humidifier.MediaPackage
{
    ...
    public class Asset : Humidifier.Base.BaseResource, IHaveTags
    {
        ...
        /// </summary>
        public List<AssetTypes.EgressEndpoint> EgressEndpoints { get; set; }
        /// <summary>
        /// Tags
    ...
    {
        public class EgressEndpoint : Humidifier.Base.BaseSubResource
        {
            /// <summary>
