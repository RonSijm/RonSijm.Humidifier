namespace Humidifier.Glue
{
    ...
    public class Trigger : Humidifier.Base.BaseResource, IHaveImpliedResourceName, IHaveDescription
    {
        ...
        /// </summary>
        public TriggerTypes.EventBatchingCondition EventBatchingCondition { get; set; }
        /// <summary>
        /// WorkflowName
        ...
        /// Type: Predicate
        /// </summary>
        public TriggerTypes.Predicate Predicate { get; set; }
    }
    ...
    namespace TriggerTypes
    {
        public class Action : Humidifier.Base.BaseSubResource
        {
            ...
            /// </summary>
            public TriggerTypes.NotificationProperty NotificationProperty { get; set; }
            /// <summary>
            /// CrawlerName
        ...
        public class EventBatchingCondition : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// BatchSize
        ...
        public class Predicate : Humidifier.Base.BaseSubResource
        {
            ...
            /// ItemType: Condition
            /// </summary>
            public List<TriggerTypes.Condition> Conditions { get; set; }
        }
    }
}