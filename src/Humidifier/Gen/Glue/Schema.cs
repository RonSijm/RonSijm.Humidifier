namespace Humidifier.Glue
{
    ...
    public class Schema : Humidifier.Base.BaseResource, IHaveImpliedResourceName, IHaveTags, IHaveDescription
    {
        ...
        /// Type: SchemaVersion
        /// </summary>
        public SchemaTypes.SchemaVersion CheckpointVersion { get; set; }
    }

    namespace SchemaTypes
    {
        public class Registry : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// Arn
        ...
        public class SchemaVersion : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// IsLatest
