namespace Humidifier.Glue
{
    ...
    public class DataQualityRuleset : Humidifier.Base.BaseResource, IHaveDescription, IHaveImpliedResourceName
    {
        ...
        /// </summary>
        public DataQualityRulesetTypes.DataQualityTargetTable TargetTable { get; set; }
        /// <summary>
        /// ClientToken
    ...
    {
        public class DataQualityTargetTable : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// TableName
