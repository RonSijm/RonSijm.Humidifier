namespace Humidifier.Glue
{
    ...
    {
        public class ConnectionInput : Humidifier.Base.BaseSubResource, IHaveDescription
        {
            /// <summary>
            /// Description
            ...
            /// </summary>
            public ConnectionTypes.PhysicalConnectionRequirements PhysicalConnectionRequirements { get; set; }
            /// <summary>
        ...
        public class PhysicalConnectionRequirements : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// AvailabilityZone
