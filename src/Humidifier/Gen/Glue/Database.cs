namespace Humidifier.Glue
{
    ...
    public class Database : Humidifier.Base.BaseResource
    {
    ...
    namespace DatabaseTypes
    {
        ...
        public class DatabaseIdentifier : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// DatabaseName
        ...
        public class DatabaseInput : Humidifier.Base.BaseSubResource, IHaveDescription
        {
            /// <summary>
            /// LocationUri
            ...
            /// </summary>
            public List<DatabaseTypes.PrincipalPrivileges> CreateTableDefaultPermissions { get; set; }
            /// <summary>
            /// Description
            ...
            /// </summary>
            public DatabaseTypes.DatabaseIdentifier TargetDatabase { get; set; }
            /// <summary>
            /// FederatedDatabase
            ...
            /// </summary>
            public DatabaseTypes.FederatedDatabase FederatedDatabase { get; set; }
            /// <summary>
            /// Name
        ...
        public class FederatedDatabase : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// ConnectionName
        ...
        public class PrincipalPrivileges : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// Permissions
            ...
            /// </summary>
            public DatabaseTypes.DataLakePrincipal Principal { get; set; }
        }
    }
}