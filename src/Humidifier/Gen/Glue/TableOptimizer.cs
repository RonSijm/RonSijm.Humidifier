namespace Humidifier.Glue
{
    ...
    public class TableOptimizer : Humidifier.Base.BaseResource
    {
        ...
        /// </summary>
        [Required]
        public TableOptimizerTypes.TableOptimizerConfiguration TableOptimizerConfiguration { get; set; }
    ...
    {
        public class TableOptimizerConfiguration : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// Enabled
