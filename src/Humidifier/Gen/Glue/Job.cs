namespace Humidifier.Glue
{
    ...
    public class Job : Humidifier.Base.BaseResource, IHaveImpliedResourceName, IHaveDescription, IHaveRole
    {
        ...
        /// </summary>
        public JobTypes.ConnectionsList Connections { get; set; }
        /// <summary>
        /// MaxRetries
        ...
        /// </summary>
        public JobTypes.NotificationProperty NotificationProperty { get; set; }
        /// <summary>
        /// WorkerType
        ...
        /// </summary>
        public JobTypes.ExecutionProperty ExecutionProperty { get; set; }
        /// <summary>
    ...
    namespace JobTypes
    {
        ...
        public class JobCommand : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// Runtime
