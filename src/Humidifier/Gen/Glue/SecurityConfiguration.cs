namespace Humidifier.Glue
{
    ...
    {
        public class CloudWatchEncryption : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// KmsKeyArn
        ...
        public class EncryptionConfiguration : Humidifier.Base.BaseSubResource
        {
            ...
            /// Type: S3Encryptions
            /// </summary>
            public SecurityConfigurationTypes.S3Encryptions S3Encryptions { get; set; }
            /// <summary>
            ...
            /// </summary>
            public SecurityConfigurationTypes.CloudWatchEncryption CloudWatchEncryption { get; set; }
            /// <summary>
            ...
            /// </summary>
            public SecurityConfigurationTypes.JobBookmarksEncryption JobBookmarksEncryption { get; set; }
        }

        public class JobBookmarksEncryption : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// KmsKeyArn
