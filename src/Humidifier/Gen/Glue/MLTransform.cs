namespace Humidifier.Glue
{
    ...
    public class MLTransform : Humidifier.Base.BaseResource, IHaveImpliedResourceName, IHaveDescription, IHaveRole
    {
        ...
        /// </summary>
        public MLTransformTypes.TransformEncryption TransformEncryption { get; set; }
        /// <summary>
        /// Timeout
    ...
    namespace MLTransformTypes
    {
        ...
        public class GlueTables : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// ConnectionName
        ...
        public class TransformEncryption : Humidifier.Base.BaseSubResource
        {
            ...
            /// </summary>
            public MLTransformTypes.MLUserDataEncryption MLUserDataEncryption { get; set; }
            /// <summary>
        ...
        public class TransformParameters : Humidifier.Base.BaseSubResource
        {
            ...
            /// </summary>
            public MLTransformTypes.FindMatchesParameters FindMatchesParameters { get; set; }
        }
    }
}