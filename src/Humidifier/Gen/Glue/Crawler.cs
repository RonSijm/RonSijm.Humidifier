namespace Humidifier.Glue
{
    ...
    public class Crawler : Humidifier.Base.BaseResource, IHaveDescription, IHaveRole, IHaveImpliedResourceName
    {
        ...
        /// </summary>
        public CrawlerTypes.SchemaChangePolicy SchemaChangePolicy { get; set; }
        /// <summary>
        /// Configuration
        ...
        /// Type: RecrawlPolicy
        /// </summary>
        public CrawlerTypes.RecrawlPolicy RecrawlPolicy { get; set; }
        /// <summary>
        /// DatabaseName
        ...
        /// </summary>
        public CrawlerTypes.LakeFormationConfiguration LakeFormationConfiguration { get; set; }
        /// <summary>
        /// Schedule
        ...
        /// Type: Schedule
        /// </summary>
        public CrawlerTypes.Schedule Schedule { get; set; }
        /// <summary>
        /// TablePrefix
    ...
    {
        public class CatalogTarget : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// ConnectionName
        ...
        public class DeltaTarget : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// ConnectionName
        ...
        public class DynamoDBTarget : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// Path
        ...
        public class IcebergTarget : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// ConnectionName
        ...
        public class JdbcTarget : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// ConnectionName
        ...
        public class LakeFormationConfiguration : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// AccountId
        ...
        public class MongoDBTarget : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// ConnectionName
        ...
        public class S3Target : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// ConnectionName
        ...
        public class Targets : Humidifier.Base.BaseSubResource
        {
            ...
            /// ItemType: S3Target
            /// </summary>
            public List<CrawlerTypes.S3Target> S3Targets { get; set; }
            /// <summary>
            /// CatalogTargets
            ...
            /// </summary>
            public List<CrawlerTypes.CatalogTarget> CatalogTargets { get; set; }
            /// <summary>
            /// DeltaTargets
            ...
            /// </summary>
            public List<CrawlerTypes.DeltaTarget> DeltaTargets { get; set; }
            /// <summary>
            /// MongoDBTargets
            ...
            /// </summary>
            public List<CrawlerTypes.MongoDBTarget> MongoDBTargets { get; set; }
            /// <summary>
            /// JdbcTargets
            ...
            /// ItemType: JdbcTarget
            /// </summary>
            public List<CrawlerTypes.JdbcTarget> JdbcTargets { get; set; }
            /// <summary>
            /// DynamoDBTargets
            ...
            /// </summary>
            public List<CrawlerTypes.DynamoDBTarget> DynamoDBTargets { get; set; }
            /// <summary>
            /// IcebergTargets
            ...
            /// </summary>
            public List<CrawlerTypes.IcebergTarget> IcebergTargets { get; set; }
        }
    }
}