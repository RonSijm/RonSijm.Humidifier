namespace Humidifier.CloudWatch
{
    ...
    public class AnomalyDetector : Humidifier.Base.BaseResource
    {
        ...
        /// </summary>
        public AnomalyDetectorTypes.MetricCharacteristics MetricCharacteristics { get; set; }
        /// <summary>
        /// MetricName
        ...
        /// Type: Configuration
        /// </summary>
        public AnomalyDetectorTypes.Configuration Configuration { get; set; }
        /// <summary>
        ...
        /// </summary>
        public AnomalyDetectorTypes.MetricMathAnomalyDetector MetricMathAnomalyDetector { get; set; }
        /// <summary>
        /// Dimensions
        ...
        /// ItemType: Dimension
        /// </summary>
        public List<AnomalyDetectorTypes.Dimension> Dimensions { get; set; }
        /// <summary>
        /// Namespace
        ...
        /// </summary>
        public AnomalyDetectorTypes.SingleMetricAnomalyDetector SingleMetricAnomalyDetector { get; set; }
    }
    ...
    namespace AnomalyDetectorTypes
    {
        public class Configuration : Humidifier.Base.BaseSubResource
        {
            ...
            /// ItemType: Range
            /// </summary>
            public List<AnomalyDetectorTypes.Range> ExcludedTimeRanges { get; set; }
        }
        ...
        public class MetricDataQuery : Humidifier.Base.BaseSubResource
        {
            ...
            /// Type: MetricStat
            /// </summary>
            public AnomalyDetectorTypes.MetricStat MetricStat { get; set; }
            /// <summary>
            /// Label
        ...
        public class MetricMathAnomalyDetector : Humidifier.Base.BaseSubResource
        {
            ...
            /// </summary>
            public List<AnomalyDetectorTypes.MetricDataQuery> MetricDataQueries { get; set; }
        }
        ...
        public class MetricStat : Humidifier.Base.BaseSubResource
        {
            ...
            /// Type: Metric
            /// </summary>
            public AnomalyDetectorTypes.Metric Metric { get; set; }
            /// <summary>
            /// Unit
        ...
        public class Range : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// EndTime
        ...
        public class SingleMetricAnomalyDetector : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// MetricName
