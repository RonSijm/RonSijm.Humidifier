namespace Humidifier.CloudWatch
{
    ...
    public class Alarm : Humidifier.Base.BaseResource, IHaveImpliedResourceName, IHaveTags, IHaveDescription
    {
        ...
        /// ItemType: Dimension
        /// </summary>
        public List<AlarmTypes.Dimension> Dimensions { get; set; }
        /// <summary>
        /// Period
        ...
        /// </summary>
        public List<AlarmTypes.MetricDataQuery> Metrics { get; set; }
        /// <summary>
        /// AlarmDescription
    ...
    namespace AlarmTypes
    {
        ...
        public class MetricDataQuery : Humidifier.Base.BaseSubResource
        {
            ...
            /// Type: MetricStat
            /// </summary>
            public AlarmTypes.MetricStat MetricStat { get; set; }
            /// <summary>
            /// Period
        ...
        public class MetricStat : Humidifier.Base.BaseSubResource
        {
            ...
            /// Type: Metric
            /// </summary>
            public AlarmTypes.Metric Metric { get; set; }
            /// <summary>
            /// Unit
