namespace Humidifier.CloudWatch
{
    ...
    namespace MetricStreamTypes
    {
        ...
        public class MetricStreamStatisticsConfiguration : Humidifier.Base.BaseSubResource
        {
            ...
            /// </summary>
            public List<MetricStreamTypes.MetricStreamStatisticsMetric> IncludeMetrics { get; set; }
            /// <summary>
        ...
        public class MetricStreamStatisticsMetric : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// MetricName
