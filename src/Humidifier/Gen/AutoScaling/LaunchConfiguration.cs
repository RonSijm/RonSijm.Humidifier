namespace Humidifier.AutoScaling
{
    ...
    public class LaunchConfiguration : Humidifier.Base.BaseResource, IHaveImpliedResourceName, IHaveSecurityGroups
    {
        ...
        /// </summary>
        public LaunchConfigurationTypes.MetadataOptions MetadataOptions { get; set; }
        /// <summary>
        /// InstanceId
        ...
        /// </summary>
        public List<LaunchConfigurationTypes.BlockDeviceMapping> BlockDeviceMappings { get; set; }
        /// <summary>
        /// IamInstanceProfile
    ...
    {
        public class BlockDevice : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// SnapshotId
        ...
        public class BlockDeviceMapping : Humidifier.Base.BaseSubResource
        {
            ...
            /// Type: BlockDevice
            /// </summary>
            public LaunchConfigurationTypes.BlockDevice Ebs { get; set; }
            /// <summary>
            /// NoDevice
