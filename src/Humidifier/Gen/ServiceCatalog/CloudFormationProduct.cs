namespace Humidifier.ServiceCatalog
{
    ...
    public class CloudFormationProduct : Humidifier.Base.BaseResource, IHaveImpliedResourceName, IHaveTags, IHaveDescription
    {
        ...
        /// </summary>
        public CloudFormationProductTypes.SourceConnection SourceConnection { get; set; }
        /// <summary>
        /// Tags
        ...
        /// </summary>
        public List<CloudFormationProductTypes.ProvisioningArtifactProperties> ProvisioningArtifactParameters { get; set; }
    }

    namespace CloudFormationProductTypes
    {
        public class CodeStarParameters : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// ArtifactPath
        ...
        public class ConnectionParameters : Humidifier.Base.BaseSubResource
        {
            ...
            /// </summary>
            public CloudFormationProductTypes.CodeStarParameters CodeStar { get; set; }
        }

        public class ProvisioningArtifactProperties : Humidifier.Base.BaseSubResource, IHaveDescription
        {
            /// <summary>
            /// Type
        ...
        public class SourceConnection : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// Type
            ...
            /// </summary>
            public CloudFormationProductTypes.ConnectionParameters ConnectionParameters { get; set; }
        }
    }
}