namespace Humidifier.ServiceCatalog
{
    ...
    public class CloudFormationProduct : Humidifier.Base.BaseResource, IHaveImpliedResourceName, IHaveName, IHaveTags, IHaveDescription, IHaveAcceptLanguage, IHaveOwner
    {
