namespace Humidifier.ServiceCatalog
{
    ...
    public class CloudFormationProvisionedProduct : Humidifier.Base.BaseResource, IHaveTags, IHaveAcceptLanguage, IHaveProductId, IHaveProvisioningArtifactId
    {
        ...
        /// </summary>
        public List<Humidifier.ServiceCatalog.CloudFormationProvisionedProductTypes.ProvisioningParameter> ProvisioningParameters { get; set; }
        /// <summary>
        ...
        /// </summary>
        public Humidifier.ServiceCatalog.CloudFormationProvisionedProductTypes.ProvisioningPreferences ProvisioningPreferences { get; set; }
        /// <summary>
        /// ProductName
