namespace Humidifier.ServiceCatalog
{
    ...
    public class CloudFormationProvisionedProduct : Humidifier.Base.BaseResource, IHaveTags
    {
        ...
        /// </summary>
        public List<CloudFormationProvisionedProductTypes.ProvisioningParameter> ProvisioningParameters { get; set; }
        /// <summary>
        ...
        /// </summary>
        public CloudFormationProvisionedProductTypes.ProvisioningPreferences ProvisioningPreferences { get; set; }
        /// <summary>
        /// ProductName
    ...
    {
        public class ProvisioningParameter : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// Value
        ...
        public class ProvisioningPreferences : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// StackSetAccounts
