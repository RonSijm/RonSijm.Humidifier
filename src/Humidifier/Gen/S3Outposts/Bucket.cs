namespace Humidifier.S3Outposts
{
    ...
    namespace BucketTypes
    {
        ...
        public class Filter : Humidifier.Base.BaseSubResource
        {
            ...
            /// </summary>
            public BucketTypes.FilterAndOperator AndOperator { get; set; }
            /// <summary>
            /// Prefix
            ...
            /// Type: FilterTag
            /// </summary>
            public BucketTypes.FilterTag Tag { get; set; }
        }

        public class FilterAndOperator : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// Prefix
            ...
            /// ItemType: FilterTag
            /// </summary>
            public List<BucketTypes.FilterTag> Tags { get; set; }
        }

        public class FilterTag : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// Value
        ...
        public class Rule : Humidifier.Base.BaseSubResource
        {
            ...
            /// Type: Filter
            /// </summary>
            public BucketTypes.Filter Filter { get; set; }
            /// <summary>
            /// ExpirationInDays
