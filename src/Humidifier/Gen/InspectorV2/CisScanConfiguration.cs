namespace Humidifier.InspectorV2
{
    ...
    namespace CisScanConfigurationTypes
    {
        ...
        public class DailySchedule : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// StartTime
            ...
            /// Type: Time
            /// </summary>
            public CisScanConfigurationTypes.Time StartTime { get; set; }
        }

        public class MonthlySchedule : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// StartTime
        ...
        public class Schedule : Humidifier.Base.BaseSubResource
        {
            ...
            /// Type: DailySchedule
            /// </summary>
            public CisScanConfigurationTypes.DailySchedule Daily { get; set; }
            /// <summary>
            /// Monthly
            ...
            /// </summary>
            public CisScanConfigurationTypes.MonthlySchedule Monthly { get; set; }
            /// <summary>
            /// Weekly
            ...
            /// Type: WeeklySchedule
            /// </summary>
            public CisScanConfigurationTypes.WeeklySchedule Weekly { get; set; }
            /// <summary>
            /// OneTime
        ...
        public class Time : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// TimeOfDay
        ...
        public class WeeklySchedule : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// Days
