namespace Humidifier.FIS
{
    ...
    public class ExperimentTemplate : Humidifier.Base.BaseResource, IHaveDescription
    {
        ...
        /// </summary>
        public Dictionary<string, ExperimentTemplateTypes.ExperimentTemplateAction> Actions { get; set; }
        /// <summary>
        /// ExperimentOptions
    ...
    namespace ExperimentTemplateTypes
    {
        ...
        public class ExperimentTemplateLogConfiguration : Humidifier.Base.BaseSubResource
        {
            ...
            /// </summary>
            public ExperimentTemplateTypes.S3Configuration S3Configuration { get; set; }
            /// <summary>
            /// LogSchemaVersion
            ...
            /// </summary>
            public ExperimentTemplateTypes.CloudWatchLogsConfiguration CloudWatchLogsConfiguration { get; set; }
        }

        public class ExperimentTemplateStopCondition : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// Value
        ...
        public class ExperimentTemplateTarget : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// Filters
            ...
            /// </summary>
            public List<ExperimentTemplateTypes.ExperimentTemplateTargetFilter> Filters { get; set; }
            /// <summary>
            /// Parameters
        ...
        public class ExperimentTemplateTargetFilter : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// Path
