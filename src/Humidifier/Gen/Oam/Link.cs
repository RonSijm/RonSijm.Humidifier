namespace Humidifier.Oam
{
    ...
    public class Link : Humidifier.Base.BaseResource
    {
        ...
        /// </summary>
        public LinkTypes.LinkConfiguration LinkConfiguration { get; set; }
        /// <summary>
        /// Tags
    ...
    namespace LinkTypes
    {
        public class LinkConfiguration : Humidifier.Base.BaseSubResource
        {
            ...
            /// Type: LinkFilter
            /// </summary>
            public LinkTypes.LinkFilter LogGroupConfiguration { get; set; }
            /// <summary>
            /// MetricConfiguration
            ...
            /// Type: LinkFilter
            /// </summary>
            public LinkTypes.LinkFilter MetricConfiguration { get; set; }
        }
