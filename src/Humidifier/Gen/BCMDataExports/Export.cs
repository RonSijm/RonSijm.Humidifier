namespace Humidifier.BCMDataExports
{
    ...
    public class Export : Humidifier.Base.BaseResource
    {
        ...
        /// </summary>
        public List<ExportTypes.ResourceTag> Tags { get; set; }
    }
    ...
    namespace ExportTypes
    {
        ...
        public class DestinationConfigurations : Humidifier.Base.BaseSubResource
        {
            ...
            /// Type: S3Destination
            /// </summary>
            public ExportTypes.S3Destination S3Destination { get; set; }
        }

        public class Export : Humidifier.Base.BaseSubResource, IHaveDescription
        {
            /// <summary>
            /// Description
            ...
            /// Type: RefreshCadence
            /// </summary>
            public ExportTypes.RefreshCadence RefreshCadence { get; set; }
            /// <summary>
            /// ExportArn
            ...
            /// Type: DataQuery
            /// </summary>
            public ExportTypes.DataQuery DataQuery { get; set; }
            /// <summary>
            ...
            /// </summary>
            public ExportTypes.DestinationConfigurations DestinationConfigurations { get; set; }
            /// <summary>
            /// Name
        ...
        public class RefreshCadence : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// Frequency
        ...
        public class S3Destination : Humidifier.Base.BaseSubResource
        {
            ...
            /// </summary>
            public ExportTypes.S3OutputConfigurations S3OutputConfigurations { get; set; }
            /// <summary>
            /// S3Region
        ...
        public class S3OutputConfigurations : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// Compression
