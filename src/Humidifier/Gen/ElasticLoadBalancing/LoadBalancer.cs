namespace Humidifier.ElasticLoadBalancing
{
    ...
    public class LoadBalancer : Humidifier.Base.BaseResource, IHaveImpliedResourceName, IHaveTags, IHaveSecurityGroups, IHaveSubnets
    {
        ...
        /// </summary>
        public LoadBalancerTypes.AccessLoggingPolicy AccessLoggingPolicy { get; set; }
        /// <summary>
        ...
        /// </summary>
        public List<LoadBalancerTypes.AppCookieStickinessPolicy> AppCookieStickinessPolicy { get; set; }
        /// <summary>
        /// AvailabilityZones
        ...
        /// </summary>
        public LoadBalancerTypes.ConnectionDrainingPolicy ConnectionDrainingPolicy { get; set; }
        /// <summary>
        /// ConnectionSettings
        ...
        /// </summary>
        public LoadBalancerTypes.ConnectionSettings ConnectionSettings { get; set; }
        /// <summary>
        /// CrossZone
        ...
        /// Type: HealthCheck
        /// </summary>
        public LoadBalancerTypes.HealthCheck HealthCheck { get; set; }
        /// <summary>
        /// Instances
        ...
        /// ItemType: Policies
        /// </summary>
        public List<LoadBalancerTypes.Policies> Policies { get; set; }
        /// <summary>
        /// Scheme
    ...
    {
        public class AccessLoggingPolicy : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// EmitInterval
        ...
        public class AppCookieStickinessPolicy : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// CookieName
        ...
        public class ConnectionDrainingPolicy : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// Enabled
        ...
        public class LBCookieStickinessPolicy : Humidifier.Base.BaseSubResource
        {
            /// <summary>
        ...
        public class Listeners : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// InstancePort
