namespace Humidifier.SSMContacts
{
    ...
    public class Plan : Humidifier.Base.BaseResource
    {
    ...
    namespace PlanTypes
    {
        ...
        public class Stage : Humidifier.Base.BaseSubResource
        {
            ...
            /// ItemType: Targets
            /// </summary>
            public List<PlanTypes.Targets> Targets { get; set; }
        }
        ...
        public class Targets : Humidifier.Base.BaseSubResource
        {
            ...
            /// </summary>
            public PlanTypes.ChannelTargetInfo ChannelTargetInfo { get; set; }
            /// <summary>
            /// ContactTargetInfo
            ...
            /// </summary>
            public PlanTypes.ContactTargetInfo ContactTargetInfo { get; set; }
        }
    }
}