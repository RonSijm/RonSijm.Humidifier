namespace Humidifier.SSMContacts
{
    ...
    {
        public class CoverageTime : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// EndTime
        ...
        public class MonthlySetting : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// DayOfMonth
        ...
        public class RecurrenceSettings : Humidifier.Base.BaseSubResource
        {
            ...
            /// </summary>
            public List<RotationTypes.ShiftCoverage> ShiftCoverages { get; set; }
            /// <summary>
            /// WeeklySettings
            ...
            /// </summary>
            public List<RotationTypes.WeeklySetting> WeeklySettings { get; set; }
            /// <summary>
            ...
            /// </summary>
            public List<RotationTypes.MonthlySetting> MonthlySettings { get; set; }
        }

        public class ShiftCoverage : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// DayOfWeek
            ...
            /// </summary>
            public List<RotationTypes.CoverageTime> CoverageTimes { get; set; }
        }

        public class WeeklySetting : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// DayOfWeek
