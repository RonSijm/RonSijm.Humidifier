namespace Humidifier.SSMContacts
{
    ...
    public class Contact : Humidifier.Base.BaseResource
    {
        ...
        /// ItemType: Stage
        /// </summary>
        public List<ContactTypes.Stage> Plan { get; set; }
    }

    namespace ContactTypes
    {
        public class ChannelTargetInfo : Humidifier.Base.BaseSubResource
        {
            /// <summary>
        ...
        public class ContactTargetInfo : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// ContactId
        ...
        public class Stage : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// DurationInMinutes
            ...
            /// ItemType: Targets
            /// </summary>
            public List<ContactTypes.Targets> Targets { get; set; }
        }
        ...
        public class Targets : Humidifier.Base.BaseSubResource
        {
            ...
            /// </summary>
            public ContactTypes.ChannelTargetInfo ChannelTargetInfo { get; set; }
            /// <summary>
            /// ContactTargetInfo
            ...
            /// </summary>
            public ContactTypes.ContactTargetInfo ContactTargetInfo { get; set; }
        }
    }
}