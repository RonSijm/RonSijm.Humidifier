namespace Humidifier.SimSpaceWeaver
{
    ...
    public class Simulation : Humidifier.Base.BaseResource, IHaveImpliedResourceName
    {
        ...
        /// Type: S3Location
        /// </summary>
        public SimulationTypes.S3Location SchemaS3Location { get; set; }
        /// <summary>
        /// SnapshotS3Location
        ...
        /// Type: S3Location
        /// </summary>
        public SimulationTypes.S3Location SnapshotS3Location { get; set; }
        /// <summary>
        /// MaximumDuration
