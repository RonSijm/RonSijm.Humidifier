namespace Humidifier.RoboMaker
{
    ...
    public class SimulationApplication : Humidifier.Base.BaseResource, IHaveImpliedResourceName
    {
        ...
        /// </summary>
        public List<SimulationApplicationTypes.SourceConfig> Sources { get; set; }
        /// <summary>
        /// Tags
    ...
    {
        public class RenderingEngine : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// Version
        ...
        public class RobotSoftwareSuite : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// Version
        ...
        public class SimulationSoftwareSuite : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// Version
        ...
        public class SourceConfig : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// S3Bucket
