namespace Humidifier.ImageBuilder
{
    ...
    namespace LifecyclePolicyTypes
    {
        public class Action : Humidifier.Base.BaseSubResource
        {
            ...
            /// </summary>
            public LifecyclePolicyTypes.IncludeResources IncludeResources { get; set; }
        }

        public class AmiExclusionRules : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// IsPublic
            ...
            /// Type: LastLaunched
            /// </summary>
            public LifecyclePolicyTypes.LastLaunched LastLaunched { get; set; }
            /// <summary>
            /// Regions
        ...
        public class ExclusionRules : Humidifier.Base.BaseSubResource
        {
            ...
            /// </summary>
            public LifecyclePolicyTypes.AmiExclusionRules Amis { get; set; }
            /// <summary>
            /// TagMap
        ...
        public class LastLaunched : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// Value
        ...
        public class PolicyDetail : Humidifier.Base.BaseSubResource
        {
            ...
            /// Type: Action
            /// </summary>
            public LifecyclePolicyTypes.Action Action { get; set; }
            /// <summary>
            /// ExclusionRules
            ...
            /// Type: ExclusionRules
            /// </summary>
            public LifecyclePolicyTypes.ExclusionRules ExclusionRules { get; set; }
            /// <summary>
            /// Filter
            ...
            /// Type: Filter
            /// </summary>
            public LifecyclePolicyTypes.Filter Filter { get; set; }
        }

        public class RecipeSelection : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// Name
        ...
        public class ResourceSelection : Humidifier.Base.BaseSubResource
        {
            ...
            /// </summary>
            public List<LifecyclePolicyTypes.RecipeSelection> Recipes { get; set; }
            /// <summary>
            /// TagMap
