namespace Humidifier.ImageBuilder
{
    ...
    public class ImageRecipe : Humidifier.Base.BaseResource, IHaveImpliedResourceName, IHaveDescription
    {
        ...
        /// </summary>
        public List<ImageRecipeTypes.InstanceBlockDeviceMapping> BlockDeviceMappings { get; set; }
        /// <summary>
        ...
        /// </summary>
        public ImageRecipeTypes.AdditionalInstanceConfiguration AdditionalInstanceConfiguration { get; set; }
        /// <summary>
        /// Tags
    ...
    namespace ImageRecipeTypes
    {
        public class AdditionalInstanceConfiguration : Humidifier.Base.BaseSubResource
        {
            ...
            /// </summary>
            public ImageRecipeTypes.SystemsManagerAgent SystemsManagerAgent { get; set; }
        }
        ...
        public class ComponentConfiguration : Humidifier.Base.BaseSubResource
        {
            ...
            /// </summary>
            public List<ImageRecipeTypes.ComponentParameter> Parameters { get; set; }
            /// <summary>
            /// ComponentArn
        ...
        public class InstanceBlockDeviceMapping : Humidifier.Base.BaseSubResource
        {
            ...
            /// </summary>
            public ImageRecipeTypes.EbsInstanceBlockDeviceSpecification Ebs { get; set; }
            /// <summary>
            /// NoDevice
