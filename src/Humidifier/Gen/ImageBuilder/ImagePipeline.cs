namespace Humidifier.ImageBuilder
{
    ...
    public class ImagePipeline : Humidifier.Base.BaseResource, IHaveImpliedResourceName, IHaveDescription, IHaveExecutionRole
    {
        ...
        /// </summary>
        public ImagePipelineTypes.ImageScanningConfiguration ImageScanningConfiguration { get; set; }
        /// <summary>
        /// Description
        ...
        /// Type: Schedule
        /// </summary>
        public ImagePipelineTypes.Schedule Schedule { get; set; }
        /// <summary>
        ...
        /// </summary>
        public ImagePipelineTypes.ImageTestsConfiguration ImageTestsConfiguration { get; set; }
        /// <summary>
    ...
    {
        public class EcrConfiguration : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// ContainerTags
        ...
        public class ImageScanningConfiguration : Humidifier.Base.BaseSubResource
        {
            ...
            /// </summary>
            public ImagePipelineTypes.EcrConfiguration EcrConfiguration { get; set; }
            /// <summary>
        ...
        public class WorkflowConfiguration : Humidifier.Base.BaseSubResource
        {
            ...
            /// </summary>
            public List<ImagePipelineTypes.WorkflowParameter> Parameters { get; set; }
            /// <summary>
            /// WorkflowArn
        ...
        public class WorkflowParameter : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// Value
