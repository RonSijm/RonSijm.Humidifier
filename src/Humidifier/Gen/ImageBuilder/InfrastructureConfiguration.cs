namespace Humidifier.ImageBuilder
{
    ...
    public class InfrastructureConfiguration : Humidifier.Base.BaseResource, IHaveDescription, IHaveImpliedResourceName
    {
        ...
        /// Type: Logging
        /// </summary>
        public InfrastructureConfigurationTypes.Logging Logging { get; set; }
        /// <summary>
        /// KeyPair
        ...
        /// </summary>
        public InfrastructureConfigurationTypes.InstanceMetadataOptions InstanceMetadataOptions { get; set; }
        /// <summary>
        /// InstanceTypes
    ...
    {
        public class InstanceMetadataOptions : Humidifier.Base.BaseSubResource
        {
            /// <summary>
        ...
        public class Logging : Humidifier.Base.BaseSubResource
        {
            ...
            /// Type: S3Logs
            /// </summary>
            public InfrastructureConfigurationTypes.S3Logs S3Logs { get; set; }
        }

        public class S3Logs : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// S3KeyPrefix
