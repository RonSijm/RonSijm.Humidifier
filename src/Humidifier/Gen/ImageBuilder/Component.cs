namespace Humidifier.ImageBuilder
{
    ...
    public class Component : Humidifier.Base.BaseResource, IHaveImpliedResourceName, IHaveName, IHaveDescription, IHaveKmsKeyId, IHaveVersion, IHaveData, IHaveUri, IHavePlatform
    {
