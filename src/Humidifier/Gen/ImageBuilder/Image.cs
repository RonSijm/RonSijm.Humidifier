namespace Humidifier.ImageBuilder
{
    ...
    public class Image : Humidifier.Base.BaseResource, IHaveExecutionRole
    {
        ...
        /// </summary>
        public ImageTypes.ImageScanningConfiguration ImageScanningConfiguration { get; set; }
        /// <summary>
        ...
        /// </summary>
        public List<ImageTypes.WorkflowConfiguration> Workflows { get; set; }
        /// <summary>
        ...
        /// </summary>
        public ImageTypes.ImageTestsConfiguration ImageTestsConfiguration { get; set; }
        /// <summary>
    ...
    namespace ImageTypes
    {
        ...
        public class ImageScanningConfiguration : Humidifier.Base.BaseSubResource
        {
            ...
            /// </summary>
            public ImageTypes.EcrConfiguration EcrConfiguration { get; set; }
            /// <summary>
        ...
        public class WorkflowConfiguration : Humidifier.Base.BaseSubResource
        {
            ...
            /// </summary>
            public List<ImageTypes.WorkflowParameter> Parameters { get; set; }
            /// <summary>
            /// WorkflowArn
