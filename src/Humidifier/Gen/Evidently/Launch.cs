namespace Humidifier.Evidently
{
    ...
    {
        public class ExecutionStatusObject : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// Status
        ...
        public class GroupToWeight : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// GroupName
        ...
        public class LaunchGroupObject : Humidifier.Base.BaseSubResource, IHaveDescription
        {
            /// <summary>
            /// GroupName
        ...
        public class MetricDefinitionObject : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// EntityIdKey
        ...
        public class SegmentOverride : Humidifier.Base.BaseSubResource
        {
            ...
            /// </summary>
            public List<LaunchTypes.GroupToWeight> Weights { get; set; }
            /// <summary>
            /// EvaluationOrder
        ...
        public class StepConfig : Humidifier.Base.BaseSubResource
        {
            ...
            /// ItemType: GroupToWeight
            /// </summary>
            public List<LaunchTypes.GroupToWeight> GroupWeights { get; set; }
            /// <summary>
            /// SegmentOverrides
            ...
            /// </summary>
            public List<LaunchTypes.SegmentOverride> SegmentOverrides { get; set; }
            /// <summary>
            /// StartTime
