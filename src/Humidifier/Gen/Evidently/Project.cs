namespace Humidifier.Evidently
{
    ...
    public class Project : Humidifier.Base.BaseResource, IHaveTags, IHaveDescription, IHaveImpliedResourceName
    {
        ...
        /// </summary>
        public ProjectTypes.DataDeliveryObject DataDelivery { get; set; }
        /// <summary>
        /// Description
        ...
        /// </summary>
        public ProjectTypes.AppConfigResourceObject AppConfigResource { get; set; }
        /// <summary>
        /// Tags
    ...
    {
        public class AppConfigResourceObject : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// EnvironmentId
        ...
        public class DataDeliveryObject : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// S3
            ...
            /// Type: S3Destination
            /// </summary>
            public ProjectTypes.S3Destination S3 { get; set; }
            /// <summary>
            /// LogGroup
