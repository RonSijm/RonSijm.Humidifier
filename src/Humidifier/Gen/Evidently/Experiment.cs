namespace Humidifier.Evidently
{
    ...
    public class Experiment : Humidifier.Base.BaseResource, IHaveTags, IHaveDescription, IHaveImpliedResourceName
    {
        ...
        /// </summary>
        public ExperimentTypes.RunningStatusObject RunningStatus { get; set; }
        /// <summary>
        /// Description
    ...
    {
        public class MetricGoalObject : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// EntityIdKey
        ...
        public class OnlineAbConfigObject : Humidifier.Base.BaseSubResource
        {
            ...
            /// </summary>
            public List<ExperimentTypes.TreatmentToWeight> TreatmentWeights { get; set; }
            /// <summary>
        ...
        public class RunningStatusObject : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// Status
        ...
        public class TreatmentObject : Humidifier.Base.BaseSubResource, IHaveDescription
        {
            /// <summary>
            /// Description
