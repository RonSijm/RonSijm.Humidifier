namespace Humidifier.Comprehend
{
    ...
    public class Flywheel : Humidifier.Base.BaseResource, IHaveImpliedResourceName, IHaveTags
    {
        ...
        /// Type: TaskConfig
        /// </summary>
        public FlywheelTypes.TaskConfig TaskConfig { get; set; }
        /// <summary>
        /// ActiveModelArn
        ...
        /// </summary>
        public FlywheelTypes.DataSecurityConfig DataSecurityConfig { get; set; }
        /// <summary>
        /// Tags
    ...
    {
        public class DataSecurityConfig : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// VpcConfig
            ...
            /// Type: VpcConfig
            /// </summary>
            public FlywheelTypes.VpcConfig VpcConfig { get; set; }
            /// <summary>
            /// VolumeKmsKeyId
        ...
        public class DocumentClassificationConfig : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// Mode
        ...
        public class EntityRecognitionConfig : Humidifier.Base.BaseSubResource
        {
            ...
            /// </summary>
            public List<FlywheelTypes.EntityTypesListItem> EntityTypes { get; set; }
        }

        public class EntityTypesListItem : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// Type
        ...
        public class TaskConfig : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// LanguageCode
            ...
            /// </summary>
            public FlywheelTypes.DocumentClassificationConfig DocumentClassificationConfig { get; set; }
            /// <summary>
            ...
            /// </summary>
            public FlywheelTypes.EntityRecognitionConfig EntityRecognitionConfig { get; set; }
        }
