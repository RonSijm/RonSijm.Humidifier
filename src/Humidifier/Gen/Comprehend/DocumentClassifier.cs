namespace Humidifier.Comprehend
{
    ...
    public class DocumentClassifier : Humidifier.Base.BaseResource, IHaveImpliedResourceName, IHaveTags
    {
        ...
        /// </summary>
        public DocumentClassifierTypes.DocumentClassifierOutputDataConfig OutputDataConfig { get; set; }
        /// <summary>
        /// VpcConfig
        ...
        /// Type: VpcConfig
        /// </summary>
        public DocumentClassifierTypes.VpcConfig VpcConfig { get; set; }
    ...
    {
        public class AugmentedManifestsListItem : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// S3Uri
        ...
        public class DocumentClassifierDocuments : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// S3Uri
        ...
        public class DocumentClassifierInputDataConfig : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            ...
            /// </summary>
            public DocumentClassifierTypes.DocumentReaderConfig DocumentReaderConfig { get; set; }
            /// <summary>
            /// S3Uri
            ...
            /// </summary>
            public DocumentClassifierTypes.DocumentClassifierDocuments Documents { get; set; }
            /// <summary>
            /// DataFormat
            ...
            /// </summary>
            public List<DocumentClassifierTypes.AugmentedManifestsListItem> AugmentedManifests { get; set; }
            /// <summary>
            /// LabelDelimiter
