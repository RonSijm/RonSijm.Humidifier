namespace Humidifier.Lex
{
    ...
    namespace BotVersionTypes
    {
        ...
        public class BotVersionLocaleSpecification : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// LocaleId
            ...
            /// </summary>
            public BotVersionTypes.BotVersionLocaleDetails BotVersionLocaleDetails { get; set; }
        }
    }
}