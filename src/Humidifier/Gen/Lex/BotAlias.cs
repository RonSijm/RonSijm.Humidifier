namespace Humidifier.Lex
{
    ...
    public class BotAlias : Humidifier.Base.BaseResource, IHaveImpliedResourceName, IHaveDescription
    {
        ...
        /// </summary>
        public List<BotAliasTypes.BotAliasLocaleSettingsItem> BotAliasLocaleSettings { get; set; }
        /// <summary>
        ...
        /// </summary>
        public BotAliasTypes.ConversationLogSettings ConversationLogSettings { get; set; }
        /// <summary>
        ...
        /// </summary>
        public BotAliasTypes.SentimentAnalysisSettings SentimentAnalysisSettings { get; set; }
    ...
    namespace BotAliasTypes
    {
        public class AudioLogDestination : Humidifier.Base.BaseSubResource
        {
            ...
            /// </summary>
            public BotAliasTypes.S3BucketLogDestination S3Bucket { get; set; }
        }
        ...
        public class AudioLogSetting : Humidifier.Base.BaseSubResource
        {
            ...
            /// </summary>
            public BotAliasTypes.AudioLogDestination Destination { get; set; }
            /// <summary>
            /// Enabled
        ...
        public class BotAliasLocaleSettings : Humidifier.Base.BaseSubResource
        {
            ...
            /// </summary>
            public BotAliasTypes.CodeHookSpecification CodeHookSpecification { get; set; }
            /// <summary>
            /// Enabled
        ...
        public class BotAliasLocaleSettingsItem : Humidifier.Base.BaseSubResource
        {
            ...
            /// </summary>
            public BotAliasTypes.BotAliasLocaleSettings BotAliasLocaleSetting { get; set; }
        }
        ...
        public class CodeHookSpecification : Humidifier.Base.BaseSubResource
        {
            ...
            /// Type: LambdaCodeHook
            /// </summary>
            public BotAliasTypes.LambdaCodeHook LambdaCodeHook { get; set; }
        }
        ...
        public class ConversationLogSettings : Humidifier.Base.BaseSubResource
        {
            ...
            /// </summary>
            public List<BotAliasTypes.TextLogSetting> TextLogSettings { get; set; }
            /// <summary>
            /// AudioLogSettings
            ...
            /// </summary>
            public List<BotAliasTypes.AudioLogSetting> AudioLogSettings { get; set; }
        }
        ...
        public class TextLogDestination : Humidifier.Base.BaseSubResource
        {
            ...
            /// </summary>
            public BotAliasTypes.CloudWatchLogGroupLogDestination CloudWatch { get; set; }
        }
        ...
        public class TextLogSetting : Humidifier.Base.BaseSubResource
        {
            ...
            /// </summary>
            public BotAliasTypes.TextLogDestination Destination { get; set; }
            /// <summary>
            /// Enabled
