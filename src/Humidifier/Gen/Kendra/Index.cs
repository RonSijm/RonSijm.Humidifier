namespace Humidifier.Kendra
{
    ...
    public class Index : Humidifier.Base.BaseResource, IHaveImpliedResourceName, IHaveTags, IHaveDescription
    {
        ...
        /// </summary>
        public IndexTypes.CapacityUnitsConfiguration CapacityUnits { get; set; }
        /// <summary>
        ...
        /// </summary>
        public IndexTypes.ServerSideEncryptionConfiguration ServerSideEncryptionConfiguration { get; set; }
        /// <summary>
        ...
        /// </summary>
        public List<IndexTypes.DocumentMetadataConfiguration> DocumentMetadataConfigurations { get; set; }
        /// <summary>
        /// Tags
        ...
        /// </summary>
        public List<IndexTypes.UserTokenConfiguration> UserTokenConfigurations { get; set; }
    }
    ...
    namespace IndexTypes
    {
        ...
        public class DocumentMetadataConfiguration : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// Relevance
            ...
            /// Type: Relevance
            /// </summary>
            public IndexTypes.Relevance Relevance { get; set; }
            /// <summary>
            /// Type
            ...
            /// Type: Search
            /// </summary>
            public IndexTypes.Search Search { get; set; }
            /// <summary>
            /// Name
        ...
        public class JwtTokenTypeConfiguration : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// ClaimRegex
        ...
        public class Relevance : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// Importance
            ...
            /// </summary>
            public List<IndexTypes.ValueImportanceItem> ValueImportanceItems { get; set; }
            /// <summary>
            /// Freshness
        ...
        public class UserTokenConfiguration : Humidifier.Base.BaseSubResource
        {
            ...
            /// </summary>
            public IndexTypes.JwtTokenTypeConfiguration JwtTokenTypeConfiguration { get; set; }
            /// <summary>
            ...
            /// </summary>
            public IndexTypes.JsonTokenTypeConfiguration JsonTokenTypeConfiguration { get; set; }
        }

        public class ValueImportanceItem : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// Value
