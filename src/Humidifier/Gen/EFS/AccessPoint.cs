namespace Humidifier.EFS
{
    ...
    public class AccessPoint : Humidifier.Base.BaseResource
    {
        ...
        /// Type: RootDirectory
        /// </summary>
        public AccessPointTypes.RootDirectory RootDirectory { get; set; }
        /// <summary>
        /// ClientToken
        ...
        /// </summary>
        public List<AccessPointTypes.AccessPointTag> AccessPointTags { get; set; }
        /// <summary>
        /// PosixUser
        ...
        /// Type: PosixUser
        /// </summary>
        public AccessPointTypes.PosixUser PosixUser { get; set; }
    }

    namespace AccessPointTypes
    {
        public class AccessPointTag : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// Value
        ...
        public class CreationInfo : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// OwnerGid
        ...
        public class PosixUser : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// Uid
        ...
        public class RootDirectory : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// Path
            ...
            /// Type: CreationInfo
            /// </summary>
            public AccessPointTypes.CreationInfo CreationInfo { get; set; }
        }
    }
}