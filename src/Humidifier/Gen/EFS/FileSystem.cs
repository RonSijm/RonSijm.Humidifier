namespace Humidifier.EFS
{
    ...
    public class FileSystem : Humidifier.Base.BaseResource, IHaveKmsKeyId
    {
        ...
        /// </summary>
        public FileSystemTypes.FileSystemProtection FileSystemProtection { get; set; }
        /// <summary>
        /// LifecyclePolicies
        ...
        /// </summary>
        public List<FileSystemTypes.LifecyclePolicy> LifecyclePolicies { get; set; }
        /// <summary>
        /// ThroughputMode
        ...
        /// </summary>
        public List<FileSystemTypes.ElasticFileSystemTag> FileSystemTags { get; set; }
        /// <summary>
        ...
        /// </summary>
        public FileSystemTypes.ReplicationConfiguration ReplicationConfiguration { get; set; }
        /// <summary>
        /// BackupPolicy
        ...
        /// Type: BackupPolicy
        /// </summary>
        public FileSystemTypes.BackupPolicy BackupPolicy { get; set; }
    }

    namespace FileSystemTypes
    {
        public class BackupPolicy : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// Status
        ...
        public class ElasticFileSystemTag : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// Value
        ...
        public class ReplicationConfiguration : Humidifier.Base.BaseSubResource
        {
            ...
            /// </summary>
            public List<FileSystemTypes.ReplicationDestination> Destinations { get; set; }
        }

        public class ReplicationDestination : Humidifier.Base.BaseSubResource, IHaveKmsKeyId
        {
            /// <summary>
            /// KmsKeyId
