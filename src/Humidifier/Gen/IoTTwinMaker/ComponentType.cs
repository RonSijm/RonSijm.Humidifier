namespace Humidifier.IoTTwinMaker
{
    ...
    public class ComponentType : Humidifier.Base.BaseResource, IHaveDescription
    {
        ...
        /// </summary>
        public Dictionary<string, ComponentTypeTypes.PropertyDefinition> PropertyDefinitions { get; set; }
        /// <summary>
        /// PropertyGroups
        ...
        /// ItemType: Function
        /// </summary>
        public Dictionary<string, ComponentTypeTypes.Function> Functions { get; set; }
        /// <summary>
        ...
        /// </summary>
        public Dictionary<string, ComponentTypeTypes.CompositeComponentType> CompositeComponentTypes { get; set; }
        /// <summary>
        /// Tags
    ...
    {
        public class CompositeComponentType : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// ComponentTypeId
        ...
        public class DataConnector : Humidifier.Base.BaseSubResource
        {
            ...
            /// Type: LambdaFunction
            /// </summary>
            public ComponentTypeTypes.LambdaFunction Lambda { get; set; }
        }

        public class DataType : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// Type
            ...
            /// ItemType: DataValue
            /// </summary>
            public List<ComponentTypeTypes.DataValue> AllowedValues { get; set; }
            /// <summary>
            /// UnitOfMeasure
            ...
            /// Type: Relationship
            /// </summary>
            public ComponentTypeTypes.Relationship Relationship { get; set; }
            /// <summary>
            /// NestedType
            ...
            /// Type: DataType
            /// </summary>
            public ComponentTypeTypes.DataType NestedType { get; set; }
        }

        public class DataValue : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// DoubleValue
            ...
            /// ItemType: DataValue
            /// </summary>
            public List<ComponentTypeTypes.DataValue> ListValue { get; set; }
            /// <summary>
            /// LongValue
            ...
            /// ItemType: DataValue
            /// </summary>
            public Dictionary<string, ComponentTypeTypes.DataValue> MapValue { get; set; }
            /// <summary>
            /// RelationshipValue
            ...
            /// </summary>
            public ComponentTypeTypes.RelationshipValue RelationshipValue { get; set; }
            /// <summary>
            /// StringValue
        ...
        public class Error : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// Message
        ...
        public class Function : Humidifier.Base.BaseSubResource
        {
            ...
            /// Type: DataConnector
            /// </summary>
            public ComponentTypeTypes.DataConnector ImplementedBy { get; set; }
        }

        public class LambdaFunction : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// Arn
        ...
        public class PropertyDefinition : Humidifier.Base.BaseSubResource
        {
            ...
            /// Type: DataValue
            /// </summary>
            public ComponentTypeTypes.DataValue DefaultValue { get; set; }
            /// <summary>
            /// IsExternalId
            ...
            /// Type: DataType
            /// </summary>
            public ComponentTypeTypes.DataType DataType { get; set; }
            /// <summary>
            /// Configurations
        ...
        public class Status : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// State
            ...
            /// Type: Error
            /// </summary>
            public ComponentTypeTypes.Error Error { get; set; }
        }
    }
}