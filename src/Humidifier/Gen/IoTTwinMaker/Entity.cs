namespace Humidifier.IoTTwinMaker
{
    ...
    public class Entity : Humidifier.Base.BaseResource, IHaveImpliedResourceName, IHaveDescription
    {
        ...
        /// ItemType: Component
        /// </summary>
        public Dictionary<string, EntityTypes.Component> Components { get; set; }
        /// <summary>
        /// ParentEntityId
        ...
        /// </summary>
        public Dictionary<string, EntityTypes.CompositeComponent> CompositeComponents { get; set; }
        /// <summary>
        /// Description
    ...
    {
        public class Component : Humidifier.Base.BaseSubResource, IHaveDescription
        {
            /// <summary>
            /// Status
            ...
            /// Type: Status
            /// </summary>
            public EntityTypes.Status Status { get; set; }
            /// <summary>
            /// Description
            ...
            /// </summary>
            public Dictionary<string, EntityTypes.PropertyGroup> PropertyGroups { get; set; }
            /// <summary>
            /// ComponentTypeId
            ...
            /// ItemType: Property
            /// </summary>
            public Dictionary<string, EntityTypes.Property> Properties { get; set; }
        }

        public class CompositeComponent : Humidifier.Base.BaseSubResource, IHaveDescription
        {
            /// <summary>
            /// Status
        ...
        public class DataType : Humidifier.Base.BaseSubResource
        {
            ...
            /// ItemType: DataValue
            /// </summary>
            public List<EntityTypes.DataValue> AllowedValues { get; set; }
            /// <summary>
            /// UnitOfMeasure
            ...
            /// Type: Relationship
            /// </summary>
            public EntityTypes.Relationship Relationship { get; set; }
            /// <summary>
            /// NestedType
            ...
            /// Type: DataType
            /// </summary>
            public EntityTypes.DataType NestedType { get; set; }
        }
        ...
        public class DataValue : Humidifier.Base.BaseSubResource
        {
            ...
            /// ItemType: DataValue
            /// </summary>
            public List<EntityTypes.DataValue> ListValue { get; set; }
            /// <summary>
            /// LongValue
            ...
            /// ItemType: DataValue
            /// </summary>
            public Dictionary<string, EntityTypes.DataValue> MapValue { get; set; }
            /// <summary>
            /// RelationshipValue
            ...
            /// </summary>
            public EntityTypes.RelationshipValue RelationshipValue { get; set; }
            /// <summary>
            /// StringValue
        ...
        public class Definition : Humidifier.Base.BaseSubResource
        {
            ...
            /// Type: DataValue
            /// </summary>
            public EntityTypes.DataValue DefaultValue { get; set; }
            /// <summary>
            /// IsImported
            ...
            /// Type: DataType
            /// </summary>
            public EntityTypes.DataType DataType { get; set; }
            /// <summary>
            /// IsFinal
        ...
        public class Property : Humidifier.Base.BaseSubResource
        {
            ...
            /// Type: Definition
            /// </summary>
            public EntityTypes.Definition Definition { get; set; }
            /// <summary>
            /// Value
            ...
            /// Type: DataValue
            /// </summary>
            public EntityTypes.DataValue Value { get; set; }
        }
        ...
        public class Status : Humidifier.Base.BaseSubResource
        {
            ...
            /// Type: Error
            /// </summary>
            public EntityTypes.Error Error { get; set; }
        }
    }
}