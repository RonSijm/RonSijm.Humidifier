namespace Humidifier.SNS
{
    ...
    public class Topic : Humidifier.Base.BaseResource, IHaveImpliedResourceName, IHaveTags
    {
        ...
        /// </summary>
        public List<TopicTypes.LoggingConfig> DeliveryStatusLogging { get; set; }
        /// <summary>
        /// KmsMasterKeyId
        ...
        /// </summary>
        public List<TopicTypes.Subscription> Subscription { get; set; }
        /// <summary>
        /// Tags
    ...
    namespace TopicTypes
    {
        ...
        public class Subscription : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// Endpoint
