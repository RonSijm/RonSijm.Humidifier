namespace Humidifier.AppRunner
{
    ...
    public class Service : Humidifier.Base.BaseResource, IHaveImpliedResourceName, IHaveTags
    {
        ...
        /// </summary>
        public ServiceTypes.HealthCheckConfiguration HealthCheckConfiguration { get; set; }
        /// <summary>
        ...
        /// </summary>
        public ServiceTypes.InstanceConfiguration InstanceConfiguration { get; set; }
        /// <summary>
        ...
        /// </summary>
        public ServiceTypes.EncryptionConfiguration EncryptionConfiguration { get; set; }
    ...
    namespace ServiceTypes
    {
        ...
        public class CodeConfiguration : Humidifier.Base.BaseSubResource
        {
            ...
            /// </summary>
            public ServiceTypes.CodeConfigurationValues CodeConfigurationValues { get; set; }
        }

        public class CodeConfigurationValues : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            ...
            /// </summary>
            public List<ServiceTypes.KeyValuePair> RuntimeEnvironmentSecrets { get; set; }
            /// <summary>
            /// Runtime
            ...
            /// ItemType: KeyValuePair
            /// </summary>
            public List<ServiceTypes.KeyValuePair> RuntimeEnvironmentVariables { get; set; }
            /// <summary>
            /// Port
        ...
        public class CodeRepository : Humidifier.Base.BaseSubResource
        {
            ...
            /// </summary>
            public ServiceTypes.SourceCodeVersion SourceCodeVersion { get; set; }
            /// <summary>
            /// CodeConfiguration
            ...
            /// </summary>
            public ServiceTypes.CodeConfiguration CodeConfiguration { get; set; }
            /// <summary>
            /// SourceDirectory
        ...
        public class HealthCheckConfiguration : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// Path
        ...
        public class ImageConfiguration : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// RuntimeEnvironmentSecrets
        ...
        public class ImageRepository : Humidifier.Base.BaseSubResource
        {
            ...
            /// </summary>
            public ServiceTypes.ImageConfiguration ImageConfiguration { get; set; }
            /// <summary>
            /// ImageRepositoryType
        ...
        public class NetworkConfiguration : Humidifier.Base.BaseSubResource
        {
            ...
            /// </summary>
            public ServiceTypes.EgressConfiguration EgressConfiguration { get; set; }
            /// <summary>
            ...
            /// </summary>
            public ServiceTypes.IngressConfiguration IngressConfiguration { get; set; }
        }
        ...
        public class SourceCodeVersion : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// Type
        ...
        public class SourceConfiguration : Humidifier.Base.BaseSubResource
        {
            ...
            /// </summary>
            public ServiceTypes.AuthenticationConfiguration AuthenticationConfiguration { get; set; }
            /// <summary>
            /// CodeRepository
            ...
            /// Type: CodeRepository
            /// </summary>
            public ServiceTypes.CodeRepository CodeRepository { get; set; }
            /// <summary>
            /// ImageRepository
            ...
            /// </summary>
            public ServiceTypes.ImageRepository ImageRepository { get; set; }
            /// <summary>
