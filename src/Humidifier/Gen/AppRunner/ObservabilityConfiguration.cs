namespace Humidifier.AppRunner
{
    ...
    public class ObservabilityConfiguration : Humidifier.Base.BaseResource, IHaveTags, IHaveImpliedResourceName
    {
        ...
        /// </summary>
        public ObservabilityConfigurationTypes.TraceConfiguration TraceConfiguration { get; set; }
