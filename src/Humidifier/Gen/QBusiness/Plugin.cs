namespace Humidifier.QBusiness
{
    ...
    public class Plugin : Humidifier.Base.BaseResource, IHaveTags
    {
    ...
    namespace PluginTypes
    {
        public class APISchema : Humidifier.Base.BaseSubResource
        {
            ...
            /// Type: S3
            /// </summary>
            public PluginTypes.S3 S3 { get; set; }
            /// <summary>
            /// Payload
        ...
        public class BasicAuthConfiguration : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// SecretArn
        ...
        public class CustomPluginConfiguration : Humidifier.Base.BaseSubResource, IHaveDescription
        {
            ...
            /// Type: APISchema
            /// </summary>
            public PluginTypes.APISchema ApiSchema { get; set; }
            /// <summary>
            /// ApiSchemaType
        ...
        public class OAuth2ClientCredentialConfiguration : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// SecretArn
        ...
        public class PluginAuthConfiguration : Humidifier.Base.BaseSubResource
        {
            ...
            /// </summary>
            public PluginTypes.BasicAuthConfiguration BasicAuthConfiguration { get; set; }
            /// <summary>
            ...
            /// </summary>
            public PluginTypes.OAuth2ClientCredentialConfiguration OAuth2ClientCredentialConfiguration { get; set; }
        }
