namespace Humidifier.QBusiness
{
    ...
    public class Index : Humidifier.Base.BaseResource, IHaveTags, IHaveDescription
    {
        ...
        /// </summary>
        public IndexTypes.IndexCapacityConfiguration CapacityConfiguration { get; set; }
    }

    namespace IndexTypes
    {
        public class DocumentAttributeConfiguration : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// Type
        ...
        public class IndexCapacityConfiguration : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// Units
        ...
        public class IndexStatistics : Humidifier.Base.BaseSubResource
        {
            ...
            /// </summary>
            public IndexTypes.TextDocumentStatistics TextDocumentStatistics { get; set; }
        }
