namespace Humidifier.QBusiness
{
    ...
    public class DataSource : Humidifier.Base.BaseResource, IHaveTags, IHaveDescription
    {
    ...
    namespace DataSourceTypes
    {
        ...
        public class DocumentAttributeCondition : Humidifier.Base.BaseSubResource
        {
            ...
            /// </summary>
            public DataSourceTypes.DocumentAttributeValue Value { get; set; }
            /// <summary>
            /// Key
        ...
        public class DocumentEnrichmentConfiguration : Humidifier.Base.BaseSubResource
        {
            ...
            /// </summary>
            public List<DataSourceTypes.InlineDocumentEnrichmentConfiguration> InlineConfigurations { get; set; }
            /// <summary>
