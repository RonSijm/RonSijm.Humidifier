namespace Humidifier.KinesisAnalyticsV2
{
    ...
    public class ApplicationReferenceDataSource : Humidifier.Base.BaseResource
    {
        ...
        /// </summary>
        [Required]
        public ApplicationReferenceDataSourceTypes.ReferenceDataSource ReferenceDataSource { get; set; }
    }
    ...
    namespace ApplicationReferenceDataSourceTypes
    {
        ...
        public class MappingParameters : Humidifier.Base.BaseSubResource
        {
            ...
            /// </summary>
            public ApplicationReferenceDataSourceTypes.JSONMappingParameters JSONMappingParameters { get; set; }
            /// <summary>
            ...
            /// </summary>
            public ApplicationReferenceDataSourceTypes.CSVMappingParameters CSVMappingParameters { get; set; }
        }
        ...
        public class RecordFormat : Humidifier.Base.BaseSubResource
        {
            ...
            /// </summary>
            public ApplicationReferenceDataSourceTypes.MappingParameters MappingParameters { get; set; }
            /// <summary>
            /// RecordFormatType
        ...
        public class ReferenceDataSource : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// ReferenceSchema
            ...
            /// </summary>
            public ApplicationReferenceDataSourceTypes.ReferenceSchema ReferenceSchema { get; set; }
            /// <summary>
            /// TableName
            ...
            /// </summary>
            public ApplicationReferenceDataSourceTypes.S3ReferenceDataSource S3ReferenceDataSource { get; set; }
        }

        public class ReferenceSchema : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// RecordEncoding
            ...
            /// </summary>
            public List<ApplicationReferenceDataSourceTypes.RecordColumn> RecordColumns { get; set; }
            /// <summary>
            /// RecordFormat
            ...
            /// Type: RecordFormat
            /// </summary>
            public ApplicationReferenceDataSourceTypes.RecordFormat RecordFormat { get; set; }
        }

        public class S3ReferenceDataSource : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// BucketARN
