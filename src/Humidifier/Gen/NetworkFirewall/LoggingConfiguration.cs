namespace Humidifier.NetworkFirewall
{
    ...
    {
        public class LogDestinationConfig : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// LogType
        ...
        public class LoggingConfiguration : Humidifier.Base.BaseSubResource
        {
            ...
            /// </summary>
            public List<LoggingConfigurationTypes.LogDestinationConfig> LogDestinationConfigs { get; set; }
        }
    }
}