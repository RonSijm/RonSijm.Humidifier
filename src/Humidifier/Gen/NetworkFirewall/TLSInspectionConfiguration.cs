namespace Humidifier.NetworkFirewall
{
    ...
    namespace TLSInspectionConfigurationTypes
    {
        ...
        public class ServerCertificate : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// ResourceArn
        ...
        public class ServerCertificateConfiguration : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            ...
            /// </summary>
            public TLSInspectionConfigurationTypes.CheckCertificateRevocationStatus CheckCertificateRevocationStatus { get; set; }
            /// <summary>
            /// Scopes
            ...
            /// </summary>
            public List<TLSInspectionConfigurationTypes.ServerCertificateScope> Scopes { get; set; }
            /// <summary>
            /// ServerCertificates
            ...
            /// </summary>
            public List<TLSInspectionConfigurationTypes.ServerCertificate> ServerCertificates { get; set; }
        }
        ...
        public class ServerCertificateScope : Humidifier.Base.BaseSubResource
        {
            ...
            /// ItemType: PortRange
            /// </summary>
            public List<TLSInspectionConfigurationTypes.PortRange> DestinationPorts { get; set; }
            /// <summary>
            /// Destinations
            ...
            /// ItemType: Address
            /// </summary>
            public List<TLSInspectionConfigurationTypes.Address> Destinations { get; set; }
            /// <summary>
            /// Sources
            ...
            /// ItemType: Address
            /// </summary>
            public List<TLSInspectionConfigurationTypes.Address> Sources { get; set; }
            /// <summary>
            /// SourcePorts
            ...
            /// ItemType: PortRange
            /// </summary>
            public List<TLSInspectionConfigurationTypes.PortRange> SourcePorts { get; set; }
        }
        ...
        public class TLSInspectionConfiguration : Humidifier.Base.BaseSubResource
        {
            ...
            /// </summary>
            public List<TLSInspectionConfigurationTypes.ServerCertificateConfiguration> ServerCertificateConfigurations { get; set; }
        }
    }
}