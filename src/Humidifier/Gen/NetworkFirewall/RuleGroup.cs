namespace Humidifier.NetworkFirewall
{
    ...
    public class RuleGroup : Humidifier.Base.BaseResource, IHaveImpliedResourceName, IHaveTags, IHaveDescription
    {
        ...
        /// Type: RuleGroup
        /// </summary>
        public RuleGroupTypes.RuleGroup RuleGroup_ { get; set; }
        /// <summary>
        /// Tags
    ...
    namespace RuleGroupTypes
    {
        public class ActionDefinition : Humidifier.Base.BaseSubResource
        {
            ...
            /// </summary>
            public RuleGroupTypes.PublishMetricAction PublishMetricAction { get; set; }
        }
        ...
        public class CustomAction : Humidifier.Base.BaseSubResource
        {
            ...
            /// </summary>
            public RuleGroupTypes.ActionDefinition ActionDefinition { get; set; }
        }
        ...
        public class Header : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// Destination
        ...
        public class IPSetReference : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// ReferenceArn
        ...
        public class MatchAttributes : Humidifier.Base.BaseSubResource
        {
            ...
            /// </summary>
            public List<RuleGroupTypes.TCPFlagField> TCPFlags { get; set; }
            /// <summary>
            /// DestinationPorts
            ...
            /// ItemType: PortRange
            /// </summary>
            public List<RuleGroupTypes.PortRange> DestinationPorts { get; set; }
            /// <summary>
            /// Destinations
            ...
            /// ItemType: Address
            /// </summary>
            public List<RuleGroupTypes.Address> Destinations { get; set; }
            /// <summary>
            /// Sources
            ...
            /// ItemType: Address
            /// </summary>
            public List<RuleGroupTypes.Address> Sources { get; set; }
            /// <summary>
            /// SourcePorts
            ...
            /// ItemType: PortRange
            /// </summary>
            public List<RuleGroupTypes.PortRange> SourcePorts { get; set; }
        }
        ...
        public class PortSet : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// Definition
        ...
        public class PublishMetricAction : Humidifier.Base.BaseSubResource
        {
            ...
            /// ItemType: Dimension
            /// </summary>
            public List<RuleGroupTypes.Dimension> Dimensions { get; set; }
        }
        ...
        public class ReferenceSets : Humidifier.Base.BaseSubResource
        {
            ...
            /// </summary>
            public Dictionary<string, RuleGroupTypes.IPSetReference> IPSetReferences { get; set; }
        }

        public class RuleDefinition : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// Actions
            ...
            /// </summary>
            public RuleGroupTypes.MatchAttributes MatchAttributes { get; set; }
        }
        ...
        public class RuleGroup : Humidifier.Base.BaseSubResource
        {
            ...
            /// </summary>
            public RuleGroupTypes.StatefulRuleOptions StatefulRuleOptions { get; set; }
            /// <summary>
            /// ReferenceSets
            ...
            /// Type: ReferenceSets
            /// </summary>
            public RuleGroupTypes.ReferenceSets ReferenceSets { get; set; }
            /// <summary>
            /// RulesSource
            ...
            /// Type: RulesSource
            /// </summary>
            public RuleGroupTypes.RulesSource RulesSource { get; set; }
            /// <summary>
            /// RuleVariables
            ...
            /// Type: RuleVariables
            /// </summary>
            public RuleGroupTypes.RuleVariables RuleVariables { get; set; }
        }
        ...
        public class RuleVariables : Humidifier.Base.BaseSubResource
        {
            ...
            /// ItemType: PortSet
            /// </summary>
            public Dictionary<string, RuleGroupTypes.PortSet> PortSets { get; set; }
            /// <summary>
            /// IPSets
            ...
            /// ItemType: IPSet
            /// </summary>
            public Dictionary<string, RuleGroupTypes.IPSet> IPSets { get; set; }
        }
        ...
        public class RulesSource : Humidifier.Base.BaseSubResource
        {
            ...
            /// </summary>
            public RuleGroupTypes.StatelessRulesAndCustomActions StatelessRulesAndCustomActions { get; set; }
            /// <summary>
            /// StatefulRules
            ...
            /// </summary>
            public List<RuleGroupTypes.StatefulRule> StatefulRules { get; set; }
            /// <summary>
            /// RulesString
            ...
            /// </summary>
            public RuleGroupTypes.RulesSourceList RulesSourceList { get; set; }
        }
        ...
        public class StatefulRule : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// Action
            ...
            /// Type: Header
            /// </summary>
            public RuleGroupTypes.Header Header { get; set; }
            /// <summary>
            /// RuleOptions
            ...
            /// ItemType: RuleOption
            /// </summary>
            public List<RuleGroupTypes.RuleOption> RuleOptions { get; set; }
        }

        public class StatefulRuleOptions : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// RuleOrder
        ...
        public class StatelessRule : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// Priority
            ...
            /// Type: RuleDefinition
            /// </summary>
            public RuleGroupTypes.RuleDefinition RuleDefinition { get; set; }
        }
        ...
        public class StatelessRulesAndCustomActions : Humidifier.Base.BaseSubResource
        {
            ...
            /// </summary>
            public List<RuleGroupTypes.StatelessRule> StatelessRules { get; set; }
            /// <summary>
            /// CustomActions
            ...
            /// </summary>
            public List<RuleGroupTypes.CustomAction> CustomActions { get; set; }
        }
