namespace Humidifier.Redshift
{
    ...
    public class Cluster : Humidifier.Base.BaseResource, IHaveTags
    {
        ...
        /// Type: Endpoint
        /// </summary>
        public ClusterTypes.Endpoint Endpoint { get; set; }
        /// <summary>
        ...
        /// </summary>
        public ClusterTypes.LoggingProperties LoggingProperties { get; set; }
        /// <summary>
        /// DeferMaintenance
    ...
    namespace ClusterTypes
    {
        ...
        public class LoggingProperties : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// BucketName
