namespace Humidifier.Redshift
{
    ...
    public class ScheduledAction : Humidifier.Base.BaseResource, IHaveImpliedResourceName, IHaveDescription
    {
        ...
        /// </summary>
        public ScheduledActionTypes.ScheduledActionType TargetAction { get; set; }
    }

    namespace ScheduledActionTypes
    {
        public class PauseClusterMessage : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// ClusterIdentifier
        ...
        public class ResizeClusterMessage : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// NodeType
        ...
        public class ResumeClusterMessage : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// ClusterIdentifier
        ...
        public class ScheduledActionType : Humidifier.Base.BaseSubResource
        {
            ...
            /// </summary>
            public ScheduledActionTypes.PauseClusterMessage PauseCluster { get; set; }
            /// <summary>
            /// ResumeCluster
            ...
            /// </summary>
            public ScheduledActionTypes.ResumeClusterMessage ResumeCluster { get; set; }
            /// <summary>
            /// ResizeCluster
            ...
            /// </summary>
            public ScheduledActionTypes.ResizeClusterMessage ResizeCluster { get; set; }
        }
    }
}