namespace Humidifier.Redshift
{
    ...
    public class EndpointAccess : Humidifier.Base.BaseResource
    {
    ...
    namespace EndpointAccessTypes
    {
        ...
        public class VpcEndpoint : Humidifier.Base.BaseSubResource, IHaveVpcId
        {
            ...
            /// </summary>
            public List<EndpointAccessTypes.NetworkInterface> NetworkInterfaces { get; set; }
            /// <summary>
            /// VpcEndpointId
        ...
        public class VpcSecurityGroup : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// Status
