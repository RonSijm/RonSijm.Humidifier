namespace Humidifier.Pinpoint
{
    ...
    public class Segment : Humidifier.Base.BaseResource, IHaveImpliedResourceName
    {
        ...
        /// Type: SegmentGroups
        /// </summary>
        public SegmentTypes.SegmentGroups SegmentGroups { get; set; }
        /// <summary>
        /// Dimensions
    ...
    namespace SegmentTypes
    {
        ...
        public class Behavior : Humidifier.Base.BaseSubResource
        {
            ...
            /// Type: Recency
            /// </summary>
            public SegmentTypes.Recency Recency { get; set; }
        }

        public class Coordinates : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// Latitude
        ...
        public class Demographic : Humidifier.Base.BaseSubResource
        {
            ...
            /// Type: SetDimension
            /// </summary>
            public SegmentTypes.SetDimension AppVersion { get; set; }
            /// <summary>
            /// DeviceType
            ...
            /// Type: SetDimension
            /// </summary>
            public SegmentTypes.SetDimension DeviceType { get; set; }
            /// <summary>
            /// Platform
            ...
            /// Type: SetDimension
            /// </summary>
            public SegmentTypes.SetDimension Platform { get; set; }
            /// <summary>
            /// Channel
            ...
            /// Type: SetDimension
            /// </summary>
            public SegmentTypes.SetDimension Channel { get; set; }
            /// <summary>
            /// Model
            ...
            /// Type: SetDimension
            /// </summary>
            public SegmentTypes.SetDimension Model { get; set; }
            /// <summary>
            /// Make
            ...
            /// Type: SetDimension
            /// </summary>
            public SegmentTypes.SetDimension Make { get; set; }
        }
        ...
        public class GPSPoint : Humidifier.Base.BaseSubResource
        {
            ...
            /// Type: Coordinates
            /// </summary>
            public SegmentTypes.Coordinates Coordinates { get; set; }
        }

        public class Groups : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// Type
            ...
            /// </summary>
            public List<SegmentTypes.SegmentDimensions> Dimensions { get; set; }
            /// <summary>
            /// SourceSegments
            ...
            /// </summary>
            public List<SegmentTypes.SourceSegments> SourceSegments { get; set; }
        }
        ...
        public class Location : Humidifier.Base.BaseSubResource
        {
            ...
            /// Type: GPSPoint
            /// </summary>
            public SegmentTypes.GPSPoint GPSPoint { get; set; }
            /// <summary>
            /// Country
            ...
            /// Type: SetDimension
            /// </summary>
            public SegmentTypes.SetDimension Country { get; set; }
        }

        public class Recency : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// Duration
        ...
        public class SegmentDimensions : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// Demographic
            ...
            /// Type: Demographic
            /// </summary>
            public SegmentTypes.Demographic Demographic { get; set; }
            /// <summary>
            /// Metrics
            ...
            /// Type: Behavior
            /// </summary>
            public SegmentTypes.Behavior Behavior { get; set; }
            /// <summary>
            /// UserAttributes
            ...
            /// Type: Location
            /// </summary>
            public SegmentTypes.Location Location { get; set; }
        }
        ...
        public class SegmentGroups : Humidifier.Base.BaseSubResource
        {
            ...
            /// ItemType: Groups
            /// </summary>
            public List<SegmentTypes.Groups> Groups { get; set; }
            /// <summary>
            /// Include
        ...
        public class SourceSegments : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// Version
