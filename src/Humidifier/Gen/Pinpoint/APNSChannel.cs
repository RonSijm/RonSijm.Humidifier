namespace Humidifier.Pinpoint
{
    ...
    public class APNSChannel : Humidifier.Base.BaseResource, IHaveEnabled, IHaveApplicationId, IHavePrivateKey, IHaveBundleId, IHaveCertificate, IHaveTeamId, IHaveDefaultAuthenticationMethod, IHaveTokenKey, IHaveTokenKeyId
    {
        public override string AWSTypeName { get => AWS.Pinpoint.APNSChannel; }
        /// <summary>
        /// BundleId
