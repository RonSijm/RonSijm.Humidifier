namespace Humidifier.Pinpoint
{
    ...
    public class APNSSandboxChannel : Humidifier.Base.BaseResource, IHaveEnabled, IHaveApplicationId, IHavePrivateKey, IHaveBundleId, IHaveCertificate, IHaveTeamId, IHaveDefaultAuthenticationMethod, IHaveTokenKey, IHaveTokenKeyId
    {
