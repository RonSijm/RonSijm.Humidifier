namespace Humidifier.Deadline
{
    ...
    public class Queue : Humidifier.Base.BaseResource, IHaveTags, IHaveDescription
    {
        ...
        /// Type: JobRunAsUser
        /// </summary>
        public QueueTypes.JobRunAsUser JobRunAsUser { get; set; }
        /// <summary>
        ...
        /// </summary>
        public QueueTypes.JobAttachmentSettings JobAttachmentSettings { get; set; }
        /// <summary>
        /// DefaultBudgetAction
    ...
    {
        public class JobAttachmentSettings : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// RootPrefix
        ...
        public class JobRunAsUser : Humidifier.Base.BaseSubResource
        {
            ...
            /// Type: PosixUser
            /// </summary>
            public QueueTypes.PosixUser Posix { get; set; }
            /// <summary>
            /// Windows
            ...
            /// Type: WindowsUser
            /// </summary>
            public QueueTypes.WindowsUser Windows { get; set; }
        }
        ...
        public class WindowsUser : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// User
