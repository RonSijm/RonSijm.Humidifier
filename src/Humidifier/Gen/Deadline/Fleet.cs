namespace Humidifier.Deadline
{
    ...
    public class Fleet : Humidifier.Base.BaseResource, IHaveTags, IHaveDescription
    {
    ...
    {
        public class AcceleratorCountRange : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// Min
        ...
        public class AcceleratorTotalMemoryMiBRange : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// Min
        ...
        public class CustomerManagedFleetConfiguration : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// StorageProfileId
            ...
            /// </summary>
            public FleetTypes.CustomerManagedWorkerCapabilities WorkerCapabilities { get; set; }
        }

        public class CustomerManagedWorkerCapabilities : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// CustomAttributes
            ...
            /// </summary>
            public List<FleetTypes.FleetAttributeCapability> CustomAttributes { get; set; }
            /// <summary>
            /// AcceleratorCount
            ...
            /// </summary>
            public FleetTypes.AcceleratorCountRange AcceleratorCount { get; set; }
            /// <summary>
            /// CustomAmounts
            ...
            /// </summary>
            public List<FleetTypes.FleetAmountCapability> CustomAmounts { get; set; }
            /// <summary>
            /// AcceleratorTypes
            ...
            /// </summary>
            public FleetTypes.AcceleratorTotalMemoryMiBRange AcceleratorTotalMemoryMiB { get; set; }
            /// <summary>
            /// VCpuCount
            ...
            /// Type: VCpuCountRange
            /// </summary>
            public FleetTypes.VCpuCountRange VCpuCount { get; set; }
            /// <summary>
            /// MemoryMiB
            ...
            /// Type: MemoryMiBRange
            /// </summary>
            public FleetTypes.MemoryMiBRange MemoryMiB { get; set; }
            /// <summary>
            /// OsFamily
        ...
        public class Ec2EbsVolume : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// SizeGiB
        ...
        public class FleetAmountCapability : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// Min
        ...
        public class FleetAttributeCapability : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// Values
        ...
        public class FleetCapabilities : Humidifier.Base.BaseSubResource
        {
            ...
            /// ItemType: FleetAmountCapability
            /// </summary>
            public List<FleetTypes.FleetAmountCapability> Amounts { get; set; }
            /// <summary>
            /// Attributes_
            ...
            /// ItemType: FleetAttributeCapability
            /// </summary>
            public List<FleetTypes.FleetAttributeCapability> Attributes_ { get; set; }
        }
        ...
        public class FleetConfiguration : Humidifier.Base.BaseSubResource
        {
            ...
            /// </summary>
            public FleetTypes.ServiceManagedEc2FleetConfiguration ServiceManagedEc2 { get; set; }
            /// <summary>
            /// CustomerManaged
            ...
            /// </summary>
            public FleetTypes.CustomerManagedFleetConfiguration CustomerManaged { get; set; }
        }

        public class MemoryMiBRange : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// Min
        ...
        public class ServiceManagedEc2FleetConfiguration : Humidifier.Base.BaseSubResource
        {
            ...
            /// </summary>
            public FleetTypes.ServiceManagedEc2InstanceMarketOptions InstanceMarketOptions { get; set; }
            /// <summary>
            ...
            /// </summary>
            public FleetTypes.ServiceManagedEc2InstanceCapabilities InstanceCapabilities { get; set; }
        }

        public class ServiceManagedEc2InstanceCapabilities : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            ...
            /// Type: Ec2EbsVolume
            /// </summary>
            public FleetTypes.Ec2EbsVolume RootEbsVolume { get; set; }
        }

        public class ServiceManagedEc2InstanceMarketOptions : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// Type
        ...
        public class VCpuCountRange : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// Min
