namespace Humidifier.Deadline
{
    ...
    public class StorageProfile : Humidifier.Base.BaseResource
    {
        ...
        /// </summary>
        public List<StorageProfileTypes.FileSystemLocation> FileSystemLocations { get; set; }
        /// <summary>
        /// FarmId
    ...
    {
        public class FileSystemLocation : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// Path
