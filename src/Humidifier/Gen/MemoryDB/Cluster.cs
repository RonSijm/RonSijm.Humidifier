namespace Humidifier.MemoryDB
{
    ...
    public class Cluster : Humidifier.Base.BaseResource, IHaveImpliedResourceName, IHaveTags, IHaveDescription, IHaveKmsKeyId
    {
        ...
        /// Type: Endpoint
        /// </summary>
        public ClusterTypes.Endpoint ClusterEndpoint { get; set; }
        /// <summary>
        /// SnapshotWindow
