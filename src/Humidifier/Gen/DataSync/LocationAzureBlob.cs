namespace Humidifier.DataSync
{
    ...
    public class LocationAzureBlob : Humidifier.Base.BaseResource, IHaveTags
    {
        ...
        /// </summary>
        public LocationAzureBlobTypes.AzureBlobSasConfiguration AzureBlobSasConfiguration { get; set; }
        /// <summary>
        /// AzureBlobType
