namespace Humidifier.DataSync
{
    ...
    public class LocationHDFS : Humidifier.Base.BaseResource, IHaveTags
    {
        ...
        /// </summary>
        public LocationHDFSTypes.QopConfiguration QopConfiguration { get; set; }
        /// <summary>
        /// KerberosPrincipal
    ...
    {
        public class NameNode : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// Port
