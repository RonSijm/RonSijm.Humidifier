namespace Humidifier.DataSync
{
    ...
    public class LocationFSxOpenZFS : Humidifier.Base.BaseResource, IHaveTags
    {
    ...
    {
        public class MountOptions : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// Version
        ...
        public class NFS : Humidifier.Base.BaseSubResource
        {
            ...
            /// Type: MountOptions
            /// </summary>
            public LocationFSxOpenZFSTypes.MountOptions MountOptions { get; set; }
        }
        ...
        public class Protocol : Humidifier.Base.BaseSubResource
        {
            ...
            /// Type: NFS
            /// </summary>
            public LocationFSxOpenZFSTypes.NFS NFS { get; set; }
        }
    }
}