namespace Humidifier.DataSync
{
    ...
    public class Task : Humidifier.Base.BaseResource, IHaveImpliedResourceName, IHaveTags
    {
        ...
        /// Type: Options
        /// </summary>
        public TaskTypes.Options Options { get; set; }
        /// <summary>
        /// Schedule
        ...
        /// Type: TaskSchedule
        /// </summary>
        public TaskTypes.TaskSchedule Schedule { get; set; }
        /// <summary>
        ...
        /// </summary>
        public TaskTypes.TaskReportConfig TaskReportConfig { get; set; }
        /// <summary>
        /// Excludes
        ...
        /// ItemType: FilterRule
        /// </summary>
        public List<TaskTypes.FilterRule> Excludes { get; set; }
        /// <summary>
        /// Tags
        ...
        /// Type: ManifestConfig
        /// </summary>
        public TaskTypes.ManifestConfig ManifestConfig { get; set; }
    }

    namespace TaskTypes
    {
        public class Deleted : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// ReportLevel
        ...
        public class Destination : Humidifier.Base.BaseSubResource
        {
            ...
            /// </summary>
            public TaskTypes.TaskReportConfigDestinationS3 S3 { get; set; }
        }
        ...
        public class ManifestConfig : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// Action
            ...
            /// Type: Source
            /// </summary>
            public TaskTypes.Source Source { get; set; }
        }

        public class ManifestConfigSourceS3 : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// S3BucketArn
        ...
        public class Overrides : Humidifier.Base.BaseSubResource
        {
            ...
            /// Type: Verified
            /// </summary>
            public TaskTypes.Verified Verified { get; set; }
            /// <summary>
            /// Skipped
            ...
            /// Type: Skipped
            /// </summary>
            public TaskTypes.Skipped Skipped { get; set; }
            /// <summary>
            /// Transferred
            ...
            /// Type: Transferred
            /// </summary>
            public TaskTypes.Transferred Transferred { get; set; }
            /// <summary>
            /// Deleted
            ...
            /// Type: Deleted
            /// </summary>
            public TaskTypes.Deleted Deleted { get; set; }
        }

        public class Skipped : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// ReportLevel
        ...
        public class Source : Humidifier.Base.BaseSubResource
        {
            ...
            /// </summary>
            public TaskTypes.ManifestConfigSourceS3 S3 { get; set; }
        }

        public class TaskReportConfig : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// Destination
            ...
            /// Type: Destination
            /// </summary>
            public TaskTypes.Destination Destination { get; set; }
            /// <summary>
            /// ReportLevel
            ...
            /// Type: Overrides
            /// </summary>
            public TaskTypes.Overrides Overrides { get; set; }
            /// <summary>
            /// OutputType
        ...
        public class TaskReportConfigDestinationS3 : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// Subdirectory
        ...
        public class TaskSchedule : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// Status
        ...
        public class Transferred : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// ReportLevel
        ...
        public class Verified : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// ReportLevel
