namespace Humidifier.DataSync
{
    ...
    public class LocationFSxONTAP : Humidifier.Base.BaseResource, IHaveTags
    {
    ...
    namespace LocationFSxONTAPTypes
    {
        public class NFS : Humidifier.Base.BaseSubResource
        {
            ...
            /// </summary>
            public LocationFSxONTAPTypes.NfsMountOptions MountOptions { get; set; }
        }

        public class NfsMountOptions : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// Version
        ...
        public class Protocol : Humidifier.Base.BaseSubResource
        {
            ...
            /// Type: SMB
            /// </summary>
            public LocationFSxONTAPTypes.SMB SMB { get; set; }
            /// <summary>
            /// NFS
            ...
            /// Type: NFS
            /// </summary>
            public LocationFSxONTAPTypes.NFS NFS { get; set; }
        }

        public class SMB : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// User
            ...
            /// </summary>
            public LocationFSxONTAPTypes.SmbMountOptions MountOptions { get; set; }
            /// <summary>
            /// Password
        ...
        public class SmbMountOptions : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// Version
