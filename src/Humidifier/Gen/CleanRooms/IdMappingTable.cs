namespace Humidifier.CleanRooms
{
    ...
    public class IdMappingTable : Humidifier.Base.BaseResource, IHaveImpliedResourceName, IHaveTags, IHaveDescription
    {
        ...
        /// </summary>
        [Required]
        public IdMappingTableTypes.IdMappingTableInputReferenceConfig InputReferenceConfig { get; set; }
        /// <summary>
        /// Tags
    ...
    namespace IdMappingTableTypes
    {
        ...
        public class IdMappingTableInputReferenceProperties : Humidifier.Base.BaseSubResource
        {
            ...
            /// </summary>
            public List<IdMappingTableTypes.IdMappingTableInputSource> IdMappingTableInputSource { get; set; }
        }

        public class IdMappingTableInputSource : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// Type
