namespace Humidifier.CleanRooms
{
    ...
    public class IdNamespaceAssociation : Humidifier.Base.BaseResource, IHaveImpliedResourceName, IHaveTags, IHaveDescription
    {
        ...
        /// </summary>
        public IdNamespaceAssociationTypes.IdMappingConfig IdMappingConfig { get; set; }
        ...
        /// </summary>
        [Required]
        public IdNamespaceAssociationTypes.IdNamespaceAssociationInputReferenceConfig InputReferenceConfig { get; set; }
        /// <summary>
        /// Tags
