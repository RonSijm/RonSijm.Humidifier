namespace Humidifier.CleanRooms
{
    ...
    public class Collaboration : Humidifier.Base.BaseResource, IHaveTags, IHaveDescription, IHaveImpliedResourceName
    {
        ...
        /// </summary>
        public CollaborationTypes.PaymentConfiguration CreatorPaymentConfiguration { get; set; }
        /// <summary>
        ...
        /// </summary>
        public CollaborationTypes.DataEncryptionMetadata DataEncryptionMetadata { get; set; }
        /// <summary>
        /// Tags
    ...
    namespace CollaborationTypes
    {
        ...
        public class MemberSpecification : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// AccountId
            ...
            /// Type: PaymentConfiguration
            /// </summary>
            public CollaborationTypes.PaymentConfiguration PaymentConfiguration { get; set; }
        }
        ...
        public class PaymentConfiguration : Humidifier.Base.BaseSubResource
        {
            ...
            /// </summary>
            public CollaborationTypes.QueryComputePaymentConfig QueryCompute { get; set; }
        }
