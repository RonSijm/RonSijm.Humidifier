namespace Humidifier.CleanRooms
{
    ...
    public class Membership : Humidifier.Base.BaseResource, IHaveTags
    {
        ...
        /// </summary>
        public MembershipTypes.MembershipPaymentConfiguration PaymentConfiguration { get; set; }
    }
    ...
    namespace MembershipTypes
    {
        public class MembershipPaymentConfiguration : Humidifier.Base.BaseSubResource
        {
            ...
            /// </summary>
            public MembershipTypes.MembershipQueryComputePaymentConfig QueryCompute { get; set; }
        }
        ...
        public class MembershipProtectedQueryOutputConfiguration : Humidifier.Base.BaseSubResource
        {
            ...
            /// </summary>
            public MembershipTypes.ProtectedQueryS3OutputConfiguration S3 { get; set; }
        }

        public class MembershipProtectedQueryResultConfiguration : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// OutputConfiguration
            ...
            /// </summary>
            public MembershipTypes.MembershipProtectedQueryOutputConfiguration OutputConfiguration { get; set; }
            /// <summary>
            /// RoleArn
        ...
        public class ProtectedQueryS3OutputConfiguration : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// Bucket
