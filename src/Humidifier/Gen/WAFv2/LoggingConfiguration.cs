namespace Humidifier.WAFv2
{
    ...
    public class LoggingConfiguration : Humidifier.Base.BaseResource
    {
        ...
        /// </summary>
        public List<LoggingConfigurationTypes.FieldToMatch> RedactedFields { get; set; }
        /// <summary>
        /// LoggingFilter
        ...
        /// Type: LoggingFilter
        /// </summary>
        public LoggingConfigurationTypes.LoggingFilter LoggingFilter { get; set; }
    }

    namespace LoggingConfigurationTypes
    {
        public class ActionCondition : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// Action
        ...
        public class Condition : Humidifier.Base.BaseSubResource
        {
            ...
            /// </summary>
            public LoggingConfigurationTypes.LabelNameCondition LabelNameCondition { get; set; }
            /// <summary>
            /// ActionCondition
            ...
            /// </summary>
            public LoggingConfigurationTypes.ActionCondition ActionCondition { get; set; }
        }
        ...
        public class FieldToMatch : Humidifier.Base.BaseSubResource
        {
            ...
            /// Type: SingleHeader
            /// </summary>
            public LoggingConfigurationTypes.SingleHeader SingleHeader { get; set; }
        }
        ...
        public class Filter : Humidifier.Base.BaseSubResource
        {
            ...
            /// ItemType: Condition
            /// </summary>
            public List<LoggingConfigurationTypes.Condition> Conditions { get; set; }
        }
        ...
        public class LoggingFilter : Humidifier.Base.BaseSubResource
        {
            ...
            /// ItemType: Filter
            /// </summary>
            public List<LoggingConfigurationTypes.Filter> Filters { get; set; }
            /// <summary>
            /// DefaultBehavior
