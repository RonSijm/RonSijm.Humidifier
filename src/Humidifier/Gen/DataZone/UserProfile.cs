namespace Humidifier.DataZone
{
    ...
    public class UserProfile : Humidifier.Base.BaseResource
    {
    ...
    {
        public class IamUserProfileDetails : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// Arn
        ...
        public class SsoUserProfileDetails : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// Username
        ...
        public class UserProfileDetails : Humidifier.Base.BaseSubResource
        {
            ...
            /// </summary>
            public UserProfileTypes.IamUserProfileDetails Iam { get; set; }
            /// <summary>
            /// Sso
            ...
            /// </summary>
            public UserProfileTypes.SsoUserProfileDetails Sso { get; set; }
        }
    }
}