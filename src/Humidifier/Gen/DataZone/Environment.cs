namespace Humidifier.DataZone
{
    ...
    public class Environment : Humidifier.Base.BaseResource, IHaveImpliedResourceName, IHaveName, IHaveDescription, IHaveDomainIdentifier, IHaveProjectIdentifier, IHaveGlossaryTerms
    {
