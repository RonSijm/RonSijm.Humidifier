namespace Humidifier.DataZone
{
    ...
    public class SubscriptionTarget : Humidifier.Base.BaseResource, IHaveImpliedResourceName
    {
        ...
        /// </summary>
        public List<SubscriptionTargetTypes.SubscriptionTargetForm> SubscriptionTargetConfig { get; set; }
        /// <summary>
    ...
    {
        public class SubscriptionTargetForm : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// Content
