namespace Humidifier.DataZone
{
    ...
    public class EnvironmentBlueprintConfiguration : Humidifier.Base.BaseResource
    {
        ...
        /// </summary>
        public List<EnvironmentBlueprintConfigurationTypes.RegionalParameter> RegionalParameters { get; set; }
        /// <summary>
        /// ProvisioningRoleArn
    ...
    {
        public class RegionalParameter : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// Parameters
