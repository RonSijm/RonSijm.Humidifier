namespace Humidifier.ElasticBeanstalk
{
    ...
    public class Environment : Humidifier.Base.BaseResource, IHaveImpliedResourceName, IHaveTags, IHaveDescription
    {
        ...
        /// Type: Tier
        /// </summary>
        public EnvironmentTypes.Tier Tier { get; set; }
        /// <summary>
        /// OptionSettings
        ...
        /// </summary>
        public List<EnvironmentTypes.OptionSetting> OptionSettings { get; set; }
        /// <summary>
        /// VersionLabel
    ...
    {
        public class OptionSetting : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// ResourceName
        ...
        public class Tier : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// Type
