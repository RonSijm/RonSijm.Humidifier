namespace Humidifier.ElasticBeanstalk
{
    ...
    public class ConfigurationTemplate : Humidifier.Base.BaseResource, IHaveDescription
    {
        ...
        /// </summary>
        public List<ConfigurationTemplateTypes.ConfigurationOptionSetting> OptionSettings { get; set; }
        /// <summary>
        /// SourceConfiguration
        ...
        /// </summary>
        public ConfigurationTemplateTypes.SourceConfiguration SourceConfiguration { get; set; }
        /// <summary>
        /// SolutionStackName
    ...
    {
        public class ConfigurationOptionSetting : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// ResourceName
