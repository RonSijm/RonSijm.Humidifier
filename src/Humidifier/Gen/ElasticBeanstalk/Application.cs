namespace Humidifier.ElasticBeanstalk
{
    ...
    public class Application : Humidifier.Base.BaseResource, IHaveImpliedResourceName, IHaveDescription
    {
        ...
        /// </summary>
        public ApplicationTypes.ApplicationResourceLifecycleConfig ResourceLifecycleConfig { get; set; }
    }

    namespace ApplicationTypes
    {
        public class ApplicationResourceLifecycleConfig : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// ServiceRole
            ...
            /// </summary>
            public ApplicationTypes.ApplicationVersionLifecycleConfig VersionLifecycleConfig { get; set; }
        }
        ...
        public class ApplicationVersionLifecycleConfig : Humidifier.Base.BaseSubResource
        {
            ...
            /// Type: MaxCountRule
            /// </summary>
            public ApplicationTypes.MaxCountRule MaxCountRule { get; set; }
            /// <summary>
            /// MaxAgeRule
            ...
            /// Type: MaxAgeRule
            /// </summary>
            public ApplicationTypes.MaxAgeRule MaxAgeRule { get; set; }
        }

        public class MaxAgeRule : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// DeleteSourceFromS3
        ...
        public class MaxCountRule : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// DeleteSourceFromS3
