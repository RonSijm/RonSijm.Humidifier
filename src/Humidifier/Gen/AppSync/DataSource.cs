namespace Humidifier.AppSync
{
    ...
    public class DataSource : Humidifier.Base.BaseResource, IHaveImpliedResourceName, IHaveDescription
    {
        ...
        /// </summary>
        public DataSourceTypes.OpenSearchServiceConfig OpenSearchServiceConfig { get; set; }
        /// <summary>
        /// Description
        ...
        /// </summary>
        public DataSourceTypes.EventBridgeConfig EventBridgeConfig { get; set; }
        /// <summary>
        /// HttpConfig
        ...
        /// Type: HttpConfig
        /// </summary>
        public DataSourceTypes.HttpConfig HttpConfig { get; set; }
        /// <summary>
        ...
        /// </summary>
        public DataSourceTypes.RelationalDatabaseConfig RelationalDatabaseConfig { get; set; }
        /// <summary>
        /// LambdaConfig
        ...
        /// Type: DynamoDBConfig
        /// </summary>
        public DataSourceTypes.DynamoDBConfig DynamoDBConfig { get; set; }
        /// <summary>
        /// ElasticsearchConfig
        ...
        /// </summary>
        public DataSourceTypes.ElasticsearchConfig ElasticsearchConfig { get; set; }
    }
    ...
    namespace DataSourceTypes
    {
        public class AuthorizationConfig : Humidifier.Base.BaseSubResource
        {
            ...
            /// Type: AwsIamConfig
            /// </summary>
            public DataSourceTypes.AwsIamConfig AwsIamConfig { get; set; }
            /// <summary>
            /// AuthorizationType
        ...
        public class DynamoDBConfig : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// TableName
            ...
            /// </summary>
            public DataSourceTypes.DeltaSyncConfig DeltaSyncConfig { get; set; }
            /// <summary>
        ...
        public class ElasticsearchConfig : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// AwsRegion
        ...
        public class EventBridgeConfig : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// EventBusArn
        ...
        public class HttpConfig : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// Endpoint
            ...
            /// </summary>
            public DataSourceTypes.AuthorizationConfig AuthorizationConfig { get; set; }
        }
        ...
        public class OpenSearchServiceConfig : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// AwsRegion
        ...
        public class RdsHttpEndpointConfig : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// AwsRegion
        ...
        public class RelationalDatabaseConfig : Humidifier.Base.BaseSubResource
        {
            ...
            /// </summary>
            public DataSourceTypes.RdsHttpEndpointConfig RdsHttpEndpointConfig { get; set; }
            /// <summary>
