namespace Humidifier.AppSync
{
    ...
    public class Resolver : Humidifier.Base.BaseResource
    {
        ...
        /// Type: PipelineConfig
        /// </summary>
        public ResolverTypes.PipelineConfig PipelineConfig { get; set; }
        /// <summary>
        ...
        /// Type: SyncConfig
        /// </summary>
        public ResolverTypes.SyncConfig SyncConfig { get; set; }
        /// <summary>
        /// Code
        ...
        /// Type: AppSyncRuntime
        /// </summary>
        public ResolverTypes.AppSyncRuntime Runtime { get; set; }
        /// <summary>
        /// CodeS3Location
        ...
        /// Type: CachingConfig
        /// </summary>
        public ResolverTypes.CachingConfig CachingConfig { get; set; }
        /// <summary>
    ...
    {
        public class AppSyncRuntime : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// RuntimeVersion
        ...
        public class CachingConfig : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// CachingKeys
        ...
        public class SyncConfig : Humidifier.Base.BaseSubResource
        {
            ...
            /// </summary>
            public ResolverTypes.LambdaConflictHandlerConfig LambdaConflictHandlerConfig { get; set; }
        }
    }
}