namespace Humidifier.AppSync
{
    ...
    public class FunctionConfiguration : Humidifier.Base.BaseResource, IHaveImpliedResourceName, IHaveDescription
    {
        ...
        /// Type: SyncConfig
        /// </summary>
        public FunctionConfigurationTypes.SyncConfig SyncConfig { get; set; }
        /// <summary>
        /// Code
        ...
        /// Type: AppSyncRuntime
        /// </summary>
        public FunctionConfigurationTypes.AppSyncRuntime Runtime { get; set; }
        /// <summary>
        /// CodeS3Location
    ...
    namespace FunctionConfigurationTypes
    {
        ...
        public class SyncConfig : Humidifier.Base.BaseSubResource
        {
            ...
            /// </summary>
            public FunctionConfigurationTypes.LambdaConflictHandlerConfig LambdaConflictHandlerConfig { get; set; }
        }
    }
}