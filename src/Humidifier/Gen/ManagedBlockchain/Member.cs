namespace Humidifier.ManagedBlockchain
{
    ...
    public class Member : Humidifier.Base.BaseResource
    {
        ...
        /// </summary>
        public MemberTypes.NetworkConfiguration NetworkConfiguration { get; set; }
        /// <summary>
        /// NetworkId
    ...
    {
        public class ApprovalThresholdPolicy : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// ThresholdComparator
        ...
        public class MemberConfiguration : Humidifier.Base.BaseSubResource, IHaveDescription
        {
            /// <summary>
            /// Description
            ...
            /// </summary>
            public MemberTypes.MemberFrameworkConfiguration MemberFrameworkConfiguration { get; set; }
            /// <summary>
            /// Name
        ...
        public class MemberFabricConfiguration : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// AdminUsername
        ...
        public class MemberFrameworkConfiguration : Humidifier.Base.BaseSubResource
        {
            ...
            /// </summary>
            public MemberTypes.MemberFabricConfiguration MemberFabricConfiguration { get; set; }
        }

        public class NetworkConfiguration : Humidifier.Base.BaseSubResource, IHaveDescription
        {
            /// <summary>
            /// Description
            ...
            /// Type: VotingPolicy
            /// </summary>
            public MemberTypes.VotingPolicy VotingPolicy { get; set; }
            /// <summary>
            /// Framework
            ...
            /// </summary>
            public MemberTypes.NetworkFrameworkConfiguration NetworkFrameworkConfiguration { get; set; }
        }

        public class NetworkFabricConfiguration : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// Edition
        ...
        public class NetworkFrameworkConfiguration : Humidifier.Base.BaseSubResource
        {
            ...
            /// </summary>
            public MemberTypes.NetworkFabricConfiguration NetworkFabricConfiguration { get; set; }
        }
        ...
        public class VotingPolicy : Humidifier.Base.BaseSubResource
        {
            ...
            /// </summary>
            public MemberTypes.ApprovalThresholdPolicy ApprovalThresholdPolicy { get; set; }
        }
    }
}