namespace Humidifier.EC2
{
    ...
    public class NetworkInsightsAccessScope : Humidifier.Base.BaseResource, IHaveTags
    {
        ...
        /// </summary>
        public List<NetworkInsightsAccessScopeTypes.AccessScopePathRequest> ExcludePaths { get; set; }
        /// <summary>
        /// MatchPaths
        ...
        /// ItemType: AccessScopePathRequest
        /// </summary>
        public List<NetworkInsightsAccessScopeTypes.AccessScopePathRequest> MatchPaths { get; set; }
        /// <summary>
        /// Tags
    ...
    namespace NetworkInsightsAccessScopeTypes
    {
        public class AccessScopePathRequest : Humidifier.Base.BaseSubResource
        {
            ...
            /// </summary>
            public NetworkInsightsAccessScopeTypes.PathStatementRequest Destination { get; set; }
            /// <summary>
            /// ThroughResources
            ...
            /// </summary>
            public List<NetworkInsightsAccessScopeTypes.ThroughResourcesStatementRequest> ThroughResources { get; set; }
            /// <summary>
            /// Source
            ...
            /// Type: PathStatementRequest
            /// </summary>
            public NetworkInsightsAccessScopeTypes.PathStatementRequest Source { get; set; }
        }

        public class PacketHeaderStatementRequest : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// Protocols
        ...
        public class PathStatementRequest : Humidifier.Base.BaseSubResource
        {
            ...
            /// </summary>
            public NetworkInsightsAccessScopeTypes.ResourceStatementRequest ResourceStatement { get; set; }
            /// <summary>
            ...
            /// </summary>
            public NetworkInsightsAccessScopeTypes.PacketHeaderStatementRequest PacketHeaderStatement { get; set; }
        }

        public class ResourceStatementRequest : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// ResourceTypes
