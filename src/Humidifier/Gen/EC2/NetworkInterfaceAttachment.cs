namespace Humidifier.EC2
{
    ...
    public class NetworkInterfaceAttachment : Humidifier.Base.BaseResource
    {
    ...
    namespace NetworkInterfaceAttachmentTypes
    {
        public class EnaSrdSpecification : Humidifier.Base.BaseSubResource
        {
            ...
            /// </summary>
            public NetworkInterfaceAttachmentTypes.EnaSrdUdpSpecification EnaSrdUdpSpecification { get; set; }
        }
