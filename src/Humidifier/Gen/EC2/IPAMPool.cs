namespace Humidifier.EC2
{
    ...
    public class IPAMPool : Humidifier.Base.BaseResource, IHaveTags, IHaveDescription
    {
        ...
        /// Type: SourceResource
        /// </summary>
        public IPAMPoolTypes.SourceResource SourceResource { get; set; }
        /// <summary>
        /// SourceIpamPoolId
        ...
        /// </summary>
        public List<IPAMPoolTypes.ProvisionedCidr> ProvisionedCidrs { get; set; }
        /// <summary>
    ...
    {
        public class ProvisionedCidr : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// Cidr
        ...
        public class SourceResource : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// ResourceRegion
