namespace Humidifier.EC2
{
    ...
    public class VerifiedAccessTrustProvider : Humidifier.Base.BaseResource, IHaveTags, IHaveDescription
    {
        ...
        /// Type: DeviceOptions
        /// </summary>
        public VerifiedAccessTrustProviderTypes.DeviceOptions DeviceOptions { get; set; }
        /// <summary>
        ...
        /// </summary>
        public VerifiedAccessTrustProviderTypes.SseSpecification SseSpecification { get; set; }
        /// <summary>
    ...
    namespace VerifiedAccessTrustProviderTypes
    {
        ...
        public class OidcOptions : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// TokenEndpoint
