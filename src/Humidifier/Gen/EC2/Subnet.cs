namespace Humidifier.EC2
{
    ...
    public class Subnet : Humidifier.Base.BaseResource, IHaveTags, IHaveVpcId
    {
        ...
        /// </summary>
        public SubnetTypes.PrivateDnsNameOptionsOnLaunch PrivateDnsNameOptionsOnLaunch { get; set; }
        /// <summary>
        /// Ipv4IpamPoolId
        ...
        /// </summary>
        public dynamic Ipv6CidrBlocks { get; set; }
        /// <summary>
        /// Ipv6CidrBlock
    ...
    {
        public class PrivateDnsNameOptionsOnLaunch : Humidifier.Base.BaseSubResource
        {
            /// <summary>
