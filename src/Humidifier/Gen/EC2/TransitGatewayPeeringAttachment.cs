namespace Humidifier.EC2
{
    ...
    public class TransitGatewayPeeringAttachment : Humidifier.Base.BaseResource, IHaveTags
    {
    ...
    {
        public class PeeringAttachmentStatus : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// Message
