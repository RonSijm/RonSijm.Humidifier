namespace Humidifier.EC2
{
    ...
    public class IPAM : Humidifier.Base.BaseResource, IHaveTags, IHaveDescription
    {
        ...
        /// </summary>
        public List<IPAMTypes.IpamOperatingRegion> OperatingRegions { get; set; }
    }

    namespace IPAMTypes
    {
        public class IpamOperatingRegion : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// RegionName
