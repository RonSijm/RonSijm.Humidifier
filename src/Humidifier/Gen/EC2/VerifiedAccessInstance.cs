namespace Humidifier.EC2
{
    ...
    public class VerifiedAccessInstance : Humidifier.Base.BaseResource, IHaveTags, IHaveDescription
    {
        ...
        /// </summary>
        public List<VerifiedAccessInstanceTypes.VerifiedAccessTrustProvider> VerifiedAccessTrustProviders { get; set; }
        /// <summary>
        /// Description
        ...
        /// </summary>
        public VerifiedAccessInstanceTypes.VerifiedAccessLogs LoggingConfigurations { get; set; }
        /// <summary>
    ...
    namespace VerifiedAccessInstanceTypes
    {
        ...
        public class KinesisDataFirehose : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// DeliveryStream
        ...
        public class VerifiedAccessLogs : Humidifier.Base.BaseSubResource
        {
            ...
            /// Type: S3
            /// </summary>
            public VerifiedAccessInstanceTypes.S3 S3 { get; set; }
            /// <summary>
            /// LogVersion
            ...
            /// </summary>
            public VerifiedAccessInstanceTypes.KinesisDataFirehose KinesisDataFirehose { get; set; }
            /// <summary>
            /// CloudWatchLogs
            ...
            /// Type: CloudWatchLogs
            /// </summary>
            public VerifiedAccessInstanceTypes.CloudWatchLogs CloudWatchLogs { get; set; }
            /// <summary>
            /// IncludeTrustContext
