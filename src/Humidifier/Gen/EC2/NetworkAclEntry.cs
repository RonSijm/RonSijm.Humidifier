namespace Humidifier.EC2
{
    ...
    public class NetworkAclEntry : Humidifier.Base.BaseResource
    {
        ...
        /// Type: Icmp
        /// </summary>
        public NetworkAclEntryTypes.Icmp Icmp { get; set; }
    }

    namespace NetworkAclEntryTypes
    {
        public class Icmp : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// Type
