namespace Humidifier.EC2
{
    ...
    public class CapacityReservationFleet : Humidifier.Base.BaseResource
    {
        ...
        /// </summary>
        public List<CapacityReservationFleetTypes.TagSpecification> TagSpecifications { get; set; }
        /// <summary>
        /// NoRemoveEndDate
        ...
        /// </summary>
        public List<CapacityReservationFleetTypes.InstanceTypeSpecification> InstanceTypeSpecifications { get; set; }
        /// <summary>
        /// RemoveEndDate
    ...
    {
        public class InstanceTypeSpecification : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// Priority
