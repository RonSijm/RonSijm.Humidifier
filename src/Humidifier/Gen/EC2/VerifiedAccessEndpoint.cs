namespace Humidifier.EC2
{
    ...
    public class VerifiedAccessEndpoint : Humidifier.Base.BaseResource, IHaveTags, IHaveDescription, IHavePolicyDocument
    {
        ...
        /// </summary>
        public VerifiedAccessEndpointTypes.SseSpecification SseSpecification { get; set; }
        /// <summary>
        /// Tags
        ...
        /// </summary>
        public VerifiedAccessEndpointTypes.NetworkInterfaceOptions NetworkInterfaceOptions { get; set; }
    }
    ...
    namespace VerifiedAccessEndpointTypes
    {
        ...
        public class NetworkInterfaceOptions : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// Port
