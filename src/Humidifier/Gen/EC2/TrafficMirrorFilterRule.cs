namespace Humidifier.EC2
{
    ...
    public class TrafficMirrorFilterRule : Humidifier.Base.BaseResource, IHaveTags, IHaveDescription
    {
        ...
        /// </summary>
        public TrafficMirrorFilterRuleTypes.TrafficMirrorPortRange DestinationPortRange { get; set; }
        /// <summary>
        /// Description
    ...
    {
        public class TrafficMirrorPortRange : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// FromPort
