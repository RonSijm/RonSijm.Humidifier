namespace Humidifier.EC2
{
    ...
    public class SecurityGroup : Humidifier.Base.BaseResource, IHaveTags, IHaveVpcId
    {
        ...
        /// ItemType: Ingress
        /// </summary>
        public List<SecurityGroupTypes.Ingress> SecurityGroupIngress { get; set; }
        /// <summary>
        /// SecurityGroupEgress
        ...
        /// ItemType: Egress
        /// </summary>
        public List<SecurityGroupTypes.Egress> SecurityGroupEgress { get; set; }
        /// <summary>
        /// Tags
    ...
    {
        public class Egress : Humidifier.Base.BaseSubResource, IHaveDescription
        {
            /// <summary>
            /// CidrIp
        ...
        public class Ingress : Humidifier.Base.BaseSubResource, IHaveDescription
        {
            /// <summary>
            /// CidrIp
