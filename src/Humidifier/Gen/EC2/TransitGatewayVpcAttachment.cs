namespace Humidifier.EC2
{
    ...
    public class TransitGatewayVpcAttachment : Humidifier.Base.BaseResource, IHaveTags, IHaveVpcId, IHaveSubnetIds
    {
        ...
        /// Type: Options
        /// </summary>
        public TransitGatewayVpcAttachmentTypes.Options Options { get; set; }
