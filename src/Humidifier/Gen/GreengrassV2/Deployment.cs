namespace Humidifier.GreengrassV2
{
    ...
    public class Deployment : Humidifier.Base.BaseResource, IHaveImpliedResourceName
    {
        ...
        /// </summary>
        public Dictionary<string, DeploymentTypes.ComponentDeploymentSpecification> Components { get; set; }
        ...
        /// </summary>
        public DeploymentTypes.DeploymentIoTJobConfiguration IotJobConfiguration { get; set; }
        /// <summary>
        /// DeploymentPolicies
    ...
    namespace DeploymentTypes
    {
        ...
        public class ComponentDeploymentSpecification : Humidifier.Base.BaseSubResource
        {
            ...
            /// </summary>
            public DeploymentTypes.ComponentRunWith RunWith { get; set; }
            /// <summary>
            /// ConfigurationUpdate
            ...
            /// </summary>
            public DeploymentTypes.ComponentConfigurationUpdate ConfigurationUpdate { get; set; }
            /// <summary>
            /// ComponentVersion
        ...
        public class ComponentRunWith : Humidifier.Base.BaseSubResource
        {
            ...
            /// </summary>
            public DeploymentTypes.SystemResourceLimits SystemResourceLimits { get; set; }
            /// <summary>
            /// PosixUser
        ...
        public class DeploymentComponentUpdatePolicy : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// Action
        ...
        public class DeploymentConfigurationValidationPolicy : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// TimeoutInSeconds
        ...
        public class DeploymentIoTJobConfiguration : Humidifier.Base.BaseSubResource
        {
            ...
            /// </summary>
            public DeploymentTypes.IoTJobExecutionsRolloutConfig JobExecutionsRolloutConfig { get; set; }
            /// <summary>
            /// TimeoutConfig
            ...
            /// </summary>
            public DeploymentTypes.IoTJobTimeoutConfig TimeoutConfig { get; set; }
            /// <summary>
            /// AbortConfig
            ...
            /// </summary>
            public DeploymentTypes.IoTJobAbortConfig AbortConfig { get; set; }
        }
        ...
        public class DeploymentPolicies : Humidifier.Base.BaseSubResource
        {
            ...
            /// </summary>
            public DeploymentTypes.DeploymentComponentUpdatePolicy ComponentUpdatePolicy { get; set; }
            /// <summary>
            ...
            /// </summary>
            public DeploymentTypes.DeploymentConfigurationValidationPolicy ConfigurationValidationPolicy { get; set; }
            /// <summary>
        ...
        public class IoTJobAbortConfig : Humidifier.Base.BaseSubResource
        {
            ...
            /// </summary>
            public List<DeploymentTypes.IoTJobAbortCriteria> CriteriaList { get; set; }
        }

        public class IoTJobAbortCriteria : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// FailureType
        ...
        public class IoTJobExecutionsRolloutConfig : Humidifier.Base.BaseSubResource
        {
            ...
            /// </summary>
            public DeploymentTypes.IoTJobExponentialRolloutRate ExponentialRate { get; set; }
        }
        ...
        public class IoTJobExponentialRolloutRate : Humidifier.Base.BaseSubResource
        {
            ...
            /// </summary>
            public DeploymentTypes.IoTJobRateIncreaseCriteria RateIncreaseCriteria { get; set; }
            /// <summary>
            /// BaseRatePerMinute
        ...
        public class SystemResourceLimits : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// Memory
