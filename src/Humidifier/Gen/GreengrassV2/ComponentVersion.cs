namespace Humidifier.GreengrassV2
{
    ...
    public class ComponentVersion : Humidifier.Base.BaseResource
    {
        ...
        /// </summary>
        public ComponentVersionTypes.LambdaFunctionRecipeSource LambdaFunction { get; set; }
        /// <summary>
        /// InlineRecipe
    ...
    namespace ComponentVersionTypes
    {
        ...
        public class ComponentPlatform : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// Attributes_
        ...
        public class LambdaContainerParams : Humidifier.Base.BaseSubResource
        {
            ...
            /// </summary>
            public List<ComponentVersionTypes.LambdaVolumeMount> Volumes { get; set; }
            /// <summary>
            /// MountROSysfs
            ...
            /// </summary>
            public List<ComponentVersionTypes.LambdaDeviceMount> Devices { get; set; }
        }

        public class LambdaDeviceMount : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// Path
        ...
        public class LambdaEventSource : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// Type
        ...
        public class LambdaExecutionParameters : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// MaxInstancesCount
            ...
            /// </summary>
            public List<ComponentVersionTypes.LambdaEventSource> EventSources { get; set; }
            /// <summary>
            /// Pinned
            ...
            /// </summary>
            public ComponentVersionTypes.LambdaLinuxProcessParams LinuxProcessParams { get; set; }
            /// <summary>
        ...
        public class LambdaFunctionRecipeSource : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            ...
            /// </summary>
            public Dictionary<string, ComponentVersionTypes.ComponentDependencyRequirement> ComponentDependencies { get; set; }
            /// <summary>
            ...
            /// </summary>
            public ComponentVersionTypes.LambdaExecutionParameters ComponentLambdaParameters { get; set; }
            /// <summary>
            /// LambdaArn
            ...
            /// </summary>
            public List<ComponentVersionTypes.ComponentPlatform> ComponentPlatforms { get; set; }
            /// <summary>
            /// ComponentName
        ...
        public class LambdaLinuxProcessParams : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// IsolationMode
            ...
            /// </summary>
            public ComponentVersionTypes.LambdaContainerParams ContainerParams { get; set; }
        }

        public class LambdaVolumeMount : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// SourcePath
