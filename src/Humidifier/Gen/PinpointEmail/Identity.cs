namespace Humidifier.PinpointEmail
{
    ...
    public class Identity : Humidifier.Base.BaseResource, IHaveImpliedResourceName
    {
        ...
        /// ItemType: Tags
        /// </summary>
        public List<IdentityTypes.Tags> Tags { get; set; }
        ...
        /// </summary>
        public IdentityTypes.MailFromAttributes MailFromAttributes { get; set; }
    }
