namespace Humidifier.PinpointEmail
{
    ...
    namespace ConfigurationSetEventDestinationTypes
    {
        ...
        public class EventDestination : Humidifier.Base.BaseSubResource
        {
            ...
            /// </summary>
            public ConfigurationSetEventDestinationTypes.PinpointDestination PinpointDestination { get; set; }
            /// <summary>
        ...
        public class PinpointDestination : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// ApplicationArn
