namespace Humidifier.HealthLake
{
    ...
    public class FHIRDatastore : Humidifier.Base.BaseResource, IHaveTags
    {
        ...
        /// </summary>
        public FHIRDatastoreTypes.IdentityProviderConfiguration IdentityProviderConfiguration { get; set; }
        /// <summary>
        /// Tags
        ...
        /// </summary>
        public FHIRDatastoreTypes.PreloadDataConfig PreloadDataConfig { get; set; }
        /// <summary>
        /// SseConfiguration
        ...
        /// </summary>
        public FHIRDatastoreTypes.SseConfiguration SseConfiguration { get; set; }
    }
    ...
    namespace FHIRDatastoreTypes
    {
        ...
        public class SseConfiguration : Humidifier.Base.BaseSubResource
        {
            ...
            /// </summary>
            public FHIRDatastoreTypes.KmsEncryptionConfig KmsEncryptionConfig { get; set; }
        }
    }
}