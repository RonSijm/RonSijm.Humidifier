namespace Humidifier.LicenseManager
{
    ...
    public class License : Humidifier.Base.BaseResource, IHaveImpliedResourceName
    {
        ...
        /// ItemType: Metadata
        /// </summary>
        public List<LicenseTypes.Metadata> LicenseMetadata { get; set; }
    ...
    namespace LicenseTypes
    {
        ...
        public class ConsumptionConfiguration : Humidifier.Base.BaseSubResource
        {
            ...
            /// </summary>
            public LicenseTypes.BorrowConfiguration BorrowConfiguration { get; set; }
            /// <summary>
            /// RenewType
            ...
            /// </summary>
            public LicenseTypes.ProvisionalConfiguration ProvisionalConfiguration { get; set; }
        }

        public class Entitlement : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// AllowCheckIn
        ...
        public class IssuerData : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// SignKey
        ...
        public class ValidityDateFormat : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// Begin
