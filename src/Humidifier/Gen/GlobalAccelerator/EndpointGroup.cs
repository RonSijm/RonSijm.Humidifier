namespace Humidifier.GlobalAccelerator
{
    ...
    public class EndpointGroup : Humidifier.Base.BaseResource
    {
        ...
        /// </summary>
        public List<EndpointGroupTypes.PortOverride> PortOverrides { get; set; }
        /// <summary>
        ...
        /// </summary>
        public List<EndpointGroupTypes.EndpointConfiguration> EndpointConfigurations { get; set; }
    }
