namespace Humidifier.GlobalAccelerator
{
    ...
    public class CrossAccountAttachment : Humidifier.Base.BaseResource, IHaveImpliedResourceName, IHaveTags
    {
        ...
        /// ItemType: Resource
        /// </summary>
        public List<CrossAccountAttachmentTypes.Resource> Resources { get; set; }
        /// <summary>
        /// Tags
