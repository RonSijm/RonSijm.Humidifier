namespace Humidifier.CodeDeploy
{
    ...
    public class DeploymentConfig : Humidifier.Base.BaseResource, IHaveImpliedResourceName
    {
        ...
        /// Type: ZonalConfig
        /// </summary>
        public DeploymentConfigTypes.ZonalConfig ZonalConfig { get; set; }
        ...
        /// </summary>
        public DeploymentConfigTypes.TrafficRoutingConfig TrafficRoutingConfig { get; set; }
        /// <summary>
        /// MinimumHealthyHosts
        ...
        /// </summary>
        public DeploymentConfigTypes.MinimumHealthyHosts MinimumHealthyHosts { get; set; }
    }

    namespace DeploymentConfigTypes
    {
        public class MinimumHealthyHosts : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// Type
        ...
        public class MinimumHealthyHostsPerZone : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// Type
        ...
        public class TrafficRoutingConfig : Humidifier.Base.BaseSubResource
        {
            ...
            /// </summary>
            public DeploymentConfigTypes.TimeBasedLinear TimeBasedLinear { get; set; }
            /// <summary>
            /// TimeBasedCanary
            ...
            /// </summary>
            public DeploymentConfigTypes.TimeBasedCanary TimeBasedCanary { get; set; }
        }
        ...
        public class ZonalConfig : Humidifier.Base.BaseSubResource
        {
            ...
            /// </summary>
            public DeploymentConfigTypes.MinimumHealthyHostsPerZone MinimumHealthyHostsPerZone { get; set; }
            /// <summary>
