namespace Humidifier.CodeDeploy
{
    ...
    public class DeploymentGroup : Humidifier.Base.BaseResource, IHaveImpliedResourceName, IHaveTags
    {
        ...
        /// </summary>
        public DeploymentGroupTypes.AutoRollbackConfiguration AutoRollbackConfiguration { get; set; }
        /// <summary>
        /// AutoScalingGroups
        ...
        /// </summary>
        public DeploymentGroupTypes.BlueGreenDeploymentConfiguration BlueGreenDeploymentConfiguration { get; set; }
        /// <summary>
        /// Deployment
        ...
        /// Type: Deployment
        /// </summary>
        public DeploymentGroupTypes.Deployment Deployment { get; set; }
        /// <summary>
        ...
        /// </summary>
        public DeploymentGroupTypes.DeploymentStyle DeploymentStyle { get; set; }
        /// <summary>
        /// ECSServices
        ...
        /// ItemType: ECSService
        /// </summary>
        public List<DeploymentGroupTypes.ECSService> ECSServices { get; set; }
        /// <summary>
        /// Ec2TagFilters
        ...
        /// </summary>
        public List<DeploymentGroupTypes.EC2TagFilter> Ec2TagFilters { get; set; }
        /// <summary>
        /// Ec2TagSet
        ...
        /// Type: EC2TagSet
        /// </summary>
        public DeploymentGroupTypes.EC2TagSet Ec2TagSet { get; set; }
        /// <summary>
        /// LoadBalancerInfo
        ...
        /// </summary>
        public DeploymentGroupTypes.LoadBalancerInfo LoadBalancerInfo { get; set; }
        /// <summary>
        ...
        /// ItemType: TagFilter
        /// </summary>
        public List<DeploymentGroupTypes.TagFilter> OnPremisesInstanceTagFilters { get; set; }
        /// <summary>
        /// OnPremisesTagSet
        ...
        /// </summary>
        public DeploymentGroupTypes.OnPremisesTagSet OnPremisesTagSet { get; set; }
        /// <summary>
        ...
        /// </summary>
        public List<DeploymentGroupTypes.TriggerConfig> TriggerConfigurations { get; set; }
    }

    namespace DeploymentGroupTypes
    {
        public class Alarm : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// Name
        ...
        public class AlarmConfiguration : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// Alarms
            ...
            /// ItemType: Alarm
            /// </summary>
            public List<DeploymentGroupTypes.Alarm> Alarms { get; set; }
            /// <summary>
            /// Enabled
        ...
        public class AutoRollbackConfiguration : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// Enabled
        ...
        public class BlueGreenDeploymentConfiguration : Humidifier.Base.BaseSubResource
        {
            ...
            /// </summary>
            public DeploymentGroupTypes.DeploymentReadyOption DeploymentReadyOption { get; set; }
            /// <summary>
            ...
            /// </summary>
            public DeploymentGroupTypes.GreenFleetProvisioningOption GreenFleetProvisioningOption { get; set; }
            /// <summary>
            ...
            /// </summary>
            public DeploymentGroupTypes.BlueInstanceTerminationOption TerminateBlueInstancesOnDeploymentSuccess { get; set; }
        }

        public class BlueInstanceTerminationOption : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// Action
        ...
        public class Deployment : Humidifier.Base.BaseSubResource, IHaveDescription
        {
            ...
            /// </summary>
            public DeploymentGroupTypes.RevisionLocation Revision { get; set; }
        }
        ...
        public class DeploymentStyle : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// DeploymentOption
        ...
        public class EC2TagFilter : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// Key
        ...
        public class EC2TagSet : Humidifier.Base.BaseSubResource
        {
            ...
            /// </summary>
            public List<DeploymentGroupTypes.EC2TagSetListObject> Ec2TagSetList { get; set; }
        }
        ...
        public class EC2TagSetListObject : Humidifier.Base.BaseSubResource
        {
            ...
            /// ItemType: EC2TagFilter
            /// </summary>
            public List<DeploymentGroupTypes.EC2TagFilter> Ec2TagGroup { get; set; }
        }

        public class ECSService : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// ClusterName
        ...
        public class ELBInfo : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// Name
        ...
        public class GitHubLocation : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// CommitId
        ...
        public class GreenFleetProvisioningOption : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// Action
        ...
        public class LoadBalancerInfo : Humidifier.Base.BaseSubResource
        {
            ...
            /// ItemType: ELBInfo
            /// </summary>
            public List<DeploymentGroupTypes.ELBInfo> ElbInfoList { get; set; }
            /// <summary>
            /// TargetGroupInfoList
            ...
            /// </summary>
            public List<DeploymentGroupTypes.TargetGroupInfo> TargetGroupInfoList { get; set; }
            /// <summary>
            ...
            /// </summary>
            public List<DeploymentGroupTypes.TargetGroupPairInfo> TargetGroupPairInfoList { get; set; }
        }
        ...
        public class OnPremisesTagSet : Humidifier.Base.BaseSubResource
        {
            ...
            /// </summary>
            public List<DeploymentGroupTypes.OnPremisesTagSetListObject> OnPremisesTagSetList { get; set; }
        }
        ...
        public class OnPremisesTagSetListObject : Humidifier.Base.BaseSubResource
        {
            ...
            /// ItemType: TagFilter
            /// </summary>
            public List<DeploymentGroupTypes.TagFilter> OnPremisesTagGroup { get; set; }
        }
        ...
        public class RevisionLocation : Humidifier.Base.BaseSubResource
        {
            ...
            /// Type: GitHubLocation
            /// </summary>
            public DeploymentGroupTypes.GitHubLocation GitHubLocation { get; set; }
            /// <summary>
            /// RevisionType
            ...
            /// Type: S3Location
            /// </summary>
            public DeploymentGroupTypes.S3Location S3Location { get; set; }
        }
        ...
        public class TargetGroupInfo : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// Name
        ...
        public class TargetGroupPairInfo : Humidifier.Base.BaseSubResource
        {
            ...
            /// Type: TrafficRoute
            /// </summary>
            public DeploymentGroupTypes.TrafficRoute ProdTrafficRoute { get; set; }
            /// <summary>
            /// TargetGroups
            ...
            /// ItemType: TargetGroupInfo
            /// </summary>
            public List<DeploymentGroupTypes.TargetGroupInfo> TargetGroups { get; set; }
            /// <summary>
            /// TestTrafficRoute
            ...
            /// Type: TrafficRoute
            /// </summary>
            public DeploymentGroupTypes.TrafficRoute TestTrafficRoute { get; set; }
        }
