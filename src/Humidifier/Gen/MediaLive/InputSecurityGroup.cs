namespace Humidifier.MediaLive
{
    ...
    public class InputSecurityGroup : Humidifier.Base.BaseResource
    {
        ...
        /// </summary>
        public List<InputSecurityGroupTypes.InputWhitelistRuleCidr> WhitelistRules { get; set; }
        /// <summary>
        /// Tags
    ...
    {
        public class InputWhitelistRuleCidr : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// Cidr
