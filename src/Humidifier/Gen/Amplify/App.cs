namespace Humidifier.Amplify
{
    ...
    public class App : Humidifier.Base.BaseResource, IHaveTags, IHaveDescription, IHaveImpliedResourceName
    {
        ...
        /// </summary>
        public AppTypes.AutoBranchCreationConfig AutoBranchCreationConfig { get; set; }
        /// <summary>
        /// OauthToken
        ...
        /// </summary>
        public List<AppTypes.EnvironmentVariable> EnvironmentVariables { get; set; }
        /// <summary>
        /// AccessToken
        ...
        /// ItemType: CustomRule
        /// </summary>
        public List<AppTypes.CustomRule> CustomRules { get; set; }
        /// <summary>
        /// BasicAuthConfig
        ...
        /// </summary>
        public AppTypes.BasicAuthConfig BasicAuthConfig { get; set; }
        /// <summary>
        /// CustomHeaders
    ...
    namespace AppTypes
    {
        public class AutoBranchCreationConfig : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// EnvironmentVariables
        ...
        public class BasicAuthConfig : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// Username
        ...
        public class CustomRule : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// Condition
