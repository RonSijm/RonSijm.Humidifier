namespace Humidifier.Amplify
{
    ...
    public class Domain : Humidifier.Base.BaseResource, IHaveImpliedResourceName
    {
        ...
        /// </summary>
        public DomainTypes.CertificateSettings CertificateSettings { get; set; }
        /// <summary>
        /// EnableAutoSubDomain
    ...
    namespace DomainTypes
    {
        ...
        public class CertificateSettings : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// CertificateType
        ...
        public class SubDomainSetting : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// Prefix
