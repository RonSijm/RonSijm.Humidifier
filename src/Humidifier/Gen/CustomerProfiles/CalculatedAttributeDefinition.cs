namespace Humidifier.CustomerProfiles
{
    ...
    public class CalculatedAttributeDefinition : Humidifier.Base.BaseResource, IHaveTags, IHaveDescription
    {
        ...
        /// Type: Conditions
        /// </summary>
        public CalculatedAttributeDefinitionTypes.Conditions Conditions { get; set; }
        /// <summary>
        /// Tags
    ...
    {
        public class AttributeDetails : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// Expression
            ...
            /// </summary>
            public List<CalculatedAttributeDefinitionTypes.AttributeItem> Attributes_ { get; set; }
        }

        public class AttributeItem : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// Name
        ...
        public class Conditions : Humidifier.Base.BaseSubResource
        {
            ...
            /// Type: Range
            /// </summary>
            public CalculatedAttributeDefinitionTypes.Range Range { get; set; }
            /// <summary>
            /// ObjectCount
            ...
            /// Type: Threshold
            /// </summary>
            public CalculatedAttributeDefinitionTypes.Threshold Threshold { get; set; }
        }
