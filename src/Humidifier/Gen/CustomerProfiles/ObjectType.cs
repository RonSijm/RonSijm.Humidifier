namespace Humidifier.CustomerProfiles
{
    ...
    public class ObjectType : Humidifier.Base.BaseResource, IHaveImpliedResourceName, IHaveTags, IHaveDescription
    {
        ...
        /// ItemType: KeyMap
        /// </summary>
        public List<ObjectTypeTypes.KeyMap> Keys { get; set; }
        /// <summary>
    ...
    {
        public class FieldMap : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// Name
            ...
            /// </summary>
            public ObjectTypeTypes.ObjectTypeField ObjectTypeField { get; set; }
        }

        public class KeyMap : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// ObjectTypeKeyList
            ...
            /// </summary>
            public List<ObjectTypeTypes.ObjectTypeKey> ObjectTypeKeyList { get; set; }
            /// <summary>
            /// Name
        ...
        public class ObjectTypeField : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// Target
