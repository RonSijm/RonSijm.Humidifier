namespace Humidifier.CustomerProfiles
{
    ...
    public class Domain : Humidifier.Base.BaseResource, IHaveTags, IHaveImpliedResourceName
    {
        ...
        /// </summary>
        public DomainTypes.RuleBasedMatching RuleBasedMatching { get; set; }
        /// <summary>
        /// Tags
    ...
    {
        public class AttributeTypesSelector : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// Address
        ...
        public class AutoMerging : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// Consolidation
            ...
            /// Type: Consolidation
            /// </summary>
            public DomainTypes.Consolidation Consolidation { get; set; }
            /// <summary>
            /// Enabled
            ...
            /// </summary>
            public DomainTypes.ConflictResolution ConflictResolution { get; set; }
            /// <summary>
        ...
        public class ConflictResolution : Humidifier.Base.BaseSubResource
        {
            /// <summary>
        ...
        public class ExportingConfig : Humidifier.Base.BaseSubResource
        {
            ...
            /// </summary>
            public DomainTypes.S3ExportingConfig S3Exporting { get; set; }
        }
        ...
        public class Matching : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// AutoMerging
            ...
            /// Type: AutoMerging
            /// </summary>
            public DomainTypes.AutoMerging AutoMerging { get; set; }
            /// <summary>
            /// JobSchedule
            ...
            /// Type: JobSchedule
            /// </summary>
            public DomainTypes.JobSchedule JobSchedule { get; set; }
            /// <summary>
            /// Enabled
            ...
            /// </summary>
            public DomainTypes.ExportingConfig ExportingConfig { get; set; }
        }
        ...
        public class RuleBasedMatching : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// Status
            ...
            /// </summary>
            public List<DomainTypes.MatchingRule> MatchingRules { get; set; }
            /// <summary>
            ...
            /// </summary>
            public DomainTypes.AttributeTypesSelector AttributeTypesSelector { get; set; }
            /// <summary>
            /// ConflictResolution
        ...
        public class S3ExportingConfig : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// S3BucketName
