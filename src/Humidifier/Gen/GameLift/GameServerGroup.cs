namespace Humidifier.GameLift
{
    ...
    public class GameServerGroup : Humidifier.Base.BaseResource, IHaveImpliedResourceName, IHaveTags
    {
        ...
        /// </summary>
        public GameServerGroupTypes.AutoScalingPolicy AutoScalingPolicy { get; set; }
        /// <summary>
        /// MinSize
        ...
        /// Type: LaunchTemplate
        /// </summary>
        public GameServerGroupTypes.LaunchTemplate LaunchTemplate { get; set; }
        /// <summary>
    ...
    namespace GameServerGroupTypes
    {
        public class AutoScalingPolicy : Humidifier.Base.BaseSubResource
        {
            ...
            /// </summary>
            public GameServerGroupTypes.TargetTrackingConfiguration TargetTrackingConfiguration { get; set; }
            /// <summary>
        ...
        public class InstanceDefinition : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// WeightedCapacity
