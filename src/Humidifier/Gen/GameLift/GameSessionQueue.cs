namespace Humidifier.GameLift
{
    ...
    public class GameSessionQueue : Humidifier.Base.BaseResource, IHaveImpliedResourceName, IHaveTags
    {
        ...
        /// </summary>
        public List<GameSessionQueueTypes.PlayerLatencyPolicy> PlayerLatencyPolicies { get; set; }
        /// <summary>
        /// Destinations
        ...
        /// </summary>
        public List<GameSessionQueueTypes.GameSessionQueueDestination> Destinations { get; set; }
        /// <summary>
        /// NotificationTarget
        ...
        /// </summary>
        public GameSessionQueueTypes.FilterConfiguration FilterConfiguration { get; set; }
        /// <summary>
        /// CustomEventData
        ...
        /// </summary>
        public GameSessionQueueTypes.PriorityConfiguration PriorityConfiguration { get; set; }
    }
    ...
    namespace GameSessionQueueTypes
    {
        ...
        public class GameSessionQueueDestination : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// DestinationArn
