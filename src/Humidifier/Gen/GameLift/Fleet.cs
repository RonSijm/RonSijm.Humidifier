namespace Humidifier.GameLift
{
    ...
    public class Fleet : Humidifier.Base.BaseResource, IHaveImpliedResourceName, IHaveDescription
    {
        ...
        /// </summary>
        public List<FleetTypes.ScalingPolicy> ScalingPolicies { get; set; }
        /// <summary>
        /// Description
        ...
        /// </summary>
        public List<FleetTypes.IpPermission> EC2InboundPermissions { get; set; }
        /// <summary>
        ...
        /// </summary>
        public FleetTypes.ContainerGroupsConfiguration ContainerGroupsConfiguration { get; set; }
        /// <summary>
        /// ComputeType
        ...
        /// </summary>
        public FleetTypes.AnywhereConfiguration AnywhereConfiguration { get; set; }
        /// <summary>
        /// InstanceRoleARN
        ...
        /// </summary>
        public FleetTypes.CertificateConfiguration CertificateConfiguration { get; set; }
        /// <summary>
        ...
        /// </summary>
        public List<FleetTypes.LocationConfiguration> Locations { get; set; }
        /// <summary>
        ...
        /// </summary>
        public FleetTypes.RuntimeConfiguration RuntimeConfiguration { get; set; }
        /// <summary>
        /// MinSize
        ...
        /// </summary>
        public FleetTypes.ResourceCreationLimitPolicy ResourceCreationLimitPolicy { get; set; }
        /// <summary>
        /// EC2InstanceType
    ...
    namespace FleetTypes
    {
        ...
        public class CertificateConfiguration : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// CertificateType
        ...
        public class ConnectionPortRange : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// FromPort
        ...
        public class ContainerGroupsConfiguration : Humidifier.Base.BaseSubResource
        {
            ...
            /// </summary>
            public FleetTypes.ConnectionPortRange ConnectionPortRange { get; set; }
            /// <summary>
            ...
            /// </summary>
            public FleetTypes.ContainerGroupsPerInstance ContainerGroupsPerInstance { get; set; }
        }
        ...
        public class IpPermission : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// IpRange
        ...
        public class LocationCapacity : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// MinSize
        ...
        public class LocationConfiguration : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// LocationCapacity
            ...
            /// </summary>
            public FleetTypes.LocationCapacity LocationCapacity { get; set; }
            /// <summary>
            /// Location
        ...
        public class RuntimeConfiguration : Humidifier.Base.BaseSubResource
        {
            ...
            /// </summary>
            public List<FleetTypes.ServerProcess> ServerProcesses { get; set; }
            /// <summary>
        ...
        public class ScalingPolicy : Humidifier.Base.BaseSubResource
        {
            ...
            /// </summary>
            public FleetTypes.TargetConfiguration TargetConfiguration { get; set; }
            /// <summary>
            /// UpdateStatus
        ...
        public class ServerProcess : Humidifier.Base.BaseSubResource
        {
            /// <summary>
