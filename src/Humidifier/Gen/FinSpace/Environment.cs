namespace Humidifier.FinSpace
{
    ...
    public class Environment : Humidifier.Base.BaseResource, IHaveImpliedResourceName, IHaveTags, IHaveDescription, IHaveKmsKeyId
    {
        ...
        /// </summary>
        public EnvironmentTypes.FederationParameters FederationParameters { get; set; }
        /// <summary>
        /// FederationMode
        ...
        /// </summary>
        public EnvironmentTypes.SuperuserParameters SuperuserParameters { get; set; }
        /// <summary>
        /// Tags
    ...
    {
        public class AttributeMapItems : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// Value
        ...
        public class FederationParameters : Humidifier.Base.BaseSubResource
        {
            ...
            /// </summary>
            public List<EnvironmentTypes.AttributeMapItems> AttributeMap { get; set; }
            /// <summary>
        ...
        public class SuperuserParameters : Humidifier.Base.BaseSubResource
        {
            /// <summary>
            /// FirstName
