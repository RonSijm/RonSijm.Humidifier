namespace Humidifier.Evidently
{
    ...
    public class Experiment : Humidifier.Resource, IHaveTags, IHaveDescription
    {
        ...
        /// </summary>
        public RunningStatusObject RunningStatus { get; set; }
        /// <summary>
        /// Description
        ...
        /// </summary>
        public List<MetricGoalObject> MetricGoals { get; set; }
        /// <summary>
        /// OnlineAbConfig
        ...
        /// </summary>
        public OnlineAbConfigObject OnlineAbConfig { get; set; }
        /// <summary>
        /// RemoveSegment
        ...
        /// </summary>
        public List<TreatmentObject> Treatments { get; set; }
        /// <summary>
        /// SamplingRate
    ...
    namespace ExperimentTypes
    {
        ...
        public class OnlineAbConfigObject
        {
            /// <summary>
            /// TreatmentWeights
            ...
            /// </summary>
            public List<TreatmentToWeight> TreatmentWeights { get; set; }
            /// <summary>
        ...
        public class RunningStatusObject
        {
            /// <summary>
            /// Status
        ...
        public class TreatmentToWeight
        {
            /// <summary>
            /// Treatment
