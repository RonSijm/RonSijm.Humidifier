namespace Humidifier.SecurityLake
{
    ...
    public class Subscriber : Humidifier.Resource, IHaveTags
    {
        ...
        /// </summary>
        public SubscriberIdentity SubscriberIdentity { get; set; }
        /// <summary>
        /// SubscriberName
        ...
        /// </summary>
        public dynamic SubscriberName { get; set; }
        /// <summary>
    ...
    namespace SubscriberTypes
    {
        ...
        public class Source
        {
            ...
            /// Type: AwsLogSource
            /// </summary>
            public AwsLogSource AwsLogSource { get; set; }
            /// <summary>
            /// CustomLogSource
            ...
            /// </summary>
            public CustomLogSource CustomLogSource { get; set; }
        }
