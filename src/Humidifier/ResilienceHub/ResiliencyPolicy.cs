namespace Humidifier.ResilienceHub
{
    ...
    public class ResiliencyPolicy : Humidifier.Resource
    {
        ...
        /// Type: PolicyMap
        /// </summary>
        public PolicyMap Policy { get; set; }
        /// <summary>
        /// PolicyDescription
    ...
    namespace ResiliencyPolicyTypes
    {
        ...
        public class PolicyMap
        {
            ...
            /// Type: FailurePolicy
            /// </summary>
            public FailurePolicy AZ { get; set; }
            /// <summary>
            /// Region
            ...
            /// Type: FailurePolicy
            /// </summary>
            public FailurePolicy Region { get; set; }
            /// <summary>
            /// Hardware
            ...
            /// Type: FailurePolicy
            /// </summary>
            public FailurePolicy Hardware { get; set; }
            /// <summary>
            /// Software
            ...
            /// Type: FailurePolicy
            /// </summary>
            public FailurePolicy Software { get; set; }
        }
    }
}