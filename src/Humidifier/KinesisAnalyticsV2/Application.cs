namespace Humidifier.KinesisAnalyticsV2
{
    ...
    public class Application : Humidifier.Resource, IHaveTags
    {
        ...
        /// </summary>
        public ApplicationMaintenanceConfiguration ApplicationMaintenanceConfiguration { get; set; }
        /// <summary>
    ...
    namespace ApplicationTypes
    {
        ...
        public class ApplicationConfiguration
        {
            ...
            /// </summary>
            public List<VpcConfiguration> VpcConfigurations { get; set; }
            /// <summary>
            ...
            /// </summary>
            public ApplicationSystemRollbackConfiguration ApplicationSystemRollbackConfiguration { get; set; }
        }

        public class ApplicationMaintenanceConfiguration
        {
            /// <summary>
        ...
        public class ApplicationSystemRollbackConfiguration
        {
            /// <summary>
            /// RollbackEnabled
