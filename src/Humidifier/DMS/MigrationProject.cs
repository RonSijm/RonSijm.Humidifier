namespace Humidifier.DMS
{
    ...
    public class MigrationProject : Humidifier.Resource, IHaveTags, IHaveDescription
    {
        ...
        /// </summary>
        public List<DataProviderDescriptor> TargetDataProviderDescriptors { get; set; }
        /// <summary>
        ...
        /// </summary>
        public dynamic MigrationProjectName { get; set; }
        /// <summary>
        /// InstanceProfileName
        ...
        /// ItemType: DataProviderDescriptor
        /// </summary>
        public List<DataProviderDescriptor> SourceDataProviderDescriptors { get; set; }
        /// <summary>
        /// TransformationRules
        ...
        /// </summary>
        public SchemaConversionApplicationAttributes SchemaConversionApplicationAttributes { get; set; }
        /// <summary>
        /// InstanceProfileArn
    ...
    namespace MigrationProjectTypes
    {
        ...
        public class SchemaConversionApplicationAttributes
        {
            /// <summary>
            /// S3BucketPath
