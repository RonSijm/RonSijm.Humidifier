namespace Humidifier.QBusiness
{
    ...
    namespace DataSourceTypes
    {
        ...
        public class DocumentEnrichmentConfiguration
        {
            /// <summary>
            ...
            /// </summary>
            public List<InlineDocumentEnrichmentConfiguration> InlineConfigurations { get; set; }
            /// <summary>
        ...
        public class InlineDocumentEnrichmentConfiguration
        {
            /// <summary>
            /// Condition
