namespace Humidifier.Glue
{
    ...
    public class TableOptimizer : Humidifier.Resource
    {
        ...
        /// </summary>
        public TableOptimizerConfiguration TableOptimizerConfiguration { get; set; }
        /// <summary>
        /// CatalogId
    ...
    {
        public class TableOptimizerConfiguration
        {
            /// <summary>
            /// Enabled
