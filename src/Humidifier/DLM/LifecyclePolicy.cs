namespace Humidifier.DLM
{
    ...
    public class LifecyclePolicy : Humidifier.Resource
    {
        ...
        /// </summary>
        public CrossRegionCopyTargets CrossRegionCopyTargets { get; set; }
        /// <summary>
        /// PolicyDetails
    ...
    namespace LifecyclePolicyTypes
    {
        ...
        public class CrossRegionCopyTarget
        {
            /// <summary>
            /// TargetRegion
        ...
        public class CrossRegionCopyTargets
        {
        }
        ...
        public class ExcludeVolumeTypesList
        {
        }
        ...
        public class Exclusions
        {
            ...
            /// Type: ExcludeTags
            /// </summary>
            public ExcludeTags ExcludeTags { get; set; }
            /// <summary>
            /// ExcludeVolumeTypes
            ...
            /// </summary>
            public ExcludeVolumeTypesList ExcludeVolumeTypes { get; set; }
        }
