namespace Humidifier.EMR
{
    ...
    public class Cluster : Humidifier.Resource, IHaveTags
    {
        ...
        /// </summary>
        public List<PlacementGroupConfig> PlacementGroupConfigs { get; set; }
        /// <summary>
        /// ReleaseLabel
    ...
    namespace ClusterTypes
    {
        ...
        public class JobFlowInstancesConfig
        {
            ...
            /// </summary>
            public List<InstanceFleetConfig> TaskInstanceFleets { get; set; }
            /// <summary>
            /// TaskInstanceGroups
            ...
            /// </summary>
            public List<InstanceGroupConfig> TaskInstanceGroups { get; set; }
            /// <summary>
