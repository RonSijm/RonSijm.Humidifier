namespace Humidifier.SageMaker
{
    ...
    public class EndpointConfig : Humidifier.Resource, IHaveTags
    {
        ...
        /// </summary>
        public List<ProductionVariant> ShadowProductionVariants { get; set; }
        /// <summary>
        /// DataCaptureConfig
    ...
    namespace EndpointConfigTypes
    {
        ...
        public class ClarifyInferenceConfig
        {
            ...
            /// </summary>
            public List<ClarifyHeader> LabelHeaders { get; set; }
            /// <summary>
            /// MaxPayloadInMB
            ...
            /// </summary>
            public List<ClarifyFeatureType> FeatureTypes { get; set; }
            /// <summary>
            /// FeatureHeaders
            ...
            /// ItemType: ClarifyHeader
            /// </summary>
            public List<ClarifyHeader> FeatureHeaders { get; set; }
            /// <summary>
            /// LabelIndex
        ...
        public class ManagedInstanceScaling
        {
            /// <summary>
            /// Status
        ...
        public class ProductionVariant
        {
            ...
            /// </summary>
            public ManagedInstanceScaling ManagedInstanceScaling { get; set; }
            /// <summary>
            /// ModelName
            ...
            /// </summary>
            public ServerlessConfig ServerlessConfig { get; set; }
            /// <summary>
            /// InstanceType
