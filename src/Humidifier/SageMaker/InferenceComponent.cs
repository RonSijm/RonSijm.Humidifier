namespace Humidifier.SageMaker
{
    ...
    public class InferenceComponent : Humidifier.Resource
    {
        ...
        /// PrimitiveType: String
        /// </summary>
        public dynamic InferenceComponentName { get; set; }
        /// <summary>
        /// Specification
        ...
        /// </summary>
        public InferenceComponentSpecification Specification { get; set; }
        /// <summary>
        /// RuntimeConfig
        ...
        /// </summary>
        public InferenceComponentRuntimeConfig RuntimeConfig { get; set; }
        /// <summary>
        /// EndpointArn
    ...
    namespace InferenceComponentTypes
    {
        ...
        public class InferenceComponentContainerSpecification
        {
            ...
            /// Type: DeployedImage
            /// </summary>
            public DeployedImage DeployedImage { get; set; }
            /// <summary>
            /// Image
        ...
        public class InferenceComponentRuntimeConfig
        {
            /// <summary>
            /// CurrentCopyCount
        ...
        public class InferenceComponentSpecification
        {
            ...
            /// </summary>
            public InferenceComponentContainerSpecification Container { get; set; }
            /// <summary>
            /// ModelName
            ...
            /// </summary>
            public InferenceComponentComputeResourceRequirements ComputeResourceRequirements { get; set; }
            /// <summary>
            /// StartupParameters
            ...
            /// </summary>
            public InferenceComponentStartupParameters StartupParameters { get; set; }
        }
