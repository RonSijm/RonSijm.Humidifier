namespace Humidifier.SageMaker
{
    ...
    public class ModelPackage : Humidifier.Resource
    {
        ...
        /// </summary>
        public ValidationSpecification ValidationSpecification { get; set; }
        /// <summary>
        ...
        /// </summary>
        public List<AdditionalInferenceSpecificationDefinition> AdditionalInferenceSpecificationsToAdd { get; set; }
        /// <summary>
        /// ModelPackageName
        ...
        /// ItemType: AdditionalInferenceSpecificationDefinition
        /// </summary>
        public List<AdditionalInferenceSpecificationDefinition> AdditionalInferenceSpecifications { get; set; }
    }
    ...
    namespace ModelPackageTypes
    {
        public class AdditionalInferenceSpecificationDefinition
        {
            ...
            /// </summary>
            public List<ModelPackageContainerDefinition> Containers { get; set; }
            /// <summary>
        ...
        public class ModelPackageStatusDetails
        {
            ...
            /// </summary>
            public List<ModelPackageStatusItem> ValidationStatuses { get; set; }
        }
        ...
        public class ValidationSpecification
        {
            ...
            /// </summary>
            public List<ValidationProfile> ValidationProfiles { get; set; }
        }
    }
}