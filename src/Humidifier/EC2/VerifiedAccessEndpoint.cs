namespace Humidifier.EC2
{
    ...
    public class VerifiedAccessEndpoint : Humidifier.Resource, IHaveTags, IHaveDescription
    {
        ...
        /// </summary>
        public NetworkInterfaceOptions NetworkInterfaceOptions { get; set; }
    }
    ...
    namespace VerifiedAccessEndpointTypes
    {
        ...
        public class NetworkInterfaceOptions
        {
            /// <summary>
            /// Port
