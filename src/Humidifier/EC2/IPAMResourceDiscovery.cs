namespace Humidifier.EC2
{
    ...
    public class IPAMResourceDiscovery : Humidifier.Resource, IHaveTags, IHaveDescription
    {
        ...
        /// </summary>
        public List<IpamOperatingRegion> OperatingRegions { get; set; }
    }

    namespace IPAMResourceDiscoveryTypes
    {
        public class IpamOperatingRegion
        {
            /// <summary>
            /// RegionName
