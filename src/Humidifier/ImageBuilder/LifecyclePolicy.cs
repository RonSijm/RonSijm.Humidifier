namespace Humidifier.ImageBuilder
{
    ...
    namespace LifecyclePolicyTypes
    {
        public class Action
        {
            ...
            /// </summary>
            public IncludeResources IncludeResources { get; set; }
        }

        public class AmiExclusionRules
        {
            /// <summary>
            /// IsPublic
            ...
            /// Type: LastLaunched
            /// </summary>
            public LastLaunched LastLaunched { get; set; }
            /// <summary>
            /// Regions
        ...
        public class ExclusionRules
        {
            ...
            /// </summary>
            public AmiExclusionRules Amis { get; set; }
            /// <summary>
            /// TagMap
