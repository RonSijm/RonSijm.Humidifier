namespace Humidifier.Cassandra
{
    ...
    public class Table : Humidifier.Resource
    {
        ...
        /// </summary>
        public List<ReplicaSpecification> ReplicaSpecifications { get; set; }
        /// <summary>
        ...
        /// </summary>
        public AutoScalingSpecification AutoScalingSpecifications { get; set; }
        /// <summary>
    ...
    namespace TableTypes
    {
        ...
        public class AutoScalingSpecification
        {
            /// <summary>
            ...
            /// </summary>
            public AutoScalingSetting ReadCapacityAutoScaling { get; set; }
            /// <summary>
            ...
            /// Type: AutoScalingSetting
            /// </summary>
            public AutoScalingSetting WriteCapacityAutoScaling { get; set; }
        }
