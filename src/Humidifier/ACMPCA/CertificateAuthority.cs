namespace Humidifier.ACMPCA
{
    ...
    namespace CertificateAuthorityTypes
    {
        ...
        public class CrlConfiguration
        {
            ...
            /// </summary>
            public CrlDistributionPointExtensionConfiguration CrlDistributionPointExtensionConfiguration { get; set; }
            /// <summary>
            /// CustomCname
        ...
        public class CrlDistributionPointExtensionConfiguration
        {
            /// <summary>
            /// OmitExtension
