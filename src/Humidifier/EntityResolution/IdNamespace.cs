namespace Humidifier.EntityResolution
{
    ...
    public class IdNamespace : Humidifier.Resource, IHaveTags, IHaveDescription
    {
        ...
        /// </summary>
        public dynamic IdNamespaceName { get; set; }
        /// <summary>
        /// Type
        ...
        /// </summary>
        public List<IdNamespaceInputSource> InputSourceConfig { get; set; }
        /// <summary>
        ...
        /// </summary>
        public List<IdNamespaceIdMappingWorkflowProperties> IdMappingWorkflowProperties { get; set; }
        /// <summary>
        /// RoleArn
    ...
    {
        public class IdNamespaceIdMappingWorkflowProperties
        {
            /// <summary>
            /// RuleBasedProperties
        ...
        public class IdNamespaceInputSource
        {
            /// <summary>
            /// InputSourceARN
        ...
        public class NamespaceProviderProperties
        {
            /// <summary>
            /// ProviderServiceArn
        ...
        public class NamespaceRuleBasedProperties
        {
            /// <summary>
