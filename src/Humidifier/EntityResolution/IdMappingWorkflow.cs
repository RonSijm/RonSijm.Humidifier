namespace Humidifier.EntityResolution
{
    ...
    public class IdMappingWorkflow : Humidifier.Resource
    {
        ...
        /// </summary>
        public List<IdMappingWorkflowInputSource> InputSourceConfig { get; set; }
        /// <summary>
        /// IdMappingTechniques
        ...
        /// </summary>
        public List<IdMappingWorkflowOutputSource> OutputSourceConfig { get; set; }
        /// <summary>
        /// RoleArn
    ...
    {
        public class IdMappingRuleBasedProperties
        {
            /// <summary>
        ...
        public class IdMappingTechniques
        {
            /// <summary>
            /// RuleBasedProperties
        ...
        public class IdMappingWorkflowOutputSource
        {
            /// <summary>
            /// KMSArn
