namespace Humidifier.ARCZonalShift
{
    ...
    public class ZonalAutoshiftConfiguration : Humidifier.Resource
    {
    ...
    namespace ZonalAutoshiftConfigurationTypes
    {
        ...
        public class PracticeRunConfiguration
        {
            /// <summary>
            /// BlockedDates
            ...
            /// </summary>
            public List<ControlCondition> OutcomeAlarms { get; set; }
            /// <summary>
            /// BlockingAlarms
            ...
            /// ItemType: ControlCondition
            /// </summary>
            public List<ControlCondition> BlockingAlarms { get; set; }
            /// <summary>
            /// BlockedWindows
