namespace Humidifier.IoTSiteWise
{
    ...
    public class AssetModel : Humidifier.Resource, IHaveTags
    {
        ...
        /// PrimitiveType: String
        /// </summary>
        public dynamic AssetModelName { get; set; }
        /// <summary>
        ...
        /// </summary>
        public List<AssetModelProperty> AssetModelProperties { get; set; }
        /// <summary>
    ...
    namespace AssetModelTypes
    {
        ...
        public class PropertyPathDefinition
        {
            /// <summary>
            /// Name
        ...
        public class VariableValue
        {
            ...
            /// </summary>
            public List<PropertyPathDefinition> PropertyPath { get; set; }
            /// <summary>
            /// HierarchyExternalId
