namespace Humidifier.CodePipeline
{
    ...
    public class Pipeline : Humidifier.Resource, IHaveTags
    {
        ...
        /// </summary>
        public List<PipelineTriggerDeclaration> Triggers { get; set; }
        /// <summary>
        /// RoleArn
    ...
    namespace PipelineTypes
    {
        ...
        public class GitBranchFilterCriteria
        {
            /// <summary>
            /// Includes
        ...
        public class GitConfiguration
        {
            ...
            /// </summary>
            public List<GitPullRequestFilter> PullRequest { get; set; }
            /// <summary>
            /// Push
            ...
            /// </summary>
            public List<GitPushFilter> Push { get; set; }
            /// <summary>
            /// SourceActionName
        ...
        public class GitFilePathFilterCriteria
        {
            /// <summary>
            /// Includes
        ...
        public class GitPullRequestFilter
        {
            ...
            /// </summary>
            public GitFilePathFilterCriteria FilePaths { get; set; }
            /// <summary>
            /// Events
            ...
            /// </summary>
            public GitBranchFilterCriteria Branches { get; set; }
        }
        ...
        public class GitPushFilter
        {
            ...
            /// </summary>
            public GitTagFilterCriteria Tags { get; set; }
        }
        ...
        public class StageDeclaration
        {
            ...
            /// </summary>
            public FailureConditions OnFailure { get; set; }
        }
