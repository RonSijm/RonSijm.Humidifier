namespace Humidifier.BCMDataExports
{
    ...
    public class Export : Humidifier.Resource
    {
    ...
    namespace ExportTypes
    {
        ...
        public class DestinationConfigurations
        {
            /// <summary>
            /// S3Destination
        ...
        public class Export
        {
            ...
            /// Type: RefreshCadence
            /// </summary>
            public RefreshCadence RefreshCadence { get; set; }
            /// <summary>
            /// ExportArn
            ...
            /// </summary>
            public DestinationConfigurations DestinationConfigurations { get; set; }
            /// <summary>
            /// Name
        ...
        public class S3Destination
        {
            ...
            /// </summary>
            public S3OutputConfigurations S3OutputConfigurations { get; set; }
            /// <summary>
            /// S3Region
