namespace Humidifier.RedshiftServerless
{
    ...
    public class Namespace : Humidifier.Resource, IHaveTags
    {
        ...
        /// </summary>
        public List<SnapshotCopyConfiguration> SnapshotCopyConfigurations { get; set; }
        /// <summary>
        /// KmsKeyId
    ...
    namespace NamespaceTypes
    {
        ...
        public class SnapshotCopyConfiguration
        {
            /// <summary>
