namespace Humidifier.Neptune
{
    ...
    public class DBCluster : Humidifier.Resource, IHaveTags
    {
        ...
        /// </summary>
        public ServerlessScalingConfiguration ServerlessScalingConfiguration { get; set; }
        /// <summary>
    ...
    namespace DBClusterTypes
    {
        ...
        public class ServerlessScalingConfiguration
        {
            /// <summary>
            /// MinCapacity
