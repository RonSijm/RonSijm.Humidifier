namespace Humidifier.IoT
{
    ...
    public class AccountAuditConfiguration : Humidifier.Resource
    {
    ...
    namespace AccountAuditConfigurationTypes
    {
        ...
        public class AuditCheckConfigurations
        {
            ...
            /// Type: AuditCheckConfiguration
            /// </summary>
            public AuditCheckConfiguration IntermediateCaRevokedForActiveDeviceCertificatesCheck { get; set; }
            /// <summary>
            ...
            /// Type: AuditCheckConfiguration
            /// </summary>
            public AuditCheckConfiguration IoTPolicyPotentialMisConfigurationCheck { get; set; }
            /// <summary>
