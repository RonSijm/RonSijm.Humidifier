...
public class ExampleStackGenerationTest : BaseStackBuilderTest
{
    protected override Task<Stack> BuildStack()
    {
        ...
        stack.Add("MonitoringSnsTopic", new SNS.Topic
        {
            ...
            Subscription = new List<SNS.TopicTypes.Subscription>
            {
                new SNS.TopicTypes.Subscription { Endpoint = "team@example.com", Protocol = "email" }
            }
        });
        ...
        stack.Resources.Add("AspNetCoreFunction", new Serverless.Function
        {
